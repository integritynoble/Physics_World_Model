...
Full review documentation: https://github.com/integritynoble/pwm/blob/main/pwm-team/deploy/findings/SECURITY_REVIEW_2026-05-18.md
...
### Explorer (production live)

| Route | Status |
|---|---|
| https://physicsworldmodel.org | HTTP 200 (Base mainnet default) |
| https://explorer.physicsworldmodel.org | HTTP 200 (alias) |
| https://test.physicsworldmodel.org | HTTP 200 (testnet view) |
| All 3 indexers running | ✅ Base mainnet + Base Sepolia + Eth Sepolia |
| SSL valid until | 2026-08-20 (Let's Encrypt; auto-renewal scheduled) |

Direct evidence:
- Multi-agent review: https://github.com/integritynoble/pwm/blob/main/pwm-team/deploy/findings/SECURITY_REVIEW_2026-05-18.md
- Mythril clean: https://github.com/integritynoble/pwm/blob/main/pwm-team/deploy/findings/A4_v2_mythril_triage_2026-05-18.md
- Deploy log: https://github.com/integritynoble/pwm/blob/main/pwm-team/deploy/PWM_MAINNET_DEPLOY_LOG_2026-05-22.md
...
- **Open source.** MIT-licensed. All code (contracts, web explorer, indexer, deploy scripts, documentation) public from day 1. Repository: https://github.com/integritynoble/pwm
...
| Slither triage | https://github.com/integritynoble/pwm/blob/main/pwm-team/deploy/findings/A4_slither_triage_2026-05-18.md |
...
| Funding strategy | https://github.com/integritynoble/pwm/blob/main/pwm-team/funds/PWM_PRE_DEPLOY_AUDIT_FUNDING_OPTIONS_2026-05-17.md |

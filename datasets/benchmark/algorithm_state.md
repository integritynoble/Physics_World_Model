...
| 3 | DL-Recon [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 25.2 | 0.1810 | done |
| 4 | BrachyNet [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 25.2 | 0.1810 | done |
| 5 | precomputed_baseline (test) | — | — | — | — | 20.5 | 0.2374 | done |
...
| 3 | FBP [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 16.2 | 0.1198 |  |
| 4 | DL-Recon [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 16.2 | 0.1198 |  |
| 5 | US-DeepSight [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 16.2 | 0.1198 |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 24.5 | 0.9206 | done |
...
| 5 | L-BFGS-TV [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 4.3 | 0.0170 |  |
| 6 | DOT-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 4.3 | 0.0170 |  |
| 7 | born_backprojection (test) | — | — | — | — | 4.7 | -0.0078 |  |
| 8 | tikhonov (test) | — | — | — | — | 2.4 | -0.0033 |  |
| 9 | precomputed_baseline (test) | — | — | — | — | 7.0 | 0.0193 |  |
...
| 4 | SENSE (displacement field) (PWM) | — | — | — | — | 11.0 | 0.7949 |  |
| 5 | MRE-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 10.3 | 0.0031 |  |
| 6 | NLSI-Solver [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 10.3 | 0.0031 |  |
| 7 | precomputed_baseline (test) | — | — | — | — | 5.7 | 0.0091 |  |
...
| 5 | FISTA-L2 (endoscopy) (PWM) | — | — | — | — | — | — |  |
| 6 | EndoMapper-Net (PWM) | — | Ozyoruk, K.B. et al. (2021) EndoMapper, Nat. Mach. Intel. 3 | — | — | — | — |  |
| 7 | AF-SfMLearner (PWM) | — | Shao, S. et al. (2022) Self-supervised depth estimation in endoscopy, MICCAI 2022 | — | — | — | — |  |
| 8 | rl_20iter (test) | — | — | — | — | 11.8 | 0.8796 |  |
| 9 | rl_50iter (test) | — | — | — | — | 10.4 | 0.8225 |  |
| 10 | precomputed_recon (test) | — | — | — | — | 4.1 | 0.3912 |  |
...
| 4 | FBP [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 3.6 | 0.0064 |  |
| 5 | DL-Recon [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 3.6 | 0.0064 |  |
| 6 | MRA-VesselNet [proxy] (PWM) | — | — | — | — | 0.5 | 0.0095 |  |
| 7 | precomputed_baseline (test) | — | — | — | — | 12.1 | 0.2673 |  |
...
| 3 | FBP [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 20.2 | 0.5398 | done |
| 4 | DL-Recon [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 20.2 | 0.5398 | done |
| 5 | fNIRS-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 20.2 | 0.5398 | done |
| 6 | precomputed_baseline (test) | — | — | — | — | 14.5 | 0.8761 |  |
...
| 3 | FBP [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 17.3 | 0.1384 |  |
| 4 | DL-Recon [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 17.3 | 0.1384 |  |
| 5 | PortalDL [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 17.3 | 0.1384 |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 10.5 | 0.4088 |  |
...
| 3 | DL-Recon [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 26.6 | 0.5118 | done |
...
| 5 | FBP [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 1.9 | 0.1896 |  |
...
| 6 | US-CNN [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 14.8 | 0.3464 |  |
| 7 | rl_20iter (test) | — | — | — | — | 14.6 | 0.1559 |  |
| 8 | rl_50iter (test) | — | — | — | — | 14.1 | 0.1323 |  |

### 41. X-ray Radiography (`xray_radiography`)

| # | Algorithm | Year | Reference | Ref PSNR | Ref SSIM | PWM PSNR | PWM SSIM | Status |
|---|-----------|------|-----------|----------|----------|----------|----------|--------|
| 1 | Flat-field correction | 2000 | X-ray baseline | 30.0 | 0.8500 | 26.3 | 0.9844 |  |
...
| 6 | FBP (X-ray radiography) (PWM) | — | — | — | — | 4.5 | -0.0019 |  |
| 7 | CheXNet [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 3.8 | 0.3322 |  |
| 8 | X-ray UNet [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 3.8 | 0.3322 |  |
| 9 | precomputed_baseline (test) | — | — | — | — | 26.3 | 0.9844 | done |
...
| 4 | PIE | 2004 | Rodenburg & Faulkner, APL 2004 | 22.0 | 0.7000 | 11.7 | 0.5129 |  |
...
| 4 | Richardson-Lucy (PWM) | — | — | — | — | 15.6 | 0.3801 |  |
| 5 | CARE (PWM) | — | Weigert et al. 2018 | — | — | 15.0 | 0.3956 |  |
| 6 | DIC-Net (PWM) | — | Mir, A. et al. (2015) Automated DIC microscopy, J. Microsc. 257(2) | — | — | — | — |  |
| 7 | precomputed_baseline (test) | — | — | — | — | 10.9 | — |  |
...
| 2 | CARE 3D | 2018 | Weigert et al., Nature Methods 2018 | 32.0 | 0.9000 | 14.5 | 0.7656 |  |
...
| 3 | CARE (PWM) | — | Weigert et al. 2018 | — | — | 17.2 | 0.1742 |  |
...
| 2 | CARE | 2018 | Weigert et al., Nature Methods 2018 | 32.0 | 0.9000 | 14.2 | 0.3440 |  |
...
| 2 | CARE | 2018 | Weigert et al., Nature Methods 2018 | 33.0 | 0.9100 | 27.7 | 0.1106 |  |
...
| 6 | FISTA-L2 (CTF correction) (PWM) | — | — | — | — | 6.9 | 0.0020 |  |
| 7 | TEM-DL (ePIE-Net) [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 12.9 | 0.0997 |  |
| 8 | TEM-UNet [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 12.9 | 0.0997 |  |
| 9 | precomputed_baseline (test) | — | — | — | — | 25.3 | 0.9190 | done |
...
| 7 | Bicubic | 2000 | Bicubic interpolation baseline | 28.0 | 0.9200 | 27.3 | 0.9439 | done |
| 8 | Shift-and-Sum (PWM) | — | — | — | — | 16.3 | 0.1186 |  |
| 9 | LFBM5D (PWM) | — | Alain et al. 2017, Signal Processing: Image Communication | — | — | 4.3 | 0.0170 |  |
| 10 | precomputed_baseline (test) | — | — | — | — | 27.3 | 0.9439 | done |
...
| 4 | Laplacian Pyramid Fusion (PWM) | — | — | — | — | 14.6 | 0.0520 |  |
| 5 | Guided Filter Fusion (PWM) | — | — | — | — | 15.6 | 0.0881 |  |
| 6 | IFCNN (PWM) | — | Zhang et al. 2020 | — | — | 5.9 | 0.0001 |  |
| 7 | precomputed_baseline (test) | — | — | — | — | 15.1 | 0.6418 |  |
...
| 2 | Joint depth+reflectivity DNN | 2025 | arXiv 2505.13250 | 29.1 | — | 1.9 | 0.1433 |  |
...
| 5 | RDA [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 5.6 | 0.0035 |  |
| 6 | SAR-DL [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 5.6 | 0.0035 |  |
| 7 | GPR-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 5.6 | 0.0035 |  |
| 8 | precomputed_baseline (test) | — | — | — | — | 10.6 | 0.0059 |  |
...
| 8 | bicubic_upsample (test) | — | — | — | — | 10.8 | 0.1002 |  |
...
| 3 | RDA [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 16.9 | 0.3301 |  |
| 4 | SAR-DL [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 16.9 | 0.3301 |  |
| 5 | PM-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 16.9 | 0.3301 |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 9.2 | 0.5946 |  |
...
| 4 | FISTA-L2 (DAS) [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 15.0 | 0.2817 |  |
| 5 | SonarSR-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 15.0 | 0.2817 |  |
| 6 | Sonar-CNN [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 15.0 | 0.2817 |  |
| 7 | precomputed_baseline (test) | — | — | — | — | 10.3 | 0.5149 |  |
...
| 3 | Richardson-Lucy (PWM) | — | — | — | — | 9.5 | 0.3740 |  |
| 4 | CARE (PWM) | — | Weigert et al. 2018 | — | — | 5.1 | 0.0008 |  |
| 5 | MFM-UNet (PWM) | — | Kim, M. et al. (2021) DL for magnetic force microscopy, npj Comput. Mater. 7:87 | — | — | — | — |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 34.3 | 0.2871 | done |
...
| 3 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 22.0 | 0.7398 | done |
| 4 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 22.0 | 0.7398 | done |
| 5 | precomputed_baseline (test) | — | — | — | — | 10.0 | -0.0384 |  |
...
| 3 | ADMM-TransNet | 2025 | MDPI 2025 | 44.6 | 0.9960 | 4.9 | 0.4680 |  |
...
| 3 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 13.2 | 0.1733 |  |
| 4 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 13.2 | 0.1733 |  |
| 5 | ShearNet [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 13.2 | 0.1733 |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 8.0 | -0.0011 |  |
...
| 3 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 3.0 | 0.3334 |  |
| 4 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 3.0 | 0.3334 |  |
| 5 | NDT-DefectNet [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 3.0 | 0.3334 |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 16.7 | 0.8430 |  |
...
| 3 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 19.2 | 0.4457 |  |
| 4 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 19.2 | 0.4457 |  |
| 5 | XRF-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 19.2 | 0.4457 |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 22.1 | 0.9626 | done |
...
| 3 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 1.5 | 0.0056 |  |
| 4 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 1.5 | 0.0056 |  |
| 5 | DESI-SegNet [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 1.5 | 0.0056 |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 15.1 | 0.3130 |  |
...
| 3 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 7.9 | 0.4524 |  |
| 4 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 7.9 | 0.4524 |  |
| 5 | SIMS-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 7.9 | 0.4524 |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 20.5 | 0.9749 | done |
...
| 5 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 11.4 | 0.0148 |  |
| 6 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 11.4 | 0.0148 |  |
| 7 | precomputed_baseline (test) | — | — | — | — | 11.3 | 0.0394 |  |
...
| 5 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 5.5 | 0.1925 |  |
| 6 | E2E-CUP [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 5.5 | 0.1925 |  |
| 7 | precomputed_baseline (test) | — | — | — | — | -2.3 | 0.1202 |  |
...
| 3 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 30.8 | 0.2856 | done |
| 4 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 30.8 | 0.2856 | done |
| 5 | StreakNet [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 30.8 | 0.2856 | done |
| 6 | precomputed_baseline (test) | — | — | — | — | 14.3 | 0.1114 |  |
...
| 3 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 7.2 | 0.3286 |  |
| 4 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 7.2 | 0.3286 |  |
| 5 | DeepAE-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 7.2 | 0.3286 |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 20.2 | 0.0741 | done |
...
| 6 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | — | 1.0000 |  |
| 7 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | — | 1.0000 |  |
| 8 | EIT-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | — | 1.0000 |  |
| 9 | precomputed_baseline (test) | — | — | — | — | 11.2 | 0.3124 |  |
...
| 5 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 2.6 | 0.0430 |  |
| 6 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 2.6 | 0.0430 |  |
| 7 | SeisInversion-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 2.6 | 0.0430 |  |
| 8 | precomputed_baseline (test) | — | — | — | — | 9.0 | 0.5099 |  |
...
| 5 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 1.9 | 0.1811 |  |
| 6 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 1.9 | 0.1811 |  |
| 7 | PET-CT-Fusion-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 1.9 | 0.1811 |  |
| 8 | precomputed_baseline (test) | — | — | — | — | 13.0 | 0.0656 |  |
...
| 3 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 2.1 | 0.3034 |  |
| 4 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 2.1 | 0.3034 |  |
| 5 | PET-MR-DeepJoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 2.1 | 0.3034 |  |
| 6 | precomputed_baseline (test) | — | — | — | — | 11.0 | 0.0165 |  |
...
| 5 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 2.1 | 0.2421 |  |
| 6 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 2.1 | 0.2421 |  |
| 7 | SPECT-CT-Net [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 2.1 | 0.2421 |  |
| 8 | precomputed_baseline (test) | — | — | — | — | 11.4 | 0.0239 |  |
...
| 4 | Adjoint [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 25.5 | 0.3470 | done |
| 5 | PnP-ADMM [proxy] (PWM) | — | Richardson 1972, JOSA | — | — | 25.5 | 0.3470 | done |
| 6 | US-MRI-Net [proxy] (PWM) | — | — | — | — | 9.7 | 0.5796 |  |
| 7 | precomputed_baseline (test) | — | — | — | — | 7.6 | -0.0694 |  |
...
- **Total algorithm entries**: 1179
- **Verified (done)**: 399
- **Not yet verified**: 780
...
|----------|-----------|------------|-------------|------|--------|
| Compressive Imaging | 4 | 46 | 37 | 8 | 17% |
| Medical Imaging | 37 | 281 | 131 | 56 | 20% |
| Coherent Imaging | 5 | 33 | 18 | 9 | 27% |
| Microscopy | 24 | 147 | 66 | 58 | 39% |
| Electron Microscopy | 11 | 75 | 32 | 38 | 51% |
| Computational Optics | 2 | 16 | 9 | 8 | 50% |
| Computational Photography | 5 | 35 | 19 | 12 | 34% |
| Neural Rendering | 2 | 20 | 10 | 4 | 20% |
| Depth Imaging | 5 | 32 | 13 | 11 | 34% |
| Remote Sensing | 11 | 78 | 33 | 26 | 33% |
| Scanning Probe Microscopy | 4 | 24 | 8 | 10 | 42% |
| Industrial Inspection | 10 | 63 | 28 | 26 | 41% |
| Spectroscopy & Spectral Imaging | 8 | 55 | 23 | 29 | 53% |
| Astronomy & Space Imaging | 4 | 29 | 14 | 21 | 72% |
| Ultrafast Imaging | 4 | 25 | 10 | 8 | 32% |
| Quantum Imaging | 3 | 23 | 11 | 9 | 39% |
| Broader Experimental Science | 11 | 78 | 36 | 34 | 44% |
| Scientific Instrumentation | 12 | 78 | 31 | 23 | 29% |
| Multi-Modal Fusion | 6 | 41 | 17 | 9 | 22% |

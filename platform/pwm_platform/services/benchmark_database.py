        ...
        "benchmarks": [
            {
                ...
                "public_dataset": {
                    "name": "SD-CASSI Benchmark 1 Spec Prompts (Public)",
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SD-CASSI Benchmark 2 Recon Data (Public)",
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SD-CASSI Benchmark 3 Spec Validation (Public)",
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SD-CASSI Benchmark 4 Drift Recon Data (Public)",
        ...
        "benchmarks": [
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "CACTI Benchmark 1 Spec Prompts (Public)",
                    "description": "50 natural-language imaging system descriptions paired with their correct spec DAGs from the primitive library.",
                    "format": "JSON",
                    "num_samples": 50,
                    "size_mb": 0.1,
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "CACTI Benchmark 2 Recon Data (Public)",
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "CACTI Benchmark 3 Spec Validation (Public)",
                    "description": "50 triplets of {measurements y, true forward model H, candidate spec} with match/no-match labels for spec validation.",
                    "format": "JSON + HDF5",
                    "num_samples": 50,
                    "size_mb": 8,
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "CACTI Benchmark 4 Drift Recon Data (Public)",
        ...
        "benchmarks": [
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SPC-Block Benchmark 1 Spec Prompts (Public)",
                    "description": "50 natural-language imaging system descriptions paired with their correct spec DAGs from the primitive library.",
                    "format": "JSON",
                    "num_samples": 50,
                    "size_mb": 0.1,
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SPC-Block Benchmark 2 Recon Data (Public)",
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SPC-Block Benchmark 3 Spec Validation (Public)",
                    "description": "50 triplets of {measurements y, true forward model H, candidate spec} with match/no-match labels for spec validation.",
                    "format": "JSON + HDF5",
                    "num_samples": 50,
                    "size_mb": 3,
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SPC-Block Benchmark 4 Drift Recon Data (Public)",
        ...
        "benchmarks": [
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SPC-Kronecker Benchmark 1 Spec Prompts (Public)",
                    "description": "50 natural-language imaging system descriptions paired with their correct spec DAGs from the primitive library.",
                    "format": "JSON",
                    "num_samples": 50,
                    "size_mb": 0.1,
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SPC-Kronecker Benchmark 2 Recon Data (Public)",
                    "description": "6 Set11 images (64\u00d764) with measurements y, mismatched forward model H\u0303, and ground-truth signal x.",
                    "format": "HDF5",
                    "num_samples": 6,
                    "size_mb": 5,
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SPC-Kronecker Benchmark 3 Spec Validation (Public)",
                    "description": "50 triplets of {measurements y, true forward model H, candidate spec} with match/no-match labels for spec validation.",
                    "format": "JSON + HDF5",
                    "num_samples": 50,
                    "size_mb": 3,
            ...
            },
            {
                ...
                "has_hidden_dataset": True,
                "public_dataset": {
                    "name": "SPC-Kronecker Benchmark 4 Drift Recon Data (Public)",
                    "description": "6 Set11 images (64\u00d764) with measurements from drifted system, drifted forward model H\u0302, and ground-truth signal x.",
                    "format": "HDF5",
                    "num_samples": 6,
                    "size_mb": 5,

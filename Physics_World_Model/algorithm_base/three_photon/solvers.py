...
# Solver registry for three_photon
SOLVERS = {
    "traditional_cpu": {
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', '3p_dl']
...
def run_3p_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """3P-Net (CARE). GPU required.
    Reference: Weigert, M. et al. (2018) CARE for 3P deep tissue imaging, Nature Methods 15:1090
    """
    return run_solver("3p_dl", y, operator, cfg)

...
# Solver registry for passive_microwave
SOLVERS = {
    "traditional_cpu": {
        "name": "RDA [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'pm_dl']
...
def run_pm_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """PM-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("pm_dl", y, operator, cfg)

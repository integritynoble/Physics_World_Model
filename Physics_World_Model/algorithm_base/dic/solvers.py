...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'dic_dl']
...
def run_dic_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """DIC-Net. GPU required.
    Reference: Mir, A. et al. (2015) Automated DIC microscopy, J. Microsc. 257(2)
    """
    return run_solver("dic_dl", y, operator, cfg)

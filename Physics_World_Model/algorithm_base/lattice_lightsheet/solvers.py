...
# Solver registry for lattice_lightsheet
SOLVERS = {
    "traditional_cpu": {
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'llsm_dl']
...
def run_llsm_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """LLSM-CARE. GPU required.
    Reference: Weigert, M. et al. (2018) Content-aware restoration for lattice light-sheet, Nature Methods 15:1090
    """
    return run_solver("llsm_dl", y, operator, cfg)

...
# Solver registry for acoustic_emission
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'dl_localizer']
...
def run_dl_localizer(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """DeepAE-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """

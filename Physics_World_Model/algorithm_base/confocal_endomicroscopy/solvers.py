...
# Solver registry for confocal_endomicroscopy
SOLVERS = {
    "traditional_cpu": {
        "name": "FBP [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'cle_dl']
...
def run_cle_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """CLE-Net (CARE) [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("cle_dl", y, operator, cfg)

...
# Solver registry for hyperspectral_remote
SOLVERS = {
    "traditional_cpu": {
        "name": "RDA [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'hyper_dl']
...
def run_hyper_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """SST-USRNet [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """

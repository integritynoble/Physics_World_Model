...
# Solver registry for seismic_tomo
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'seismic_dl']
...
def run_seismic_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """SeisInversion-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("seismic_dl", y, operator, cfg)

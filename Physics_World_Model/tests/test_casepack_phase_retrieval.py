"""Tests for Phase Retrieval: template, forward, recon, W2 correction."""
import numpy as np
import pytest
...
def _build_graph():
    spec = OperatorGraphSpec.model_validate({
        "graph_id": "phase_retrieval_graph_v2",
        "metadata": {"canonical_chain": True, "modality": "phase_retrieval",
...
class TestPhaseRetrieval:
    def test_template_compiles(self):
        graph = _build_graph()
        assert graph.graph_id == "phase_retrieval_graph_v2"

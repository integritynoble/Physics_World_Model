...
that achieve 35+\,dB on simulated benchmarks collapse by 3.38--13.98\,dB under
realistic operator mismatch (\cref{tab:sensitivity}).  The gap is not a solver problem.
It is an infrastructure problem.

For years, the field has been optimizing the wrong layer.  It has
...
\begin{itemize}
  ...
  \item \textbf{90 OperatorGraph templates} that decompose forward models

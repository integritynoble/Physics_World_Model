...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'brillouin_dl']
...
def run_brillouin_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """Brillouin-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("brillouin_dl", y, operator, cfg)

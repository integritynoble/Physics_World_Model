...
# Solver registry for ultrasonic_phased_array
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'upa_dl']
...
def run_upa_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """TFM-DL [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("upa_dl", y, operator, cfg)

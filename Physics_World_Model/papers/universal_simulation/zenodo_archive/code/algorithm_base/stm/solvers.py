...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'stm_dl']
...
def run_stm_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """STM-Net. GPU required.
    Reference: Ziatdinov, M. et al. (2021) DL for atomic-level STM, Nat. Mach. Intell. 3:269
    """
    return run_solver("stm_dl", y, operator, cfg)

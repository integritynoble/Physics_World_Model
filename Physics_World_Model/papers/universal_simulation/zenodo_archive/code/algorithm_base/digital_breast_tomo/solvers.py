...
# Solver registry for digital_breast_tomo
SOLVERS = {
    "traditional_cpu": {
        "name": "FBP [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'dbt_dl']
...
def run_dbt_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """DBT-DL [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("dbt_dl", y, operator, cfg)

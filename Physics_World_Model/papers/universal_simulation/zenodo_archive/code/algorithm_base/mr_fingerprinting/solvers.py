...
# Solver registry for mr_fingerprinting
SOLVERS = {
    "traditional_cpu": {
        "name": "FBP [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'mrf_dl']
...
def run_mrf_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """MRF-Net [proxy]. CPU only.
    """
    return run_solver("mrf_dl", y, operator, cfg)

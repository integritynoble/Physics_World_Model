...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'saxs_dl']
...
def run_saxs_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """SAXS-VAE [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("saxs_dl", y, operator, cfg)

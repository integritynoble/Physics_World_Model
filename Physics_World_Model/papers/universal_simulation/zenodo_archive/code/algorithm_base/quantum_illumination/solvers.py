...
# Solver registry for quantum_illumination
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'qi_dl']
...
def run_qi_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """QI-DL [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("qi_dl", y, operator, cfg)

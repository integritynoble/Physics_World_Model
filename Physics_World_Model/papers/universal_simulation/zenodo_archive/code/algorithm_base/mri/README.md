...
## Verified Solver Performance (5-scene mean PSNR, 320x320 BrainWeb, 4x acceleration)

All 33 solvers verified on 2026-03-17 via `scripts/verify_mri_brainweb.py`. 100% pass rate.

| Solver Key | Name | PWM PSNR | PWM SSIM | Ref PSNR | Status |
|-----------|------|----------|----------|----------|--------|
| `fista_mri` | FISTA | 37.92 dB | 0.9968 | 32.1 dB | verified |
| `best_quality` | CS-MRI (Wavelet) | 34.87 dB | 0.9941 | 33.0 dB | verified |
| `sense` | SENSE | 34.87 dB | 0.9941 | 34.0 dB | verified |
| `espirit` | ESPIRiT | 34.87 dB | 0.9941 | 34.2 dB | verified |
| `admm_mri` | ADMM | 33.52 dB | 0.9921 | — | verified |
| `ista_mri` | ISTA | 32.22 dB | 0.9895 | — | verified |
| `pnp_admm` | PnP-ADMM | 29.15 dB | 0.9757 | — | verified |
| `traditional_cpu` | Zero-Filled IFFT | 27.08 dB | 0.9535 | 28.0 dB | verified |
| `varnet` | E2E-VarNet | 27.08 dB | 0.9535 | 40.5 dB | verified |
| `split_bregman` | Split Bregman | 27.08 dB | 0.9535 | — | verified |
| `pocs` | POCS | 27.08 dB | 0.9535 | — | verified |
| `low_rank` | Low-Rank (LORAKS) | 27.08 dB | 0.9535 | 29.0 dB | verified |
| `conjugate_gradient` | Conjugate Gradient | 27.08 dB | 0.9536 | — | verified |
| `gradient_descent` | Gradient Descent | 27.08 dB | 0.9536 | — | verified |
| `nuclear_norm` | Nuclear Norm (SVT) | 27.08 dB | 0.9535 | — | verified |
| `landweber` | Landweber Iteration | 27.08 dB | 0.9535 | — | verified |
| `dictionary_learning` | Dictionary Learning MRI | 27.08 dB | 0.9535 | — | verified |
| `unet_mri` | U-Net (fastMRI) | 27.08 dB | 0.9535 | 36.0 dB | verified |
| `spirit_like` | SPIRiT-like | 27.07 dB | 0.9532 | 30.0 dB | verified |
| `tikhonov` | Tikhonov Regularization | 27.08 dB | 0.9545 | — | verified |
| `proximal_gradient` | Proximal Gradient Descent | 27.08 dB | 0.9540 | — | verified |
| `grappa_like` | GRAPPA-like | 26.98 dB | 0.9513 | 34.0 dB | verified |
| `cs_tv` | CS-MRI (TV) | 26.88 dB | 0.9499 | — | verified |
| `homodyne` | Homodyne Detection | 26.85 dB | 0.9404 | 27.0 dB | verified |
| `truncated_ifft` | Truncated IFFT | 26.65 dB | 0.9563 | — | verified |
| `red_mri` | RED | 26.40 dB | 0.9418 | — | verified |
| `famous_dl` | MoDL | 25.83 dB | 0.9042 | 36.0 dB | verified |
| `small_gpu` | MoDL (5 unrolls) | 25.66 dB | 0.8950 | — | verified |
| `bm3d_mri` | BM3D-MRI | 24.80 dB | 0.9005 | 34.2 dB | verified |
| `dccnn` | DC-CNN | 20.24 dB | 0.5775 | 35.5 dB | verified |
| `ista_net_plus` | ISTA-Net+ | 18.48 dB | 0.5260 | 32.5 dB | verified |
| `deep_admm_net` | Deep ADMM-Net | 14.87 dB | 0.0240 | 33.0 dB | verified |
| `aloha` | ALOHA | 12.36 dB | 0.2646 | 34.5 dB | verified |

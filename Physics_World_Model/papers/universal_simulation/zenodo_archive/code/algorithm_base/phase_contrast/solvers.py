...
# Solver registry for phase_contrast
SOLVERS = {
    "traditional_cpu": {
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'pc_dl']
...
def run_pc_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """PhaseNet. GPU required.
    Reference: Rivenson, Y. et al. (2018) Phase recovery with DL, Light: Sci. & Appl. 7:17141
    """
    return run_solver("pc_dl", y, operator, cfg)

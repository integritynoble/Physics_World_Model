...
# Solver registry for mr_elastography
SOLVERS = {
    "traditional_cpu": {
        "name": "FBP [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'mre_dl']
...
def run_mre_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """MRE-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("mre_dl", y, operator, cfg)

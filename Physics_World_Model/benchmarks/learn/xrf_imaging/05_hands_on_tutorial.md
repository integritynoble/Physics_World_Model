# 05 — Hands-On Tutorial: X-ray Fluorescence (XRF) Imaging

This tutorial walks through running the PWM benchmark for X-ray Fluorescence (XRF) Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "xrf_imaging.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("xrf_imaging_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/xrf_imaging.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/xrf_imaging_expanded.yaml`

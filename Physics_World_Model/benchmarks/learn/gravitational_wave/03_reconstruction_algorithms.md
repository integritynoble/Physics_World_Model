# 03 — Reconstruction Algorithms: Gravitational Wave Detection
...
The default solver for Gravitational Wave Detection is **`matched_filter`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/gravitational_wave.yaml`

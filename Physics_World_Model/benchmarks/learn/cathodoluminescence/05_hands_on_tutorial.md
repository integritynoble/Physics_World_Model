# 05 — Hands-On Tutorial: Cathodoluminescence (CL) Imaging

This tutorial walks through running the PWM benchmark for Cathodoluminescence (CL) Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "cathodoluminescence.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("cathodoluminescence_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/cathodoluminescence.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/cathodoluminescence_expanded.yaml`

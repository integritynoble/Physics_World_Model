# 03 — Reconstruction Algorithms: Cathodoluminescence (CL) Imaging
...
The default solver for Cathodoluminescence (CL) Imaging is **`hyperspectral_unmixing`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/cathodoluminescence.yaml`

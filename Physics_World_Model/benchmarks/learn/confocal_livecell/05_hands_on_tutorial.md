# 05 — Hands-On Tutorial: Confocal Live-Cell Microscopy

This tutorial walks through running the PWM benchmark for Confocal Live-Cell Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "confocal_livecell.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("confocal_livecell_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/confocal_livecell.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/confocal_livecell_expanded.yaml`

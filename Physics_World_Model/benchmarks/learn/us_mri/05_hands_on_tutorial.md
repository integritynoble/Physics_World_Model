# 05 — Hands-On Tutorial: US/MRI Fusion

This tutorial walks through running the PWM benchmark for US/MRI Fusion,
...
config_path = ROOT / "benchmarks" / "configs" / "us_mri.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("us_mri_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/us_mri.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/us_mri_expanded.yaml`

# 05 — Hands-On Tutorial: MR Elastography (MRE)

This tutorial walks through running the PWM benchmark for MR Elastography (MRE),
...
config_path = ROOT / "benchmarks" / "configs" / "mr_elastography.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality mr_elastography
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("mr_elastography_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/mr_elastography.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/mr_elastography_expanded.yaml`

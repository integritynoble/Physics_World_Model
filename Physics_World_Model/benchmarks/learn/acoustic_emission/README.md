# Acoustic Emission Testing (AE) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Acoustic Emission Testing (AE)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `acoustic_emission` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/acoustic_emission.yaml` |

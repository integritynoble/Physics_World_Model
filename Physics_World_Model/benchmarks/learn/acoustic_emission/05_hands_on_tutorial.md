# 05 — Hands-On Tutorial: Acoustic Emission Testing (AE)

This tutorial walks through running the PWM benchmark for Acoustic Emission Testing (AE),
...
config_path = ROOT / "benchmarks" / "configs" / "acoustic_emission.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("acoustic_emission_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/acoustic_emission.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/acoustic_emission_expanded.yaml`

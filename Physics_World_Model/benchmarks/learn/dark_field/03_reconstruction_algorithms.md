# 03 — Reconstruction Algorithms: Dark-Field Microscopy
...
The default solver for Dark-Field Microscopy is **`richardson_lucy`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/dark_field.yaml`

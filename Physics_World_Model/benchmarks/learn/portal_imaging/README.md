# Portal Imaging (EPID) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Portal Imaging (EPID)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `portal_imaging` |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of MV imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/portal_imaging.yaml` |

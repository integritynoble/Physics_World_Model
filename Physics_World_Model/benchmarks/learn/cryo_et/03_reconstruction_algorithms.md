# 03 — Reconstruction Algorithms: Cryo-Electron Tomography (Cryo-ET)
...
The default solver for Cryo-Electron Tomography (Cryo-ET) is **`sirt`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/cryo_et.yaml`

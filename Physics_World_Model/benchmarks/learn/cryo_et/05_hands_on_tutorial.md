# 05 — Hands-On Tutorial: Cryo-Electron Tomography (Cryo-ET)

This tutorial walks through running the PWM benchmark for Cryo-Electron Tomography (Cryo-ET),
...
config_path = ROOT / "benchmarks" / "configs" / "cryo_et.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality cryo_et
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("cryo_et_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/cryo_et.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/cryo_et_expanded.yaml`

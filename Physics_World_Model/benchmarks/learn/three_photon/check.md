...
| Metric | Value |
|--------|-------|
| PSNR (sample_00) | 21.21 dB |
| SSIM (sample_00) | 0.2608 |
...
| Metric | Value |
|--------|-------|
| PSNR (sample_00) | 22.7 dB |
| SSIM (sample_00) | 0.2909 |
| Runtime | 8.35 s/sample |

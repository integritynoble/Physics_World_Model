# 05 — Hands-On Tutorial: Atom Probe Tomography (APT)

This tutorial walks through running the PWM benchmark for Atom Probe Tomography (APT),
...
config_path = ROOT / "benchmarks" / "configs" / "atom_probe.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("atom_probe_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/atom_probe.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/atom_probe_expanded.yaml`

# 03 — Reconstruction Algorithms: Atom Probe Tomography (APT)
...
The default solver for Atom Probe Tomography (APT) is **`trajectory_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/atom_probe.yaml`

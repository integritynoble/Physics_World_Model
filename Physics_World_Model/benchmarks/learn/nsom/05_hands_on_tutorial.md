# 05 — Hands-On Tutorial: Near-field Scanning Optical Microscopy (NSOM)

This tutorial walks through running the PWM benchmark for Near-field Scanning Optical Microscopy (NSOM),
...
config_path = ROOT / "benchmarks" / "configs" / "nsom.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality nsom
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("nsom_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/nsom.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/nsom_expanded.yaml`

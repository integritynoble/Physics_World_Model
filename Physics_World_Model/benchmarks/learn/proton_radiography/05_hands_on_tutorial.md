# 05 — Hands-On Tutorial: Proton Radiography

This tutorial walks through running the PWM benchmark for Proton Radiography,
...
config_path = ROOT / "benchmarks" / "configs" / "proton_radiography.yaml"
...
try:
    ...
    print("Solver loaded: FBP (proton radiography)")
except ImportError:
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality proton_radiography
...
solvers_to_test = {
    "FBP (proton radiography)": ("pwm_core.recon.ct_solvers", "run_fbp"),
...
# axes[1].set_title("FBP (proton radiography)")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Best Quality")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("proton_radiography_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/proton_radiography.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/proton_radiography_expanded.yaml`

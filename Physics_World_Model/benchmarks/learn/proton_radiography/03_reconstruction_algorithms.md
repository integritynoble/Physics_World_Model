# 03 — Reconstruction Algorithms: Proton Radiography
...
The default solver for Proton Radiography is **`filtered_back_projection`**.
...
### Traditional Cpu: FBP (proton radiography)
...
3. Add the solver tier to the modality config in `benchmarks/configs/proton_radiography.yaml`

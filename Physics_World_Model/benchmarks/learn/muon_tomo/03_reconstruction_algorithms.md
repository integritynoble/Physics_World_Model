# 03 — Reconstruction Algorithms: Muon Tomography
...
The default solver for Muon Tomography is **`poca_reconstruction`**.
...
### Traditional Cpu: FBP (muon tomography)
...
3. Add the solver tier to the modality config in `benchmarks/configs/muon_tomo.yaml`

# Cone-Beam Computed Tomography (CBCT) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Cone-Beam Computed Tomography (CBCT)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/cbct.yaml` |

# 05 — Hands-On Tutorial: Confocal Laser Endomicroscopy (CLE)

This tutorial walks through running the PWM benchmark for Confocal Laser Endomicroscopy (CLE),
...
config_path = ROOT / "benchmarks" / "configs" / "confocal_endomicroscopy.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("confocal_endomicroscopy_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/confocal_endomicroscopy.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/confocal_endomicroscopy_expanded.yaml`

# 03 — Reconstruction Algorithms: Confocal Laser Endomicroscopy (CLE)
...
The default solver for Confocal Laser Endomicroscopy (CLE) is **`fiber_deconvolution`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/confocal_endomicroscopy.yaml`

# 05 — Hands-On Tutorial: PET/CT Fusion

This tutorial walks through running the PWM benchmark for PET/CT Fusion,
...
config_path = ROOT / "benchmarks" / "configs" / "pet_ct.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("pet_ct_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/pet_ct.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/pet_ct_expanded.yaml`

# 03 — Reconstruction Algorithms: MR Spectroscopy (MRS)
...
The default solver for MR Spectroscopy (MRS) is **`lcmodel`**.
...
|------|------|--------|----------|-----|-----------|
| traditional_cpu | SENSE (spectroscopy) | `pwm_core.recon.mri_solvers` | `run_sense` | No |  |
...
### Traditional Cpu: SENSE (spectroscopy)
...
3. Add the solver tier to the modality config in `benchmarks/configs/mrs.yaml`

# 05 — Hands-On Tutorial: Coded Aperture Snapshot Spectral Imaging (CASSI)

This tutorial walks through running the PWM benchmark for Coded Aperture Snapshot Spectral Imaging (CASSI),
...
config_path = ROOT / "benchmarks" / "configs" / "cassi.yaml"
...
solvers_to_test = {
    ...
    "HDNet": ("pwm_core.recon.hdnet", "hdnet_recon_cassi"),
}
...
# axes[2].set_title("HDNet")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("cassi_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/cassi.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/cassi_expanded.yaml`

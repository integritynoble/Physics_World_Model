# 05 — Hands-On Tutorial: Generic Matrix Sensing

This tutorial walks through running the PWM benchmark for Generic Matrix Sensing,
...
config_path = ROOT / "benchmarks" / "configs" / "matrix.yaml"
...
try:
    ...
    print("Solver loaded: Tikhonov / FISTA-L2")
except ImportError:
...
solvers_to_test = {
    "Tikhonov / FISTA-L2": ("pwm_core.recon.classical", "run_fista_l2"),
    "Diffusion Posterior Sampling": ("pwm_core.recon.diffusion_posterior", "diffusion_posterior_sample"),
}
...
- Read the full config: `benchmarks/configs/matrix.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/matrix_expanded.yaml`

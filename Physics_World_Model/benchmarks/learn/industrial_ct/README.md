# Industrial X-ray CT — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Industrial X-ray CT**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `industrial_ct` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/industrial_ct.yaml` |

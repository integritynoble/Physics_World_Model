# 03 — Reconstruction Algorithms: Image Scanning Microscopy (ISM)
...
The default solver for Image Scanning Microscopy (ISM) is **`pixel_reassignment`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/ism.yaml`

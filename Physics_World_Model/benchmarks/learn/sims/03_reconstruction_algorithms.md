# 03 — Reconstruction Algorithms: Secondary Ion Mass Spectrometry (SIMS) Imaging
...
The default solver for Secondary Ion Mass Spectrometry (SIMS) Imaging is **`mass_image_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/sims.yaml`

# 03 — Reconstruction Algorithms: Particle Calorimetry
...
The default solver for Particle Calorimetry is **`energy_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/particle_calorimetry.yaml`

# 05 — Hands-On Tutorial: Polarimetric SAR (PolSAR)

This tutorial walks through running the PWM benchmark for Polarimetric SAR (PolSAR),
...
config_path = ROOT / "benchmarks" / "configs" / "polsar.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality polsar
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("polsar_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/polsar.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/polsar_expanded.yaml`

# DESI Mass Spectrometry Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **DESI Mass Spectrometry Imaging**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/desi.yaml` |

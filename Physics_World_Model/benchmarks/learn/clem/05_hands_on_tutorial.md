# 05 — Hands-On Tutorial: Correlative Light-Electron Microscopy (CLEM)

This tutorial walks through running the PWM benchmark for Correlative Light-Electron Microscopy (CLEM),
...
config_path = ROOT / "benchmarks" / "configs" / "clem.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("clem_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/clem.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/clem_expanded.yaml`

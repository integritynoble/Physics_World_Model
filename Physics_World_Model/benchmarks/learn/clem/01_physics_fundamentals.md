# 01 — Physics Fundamentals: Correlative Light-Electron Microscopy (CLEM)

## 1. Overview

Correlative Light-Electron Microscopy (CLEM) imaging modality with DAG: C --> D (LM) + C --> D (EM) --> Fusion.

# 05 — Hands-On Tutorial: Positron Emission Tomography (PET)

This tutorial walks through running the PWM benchmark for Positron Emission Tomography (PET),
...
config_path = ROOT / "benchmarks" / "configs" / "pet.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("pet_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/pet.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/pet_expanded.yaml`

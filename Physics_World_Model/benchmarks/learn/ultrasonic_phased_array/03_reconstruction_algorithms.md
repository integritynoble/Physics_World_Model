# 03 — Reconstruction Algorithms: Ultrasonic Phased Array (TFM/FMC)
...
The default solver for Ultrasonic Phased Array (TFM/FMC) is **`total_focusing_method`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/ultrasonic_phased_array.yaml`

# 03 — Reconstruction Algorithms: X-ray Radiography
...
The default solver for X-ray Radiography is **`tv_fista`**.
...
### Traditional Cpu: FBP (X-ray radiography)
...
3. Add the solver tier to the modality config in `benchmarks/configs/xray_radiography.yaml`

# Coherent Anti-Stokes Raman (CARS) Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Coherent Anti-Stokes Raman (CARS) Microscopy**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/cars.yaml` |

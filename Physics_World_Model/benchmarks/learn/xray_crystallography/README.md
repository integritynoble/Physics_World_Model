# X-ray Crystallography — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **X-ray Crystallography**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `xray_crystallography` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/xray_crystallography.yaml` |

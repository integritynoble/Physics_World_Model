# Single-Pixel Camera (SPC) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Single-Pixel Camera (SPC)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/spc.yaml` |

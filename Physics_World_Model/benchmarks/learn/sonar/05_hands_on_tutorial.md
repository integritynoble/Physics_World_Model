# 05 — Hands-On Tutorial: Sonar Imaging

This tutorial walks through running the PWM benchmark for Sonar Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "sonar.yaml"
...
try:
    ...
    print("Solver loaded: FISTA-L2 (DAS)")
except ImportError:
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality sonar
...
solvers_to_test = {
    "FISTA-L2 (DAS)": ("pwm_core.recon.classical", "run_fista_l2"),
...
# axes[1].set_title("FISTA-L2 (DAS)")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Best Quality")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("sonar_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/sonar.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/sonar_expanded.yaml`

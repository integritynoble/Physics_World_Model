# 03 — Reconstruction Algorithms: Sonar Imaging
...
The default solver for Sonar Imaging is **`beamform_das`**.
...
|------|------|--------|----------|-----|-----------|
| traditional_cpu | FISTA-L2 (DAS) | `pwm_core.recon.classical` | `run_fista_l2` | No |  |
...
3. Add the solver tier to the modality config in `benchmarks/configs/sonar.yaml`

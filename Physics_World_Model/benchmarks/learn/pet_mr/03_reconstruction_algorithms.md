# 03 — Reconstruction Algorithms: PET/MR Fusion
...
The default solver for PET/MR Fusion is **`joint_recon_petmr`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/pet_mr.yaml`

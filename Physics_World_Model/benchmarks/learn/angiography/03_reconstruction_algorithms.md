# 03 — Reconstruction Algorithms: X-ray Angiography
...
The default solver for X-ray Angiography is **`dsa_subtraction`**.
...
### Traditional Cpu: FBP (DSA baseline)
...
3. Add the solver tier to the modality config in `benchmarks/configs/angiography.yaml`

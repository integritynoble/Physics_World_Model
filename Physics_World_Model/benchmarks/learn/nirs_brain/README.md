# Functional Near-Infrared Spectroscopy (fNIRS) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Functional Near-Infrared Spectroscopy (fNIRS)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `nirs_brain` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/nirs_brain.yaml` |

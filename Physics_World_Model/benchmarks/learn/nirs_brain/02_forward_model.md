# 02 — Forward Model: Functional Near-Infrared Spectroscopy (fNIRS)
...
The PWM benchmark for Functional Near-Infrared Spectroscopy (fNIRS) uses:

- **Forward model**: `medical_ct_radon` with `nonlinear_operator` operator
- **Default solver**: `modified_beer_lambert`
- **Metrics**: ['psnr', 'ssim']
- **Primary metric**: psnr

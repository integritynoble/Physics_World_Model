# Electron Energy Loss Spectroscopy (EELS) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Electron Energy Loss Spectroscopy (EELS)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/eels.yaml` |

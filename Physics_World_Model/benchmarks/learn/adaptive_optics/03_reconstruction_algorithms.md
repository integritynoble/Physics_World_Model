# 03 — Reconstruction Algorithms: Adaptive Optics (AO) Imaging
...
The default solver for Adaptive Optics (AO) Imaging is **`psf_deconvolution`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/adaptive_optics.yaml`

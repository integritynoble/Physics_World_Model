# Electron Tomography — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Electron Tomography**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/electron_tomography.yaml` |

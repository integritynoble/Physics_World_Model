# 05 — Hands-On Tutorial: Light Field Imaging

This tutorial walks through running the PWM benchmark for Light Field Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "light_field.yaml"
...
try:
    from pwm_core.recon.light_field_solver import run_light_field
    print("Solver loaded: Shift-and-Sum")
except ImportError:
...
solvers_to_test = {
    "Shift-and-Sum": ("pwm_core.recon.light_field_solver", "run_light_field"),
    "LFBM5D": ("pwm_core.recon.light_field_solver", "lfbm5d_recon"),
}
...
# axes[1].set_title("Shift-and-Sum")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("LFBM5D")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("light_field_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/light_field.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/light_field_expanded.yaml`

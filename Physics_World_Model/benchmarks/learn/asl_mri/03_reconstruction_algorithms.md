# 03 — Reconstruction Algorithms: Arterial Spin Labeling (ASL) MRI
...
The default solver for Arterial Spin Labeling (ASL) MRI is **`perfusion_quantification`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/asl_mri.yaml`

# Arterial Spin Labeling (ASL) MRI — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Arterial Spin Labeling (ASL) MRI**.
...
| Default Solver | `perfusion_quantification` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/asl_mri.yaml` |

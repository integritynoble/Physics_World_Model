# 03 — Reconstruction Algorithms: MR Angiography (MRA)
...
The default solver for MR Angiography (MRA) is **`mip_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/mra.yaml`

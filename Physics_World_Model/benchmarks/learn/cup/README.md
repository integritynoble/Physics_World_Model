# Compressed Ultrafast Photography (CUP) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Compressed Ultrafast Photography (CUP)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/cup.yaml` |

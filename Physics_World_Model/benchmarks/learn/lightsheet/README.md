# Light-Sheet Fluorescence Microscopy (LSFM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Light-Sheet Fluorescence Microscopy (LSFM)**.
...
| Default Solver | `fourier_notch_destripe` |
| Maturity | M1 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/lightsheet.yaml` |

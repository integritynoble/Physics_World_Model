# 05 — Hands-On Tutorial: Light-Sheet Fluorescence Microscopy (LSFM)

This tutorial walks through running the PWM benchmark for Light-Sheet Fluorescence Microscopy (LSFM),
...
config_path = ROOT / "benchmarks" / "configs" / "lightsheet.yaml"
...
try:
    ...
    print("Solver loaded: Fourier Notch Filter")
except ImportError:
...
solvers_to_test = {
    "Fourier Notch Filter": ("pwm_core.recon.lightsheet_solver", "run_lightsheet"),
    "VSNR": ("pwm_core.recon.lightsheet_solver", "vsnr_destripe"),
}
...
# axes[1].set_title("Fourier Notch Filter")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("VSNR")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("lightsheet_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/lightsheet.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/lightsheet_expanded.yaml`

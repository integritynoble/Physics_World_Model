# 02 — Forward Model: Talbot-Lau X-ray Grating Interferometry
...
The PWM benchmark for Talbot-Lau X-ray Grating Interferometry uses:

- **Forward model**: `microscopy_psf` with `nonlinear_operator` operator
- **Default solver**: `phase_stepping`
- **Metrics**: ['psnr', 'ssim']
- **Primary metric**: psnr

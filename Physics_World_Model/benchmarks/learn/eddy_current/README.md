# Eddy Current Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Eddy Current Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `eddy_current` |
| Category | Industrial Inspection |
| Carrier | EM |
| Forward Model | nonlinear_operator |
| Default Solver | `impedance_inversion` |
| Maturity | M0 |
| Tier | A |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of EM imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/eddy_current.yaml` |

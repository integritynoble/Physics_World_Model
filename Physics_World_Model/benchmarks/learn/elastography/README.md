# Shear-Wave Elastography — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Shear-Wave Elastography**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/elastography.yaml` |

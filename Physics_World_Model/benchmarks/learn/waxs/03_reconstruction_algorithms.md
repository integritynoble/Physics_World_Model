# 03 — Reconstruction Algorithms: Wide-Angle X-ray Scattering (WAXS)
...
The default solver for Wide-Angle X-ray Scattering (WAXS) is **`azimuthal_integration`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/waxs.yaml`

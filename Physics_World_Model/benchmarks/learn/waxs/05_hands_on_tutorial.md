# 05 — Hands-On Tutorial: Wide-Angle X-ray Scattering (WAXS)

This tutorial walks through running the PWM benchmark for Wide-Angle X-ray Scattering (WAXS),
...
config_path = ROOT / "benchmarks" / "configs" / "waxs.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("waxs_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/waxs.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/waxs_expanded.yaml`

# 05 — Hands-On Tutorial: Ocean Acoustic Tomography

This tutorial walks through running the PWM benchmark for Ocean Acoustic Tomography,
...
config_path = ROOT / "benchmarks" / "configs" / "ocean_acoustic_tomo.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ocean_acoustic_tomo_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ocean_acoustic_tomo.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ocean_acoustic_tomo_expanded.yaml`

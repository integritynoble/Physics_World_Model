# 03 — Reconstruction Algorithms: Ocean Acoustic Tomography
...
The default solver for Ocean Acoustic Tomography is **`travel_time_inversion`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/ocean_acoustic_tomo.yaml`

# 03 — Reconstruction Algorithms: Neutron Radiography / Tomography
...
The default solver for Neutron Radiography / Tomography is **`filtered_back_projection`**.
...
### Traditional Cpu: FBP (neutron tomography)
...
3. Add the solver tier to the modality config in `benchmarks/configs/neutron_tomo.yaml`

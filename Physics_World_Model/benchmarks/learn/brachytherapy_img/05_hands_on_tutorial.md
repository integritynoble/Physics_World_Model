# 05 — Hands-On Tutorial: Brachytherapy Imaging

This tutorial walks through running the PWM benchmark for Brachytherapy Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "brachytherapy_img.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality brachytherapy_img
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("brachytherapy_img_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/brachytherapy_img.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/brachytherapy_img_expanded.yaml`

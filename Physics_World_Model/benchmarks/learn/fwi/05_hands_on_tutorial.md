# 05 — Hands-On Tutorial: Full-Waveform Inversion (FWI)

This tutorial walks through running the PWM benchmark for Full-Waveform Inversion (FWI),
...
config_path = ROOT / "benchmarks" / "configs" / "fwi.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("fwi_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/fwi.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/fwi_expanded.yaml`

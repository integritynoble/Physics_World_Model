# 03 — Reconstruction Algorithms: Full-Waveform Inversion (FWI)
...
The default solver for Full-Waveform Inversion (FWI) is **`adjoint_state`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/fwi.yaml`

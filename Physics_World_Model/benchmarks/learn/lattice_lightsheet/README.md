# Lattice Light-Sheet Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Lattice Light-Sheet Microscopy**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `lattice_lightsheet` |
| Category | Microscopy |
| Carrier | Photon |
| Forward Model | linear_operator |
| Default Solver | `richardson_lucy_3d` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/lattice_lightsheet.yaml` |

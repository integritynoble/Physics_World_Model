# 03 — Reconstruction Algorithms: Electron Holography
...
The default solver for Electron Holography is **`fourier_sideband`**.
...
### Traditional Cpu: Phase Retrieval (HIO)
...
3. Add the solver tier to the modality config in `benchmarks/configs/electron_holography.yaml`

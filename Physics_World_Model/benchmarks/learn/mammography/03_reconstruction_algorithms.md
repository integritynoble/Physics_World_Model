# 03 — Reconstruction Algorithms: Mammography
...
The default solver for Mammography is **`tv_fista`**.
...
### Traditional Cpu: FBP (mammography)
...
3. Add the solver tier to the modality config in `benchmarks/configs/mammography.yaml`

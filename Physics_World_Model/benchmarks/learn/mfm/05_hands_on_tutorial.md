# 05 — Hands-On Tutorial: Magnetic Force Microscopy (MFM)

This tutorial walks through running the PWM benchmark for Magnetic Force Microscopy (MFM),
...
config_path = ROOT / "benchmarks" / "configs" / "mfm.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality mfm
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("mfm_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/mfm.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/mfm_expanded.yaml`

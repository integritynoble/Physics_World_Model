# Scanning Tunneling Microscopy (STM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Scanning Tunneling Microscopy (STM)**.
...
| Default Solver | `ldos_normalization` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/stm.yaml` |

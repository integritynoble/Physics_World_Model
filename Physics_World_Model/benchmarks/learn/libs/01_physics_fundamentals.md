# 01 — Physics Fundamentals: Laser-Induced Breakdown Spectroscopy (LIBS) Imaging

## 1. Overview

Laser-Induced Breakdown Spectroscopy (LIBS) Imaging imaging modality with DAG: M --> R --> D.

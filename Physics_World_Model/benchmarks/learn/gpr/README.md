# Ground-Penetrating Radar (GPR) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Ground-Penetrating Radar (GPR)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/gpr.yaml` |

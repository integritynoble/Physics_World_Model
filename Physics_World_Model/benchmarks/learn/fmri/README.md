# Functional MRI (BOLD fMRI) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Functional MRI (BOLD fMRI)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/fmri.yaml` |

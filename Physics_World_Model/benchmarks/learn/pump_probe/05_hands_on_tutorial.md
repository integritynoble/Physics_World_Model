# 05 — Hands-On Tutorial: Pump-Probe Microscopy

This tutorial walks through running the PWM benchmark for Pump-Probe Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "pump_probe.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("pump_probe_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/pump_probe.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/pump_probe_expanded.yaml`

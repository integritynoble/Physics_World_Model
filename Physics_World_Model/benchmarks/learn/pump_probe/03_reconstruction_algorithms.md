# 03 — Reconstruction Algorithms: Pump-Probe Microscopy
...
The default solver for Pump-Probe Microscopy is **`transient_absorption`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/pump_probe.yaml`

# 05 — Hands-On Tutorial: Integral Photography

This tutorial walks through running the PWM benchmark for Integral Photography,
...
config_path = ROOT / "benchmarks" / "configs" / "integral.yaml"
...
try:
    ...
    print("Solver loaded: Depth Estimation")
except ImportError:
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality integral
...
solvers_to_test = {
    "Depth Estimation": ("pwm_core.recon.integral_solver", "run_integral"),
    "DIBR": ("pwm_core.recon.integral_solver", "dibr_recon"),
}
...
# axes[2].set_title("DIBR")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("integral_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/integral.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/integral_expanded.yaml`

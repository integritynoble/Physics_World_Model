# 03 — Reconstruction Algorithms: STEM-EDX Elemental Mapping
...
The default solver for STEM-EDX Elemental Mapping is **`cliff_lorimer`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/edx_mapping.yaml`

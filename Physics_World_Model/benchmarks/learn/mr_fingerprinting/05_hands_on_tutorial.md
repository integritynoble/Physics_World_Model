# 05 — Hands-On Tutorial: MR Fingerprinting (MRF)

This tutorial walks through running the PWM benchmark for MR Fingerprinting (MRF),
...
config_path = ROOT / "benchmarks" / "configs" / "mr_fingerprinting.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality mr_fingerprinting
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("mr_fingerprinting_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/mr_fingerprinting.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/mr_fingerprinting_expanded.yaml`

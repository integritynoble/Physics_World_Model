# Stimulated Raman Scattering (SRS) Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Stimulated Raman Scattering (SRS) Microscopy**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/srs.yaml` |

# 05 — Hands-On Tutorial: Machine Vision / AOI

This tutorial walks through running the PWM benchmark for Machine Vision / AOI,
...
config_path = ROOT / "benchmarks" / "configs" / "machine_vision.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("machine_vision_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/machine_vision.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/machine_vision_expanded.yaml`

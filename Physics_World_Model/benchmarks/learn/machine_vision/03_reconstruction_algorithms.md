# 03 — Reconstruction Algorithms: Machine Vision / AOI
...
The default solver for Machine Vision / AOI is **`defect_detection`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/machine_vision.yaml`

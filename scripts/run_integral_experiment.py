#!/usr/bin/env python3
"""Integral Imaging — Phase B Experiment Script.

Integral: y = Sensor(Conv2D(x)) + noise

Usage:
    PYTHONPATH="$PWD:$PWD/packages/pwm_core" python scripts/run_integral_experiment.py
"""
...
SEED = 42
MODALITY = "integral"
TEMPLATE_KEY = "integral_graph_v2"
H, W = 64, 64

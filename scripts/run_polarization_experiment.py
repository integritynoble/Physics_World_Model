#!/usr/bin/env python3
"""Polarization Microscopy — Phase B Experiment Script.

Polarization: y = Sensor(Conv2D(x)) + noise

Usage:
    PYTHONPATH="$PWD:$PWD/packages/pwm_core" python scripts/run_polarization_experiment.py
"""
...
TEMPLATE_KEY = "polarization_graph_v2"
H, W = 64, 64

# Atom Probe Tomography (APT) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Atom Probe Tomography (APT)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `atom_probe` |
| Category | Scientific Instrumentation |
| Carrier | Ion |
| Forward Model | nonlinear_operator |
| Default Solver | `trajectory_recon` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/atom_probe.yaml` |

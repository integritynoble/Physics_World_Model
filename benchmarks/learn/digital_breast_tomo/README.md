# Digital Breast Tomosynthesis (DBT) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Digital Breast Tomosynthesis (DBT)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `digital_breast_tomo` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/digital_breast_tomo.yaml` |

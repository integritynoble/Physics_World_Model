# 05 — Hands-On Tutorial: Digital Breast Tomosynthesis (DBT)

This tutorial walks through running the PWM benchmark for Digital Breast Tomosynthesis (DBT),
...
config_path = ROOT / "benchmarks" / "configs" / "digital_breast_tomo.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("digital_breast_tomo_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/digital_breast_tomo.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/digital_breast_tomo_expanded.yaml`

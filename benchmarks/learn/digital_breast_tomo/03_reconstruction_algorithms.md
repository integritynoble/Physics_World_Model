# 03 — Reconstruction Algorithms: Digital Breast Tomosynthesis (DBT)
...
The default solver for Digital Breast Tomosynthesis (DBT) is **`back_projection`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/digital_breast_tomo.yaml`

# 03 — Reconstruction Algorithms: Functional Near-Infrared Spectroscopy (fNIRS)
...
The default solver for Functional Near-Infrared Spectroscopy (fNIRS) is **`modified_beer_lambert`**.
...
|------|------|--------|----------|-----|-----------|
| traditional_cpu | FBP | `pwm_core.recon.fbp` | `run_fbp` | No |  |
| best_quality | DL-Recon | `pwm_core.recon.dl_recon` | `dl_reconstruct` | Yes |  |
...
- **Module**: `pwm_core.recon.fbp`
- **Function**: `run_fbp`
- **Parameters**: 0
- **GPU required**: No

### Best Quality: DL-Recon

- **Module**: `pwm_core.recon.dl_recon`
- **Function**: `dl_reconstruct`
- **Parameters**: 5M
- **GPU required**: Yes
...
3. Add the solver tier to the modality config in `benchmarks/configs/nirs_brain.yaml`

# 03 — Reconstruction Algorithms: Weather / Doppler Radar
...
The default solver for Weather / Doppler Radar is **`reflectivity_estimation`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/weather_radar.yaml`

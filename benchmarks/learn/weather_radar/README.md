# Weather / Doppler Radar — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Weather / Doppler Radar**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `weather_radar` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/weather_radar.yaml` |

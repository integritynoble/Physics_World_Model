...
| Tier | Samples | HDF5 file | Mean PSNR (Wiener) | Mean SSIM |
|------|---------|-----------|-------------------|-----------|
| public | 12 (4 normal + 4 pathological + 4 varied) | `fundus_challenge_public.h5` | 18.99 dB | 0.822 |
| dev | 20 (augmented, moderate pathology) | `fundus_challenge_dev.h5` | 18.31 dB | 0.786 |
| hidden | 20 (adversarial, severe pathology) | `fundus_challenge_hidden.h5` | 16.31 dB | 0.679 |

**Forward model:** `y = N(B(PSF * x) * I + scatter)` with Poisson-Gaussian noise, defocus PSF, cosine-4th vignetting, and media opacity haze.

**HDF5 fields per sample:**
- `x_true` (256, 256) float32 -- ground-truth retinal image (green channel)
- `y` (256, 256) float32 -- degraded measurement (alias for image_measured)
...
- `gs://pwm-benchmark-datasets/challenge-data/v1.0/fundus_challenge_public.h5` (16.7 MB)
- `gs://pwm-benchmark-datasets/challenge-data/v1.0/fundus_challenge_dev.h5` (29.4 MB)
- `gs://pwm-benchmark-datasets/challenge-data/v1.0/fundus_challenge_hidden.h5` (29.4 MB)
- `gs://pwm-benchmark-datasets/datasets/Benchmark/fundus/` (mirror copy)

**Gallery images (uploaded 2026-03-10):**
- `gs://pwm-benchmark-datasets/img/benchmark_gallery/fundus/scene_0{0,1,2,3}/` (24 PNGs)
- Local: `platform/pwm_platform/static/img/benchmark_gallery/fundus/`

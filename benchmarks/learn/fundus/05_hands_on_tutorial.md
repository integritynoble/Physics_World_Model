# 05 — Hands-On Tutorial: Fundus Camera

This tutorial walks through running the PWM benchmark for Fundus Camera,
...
config_path = ROOT / "benchmarks" / "configs" / "fundus.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality fundus
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("fundus_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/fundus.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/fundus_expanded.yaml`

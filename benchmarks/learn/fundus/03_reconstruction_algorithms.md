# 03 — Reconstruction Algorithms: Fundus Camera
...
The default solver for Fundus Camera is **`richardson_lucy`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/fundus.yaml`

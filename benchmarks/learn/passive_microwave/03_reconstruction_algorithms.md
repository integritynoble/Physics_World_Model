# 03 — Reconstruction Algorithms: Passive Microwave Radiometry
...
The default solver for Passive Microwave Radiometry is **`deconvolution`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/passive_microwave.yaml`

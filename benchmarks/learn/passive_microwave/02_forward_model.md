# 02 — Forward Model: Passive Microwave Radiometry
...
The PWM benchmark for Passive Microwave Radiometry uses:

- **Forward model**: `remote_sensing_sar` with `linear_operator` operator

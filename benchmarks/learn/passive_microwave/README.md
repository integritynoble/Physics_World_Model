# Passive Microwave Radiometry — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Passive Microwave Radiometry**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `passive_microwave` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/passive_microwave.yaml` |

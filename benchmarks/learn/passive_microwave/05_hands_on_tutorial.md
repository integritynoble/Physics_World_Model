# 05 — Hands-On Tutorial: Passive Microwave Radiometry

This tutorial walks through running the PWM benchmark for Passive Microwave Radiometry,
...
config_path = ROOT / "benchmarks" / "configs" / "passive_microwave.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("passive_microwave_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/passive_microwave.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/passive_microwave_expanded.yaml`

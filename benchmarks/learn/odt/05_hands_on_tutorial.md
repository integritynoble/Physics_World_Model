# 05 — Hands-On Tutorial: Optical Diffraction Tomography (ODT)

This tutorial walks through running the PWM benchmark for Optical Diffraction Tomography (ODT),
...
config_path = ROOT / "benchmarks" / "configs" / "odt.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("odt_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/odt.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/odt_expanded.yaml`

# Optical Diffraction Tomography (ODT) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Optical Diffraction Tomography (ODT)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/odt.yaml` |

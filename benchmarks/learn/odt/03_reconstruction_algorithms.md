# 03 — Reconstruction Algorithms: Optical Diffraction Tomography (ODT)
...
The default solver for Optical Diffraction Tomography (ODT) is **`rytov_inversion`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/odt.yaml`

# 03 — Reconstruction Algorithms: Acoustic Emission Testing (AE)
...
The default solver for Acoustic Emission Testing (AE) is **`source_localization`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/acoustic_emission.yaml`

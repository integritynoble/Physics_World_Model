# 03 — Reconstruction Algorithms: X-ray Fluorescence Tomography
...
The default solver for X-ray Fluorescence Tomography is **`fbp_self_absorption`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/xrf_tomo.yaml`

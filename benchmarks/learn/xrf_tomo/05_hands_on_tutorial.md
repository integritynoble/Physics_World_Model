# 05 — Hands-On Tutorial: X-ray Fluorescence Tomography

This tutorial walks through running the PWM benchmark for X-ray Fluorescence Tomography,
...
config_path = ROOT / "benchmarks" / "configs" / "xrf_tomo.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("xrf_tomo_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/xrf_tomo.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/xrf_tomo_expanded.yaml`

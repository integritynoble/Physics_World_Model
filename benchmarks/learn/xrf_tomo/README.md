# X-ray Fluorescence Tomography — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **X-ray Fluorescence Tomography**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `xrf_tomo` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/xrf_tomo.yaml` |

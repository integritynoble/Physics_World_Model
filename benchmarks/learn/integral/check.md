...
- Methods: SwinIR + gradient, U-Net + gradient, PnP-RED + gradient, FISTA + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Integral — Physics World Model
- [x] Description: Integral Photography
- [x] Spec notation: Π(lens-array) → D(g, η₁)
...
- [x] Learn: 01_physics_fundamentals.md (3,231 B)
- [x] Learn: 02_forward_model.md (2,497 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,623 B)
- [x] Learn: 04_pwm_benchmark.md (2,290 B)
- [x] Learn: 05_hands_on_tutorial.md (3,534 B)

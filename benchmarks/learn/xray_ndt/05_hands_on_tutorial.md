# 05 — Hands-On Tutorial: X-ray NDT (Radiography)

This tutorial walks through running the PWM benchmark for X-ray NDT (Radiography),
...
config_path = ROOT / "benchmarks" / "configs" / "xray_ndt.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("xray_ndt_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/xray_ndt.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/xray_ndt_expanded.yaml`

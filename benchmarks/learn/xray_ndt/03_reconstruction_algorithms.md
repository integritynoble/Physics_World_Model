# 03 — Reconstruction Algorithms: X-ray NDT (Radiography)
...
The default solver for X-ray NDT (Radiography) is **`contrast_enhancement`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/xray_ndt.yaml`

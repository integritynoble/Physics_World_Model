# X-ray NDT (Radiography) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **X-ray NDT (Radiography)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `xray_ndt` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/xray_ndt.yaml` |

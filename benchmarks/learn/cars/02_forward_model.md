# 02 — Forward Model: Coherent Anti-Stokes Raman (CARS) Microscopy
...
The PWM benchmark for Coherent Anti-Stokes Raman (CARS) Microscopy uses:

- **Forward model**: `microscopy_psf` with `nonlinear_operator` operator
- **Default solver**: `nrb_removal`
- **Metrics**: ['psnr', 'ssim']
- **Primary metric**: psnr

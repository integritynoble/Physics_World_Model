...
- Page size: 55,388 bytes
- Methods: Cascade-UNet + gradient, RamanNet + gradient, PnP-DnCNN + gradient, MCR-ALS + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Coherent Anti-Stokes Raman (CARS) Microscopy — Physics World Model
- [x] Description: Coherent Anti-Stokes Raman (CARS) Microscopy
...
- [x] Learn: 01_physics_fundamentals.md (2,171 B)
- [x] Learn: 02_forward_model.md (2,695 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,054 B)
- [x] Learn: 04_pwm_benchmark.md (2,414 B)

# 05 — Hands-On Tutorial: Coherent Anti-Stokes Raman (CARS) Microscopy

This tutorial walks through running the PWM benchmark for Coherent Anti-Stokes Raman (CARS) Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "cars.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("cars_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/cars.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/cars_expanded.yaml`

# 03 — Reconstruction Algorithms: CEST MRI
...
The default solver for CEST MRI is **`z_spectrum_fit`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/cest_mri.yaml`

# CEST MRI — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **CEST MRI**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `cest_mri` |
| Category | Medical Imaging |
| Carrier | Spin/RF |
| Forward Model | nonlinear_operator |
| Default Solver | `z_spectrum_fit` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/cest_mri.yaml` |

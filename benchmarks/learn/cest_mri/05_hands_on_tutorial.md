# 05 — Hands-On Tutorial: CEST MRI

This tutorial walks through running the PWM benchmark for CEST MRI,
...
config_path = ROOT / "benchmarks" / "configs" / "cest_mri.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality cest_mri
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("cest_mri_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/cest_mri.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/cest_mri_expanded.yaml`

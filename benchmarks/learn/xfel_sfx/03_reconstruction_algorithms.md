# 03 — Reconstruction Algorithms: XFEL Serial Femtosecond Crystallography (SFX)
...
The default solver for XFEL Serial Femtosecond Crystallography (SFX) is **`indexing_merge`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/xfel_sfx.yaml`

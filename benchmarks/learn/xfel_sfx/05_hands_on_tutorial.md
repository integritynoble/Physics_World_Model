# 05 — Hands-On Tutorial: XFEL Serial Femtosecond Crystallography (SFX)

This tutorial walks through running the PWM benchmark for XFEL Serial Femtosecond Crystallography (SFX),
...
config_path = ROOT / "benchmarks" / "configs" / "xfel_sfx.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("xfel_sfx_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/xfel_sfx.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/xfel_sfx_expanded.yaml`

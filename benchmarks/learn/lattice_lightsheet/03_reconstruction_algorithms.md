# 03 — Reconstruction Algorithms: Lattice Light-Sheet Microscopy
...
The default solver for Lattice Light-Sheet Microscopy is **`richardson_lucy_3d`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/lattice_lightsheet.yaml`

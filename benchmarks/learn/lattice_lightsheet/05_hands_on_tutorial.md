# 05 — Hands-On Tutorial: Lattice Light-Sheet Microscopy

This tutorial walks through running the PWM benchmark for Lattice Light-Sheet Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "lattice_lightsheet.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("lattice_lightsheet_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/lattice_lightsheet.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/lattice_lightsheet_expanded.yaml`

# Benchmark QA Check — lattice_lightsheet
...
- Page size: 56,734 bytes
- Methods: RCAN + gradient, CARE + gradient, PnP-DRUNet + gradient, Richardson-Lucy + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Lattice Light-Sheet Microscopy — Physics World Model
- [x] Description: Lattice Light-Sheet Microscopy
- [x] Spec notation: C → D
...
- [x] Learn: 01_physics_fundamentals.md (2,208 B)
- [x] Learn: 02_forward_model.md (2,743 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,147 B)
- [x] Learn: 04_pwm_benchmark.md (2,416 B)
- [x] Learn: 05_hands_on_tutorial.md (3,614 B)

# 05 — Hands-On Tutorial: Magnetic Particle Imaging (MPI)

This tutorial walks through running the PWM benchmark for Magnetic Particle Imaging (MPI),
...
config_path = ROOT / "benchmarks" / "configs" / "magnetic_particle.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("magnetic_particle_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/magnetic_particle.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/magnetic_particle_expanded.yaml`

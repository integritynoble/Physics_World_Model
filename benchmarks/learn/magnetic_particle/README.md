# Magnetic Particle Imaging (MPI) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Magnetic Particle Imaging (MPI)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `magnetic_particle` |
| Category | Broader Experimental Science |
| Carrier | Magnetic |
| Forward Model | linear_operator |
| Default Solver | `system_function_inversion` |
| Maturity | M0 |
| Tier | A |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of Magnetic imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/magnetic_particle.yaml` |

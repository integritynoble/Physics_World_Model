# 03 — Reconstruction Algorithms: Magnetic Particle Imaging (MPI)
...
The default solver for Magnetic Particle Imaging (MPI) is **`system_function_inversion`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/magnetic_particle.yaml`

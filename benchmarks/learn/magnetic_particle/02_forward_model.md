# 02 — Forward Model: Magnetic Particle Imaging (MPI)
...
The PWM benchmark for Magnetic Particle Imaging (MPI) uses:

- **Forward model**: `microscopy_psf` with `linear_operator` operator

# 03 — Reconstruction Algorithms: Raman Imaging / Microscopy
...
The default solver for Raman Imaging / Microscopy is **`spectral_unmixing`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/raman_imaging.yaml`

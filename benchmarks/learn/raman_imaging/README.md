# Raman Imaging / Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Raman Imaging / Microscopy**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `raman_imaging` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/raman_imaging.yaml` |

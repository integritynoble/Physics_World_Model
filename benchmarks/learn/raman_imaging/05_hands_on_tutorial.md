# 05 — Hands-On Tutorial: Raman Imaging / Microscopy

This tutorial walks through running the PWM benchmark for Raman Imaging / Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "raman_imaging.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("raman_imaging_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/raman_imaging.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/raman_imaging_expanded.yaml`

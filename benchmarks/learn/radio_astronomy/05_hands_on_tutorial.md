# 05 — Hands-On Tutorial: Radio Aperture Synthesis

This tutorial walks through running the PWM benchmark for Radio Aperture Synthesis,
...
config_path = ROOT / "benchmarks" / "configs" / "radio_astronomy.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("radio_astronomy_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/radio_astronomy.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/radio_astronomy_expanded.yaml`

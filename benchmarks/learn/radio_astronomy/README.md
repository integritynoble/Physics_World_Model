# Radio Aperture Synthesis — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Radio Aperture Synthesis**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `radio_astronomy` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/radio_astronomy.yaml` |

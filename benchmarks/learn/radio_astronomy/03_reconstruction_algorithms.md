# 03 — Reconstruction Algorithms: Radio Aperture Synthesis
...
The default solver for Radio Aperture Synthesis is **`clean`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/radio_astronomy.yaml`

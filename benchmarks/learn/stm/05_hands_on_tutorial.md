# 05 — Hands-On Tutorial: Scanning Tunneling Microscopy (STM)

This tutorial walks through running the PWM benchmark for Scanning Tunneling Microscopy (STM),
...
config_path = ROOT / "benchmarks" / "configs" / "stm.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality stm
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("stm_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/stm.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/stm_expanded.yaml`

# 03 — Reconstruction Algorithms: Scanning Tunneling Microscopy (STM)
...
The default solver for Scanning Tunneling Microscopy (STM) is **`ldos_normalization`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/stm.yaml`

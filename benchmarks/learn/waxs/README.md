# Wide-Angle X-ray Scattering (WAXS) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Wide-Angle X-ray Scattering (WAXS)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/waxs.yaml` |

# Active Thermography (IR) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Active Thermography (IR)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `active_thermography` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/active_thermography.yaml` |

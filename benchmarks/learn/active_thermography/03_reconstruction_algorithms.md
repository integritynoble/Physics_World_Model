# 03 — Reconstruction Algorithms: Active Thermography (IR)
...
The default solver for Active Thermography (IR) is **`thermal_diffusivity_inversion`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/active_thermography.yaml`

# 05 — Hands-On Tutorial: Active Thermography (IR)

This tutorial walks through running the PWM benchmark for Active Thermography (IR),
...
config_path = ROOT / "benchmarks" / "configs" / "active_thermography.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality active_thermography
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("active_thermography_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/active_thermography.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/active_thermography_expanded.yaml`

# Benchmark QA Check — pump_probe

**URL:** https://pwm.platformai.org/benchmark/pump_probe
**HTTP Status:** 200
**Page Size:** 57,172 bytes
...
- 🔵 **INFO**: GCS image reference: /gcs/challenge-data/v1.0/pump_probe_challenge_public.h5 — verify it loads
- 🔵 **INFO**: GCS image reference: /gcs/challenge-data/v1.0/pump_probe_challenge_dev.h5 — verify it loads

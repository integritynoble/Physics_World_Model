# Pump-Probe Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Pump-Probe Microscopy**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `pump_probe` |
| Category | Ultrafast Imaging |
| Carrier | Photon |
| Forward Model | nonlinear_operator |
| Default Solver | `transient_absorption` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/pump_probe.yaml` |

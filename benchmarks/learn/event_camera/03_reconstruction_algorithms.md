# 03 — Reconstruction Algorithms: Event Camera / Dynamic Vision Sensor (DVS)
...
The default solver for Event Camera / Dynamic Vision Sensor (DVS) is **`event_to_frame`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/event_camera.yaml`

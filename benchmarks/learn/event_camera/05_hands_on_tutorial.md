# 05 — Hands-On Tutorial: Event Camera / Dynamic Vision Sensor (DVS)

This tutorial walks through running the PWM benchmark for Event Camera / Dynamic Vision Sensor (DVS),
...
config_path = ROOT / "benchmarks" / "configs" / "event_camera.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("event_camera_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/event_camera.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/event_camera_expanded.yaml`

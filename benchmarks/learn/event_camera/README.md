# Event Camera / Dynamic Vision Sensor (DVS) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Event Camera / Dynamic Vision Sensor (DVS)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `event_camera` |
| Category | Computational Photography |
| Carrier | Photon |
| Forward Model | nonlinear_operator |
| Default Solver | `event_to_frame` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/event_camera.yaml` |

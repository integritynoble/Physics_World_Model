# Three-Photon Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Three-Photon Microscopy**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `three_photon` |
| Category | Microscopy |
| Carrier | Photon |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/three_photon.yaml` |

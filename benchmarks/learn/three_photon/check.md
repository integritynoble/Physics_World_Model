# Quality Check: `three_photon`

**Checked:** 2026-03-03T14:11:16.866118+00:00
...
- [x] Page title: Three-Photon Microscopy — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: C → D
- [x] Description: Three-Photon Microscopy
...
- [x] Learn file README.md exists (1436 bytes)
- [x] Learn file 01_physics_fundamentals.md exists (2197 bytes)
- [x] Learn file 02_forward_model.md exists (2653 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2124 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2334 bytes)

# 03 — Reconstruction Algorithms: Three-Photon Microscopy
...
The default solver for Three-Photon Microscopy is **`richardson_lucy`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/three_photon.yaml`

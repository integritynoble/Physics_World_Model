# 05 — Hands-On Tutorial: Three-Photon Microscopy

This tutorial walks through running the PWM benchmark for Three-Photon Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "three_photon.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality three_photon
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("three_photon_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/three_photon.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/three_photon_expanded.yaml`

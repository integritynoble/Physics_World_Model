# 05 — Hands-On Tutorial: Ocean Color Remote Sensing

This tutorial walks through running the PWM benchmark for Ocean Color Remote Sensing,
...
config_path = ROOT / "benchmarks" / "configs" / "ocean_color.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ocean_color_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ocean_color.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ocean_color_expanded.yaml`

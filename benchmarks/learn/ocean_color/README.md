# Ocean Color Remote Sensing — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Ocean Color Remote Sensing**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `ocean_color` |
| Category | Remote Sensing |
| Carrier | Photon |
| Forward Model | nonlinear_operator |
| Default Solver | `atmospheric_correction` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/ocean_color.yaml` |

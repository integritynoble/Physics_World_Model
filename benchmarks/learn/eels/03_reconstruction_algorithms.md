# 03 — Reconstruction Algorithms: Electron Energy Loss Spectroscopy (EELS)
...
The default solver for Electron Energy Loss Spectroscopy (EELS) is **`fourier_ratio`**.
...
|------|------|--------|----------|-----|-----------|
| traditional_cpu | FISTA-L2 (Fourier ratio) | `pwm_core.recon.classical` | `run_fista_l2` | No |  |
...
### Traditional Cpu: FISTA-L2 (Fourier ratio)
...
3. Add the solver tier to the modality config in `benchmarks/configs/eels.yaml`

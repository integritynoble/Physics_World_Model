# Comprehensive Benchmark QA Check — MR Spectroscopy
...
**Display Name:** MR Spectroscopy

**Physics Class:** fourier_sampling
**Forward Model:** spectral_fitting
...
5. **Define mismatch modes** — b0_inhomogeneity, voxel_contamination, lipid_contamination etc.
...
*Automated 6-point review on 2026-03-03 — MR Spectroscopy*

...
- [x] Title: MRS — Physics World Model
- [x] Description: MR Spectroscopy
- [x] Spec notation: F(FID) → D(g, η₁)
...
- [x] Learn: 01_physics_fundamentals.md (2,752 B)
- [x] Learn: 02_forward_model.md (2,510 B)
- [x] Learn: 03_reconstruction_algorithms.md (1,802 B)
- [x] Learn: 04_pwm_benchmark.md (2,185 B)
- [x] Learn: 05_hands_on_tutorial.md (3,510 B)

# Cryo-Electron Tomography (Cryo-ET) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Cryo-Electron Tomography (Cryo-ET)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/cryo_et.yaml` |

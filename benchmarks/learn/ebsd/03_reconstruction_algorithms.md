# 03 — Reconstruction Algorithms: Electron Backscatter Diffraction (EBSD)
...
The default solver for Electron Backscatter Diffraction (EBSD) is **`hough_indexing`**.
...
### Traditional Cpu: FISTA-L2 (Hough baseline)
...
3. Add the solver tier to the modality config in `benchmarks/configs/ebsd.yaml`

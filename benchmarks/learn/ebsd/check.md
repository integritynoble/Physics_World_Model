...
- [x] Title: EBSD — Physics World Model
- [x] Description: Electron Backscatter Diffraction
- [x] Spec notation: P(e⁻) → Π(backscatter) → D(g, η₁)
...
- [x] Learn: 01_physics_fundamentals.md (2,374 B)
- [x] Learn: 02_forward_model.md (2,510 B)
- [x] Learn: 03_reconstruction_algorithms.md (1,858 B)
- [x] Learn: 04_pwm_benchmark.md (2,278 B)
- [x] Learn: 05_hands_on_tutorial.md (3,568 B)

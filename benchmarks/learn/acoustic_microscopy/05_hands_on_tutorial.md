# 05 — Hands-On Tutorial: Scanning Acoustic Microscopy (SAM)

This tutorial walks through running the PWM benchmark for Scanning Acoustic Microscopy (SAM),
...
config_path = ROOT / "benchmarks" / "configs" / "acoustic_microscopy.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("acoustic_microscopy_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/acoustic_microscopy.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/acoustic_microscopy_expanded.yaml`

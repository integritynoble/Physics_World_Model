# 03 — Reconstruction Algorithms: Scanning Acoustic Microscopy (SAM)
...
The default solver for Scanning Acoustic Microscopy (SAM) is **`c_scan_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/acoustic_microscopy.yaml`

# Scanning Acoustic Microscopy (SAM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Scanning Acoustic Microscopy (SAM)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `acoustic_microscopy` |
| Category | Industrial Inspection |
| Carrier | Acoustic |
| Forward Model | nonlinear_operator |
| Default Solver | `c_scan_recon` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/acoustic_microscopy.yaml` |

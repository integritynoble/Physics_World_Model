...
**Check Date:** 2026-03-03 14:33 UTC
**Status:** PASS
...
- Methods: NDT-Former + gradient, PnP-DnCNN + gradient, DefectNet + gradient, TSR + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Scanning Acoustic Microscopy (SAM) — Physics World Model
- [x] Description: Scanning Acoustic Microscopy (SAM)
- [x] Spec notation: P → D
...
- [x] Learn: README.md (1,484 B)
- [x] Learn: 01_physics_fundamentals.md (2,073 B)
- [x] Learn: 02_forward_model.md (2,720 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,050 B)
- [x] Learn: 04_pwm_benchmark.md (2,432 B)

# 05 — Hands-On Tutorial: Coded Aperture Compressive Temporal Imaging (CACTI)

This tutorial walks through running the PWM benchmark for Coded Aperture Compressive Temporal Imaging (CACTI),
...
config_path = ROOT / "benchmarks" / "configs" / "cacti.yaml"
...
solvers_to_test = {
    "GAP-TV": ("pwm_core.recon.gap_tv", "run_gap_tv"),
    "EfficientSCI": ("pwm_core.recon.efficientsci", "efficientsci_recon"),
}
...
# axes[1].set_title("GAP-TV")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("EfficientSCI")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("cacti_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/cacti.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/cacti_expanded.yaml`

# Coded Aperture Compressive Temporal Imaging (CACTI) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Coded Aperture Compressive Temporal Imaging (CACTI)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/cacti.yaml` |

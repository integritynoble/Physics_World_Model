# 03 — Reconstruction Algorithms: Electron Tomography
...
The default solver for Electron Tomography is **`sirt`**.
...
### Traditional Cpu: FBP (SIRT baseline)
...
3. Add the solver tier to the modality config in `benchmarks/configs/electron_tomography.yaml`

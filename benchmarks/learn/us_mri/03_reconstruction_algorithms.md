# 03 — Reconstruction Algorithms: US/MRI Fusion
...
The default solver for US/MRI Fusion is **`registration_fusion`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/us_mri.yaml`

# Ghost Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Ghost Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `ghost_imaging` |
| Category | Quantum Imaging |
| Carrier | Photon |
| Forward Model | linear_operator |
| Default Solver | `correlation_recon` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/ghost_imaging.yaml` |

# 03 — Reconstruction Algorithms: Ghost Imaging
...
The default solver for Ghost Imaging is **`correlation_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/ghost_imaging.yaml`

# 05 — Hands-On Tutorial: Ghost Imaging

This tutorial walks through running the PWM benchmark for Ghost Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "ghost_imaging.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ghost_imaging_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ghost_imaging.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ghost_imaging_expanded.yaml`

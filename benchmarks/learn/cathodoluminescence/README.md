# Cathodoluminescence (CL) Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Cathodoluminescence (CL) Imaging**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/cathodoluminescence.yaml` |

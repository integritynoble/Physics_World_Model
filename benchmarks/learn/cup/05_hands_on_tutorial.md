# 05 — Hands-On Tutorial: Compressed Ultrafast Photography (CUP)

This tutorial walks through running the PWM benchmark for Compressed Ultrafast Photography (CUP),
...
config_path = ROOT / "benchmarks" / "configs" / "cup.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("cup_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/cup.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/cup_expanded.yaml`

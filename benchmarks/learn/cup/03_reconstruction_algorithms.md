# 03 — Reconstruction Algorithms: Compressed Ultrafast Photography (CUP)
...
The default solver for Compressed Ultrafast Photography (CUP) is **`cup_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/cup.yaml`

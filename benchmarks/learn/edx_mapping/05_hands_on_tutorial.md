# 05 — Hands-On Tutorial: STEM-EDX Elemental Mapping

This tutorial walks through running the PWM benchmark for STEM-EDX Elemental Mapping,
...
config_path = ROOT / "benchmarks" / "configs" / "edx_mapping.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("edx_mapping_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/edx_mapping.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/edx_mapping_expanded.yaml`

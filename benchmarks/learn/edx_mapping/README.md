# STEM-EDX Elemental Mapping — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **STEM-EDX Elemental Mapping**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `edx_mapping` |
| Category | Electron Microscopy |
| Carrier | Electron |
| Forward Model | nonlinear_operator |
| Default Solver | `cliff_lorimer` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/edx_mapping.yaml` |

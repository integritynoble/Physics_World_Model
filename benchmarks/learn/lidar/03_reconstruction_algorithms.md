# 03 — Reconstruction Algorithms: LiDAR Scanner
...
The default solver for LiDAR Scanner is **`point_cloud_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/lidar.yaml`

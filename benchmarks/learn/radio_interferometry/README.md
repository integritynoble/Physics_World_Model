# Radio Interferometry (VLBI) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Radio Interferometry (VLBI)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `radio_interferometry` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/radio_interferometry.yaml` |

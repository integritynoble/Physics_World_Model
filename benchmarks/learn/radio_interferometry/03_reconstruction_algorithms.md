# 03 — Reconstruction Algorithms: Radio Interferometry (VLBI)
...
The default solver for Radio Interferometry (VLBI) is **`clean`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/radio_interferometry.yaml`

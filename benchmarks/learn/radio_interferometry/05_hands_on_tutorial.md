# 05 — Hands-On Tutorial: Radio Interferometry (VLBI)

This tutorial walks through running the PWM benchmark for Radio Interferometry (VLBI),
...
config_path = ROOT / "benchmarks" / "configs" / "radio_interferometry.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("radio_interferometry_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/radio_interferometry.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/radio_interferometry_expanded.yaml`

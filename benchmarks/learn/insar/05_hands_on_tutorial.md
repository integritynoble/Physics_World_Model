# 05 — Hands-On Tutorial: Interferometric SAR (InSAR)

This tutorial walks through running the PWM benchmark for Interferometric SAR (InSAR),
...
config_path = ROOT / "benchmarks" / "configs" / "insar.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality insar
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("insar_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/insar.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/insar_expanded.yaml`

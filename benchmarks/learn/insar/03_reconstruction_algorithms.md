# 03 — Reconstruction Algorithms: Interferometric SAR (InSAR)
...
The default solver for Interferometric SAR (InSAR) is **`phase_unwrap`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/insar.yaml`

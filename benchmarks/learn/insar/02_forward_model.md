# 02 — Forward Model: Interferometric SAR (InSAR)
...
The PWM benchmark for Interferometric SAR (InSAR) uses:

- **Forward model**: `medical_mri_kspace` with `nonlinear_operator` operator
- **Default solver**: `phase_unwrap`
- **Metrics**: ['psnr', 'ssim']
- **Primary metric**: psnr

# Interferometric SAR (InSAR) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Interferometric SAR (InSAR)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/insar.yaml` |

# Structured Illumination Microscopy (SIM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Structured Illumination Microscopy (SIM)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/sim.yaml` |

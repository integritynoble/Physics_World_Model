# 03 — Reconstruction Algorithms: Scanning Electron Microscopy (SEM)
...
The default solver for Scanning Electron Microscopy (SEM) is **`direct_imaging`**.
...
### Traditional Cpu: Richardson-Lucy (SEM)
...
3. Add the solver tier to the modality config in `benchmarks/configs/sem.yaml`

# Comprehensive Benchmark QA Check — Scanning Electron Microscopy
...
**Display Name:** Scanning Electron Microscopy

**Physics Class:** electron_beam
**Forward Model:** raster_scan_detection
**Noise Model:** poisson
...
5. **Define mismatch modes** — charging, drift, contamination etc.
...
*Automated 6-point review on 2026-03-03 — Scanning Electron Microscopy*

# Scanning Electron Microscopy (SEM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Scanning Electron Microscopy (SEM)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/sem.yaml` |

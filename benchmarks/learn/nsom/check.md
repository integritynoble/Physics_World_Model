...
- Methods: E2E-BTR + gradient, AFM-Net + gradient, Reg-Deconv + gradient, Erosion-Dilation + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Near-field Scanning Optical Microscopy (NSOM) — Physics World Model
- [x] Description: Near-field Scanning Optical Microscopy (NSOM)
...
- [x] Learn: README.md (1,480 B)
- [x] Learn: 01_physics_fundamentals.md (2,262 B)
- [x] Learn: 02_forward_model.md (2,745 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,161 B)
- [x] Learn: 04_pwm_benchmark.md (2,478 B)
- [x] Learn: 05_hands_on_tutorial.md (3,574 B)

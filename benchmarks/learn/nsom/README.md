# Near-field Scanning Optical Microscopy (NSOM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Near-field Scanning Optical Microscopy (NSOM)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/nsom.yaml` |

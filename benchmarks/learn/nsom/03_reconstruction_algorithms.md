# 03 — Reconstruction Algorithms: Near-field Scanning Optical Microscopy (NSOM)
...
The default solver for Near-field Scanning Optical Microscopy (NSOM) is **`near_field_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/nsom.yaml`

# 03 — Reconstruction Algorithms: Lucky Imaging
...
The default solver for Lucky Imaging is **`shift_and_add`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/lucky_imaging.yaml`

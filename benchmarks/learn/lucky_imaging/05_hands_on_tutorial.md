# 05 — Hands-On Tutorial: Lucky Imaging

This tutorial walks through running the PWM benchmark for Lucky Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "lucky_imaging.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("lucky_imaging_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/lucky_imaging.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/lucky_imaging_expanded.yaml`

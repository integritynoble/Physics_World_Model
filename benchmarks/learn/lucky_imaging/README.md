# Lucky Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Lucky Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `lucky_imaging` |
| Category | Astronomy & Space Imaging |
| Carrier | Photon |
| Forward Model | nonlinear_operator |
| Default Solver | `shift_and_add` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/lucky_imaging.yaml` |

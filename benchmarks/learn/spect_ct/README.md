# SPECT/CT Fusion — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **SPECT/CT Fusion**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `spect_ct` |
| Category | Multi-Modal Fusion |
| Carrier | Gamma |
| Forward Model | linear_operator |
| Default Solver | `joint_recon_spectct` |
| Maturity | M0 |
| Tier | A |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of Gamma imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/spect_ct.yaml` |

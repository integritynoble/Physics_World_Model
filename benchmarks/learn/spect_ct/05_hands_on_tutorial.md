# 05 — Hands-On Tutorial: SPECT/CT Fusion

This tutorial walks through running the PWM benchmark for SPECT/CT Fusion,
...
config_path = ROOT / "benchmarks" / "configs" / "spect_ct.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("spect_ct_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/spect_ct.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/spect_ct_expanded.yaml`

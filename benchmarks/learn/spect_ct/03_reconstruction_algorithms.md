# 03 — Reconstruction Algorithms: SPECT/CT Fusion
...
The default solver for SPECT/CT Fusion is **`joint_recon_spectct`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/spect_ct.yaml`

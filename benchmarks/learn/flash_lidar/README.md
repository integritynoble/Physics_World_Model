# Flash LiDAR — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Flash LiDAR**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `flash_lidar` |
| Category | Depth Imaging |
| Carrier | Photon |
| Forward Model | nonlinear_operator |
| Default Solver | `depth_map_recon` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/flash_lidar.yaml` |

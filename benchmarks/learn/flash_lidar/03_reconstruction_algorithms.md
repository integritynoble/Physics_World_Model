# 03 — Reconstruction Algorithms: Flash LiDAR
...
The default solver for Flash LiDAR is **`depth_map_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/flash_lidar.yaml`

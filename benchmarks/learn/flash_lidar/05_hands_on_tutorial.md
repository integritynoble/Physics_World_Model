# 05 — Hands-On Tutorial: Flash LiDAR

This tutorial walks through running the PWM benchmark for Flash LiDAR,
...
config_path = ROOT / "benchmarks" / "configs" / "flash_lidar.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("flash_lidar_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/flash_lidar.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/flash_lidar_expanded.yaml`

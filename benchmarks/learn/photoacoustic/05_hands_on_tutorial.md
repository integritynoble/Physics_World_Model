# 05 — Hands-On Tutorial: Photoacoustic Imaging

This tutorial walks through running the PWM benchmark for Photoacoustic Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "photoacoustic.yaml"
...
try:
    ...
    print("Solver loaded: Back Projection")
except ImportError:
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality photoacoustic
...
solvers_to_test = {
    "Back Projection": ("pwm_core.recon.photoacoustic_solver", "run_photoacoustic"),
    "Time Reversal": ("pwm_core.recon.photoacoustic_solver", "time_reversal_recon"),
}
...
# axes[2].set_title("Time Reversal")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("photoacoustic_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/photoacoustic.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/photoacoustic_expanded.yaml`

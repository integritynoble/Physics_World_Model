# Photoacoustic Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Photoacoustic Imaging**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/photoacoustic.yaml` |

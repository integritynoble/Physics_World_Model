# MR Elastography (MRE) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **MR Elastography (MRE)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `mr_elastography` |
| Category | Medical Imaging |
| Carrier | Spin/RF |
| Forward Model | linear_operator |
| Default Solver | `lfe_inversion` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/mr_elastography.yaml` |

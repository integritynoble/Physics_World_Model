# 03 — Reconstruction Algorithms: MR Elastography (MRE)
...
The default solver for MR Elastography (MRE) is **`lfe_inversion`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/mr_elastography.yaml`

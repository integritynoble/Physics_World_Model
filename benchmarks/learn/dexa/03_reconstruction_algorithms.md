# 03 — Reconstruction Algorithms: Dual-Energy X-ray Absorptiometry (DEXA)
...
The default solver for Dual-Energy X-ray Absorptiometry (DEXA) is **`dual_energy_decomposition`**.
...
### Traditional Cpu: FISTA-L2 (dual-energy)
...
3. Add the solver tier to the modality config in `benchmarks/configs/dexa.yaml`

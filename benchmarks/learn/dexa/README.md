# Dual-Energy X-ray Absorptiometry (DEXA) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Dual-Energy X-ray Absorptiometry (DEXA)**.
...
| Default Solver | `dual_energy_decomposition` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/dexa.yaml` |

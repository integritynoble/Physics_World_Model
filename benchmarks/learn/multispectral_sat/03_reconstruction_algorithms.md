# 03 — Reconstruction Algorithms: Multispectral Satellite Imaging
...
The default solver for Multispectral Satellite Imaging is **`pan_sharpening`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/multispectral_sat.yaml`

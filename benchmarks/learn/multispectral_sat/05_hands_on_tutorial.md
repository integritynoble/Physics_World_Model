# 05 — Hands-On Tutorial: Multispectral Satellite Imaging

This tutorial walks through running the PWM benchmark for Multispectral Satellite Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "multispectral_sat.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("multispectral_sat_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/multispectral_sat.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/multispectral_sat_expanded.yaml`

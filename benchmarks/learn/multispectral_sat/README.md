# Multispectral Satellite Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Multispectral Satellite Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `multispectral_sat` |
| Category | Remote Sensing |
| Carrier | Photon |
| Forward Model | linear_operator |
| Default Solver | `pan_sharpening` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/multispectral_sat.yaml` |

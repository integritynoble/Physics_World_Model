# 05 — Hands-On Tutorial: Laser-Induced Breakdown Spectroscopy (LIBS) Imaging

This tutorial walks through running the PWM benchmark for Laser-Induced Breakdown Spectroscopy (LIBS) Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "libs.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("libs_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/libs.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/libs_expanded.yaml`

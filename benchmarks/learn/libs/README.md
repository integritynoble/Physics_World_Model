# Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Laser-Induced Breakdown Spectroscopy (LIBS) Imaging**.
...
| Default Solver | `element_quantification` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/libs.yaml` |

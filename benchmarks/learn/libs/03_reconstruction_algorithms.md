# 03 — Reconstruction Algorithms: Laser-Induced Breakdown Spectroscopy (LIBS) Imaging
...
The default solver for Laser-Induced Breakdown Spectroscopy (LIBS) Imaging is **`element_quantification`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/libs.yaml`

...
- Page size: 57,304 bytes
- Methods: SpecFormer + gradient, CDAE + gradient, PnP-BM3D + gradient, SG-ALS + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Physics World Model
- [x] Description: Laser-Induced Breakdown Spectroscopy (LIBS) Imaging
...
- [x] Learn: README.md (1,504 B)
- [x] Learn: 01_physics_fundamentals.md (2,185 B)
- [x] Learn: 02_forward_model.md (2,766 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,079 B)
- [x] Learn: 04_pwm_benchmark.md (2,407 B)

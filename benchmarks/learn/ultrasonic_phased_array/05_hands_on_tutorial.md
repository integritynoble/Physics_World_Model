# 05 — Hands-On Tutorial: Ultrasonic Phased Array (TFM/FMC)

This tutorial walks through running the PWM benchmark for Ultrasonic Phased Array (TFM/FMC),
...
config_path = ROOT / "benchmarks" / "configs" / "ultrasonic_phased_array.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ultrasonic_phased_array_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ultrasonic_phased_array.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ultrasonic_phased_array_expanded.yaml`

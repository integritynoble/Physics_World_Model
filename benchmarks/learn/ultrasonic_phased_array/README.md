# Ultrasonic Phased Array (TFM/FMC) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Ultrasonic Phased Array (TFM/FMC)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `ultrasonic_phased_array` |
| Category | Industrial Inspection |
| Carrier | Acoustic |
| Forward Model | linear_operator |
| Default Solver | `total_focusing_method` |
| Maturity | M0 |
| Tier | A |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of Acoustic imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/ultrasonic_phased_array.yaml` |

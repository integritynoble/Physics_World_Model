# 05 — Hands-On Tutorial: Time-of-Flight Depth Camera

This tutorial walks through running the PWM benchmark for Time-of-Flight Depth Camera,
...
config_path = ROOT / "benchmarks" / "configs" / "tof_camera.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("tof_camera_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/tof_camera.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/tof_camera_expanded.yaml`

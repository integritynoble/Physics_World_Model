# Susceptibility-Weighted Imaging (SWI) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Susceptibility-Weighted Imaging (SWI)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/swi.yaml` |

...
**Checked:** 2026-03-03T14:11:19.270830+00:00
...
- [x] Page title: Susceptibility-Weighted Imaging (SWI) — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: M → F → S → D
- [x] Description: Susceptibility-Weighted Imaging (SWI)
...
- [x] Learn file 01_physics_fundamentals.md exists (2138 bytes)
- [x] Learn file 02_forward_model.md exists (2744 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2018 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2404 bytes)
- [x] Learn file 05_hands_on_tutorial.md exists (3475 bytes)

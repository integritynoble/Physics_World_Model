# 03 — Reconstruction Algorithms: Susceptibility-Weighted Imaging (SWI)
...
The default solver for Susceptibility-Weighted Imaging (SWI) is **`swi_phase_mask`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/swi.yaml`

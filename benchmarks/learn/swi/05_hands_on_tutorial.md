# 05 — Hands-On Tutorial: Susceptibility-Weighted Imaging (SWI)

This tutorial walks through running the PWM benchmark for Susceptibility-Weighted Imaging (SWI),
...
config_path = ROOT / "benchmarks" / "configs" / "swi.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality swi
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("swi_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/swi.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/swi_expanded.yaml`

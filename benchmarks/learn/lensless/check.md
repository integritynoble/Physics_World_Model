...
- [x] Title: Lensless — Physics World Model
- [x] Description: Lensless (Diffuser Camera) Imaging
- [x] Spec notation: P(diffuser) → D(g, η₁)
...
- [x] Learn: 01_physics_fundamentals.md (2,993 B)
- [x] Learn: 02_forward_model.md (2,516 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,641 B)
- [x] Learn: 04_pwm_benchmark.md (2,361 B)
- [x] Learn: 05_hands_on_tutorial.md (3,542 B)

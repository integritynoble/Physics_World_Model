# 05 — Hands-On Tutorial: Lensless (Diffuser Camera) Imaging

This tutorial walks through running the PWM benchmark for Lensless (Diffuser Camera) Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "lensless.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality lensless
...
solvers_to_test = {
    "ADMM-TV": ("pwm_core.recon.lensless_solver", "run_lensless"),
    "FlatNet": ("pwm_core.recon.flatnet", "flatnet_reconstruct"),
}
...
# axes[1].set_title("ADMM-TV")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("FlatNet")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("lensless_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/lensless.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/lensless_expanded.yaml`

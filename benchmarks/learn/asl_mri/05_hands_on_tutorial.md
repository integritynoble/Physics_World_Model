# 05 — Hands-On Tutorial: Arterial Spin Labeling (ASL) MRI

This tutorial walks through running the PWM benchmark for Arterial Spin Labeling (ASL) MRI,
...
config_path = ROOT / "benchmarks" / "configs" / "asl_mri.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("asl_mri_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/asl_mri.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/asl_mri_expanded.yaml`

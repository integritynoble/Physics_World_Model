# Benchmark QA Check — industrial_ct
...
- [x] Learn: README.md (1,424 B)
- [x] Learn: 01_physics_fundamentals.md (2,082 B)
- [x] Learn: 02_forward_model.md (2,730 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,005 B)

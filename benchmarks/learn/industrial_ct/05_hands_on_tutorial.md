# 05 — Hands-On Tutorial: Industrial X-ray CT

This tutorial walks through running the PWM benchmark for Industrial X-ray CT,
...
config_path = ROOT / "benchmarks" / "configs" / "industrial_ct.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("industrial_ct_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/industrial_ct.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/industrial_ct_expanded.yaml`

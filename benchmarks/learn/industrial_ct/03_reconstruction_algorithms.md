# 03 — Reconstruction Algorithms: Industrial X-ray CT
...
The default solver for Industrial X-ray CT is **`fbp`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/industrial_ct.yaml`

# 05 — Hands-On Tutorial: Cryo-EM Single Particle Analysis

This tutorial walks through running the PWM benchmark for Cryo-EM Single Particle Analysis,
...
config_path = ROOT / "benchmarks" / "configs" / "cryo_em.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("cryo_em_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/cryo_em.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/cryo_em_expanded.yaml`

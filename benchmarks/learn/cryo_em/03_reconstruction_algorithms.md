# 03 — Reconstruction Algorithms: Cryo-EM Single Particle Analysis
...
The default solver for Cryo-EM Single Particle Analysis is **`ctf_3d_refinement`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/cryo_em.yaml`

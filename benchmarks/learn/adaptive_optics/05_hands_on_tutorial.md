# 05 — Hands-On Tutorial: Adaptive Optics (AO) Imaging

This tutorial walks through running the PWM benchmark for Adaptive Optics (AO) Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "adaptive_optics.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("adaptive_optics_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/adaptive_optics.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/adaptive_optics_expanded.yaml`

# Adaptive Optics (AO) Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Adaptive Optics (AO) Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `adaptive_optics` |
| Category | Broader Experimental Science |
| Carrier | Photon |
| Forward Model | nonlinear_operator |
| Default Solver | `psf_deconvolution` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/adaptive_optics.yaml` |

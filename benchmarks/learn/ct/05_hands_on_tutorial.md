# 05 — Hands-On Tutorial: X-ray Computed Tomography (CT)

This tutorial walks through running the PWM benchmark for X-ray Computed Tomography (CT),
...
config_path = ROOT / "benchmarks" / "configs" / "ct.yaml"
...
solvers_to_test = {
    "FBP": ("pwm_core.recon.ct_solvers", "run_fbp"),
    "PnP-ADMM + RED-CNN": ("pwm_core.recon.pnp", "pnp_admm"),
}
...
# axes[2].set_title("PnP-ADMM + RED-CNN")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ct_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ct.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ct_expanded.yaml`

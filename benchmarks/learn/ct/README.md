# X-ray Computed Tomography (CT) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **X-ray Computed Tomography (CT)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/ct.yaml` |

# Diffusion MRI (DTI) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Diffusion MRI (DTI)**.
...
| Default Solver | `weighted_least_squares` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/diffusion_mri.yaml` |

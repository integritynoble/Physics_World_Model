# 05 — Hands-On Tutorial: Coherent Diffractive Imaging / Phase Retrieval

This tutorial walks through running the PWM benchmark for Coherent Diffractive Imaging / Phase Retrieval,
...
config_path = ROOT / "benchmarks" / "configs" / "phase_retrieval.yaml"
...
solvers_to_test = {
    "HIO": ("pwm_core.recon.phase_retrieval_solver", "run_phase_retrieval"),
    "RAAR": ("pwm_core.recon.phase_retrieval_solver", "raar_recon"),
}
...
# axes[1].set_title("HIO")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("RAAR")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
...
- Read the full config: `benchmarks/configs/phase_retrieval.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/phase_retrieval_expanded.yaml`

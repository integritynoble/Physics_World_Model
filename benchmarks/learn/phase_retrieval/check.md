# Quality Check: `phase_retrieval`

**Checked:** 2026-03-03T14:14:41.826028+00:00
...
- [ ] PSNR 2.2 dB < 5 (unrealistically low)
- [ ] PSNR 3.8 dB < 5 (unrealistically low)

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Page title: CDI — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: P(far-field) → D(g, η₁)
- [x] Description: Coherent Diffractive Imaging
...
- [x] Learn file README.md exists (1500 bytes)
- [x] Learn file 01_physics_fundamentals.md exists (3267 bytes)
- [x] Learn file 02_forward_model.md exists (2643 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2737 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2522 bytes)
- [x] Learn file 05_hands_on_tutorial.md exists (3617 bytes)

# 03 — Reconstruction Algorithms: Coded Exposure / Flutter Shutter
...
The default solver for Coded Exposure / Flutter Shutter is **`wiener_deblur`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/coded_exposure.yaml`

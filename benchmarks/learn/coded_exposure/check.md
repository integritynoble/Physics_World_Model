# Benchmark QA Check — coded_exposure
...
- Page size: 55,436 bytes
- Methods: Restormer + gradient, HDR-CNN + gradient, PnP-DRUNet + gradient, Wiener-Deconv + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Coded Exposure / Flutter Shutter — Physics World Model
- [x] Description: Coded Exposure / Flutter Shutter
...
- [x] Learn: README.md (1,468 B)
- [x] Learn: 01_physics_fundamentals.md (2,235 B)
- [x] Learn: 02_forward_model.md (2,721 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,042 B)
- [x] Learn: 04_pwm_benchmark.md (2,449 B)

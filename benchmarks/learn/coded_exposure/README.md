# Coded Exposure / Flutter Shutter — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Coded Exposure / Flutter Shutter**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `coded_exposure` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/coded_exposure.yaml` |

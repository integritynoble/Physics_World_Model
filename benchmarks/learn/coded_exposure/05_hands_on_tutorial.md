# 05 — Hands-On Tutorial: Coded Exposure / Flutter Shutter

This tutorial walks through running the PWM benchmark for Coded Exposure / Flutter Shutter,
...
config_path = ROOT / "benchmarks" / "configs" / "coded_exposure.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("coded_exposure_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/coded_exposure.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/coded_exposure_expanded.yaml`

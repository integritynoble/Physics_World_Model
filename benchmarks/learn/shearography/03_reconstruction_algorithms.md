# 03 — Reconstruction Algorithms: Shearography
...
The default solver for Shearography is **`phase_unwrap`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/shearography.yaml`

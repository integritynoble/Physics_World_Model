# 05 — Hands-On Tutorial: Shearography

This tutorial walks through running the PWM benchmark for Shearography,
...
config_path = ROOT / "benchmarks" / "configs" / "shearography.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("shearography_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/shearography.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/shearography_expanded.yaml`

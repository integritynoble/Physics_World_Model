# Shearography — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Shearography**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `shearography` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/shearography.yaml` |

# 05 — Hands-On Tutorial: Bioluminescence Tomography (BLT)

This tutorial walks through running the PWM benchmark for Bioluminescence Tomography (BLT),
...
config_path = ROOT / "benchmarks" / "configs" / "bioluminescence_tomo.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("bioluminescence_tomo_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/bioluminescence_tomo.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/bioluminescence_tomo_expanded.yaml`

# 03 — Reconstruction Algorithms: Bioluminescence Tomography (BLT)
...
The default solver for Bioluminescence Tomography (BLT) is **`diffusion_inversion`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/bioluminescence_tomo.yaml`

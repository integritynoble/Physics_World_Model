# Bioluminescence Tomography (BLT) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Bioluminescence Tomography (BLT)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `bioluminescence_tomo` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/bioluminescence_tomo.yaml` |

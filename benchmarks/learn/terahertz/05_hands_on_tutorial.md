# 05 — Hands-On Tutorial: Terahertz Imaging (THz)

This tutorial walks through running the PWM benchmark for Terahertz Imaging (THz),
...
config_path = ROOT / "benchmarks" / "configs" / "terahertz.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("terahertz_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/terahertz.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/terahertz_expanded.yaml`

# 03 — Reconstruction Algorithms: Terahertz Imaging (THz)
...
The default solver for Terahertz Imaging (THz) is **`deconvolution`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/terahertz.yaml`

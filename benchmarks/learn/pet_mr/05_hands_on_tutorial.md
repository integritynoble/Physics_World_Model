# 05 — Hands-On Tutorial: PET/MR Fusion

This tutorial walks through running the PWM benchmark for PET/MR Fusion,
...
config_path = ROOT / "benchmarks" / "configs" / "pet_mr.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("pet_mr_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/pet_mr.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/pet_mr_expanded.yaml`

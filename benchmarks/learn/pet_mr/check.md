# Quality Check: `pet_mr`

**Checked:** 2026-03-03T14:14:43.005406+00:00
...
- [x] Page title: PET/MR Fusion — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: (Π → D) + (M → F → S → D) → ⊕
- [x] Description: PET/MR Fusion
...
- [x] Learn file README.md exists (1409 bytes)
- [x] Learn file 01_physics_fundamentals.md exists (2125 bytes)
- [x] Learn file 02_forward_model.md exists (2754 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2000 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2469 bytes)
- [x] Learn file 05_hands_on_tutorial.md exists (3470 bytes)

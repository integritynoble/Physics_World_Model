...
- Page size: 59,725 bytes
- Methods: PPMF-Net + gradient, OSEM+AC + gradient, MR-Guided + gradient, FuseNet + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: PET/MR Fusion — Physics World Model
- [x] Description: PET/MR Fusion
- [x] Spec notation: (Π → D) + (M → F → S → D) → ⊕
...
- [x] Learn: 01_physics_fundamentals.md (2,125 B)
- [x] Learn: 02_forward_model.md (2,754 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,000 B)
- [x] Learn: 04_pwm_benchmark.md (2,469 B)

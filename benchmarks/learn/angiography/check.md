# Comprehensive Benchmark QA Check — X-ray Angiography
...
**Display Name:** X-ray Angiography

**Physics Class:** radiographic
**Forward Model:** subtraction_projection
**Noise Model:** poisson
...
5. **Define mismatch modes** — motion_misregistration, breathing_artifact, bowel_gas_motion etc.
...
*Automated 6-point review on 2026-03-03 — X-ray Angiography*

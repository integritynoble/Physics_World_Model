# 05 — Hands-On Tutorial: X-ray Angiography

This tutorial walks through running the PWM benchmark for X-ray Angiography,
...
config_path = ROOT / "benchmarks" / "configs" / "angiography.yaml"
...
try:
    ...
    print("Solver loaded: FBP (DSA baseline)")
except ImportError:
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality angiography
...
solvers_to_test = {
    "FBP (DSA baseline)": ("pwm_core.recon.ct_solvers", "run_fbp"),
...
# axes[1].set_title("FBP (DSA baseline)")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Best Quality")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("angiography_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/angiography.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/angiography_expanded.yaml`

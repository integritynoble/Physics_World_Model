# Hyperspectral Remote Sensing — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Hyperspectral Remote Sensing**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `hyperspectral_remote` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/hyperspectral_remote.yaml` |

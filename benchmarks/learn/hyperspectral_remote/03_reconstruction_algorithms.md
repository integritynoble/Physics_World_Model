# 03 — Reconstruction Algorithms: Hyperspectral Remote Sensing
...
The default solver for Hyperspectral Remote Sensing is **`spectral_unmixing`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/hyperspectral_remote.yaml`

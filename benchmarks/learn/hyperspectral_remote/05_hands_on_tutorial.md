# 05 — Hands-On Tutorial: Hyperspectral Remote Sensing

This tutorial walks through running the PWM benchmark for Hyperspectral Remote Sensing,
...
config_path = ROOT / "benchmarks" / "configs" / "hyperspectral_remote.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("hyperspectral_remote_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/hyperspectral_remote.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/hyperspectral_remote_expanded.yaml`

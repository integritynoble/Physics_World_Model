# 03 — Reconstruction Algorithms: Event Horizon Telescope (EHT) Imaging
...
The default solver for Event Horizon Telescope (EHT) Imaging is **`rml_clean`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/eht_imaging.yaml`

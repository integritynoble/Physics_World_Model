# 05 — Hands-On Tutorial: Event Horizon Telescope (EHT) Imaging

This tutorial walks through running the PWM benchmark for Event Horizon Telescope (EHT) Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "eht_imaging.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("eht_imaging_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/eht_imaging.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/eht_imaging_expanded.yaml`

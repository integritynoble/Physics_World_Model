# Event Horizon Telescope (EHT) Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Event Horizon Telescope (EHT) Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `eht_imaging` |
| Category | Astronomy & Space Imaging |
| Carrier | RF |
| Forward Model | linear_operator |
| Default Solver | `rml_clean` |
| Maturity | M0 |
| Tier | A |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of RF imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/eht_imaging.yaml` |

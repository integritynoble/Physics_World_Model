# 05 — Hands-On Tutorial: Neutron Diffraction

This tutorial walks through running the PWM benchmark for Neutron Diffraction,
...
config_path = ROOT / "benchmarks" / "configs" / "neutron_diffraction.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("neutron_diffraction_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/neutron_diffraction.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/neutron_diffraction_expanded.yaml`

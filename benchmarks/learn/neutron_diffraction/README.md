# Neutron Diffraction — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Neutron Diffraction**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `neutron_diffraction` |
| Category | Scientific Instrumentation |
| Carrier | Neutron |
| Forward Model | nonlinear_operator |
| Default Solver | `rietveld_refinement` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/neutron_diffraction.yaml` |

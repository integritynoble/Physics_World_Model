# 03 — Reconstruction Algorithms: Neutron Diffraction
...
The default solver for Neutron Diffraction is **`rietveld_refinement`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/neutron_diffraction.yaml`

# 05 — Hands-On Tutorial: Ptychographic Imaging

This tutorial walks through running the PWM benchmark for Ptychographic Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "ptychography.yaml"
...
solvers_to_test = {
    "ePIE": ("pwm_core.recon.ptychography_solver", "run_epie"),
    "PtychoNN": ("pwm_core.recon.ptychonn", "ptychonn_reconstruct"),
}
...
# axes[1].set_title("ePIE")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("PtychoNN")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ptychography_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ptychography.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ptychography_expanded.yaml`

# Quality Check: `ptychography`

**Checked:** 2026-03-03T14:14:37.469674+00:00
...
- [x] Page title: Ptychography — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: P(probe) → D(g, η₁)
- [x] Description: Ptychographic Imaging
...
- [x] Learn file README.md exists (1445 bytes)
- [x] Learn file 01_physics_fundamentals.md exists (3115 bytes)
- [x] Learn file 02_forward_model.md exists (2607 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2575 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2506 bytes)

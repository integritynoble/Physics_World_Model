# Quality Check: `pet_ct`

**Checked:** 2026-03-03T14:14:43.515519+00:00
...
- [x] Page title: PET/CT Fusion — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: (Π → D) + (Π → D) → ⊕
...
- [x] Learn file 01_physics_fundamentals.md exists (2131 bytes)
- [x] Learn file 02_forward_model.md exists (2750 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2000 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2473 bytes)

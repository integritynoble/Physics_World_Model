# 03 — Reconstruction Algorithms: PET/CT Fusion
...
The default solver for PET/CT Fusion is **`joint_recon_petct`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/pet_ct.yaml`

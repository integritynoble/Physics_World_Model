# 05 — Hands-On Tutorial: Low-Dose Widefield Microscopy

This tutorial walks through running the PWM benchmark for Low-Dose Widefield Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "widefield_lowdose.yaml"
...
solvers_to_test = {
    "BM3D + RL": ("pwm_core.recon.richardson_lucy", "run_richardson_lucy"),
...
# axes[1].set_title("BM3D + RL")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("CARE")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("widefield_lowdose_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/widefield_lowdose.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/widefield_lowdose_expanded.yaml`

# 03 — Reconstruction Algorithms: MALDI Mass Spectrometry Imaging
...
The default solver for MALDI Mass Spectrometry Imaging is **`peak_picking`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/maldi_msi.yaml`

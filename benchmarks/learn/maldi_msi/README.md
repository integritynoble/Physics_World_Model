# MALDI Mass Spectrometry Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **MALDI Mass Spectrometry Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `maldi_msi` |
| Category | Scientific Instrumentation |
| Carrier | Ion |
| Forward Model | nonlinear_operator |
| Default Solver | `peak_picking` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/maldi_msi.yaml` |

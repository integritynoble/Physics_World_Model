# 05 — Hands-On Tutorial: MALDI Mass Spectrometry Imaging

This tutorial walks through running the PWM benchmark for MALDI Mass Spectrometry Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "maldi_msi.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("maldi_msi_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/maldi_msi.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/maldi_msi_expanded.yaml`

# 03 — Reconstruction Algorithms: MINFLUX Nanoscopy
...
The default solver for MINFLUX Nanoscopy is **`mle_localization`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/minflux.yaml`

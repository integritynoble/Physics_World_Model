# MINFLUX Nanoscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **MINFLUX Nanoscopy**.
...
| Default Solver | `mle_localization` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/minflux.yaml` |

# 05 — Hands-On Tutorial: MINFLUX Nanoscopy

This tutorial walks through running the PWM benchmark for MINFLUX Nanoscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "minflux.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality minflux
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("minflux_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/minflux.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/minflux_expanded.yaml`

# 05 — Hands-On Tutorial: Neural Radiance Fields (NeRF)

This tutorial walks through running the PWM benchmark for Neural Radiance Fields (NeRF),
...
config_path = ROOT / "benchmarks" / "configs" / "nerf.yaml"
...
solvers_to_test = {
    "SfM + MVS": ("pwm_core.recon.nerf_solver", "run_nerf"),
    "Mip-NeRF 360": ("pwm_core.recon.nerf_solver", "run_nerf"),
}
...
# axes[1].set_title("SfM + MVS")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Mip-NeRF 360")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("nerf_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/nerf.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/nerf_expanded.yaml`

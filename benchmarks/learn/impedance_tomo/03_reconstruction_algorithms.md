# 03 — Reconstruction Algorithms: Electrical Impedance Tomography (EIT)
...
The default solver for Electrical Impedance Tomography (EIT) is **`gauss_newton`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/impedance_tomo.yaml`

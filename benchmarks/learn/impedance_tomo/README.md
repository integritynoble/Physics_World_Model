# Electrical Impedance Tomography (EIT) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Electrical Impedance Tomography (EIT)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `impedance_tomo` |
| Category | Broader Experimental Science |
| Carrier | Electric |
| Forward Model | nonlinear_operator |
| Default Solver | `gauss_newton` |
| Maturity | M0 |
| Tier | A |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of Electric imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/impedance_tomo.yaml` |

# 05 — Hands-On Tutorial: Electrical Impedance Tomography (EIT)

This tutorial walks through running the PWM benchmark for Electrical Impedance Tomography (EIT),
...
config_path = ROOT / "benchmarks" / "configs" / "impedance_tomo.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("impedance_tomo_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/impedance_tomo.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/impedance_tomo_expanded.yaml`

...
- [x] Title: Electrical Impedance Tomography (EIT) — Physics World Model
- [x] Description: Electrical Impedance Tomography (EIT)
- [x] Spec notation: M → D
...
- [x] Learn: 01_physics_fundamentals.md (1,938 B)
- [x] Learn: 02_forward_model.md (2,746 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,051 B)
- [x] Learn: 04_pwm_benchmark.md (2,429 B)

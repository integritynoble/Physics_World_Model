# Two-Photon / Multiphoton Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Two-Photon / Multiphoton Microscopy**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/two_photon.yaml` |

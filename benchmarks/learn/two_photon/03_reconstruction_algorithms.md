# 03 — Reconstruction Algorithms: Two-Photon / Multiphoton Microscopy
...
The default solver for Two-Photon / Multiphoton Microscopy is **`richardson_lucy`**.
...
### Traditional Cpu: Richardson-Lucy (2P)
...
3. Add the solver tier to the modality config in `benchmarks/configs/two_photon.yaml`

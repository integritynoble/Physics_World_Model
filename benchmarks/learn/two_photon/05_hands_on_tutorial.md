# 05 — Hands-On Tutorial: Two-Photon / Multiphoton Microscopy

This tutorial walks through running the PWM benchmark for Two-Photon / Multiphoton Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "two_photon.yaml"
...
try:
    ...
    print("Solver loaded: Richardson-Lucy (2P)")
except ImportError:
...
solvers_to_test = {
    "Richardson-Lucy (2P)": ("pwm_core.recon.richardson_lucy", "run_richardson_lucy"),
...
# axes[1].set_title("Richardson-Lucy (2P)")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Best Quality")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("two_photon_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/two_photon.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/two_photon_expanded.yaml`

# Quality Check: `two_photon`

**Checked:** 2026-03-03T14:09:07.175151+00:00
...
- [ ] PSNR 3.2 dB < 5 (unrealistically low)
- [ ] PSNR 2.6 dB < 5 (unrealistically low)

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Page title: Two-Photon — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: C(PSF_2P) → D(g, η₃)
- [x] Description: Two-Photon / Multiphoton Microscopy
...
- [x] Learn file 01_physics_fundamentals.md exists (2838 bytes)
- [x] Learn file 02_forward_model.md exists (2720 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (1873 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2629 bytes)
- [x] Learn file 05_hands_on_tutorial.md exists (3601 bytes)

# 03 — Reconstruction Algorithms: Stimulated Raman Scattering (SRS) Microscopy
...
The default solver for Stimulated Raman Scattering (SRS) Microscopy is **`lock_in_demod`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/srs.yaml`

# 02 — Forward Model: Stimulated Raman Scattering (SRS) Microscopy
...
The PWM benchmark for Stimulated Raman Scattering (SRS) Microscopy uses:

- **Forward model**: `microscopy_psf` with `nonlinear_operator` operator
- **Default solver**: `lock_in_demod`
- **Metrics**: ['psnr', 'ssim']
- **Primary metric**: psnr

# 05 — Hands-On Tutorial: Stimulated Raman Scattering (SRS) Microscopy

This tutorial walks through running the PWM benchmark for Stimulated Raman Scattering (SRS) Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "srs.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("srs_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/srs.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/srs_expanded.yaml`

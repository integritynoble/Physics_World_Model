# Magnetic Force Microscopy (MFM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Magnetic Force Microscopy (MFM)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/mfm.yaml` |

# 03 — Reconstruction Algorithms: Magnetic Force Microscopy (MFM)
...
The default solver for Magnetic Force Microscopy (MFM) is **`lift_mode_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/mfm.yaml`

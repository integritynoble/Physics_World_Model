...
- Page size: 55,228 bytes
- Methods: E2E-BTR + gradient, AFM-Net + gradient, Reg-Deconv + gradient, Erosion-Dilation + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Magnetic Force Microscopy (MFM) — Physics World Model
- [x] Description: Magnetic Force Microscopy (MFM)
- [x] Spec notation: S → M → D
...
- [x] Learn: 02_forward_model.md (2,677 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,131 B)
- [x] Learn: 04_pwm_benchmark.md (2,389 B)
- [x] Learn: 05_hands_on_tutorial.md (3,541 B)

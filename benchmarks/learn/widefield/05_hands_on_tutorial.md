# 05 — Hands-On Tutorial: Widefield Fluorescence Microscopy

This tutorial walks through running the PWM benchmark for Widefield Fluorescence Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "widefield.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("widefield_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/widefield.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/widefield_expanded.yaml`

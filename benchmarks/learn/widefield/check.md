# Quality Check: `widefield`

**Checked:** 2026-03-03T14:09:03.184191+00:00
...
- [ ] PSNR 0.6 dB < 5 (unrealistically low)

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Page title: Widefield — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: C(PSF) → D(g, η₃)
- [x] Description: Widefield Fluorescence Microscopy
...
- [x] Learn file README.md exists (1447 bytes)
- [x] Learn file 01_physics_fundamentals.md exists (2935 bytes)
- [x] Learn file 02_forward_model.md exists (2792 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2610 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2636 bytes)
- [x] Learn file 05_hands_on_tutorial.md exists (3575 bytes)

# Widefield Fluorescence Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Widefield Fluorescence Microscopy**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/widefield.yaml` |

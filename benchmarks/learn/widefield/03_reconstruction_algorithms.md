# 03 — Reconstruction Algorithms: Widefield Fluorescence Microscopy
...
The default solver for Widefield Fluorescence Microscopy is **`richardson_lucy`**.
...
| best_quality | CARE | `pwm_core.recon.care_unet` | `care_restore_2d` | Yes | Weigert et al. 2018, Nature Methods |
| famous_dl | CARE | `pwm_core.recon.care_unet` | `care_restore_2d` | No |  |
| small_gpu | CARE | `pwm_core.recon.care_unet` | `care_restore_2d` | No |  |
...
3. Add the solver tier to the modality config in `benchmarks/configs/widefield.yaml`

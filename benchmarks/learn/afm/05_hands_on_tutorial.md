# 05 — Hands-On Tutorial: Atomic Force Microscopy (AFM)

This tutorial walks through running the PWM benchmark for Atomic Force Microscopy (AFM),
...
config_path = ROOT / "benchmarks" / "configs" / "afm.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality afm
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("afm_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/afm.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/afm_expanded.yaml`

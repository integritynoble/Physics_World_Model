# 03 — Reconstruction Algorithms: Atomic Force Microscopy (AFM)
...
The default solver for Atomic Force Microscopy (AFM) is **`tip_deconvolution`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/afm.yaml`

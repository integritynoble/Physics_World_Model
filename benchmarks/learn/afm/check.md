...
- Methods: ProbeFormer + gradient, DeepSPM + gradient, PnP-DnCNN + gradient, BTR + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Atomic Force Microscopy (AFM) — Physics World Model
- [x] Description: Atomic Force Microscopy (AFM)
- [x] Spec notation: S → D
...
- [x] Learn: 01_physics_fundamentals.md (2,001 B)
- [x] Learn: 02_forward_model.md (2,688 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,129 B)
- [x] Learn: 04_pwm_benchmark.md (2,426 B)

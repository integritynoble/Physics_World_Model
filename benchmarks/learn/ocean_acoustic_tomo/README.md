# Ocean Acoustic Tomography — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Ocean Acoustic Tomography**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `ocean_acoustic_tomo` |
| Category | Broader Experimental Science |
| Carrier | Acoustic |
| Forward Model | linear_operator |
| Default Solver | `travel_time_inversion` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/ocean_acoustic_tomo.yaml` |

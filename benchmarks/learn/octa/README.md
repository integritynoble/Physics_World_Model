# OCT Angiography (OCTA) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **OCT Angiography (OCTA)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/octa.yaml` |

...
- Methods: Retinal-Former + gradient, Speckle-DenoiseNet + gradient, PnP-DnCNN + gradient, FFT-OCT + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: OCTA — Physics World Model
- [x] Description: OCT Angiography
...
- [x] Learn: README.md (1,416 B)
- [x] Learn: 01_physics_fundamentals.md (2,751 B)

# Solar EUV/X-ray Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Solar EUV/X-ray Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `solar_imaging` |
| Category | Astronomy & Space Imaging |
| Carrier | Photon/EUV |
| Forward Model | nonlinear_operator |
| Default Solver | `dem_inversion` |
| Maturity | M0 |
| Tier | A |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of Photon/EUV imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/solar_imaging.yaml` |

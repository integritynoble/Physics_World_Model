# 03 — Reconstruction Algorithms: Solar EUV/X-ray Imaging
...
The default solver for Solar EUV/X-ray Imaging is **`dem_inversion`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/solar_imaging.yaml`

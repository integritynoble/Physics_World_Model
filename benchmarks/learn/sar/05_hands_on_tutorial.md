# 05 — Hands-On Tutorial: Synthetic Aperture Radar (SAR)

This tutorial walks through running the PWM benchmark for Synthetic Aperture Radar (SAR),
...
config_path = ROOT / "benchmarks" / "configs" / "sar.yaml"
...
try:
    ...
    print("Solver loaded: FBP (SAR backprojection)")
except ImportError:
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality sar
...
solvers_to_test = {
    "FBP (SAR backprojection)": ("pwm_core.recon.ct_solvers", "run_fbp"),
...
# axes[1].set_title("FBP (SAR backprojection)")
...
- Read the full config: `benchmarks/configs/sar.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/sar_expanded.yaml`

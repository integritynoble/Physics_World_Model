# 03 — Reconstruction Algorithms: Synthetic Aperture Radar (SAR)
...
The default solver for Synthetic Aperture Radar (SAR) is **`backprojection`**.
...
### Traditional Cpu: FBP (SAR backprojection)
...
3. Add the solver tier to the modality config in `benchmarks/configs/sar.yaml`

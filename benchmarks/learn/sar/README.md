# Synthetic Aperture Radar (SAR) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Synthetic Aperture Radar (SAR)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/sar.yaml` |

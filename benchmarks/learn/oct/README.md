# Optical Coherence Tomography (OCT) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Optical Coherence Tomography (OCT)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/oct.yaml` |

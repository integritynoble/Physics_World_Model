# 03 — Reconstruction Algorithms: Seismic Tomography
...
The default solver for Seismic Tomography is **`travel_time_inversion`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/seismic_tomo.yaml`

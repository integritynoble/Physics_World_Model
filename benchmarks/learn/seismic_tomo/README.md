# Seismic Tomography — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Seismic Tomography**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `seismic_tomo` |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of Seismic imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/seismic_tomo.yaml` |

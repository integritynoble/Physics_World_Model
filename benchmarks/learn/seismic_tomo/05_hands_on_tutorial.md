# 05 — Hands-On Tutorial: Seismic Tomography

This tutorial walks through running the PWM benchmark for Seismic Tomography,
...
config_path = ROOT / "benchmarks" / "configs" / "seismic_tomo.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("seismic_tomo_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/seismic_tomo.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/seismic_tomo_expanded.yaml`

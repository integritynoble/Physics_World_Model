# Quality Check: `seismic_tomo`

**Checked:** 2026-03-03T14:12:58.127522+00:00
...
- [x] Page title: Seismic Tomography — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: P → D
- [x] Description: Seismic Tomography
...
- [x] Learn file README.md exists (1449 bytes)
- [x] Learn file 01_physics_fundamentals.md exists (1798 bytes)
- [x] Learn file 02_forward_model.md exists (2705 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2020 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2371 bytes)
- [x] Learn file 05_hands_on_tutorial.md exists (3510 bytes)

# Transmission Electron Microscopy (TEM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Transmission Electron Microscopy (TEM)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/tem.yaml` |

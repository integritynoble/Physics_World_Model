# 03 — Reconstruction Algorithms: Transmission Electron Microscopy (TEM)
...
The default solver for Transmission Electron Microscopy (TEM) is **`ctf_correction`**.
...
### Traditional Cpu: FISTA-L2 (CTF correction)
...
3. Add the solver tier to the modality config in `benchmarks/configs/tem.yaml`

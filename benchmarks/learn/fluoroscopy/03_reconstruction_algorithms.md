# 03 — Reconstruction Algorithms: Fluoroscopy
...
The default solver for Fluoroscopy is **`tv_fista`**.
...
### Traditional Cpu: FBP (fluoroscopy)
...
3. Add the solver tier to the modality config in `benchmarks/configs/fluoroscopy.yaml`

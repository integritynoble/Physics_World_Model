# 03 — Reconstruction Algorithms: Polarimetric SAR (PolSAR)
...
The default solver for Polarimetric SAR (PolSAR) is **`polarimetric_decomposition`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/polsar.yaml`

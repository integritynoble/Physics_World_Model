# Polarimetric SAR (PolSAR) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Polarimetric SAR (PolSAR)**.
...
| Default Solver | `polarimetric_decomposition` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/polsar.yaml` |

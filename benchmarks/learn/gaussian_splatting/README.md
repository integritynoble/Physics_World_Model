# 3D Gaussian Splatting (3DGS) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **3D Gaussian Splatting (3DGS)**.
...
| Default Solver | `gaussian_splatting_3dgs` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/gaussian_splatting.yaml` |

# 03 — Reconstruction Algorithms: 3D Gaussian Splatting (3DGS)
...
The default solver for 3D Gaussian Splatting (3DGS) is **`gaussian_splatting_3dgs`**.
...
### Famous Dl: NeRF (baseline comparison)
...
3. Add the solver tier to the modality config in `benchmarks/configs/gaussian_splatting.yaml`

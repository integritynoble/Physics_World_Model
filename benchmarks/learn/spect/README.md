# Single Photon Emission CT (SPECT) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Single Photon Emission CT (SPECT)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/spect.yaml` |

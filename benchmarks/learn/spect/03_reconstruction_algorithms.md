# 03 — Reconstruction Algorithms: Single Photon Emission CT (SPECT)
...
The default solver for Single Photon Emission CT (SPECT) is **`mlem`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/spect.yaml`

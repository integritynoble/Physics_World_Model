# Spinning Disk Confocal Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Spinning Disk Confocal Microscopy**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `spinning_disk` |
| Category | Microscopy |
| Carrier | Photon |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/spinning_disk.yaml` |

# 03 — Reconstruction Algorithms: Spinning Disk Confocal Microscopy
...
The default solver for Spinning Disk Confocal Microscopy is **`richardson_lucy`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/spinning_disk.yaml`

# 05 — Hands-On Tutorial: Spinning Disk Confocal Microscopy

This tutorial walks through running the PWM benchmark for Spinning Disk Confocal Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "spinning_disk.yaml"
...
try:
    ...
    print("Solver loaded: Richardson-Lucy")
except ImportError:
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality spinning_disk
...
solvers_to_test = {
    "Richardson-Lucy": ("pwm_core.recon.richardson_lucy", "run_richardson_lucy"),
    "CARE": ("pwm_core.recon.care_unet", "care_restore_2d"),
}
...
# axes[1].set_title("Richardson-Lucy")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("CARE")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("spinning_disk_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/spinning_disk.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/spinning_disk_expanded.yaml`

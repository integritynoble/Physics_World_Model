# Confocal Laser Endomicroscopy (CLE) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Confocal Laser Endomicroscopy (CLE)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `confocal_endomicroscopy` |
| Category | Medical Imaging |
| Carrier | Photon |
| Forward Model | nonlinear_operator |
| Default Solver | `fiber_deconvolution` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/confocal_endomicroscopy.yaml` |

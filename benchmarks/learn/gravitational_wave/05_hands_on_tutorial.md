# 05 — Hands-On Tutorial: Gravitational Wave Detection

This tutorial walks through running the PWM benchmark for Gravitational Wave Detection,
...
config_path = ROOT / "benchmarks" / "configs" / "gravitational_wave.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality gravitational_wave
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("gravitational_wave_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/gravitational_wave.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/gravitational_wave_expanded.yaml`

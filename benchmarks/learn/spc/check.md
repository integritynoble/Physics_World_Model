# Comprehensive Benchmark QA Check — Single-Pixel Camera
...
**Display Name:** Single-Pixel Camera

**Physics Class:** compressive_sensing
**Forward Model:** structured_illumination_sensing
...
5. **Define mismatch modes** — pattern_misalignment, detector_nonlinearity, diffraction_at_dmd etc.
...
*Automated 6-point review on 2026-03-03 — Single-Pixel Camera*

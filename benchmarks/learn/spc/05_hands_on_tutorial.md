# 05 — Hands-On Tutorial: Single-Pixel Camera (SPC)

This tutorial walks through running the PWM benchmark for Single-Pixel Camera (SPC),
...
config_path = ROOT / "benchmarks" / "configs" / "spc.yaml"
...
solvers_to_test = {
    "TVAL3": ("pwm_core.recon.cs_solvers", "run_tval3"),
    "HATNet": ("pwm_core.recon.hatnet", "hatnet_reconstruct"),
}
...
# axes[1].set_title("TVAL3")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("HATNet")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("spc_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/spc.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/spc_expanded.yaml`

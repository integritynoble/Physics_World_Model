# Sonar Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Sonar Imaging**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/sonar.yaml` |

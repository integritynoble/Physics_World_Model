# Comprehensive Benchmark QA Check — Polarization Microscopy
...
**Display Name:** Polarization Microscopy

**Physics Class:** polarimetric
**Forward Model:** mueller_matrix
...
5. **Define mismatch modes** — retarder_calibration_drift, polariser_extinction_ratio, stress_birefringence_optics etc.
...
*Automated 6-point review on 2026-03-03 — Polarization Microscopy*

# 05 — Hands-On Tutorial: Polarization Microscopy

This tutorial walks through running the PWM benchmark for Polarization Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "polarization.yaml"
...
solvers_to_test = {
    "PnP-HQS": ("pwm_core.recon.pnp", "run_pnp"),
...
- Read the full config: `benchmarks/configs/polarization.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/polarization_expanded.yaml`

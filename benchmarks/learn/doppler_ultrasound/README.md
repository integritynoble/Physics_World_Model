# Doppler Ultrasound — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Doppler Ultrasound**.
...
| Default Solver | `autocorrelation_estimator` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/doppler_ultrasound.yaml` |

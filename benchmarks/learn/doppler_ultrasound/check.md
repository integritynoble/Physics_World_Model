...
- Methods: MU-Net + gradient, PnP-ADMM + gradient, US-CycleGAN + gradient, MV-Beamformer + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Doppler Ultrasound — Physics World Model
- [x] Description: Doppler Ultrasound
- [x] Spec notation: P(acoustic) → Σ_t → D(g, η₂)
...
- [x] Learn: 01_physics_fundamentals.md (2,683 B)
- [x] Learn: 02_forward_model.md (2,480 B)
- [x] Learn: 03_reconstruction_algorithms.md (1,873 B)
- [x] Learn: 04_pwm_benchmark.md (2,287 B)
- [x] Learn: 05_hands_on_tutorial.md (3,628 B)

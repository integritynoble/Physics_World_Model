# Comprehensive Benchmark QA Check — Doppler Ultrasound
...
**Display Name:** Doppler Ultrasound

**Physics Class:** acoustic
**Forward Model:** doppler_frequency_shift
**Noise Model:** speckle
...
5. **Define mismatch modes** — aliasing, angle_dependence, clutter_residual etc.
...
*Automated 6-point review on 2026-03-03 — Doppler Ultrasound*

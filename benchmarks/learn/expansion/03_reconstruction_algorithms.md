# 03 — Reconstruction Algorithms: Expansion Microscopy (ExM)
...
The default solver for Expansion Microscopy (ExM) is **`richardson_lucy`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/expansion.yaml`

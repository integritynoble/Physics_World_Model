# Expansion Microscopy (ExM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Expansion Microscopy (ExM)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `expansion` |
| Category | Microscopy |
| Carrier | Photon |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/expansion.yaml` |

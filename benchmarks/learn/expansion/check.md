...
- Page size: 54,648 bytes
- Methods: DECODE + gradient, ANNA-PALM + gradient, SPARCOM + gradient, SOFI + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Expansion Microscopy (ExM) — Physics World Model
- [x] Description: Expansion Microscopy (ExM)
- [x] Spec notation: C → D
...
- [x] Learn: 01_physics_fundamentals.md (2,200 B)
- [x] Learn: 02_forward_model.md (2,681 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,127 B)
- [x] Learn: 04_pwm_benchmark.md (2,321 B)

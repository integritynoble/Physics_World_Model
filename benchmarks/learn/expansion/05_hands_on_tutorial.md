# 05 — Hands-On Tutorial: Expansion Microscopy (ExM)

This tutorial walks through running the PWM benchmark for Expansion Microscopy (ExM),
...
config_path = ROOT / "benchmarks" / "configs" / "expansion.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("expansion_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/expansion.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/expansion_expanded.yaml`

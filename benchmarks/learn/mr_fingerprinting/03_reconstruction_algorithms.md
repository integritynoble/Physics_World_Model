# 03 — Reconstruction Algorithms: MR Fingerprinting (MRF)
...
The default solver for MR Fingerprinting (MRF) is **`dictionary_matching`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/mr_fingerprinting.yaml`

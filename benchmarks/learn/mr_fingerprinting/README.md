# MR Fingerprinting (MRF) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **MR Fingerprinting (MRF)**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `mr_fingerprinting` |
| Category | Medical Imaging |
| Carrier | Spin/RF |
| Forward Model | nonlinear_operator |
| Default Solver | `dictionary_matching` |
| Maturity | M0 |
| Tier | A |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of Spin/RF imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/mr_fingerprinting.yaml` |

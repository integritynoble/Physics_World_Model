# 03 — Reconstruction Algorithms: CT + Fluorescence (FLIT)
...
The default solver for CT + Fluorescence (FLIT) is **`joint_recon_flit`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/ct_fluorescence.yaml`

# 05 — Hands-On Tutorial: CT + Fluorescence (FLIT)

This tutorial walks through running the PWM benchmark for CT + Fluorescence (FLIT),
...
config_path = ROOT / "benchmarks" / "configs" / "ct_fluorescence.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ct_fluorescence_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ct_fluorescence.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ct_fluorescence_expanded.yaml`

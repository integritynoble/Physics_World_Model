# 05 — Hands-On Tutorial: Small-Angle X-ray Scattering (SAXS)

This tutorial walks through running the PWM benchmark for Small-Angle X-ray Scattering (SAXS),
...
config_path = ROOT / "benchmarks" / "configs" / "saxs.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("saxs_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/saxs.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/saxs_expanded.yaml`

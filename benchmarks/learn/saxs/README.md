# Small-Angle X-ray Scattering (SAXS) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Small-Angle X-ray Scattering (SAXS)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/saxs.yaml` |

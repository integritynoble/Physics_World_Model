# 03 — Reconstruction Algorithms: Small-Angle X-ray Scattering (SAXS)
...
The default solver for Small-Angle X-ray Scattering (SAXS) is **`desmearing`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/saxs.yaml`

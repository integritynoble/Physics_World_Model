# 05 — Hands-On Tutorial: Stellar Coronagraphy

This tutorial walks through running the PWM benchmark for Stellar Coronagraphy,
...
config_path = ROOT / "benchmarks" / "configs" / "coronagraphy.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("coronagraphy_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/coronagraphy.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/coronagraphy_expanded.yaml`

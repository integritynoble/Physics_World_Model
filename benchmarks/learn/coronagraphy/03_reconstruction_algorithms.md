# 03 — Reconstruction Algorithms: Stellar Coronagraphy
...
The default solver for Stellar Coronagraphy is **`adi_speckle_subtraction`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/coronagraphy.yaml`

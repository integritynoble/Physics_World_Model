# Benchmark QA Check — coronagraphy
...
- Methods: PRIMO + gradient, VLA-Net + gradient, AIRI + gradient, MEM + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Stellar Coronagraphy — Physics World Model
- [x] Description: Stellar Coronagraphy
- [x] Spec notation: M → P → D
...
- [x] Learn: 03_reconstruction_algorithms.md (2,026 B)

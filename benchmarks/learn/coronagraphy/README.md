# Stellar Coronagraphy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Stellar Coronagraphy**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/coronagraphy.yaml` |

# 05 — Hands-On Tutorial: DNA-PAINT Super-Resolution

This tutorial walks through running the PWM benchmark for DNA-PAINT Super-Resolution,
...
config_path = ROOT / "benchmarks" / "configs" / "dna_paint.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("dna_paint_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/dna_paint.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/dna_paint_expanded.yaml`

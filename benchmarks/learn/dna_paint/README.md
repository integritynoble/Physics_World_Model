# DNA-PAINT Super-Resolution — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **DNA-PAINT Super-Resolution**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `dna_paint` |
| Category | Microscopy |
| Carrier | Photon |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/dna_paint.yaml` |

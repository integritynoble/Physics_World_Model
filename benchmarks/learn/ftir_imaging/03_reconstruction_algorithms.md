# 03 — Reconstruction Algorithms: FTIR Spectroscopic Imaging
...
The default solver for FTIR Spectroscopic Imaging is **`interferogram_fft`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/ftir_imaging.yaml`

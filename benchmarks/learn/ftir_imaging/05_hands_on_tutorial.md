# 05 — Hands-On Tutorial: FTIR Spectroscopic Imaging

This tutorial walks through running the PWM benchmark for FTIR Spectroscopic Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "ftir_imaging.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ftir_imaging_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ftir_imaging.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ftir_imaging_expanded.yaml`

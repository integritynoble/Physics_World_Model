# PALM/STORM Single-Molecule Localization — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **PALM/STORM Single-Molecule Localization**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/palm_storm.yaml` |

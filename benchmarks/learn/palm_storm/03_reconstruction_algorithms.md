# 03 — Reconstruction Algorithms: PALM/STORM Single-Molecule Localization
...
The default solver for PALM/STORM Single-Molecule Localization is **`thunderstorm`**.
...
### Traditional Cpu: Richardson-Lucy (STORM/PALM)
...
3. Add the solver tier to the modality config in `benchmarks/configs/palm_storm.yaml`

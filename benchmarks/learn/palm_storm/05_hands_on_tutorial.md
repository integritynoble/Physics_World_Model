# 05 — Hands-On Tutorial: PALM/STORM Single-Molecule Localization

This tutorial walks through running the PWM benchmark for PALM/STORM Single-Molecule Localization,
...
config_path = ROOT / "benchmarks" / "configs" / "palm_storm.yaml"
...
try:
    ...
    print("Solver loaded: Richardson-Lucy (STORM/PALM)")
except ImportError:
...
solvers_to_test = {
    "Richardson-Lucy (STORM/PALM)": ("pwm_core.recon.richardson_lucy", "run_richardson_lucy"),
...
# axes[1].set_title("Richardson-Lucy (STORM/PALM)")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Best Quality")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("palm_storm_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/palm_storm.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/palm_storm_expanded.yaml`

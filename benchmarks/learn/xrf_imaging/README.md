# X-ray Fluorescence (XRF) Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **X-ray Fluorescence (XRF) Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `xrf_imaging` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/xrf_imaging.yaml` |

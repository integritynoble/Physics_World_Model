# 03 — Reconstruction Algorithms: X-ray Fluorescence (XRF) Imaging
...
The default solver for X-ray Fluorescence (XRF) Imaging is **`element_quantification`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/xrf_imaging.yaml`

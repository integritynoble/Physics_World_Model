# Streak Camera Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Streak Camera Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `streak_camera` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/streak_camera.yaml` |

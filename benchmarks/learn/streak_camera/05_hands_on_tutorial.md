# 05 — Hands-On Tutorial: Streak Camera Imaging

This tutorial walks through running the PWM benchmark for Streak Camera Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "streak_camera.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("streak_camera_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/streak_camera.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/streak_camera_expanded.yaml`

# 03 — Reconstruction Algorithms: Streak Camera Imaging
...
The default solver for Streak Camera Imaging is **`spatiotemporal_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/streak_camera.yaml`

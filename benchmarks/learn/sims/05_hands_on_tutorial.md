# 05 — Hands-On Tutorial: Secondary Ion Mass Spectrometry (SIMS) Imaging

This tutorial walks through running the PWM benchmark for Secondary Ion Mass Spectrometry (SIMS) Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "sims.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("sims_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/sims.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/sims_expanded.yaml`

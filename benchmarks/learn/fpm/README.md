# Fourier Ptychographic Microscopy (FPM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Fourier Ptychographic Microscopy (FPM)**.
...
| Default Solver | `sequential_phase_retrieval` |
| Maturity | M1 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/fpm.yaml` |

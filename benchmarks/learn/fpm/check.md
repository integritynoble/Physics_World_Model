...
- [x] Title: FPM — Physics World Model
- [x] Description: Fourier Ptychographic Microscopy
- [x] Spec notation: S(LED array) → C(PSF_NA) → Σ_θ → D(g, η₁)
...
- [x] Learn: 01_physics_fundamentals.md (3,455 B)
- [x] Learn: 02_forward_model.md (2,735 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,856 B)
- [x] Learn: 04_pwm_benchmark.md (2,547 B)
- [x] Learn: 05_hands_on_tutorial.md (3,598 B)

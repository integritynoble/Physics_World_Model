# 03 — Reconstruction Algorithms: Photon-Counting Spectral CT
...
The default solver for Photon-Counting Spectral CT is **`material_decomposition`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/spectral_ct.yaml`

# 05 — Hands-On Tutorial: Photon-Counting Spectral CT

This tutorial walks through running the PWM benchmark for Photon-Counting Spectral CT,
...
config_path = ROOT / "benchmarks" / "configs" / "spectral_ct.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality spectral_ct
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("spectral_ct_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/spectral_ct.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/spectral_ct_expanded.yaml`

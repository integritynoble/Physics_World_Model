# Photon-Counting Spectral CT — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Photon-Counting Spectral CT**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `spectral_ct` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/spectral_ct.yaml` |

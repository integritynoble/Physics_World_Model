# Comprehensive Benchmark QA Check — Functional MRI (BOLD)
...
**Display Name:** Functional MRI (BOLD)

**Physics Class:** fourier_sampling
**Forward Model:** bold_hemodynamic
...
5. **Define mismatch modes** — head_motion, susceptibility_distortion, physiological_noise etc.
...
*Automated 6-point review on 2026-03-03 — Functional MRI (BOLD)*

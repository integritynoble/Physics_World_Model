# Comprehensive Benchmark QA Check — TIRF Microscopy
...
**Display Name:** TIRF Microscopy

**Physics Class:** evanescent_wave_fluorescence
**Forward Model:** tirf_psf_convolution
...
5. **Define mismatch modes** — angle_calibration_error, scattering_excitation, interference_fringes etc.
...
*Automated 6-point review on 2026-03-03 — TIRF Microscopy*

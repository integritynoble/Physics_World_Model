# 03 — Reconstruction Algorithms: TIRF Microscopy
...
The default solver for TIRF Microscopy is **`richardson_lucy`**.
...
### Traditional Cpu: Richardson-Lucy (TIRF)
...
3. Add the solver tier to the modality config in `benchmarks/configs/tirf.yaml`

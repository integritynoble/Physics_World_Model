# 05 — Hands-On Tutorial: TIRF Microscopy

This tutorial walks through running the PWM benchmark for TIRF Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "tirf.yaml"
...
try:
    ...
    print("Solver loaded: Richardson-Lucy (TIRF)")
except ImportError:
...
solvers_to_test = {
    "Richardson-Lucy (TIRF)": ("pwm_core.recon.richardson_lucy", "run_richardson_lucy"),
...
# axes[1].set_title("Richardson-Lucy (TIRF)")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Best Quality")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("tirf_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/tirf.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/tirf_expanded.yaml`

# 05 — Hands-On Tutorial: Cone-Beam Computed Tomography (CBCT)

This tutorial walks through running the PWM benchmark for Cone-Beam Computed Tomography (CBCT),
...
config_path = ROOT / "benchmarks" / "configs" / "cbct.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality cbct
...
solvers_to_test = {
    "FDK / FBP": ("pwm_core.recon.ct_solvers", "run_fbp"),
...
# axes[1].set_title("FDK / FBP")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Best Quality")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("cbct_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/cbct.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/cbct_expanded.yaml`

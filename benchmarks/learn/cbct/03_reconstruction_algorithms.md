# 03 — Reconstruction Algorithms: Cone-Beam Computed Tomography (CBCT)
...
The default solver for Cone-Beam Computed Tomography (CBCT) is **`fdk`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/cbct.yaml`

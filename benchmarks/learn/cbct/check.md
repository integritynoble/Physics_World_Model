...
- Methods: TransCT + gradient, FBPConvNet + gradient, PnP-DRUNet + gradient, FBP + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: CBCT — Physics World Model
- [x] Description: Cone-Beam Computed Tomography
- [x] Spec notation: R(θ) → Π(cone) → D(g, η₁)
...
- [x] Learn: 01_physics_fundamentals.md (2,613 B)
- [x] Learn: 02_forward_model.md (2,523 B)
- [x] Learn: 03_reconstruction_algorithms.md (1,801 B)
- [x] Learn: 04_pwm_benchmark.md (2,262 B)
- [x] Learn: 05_hands_on_tutorial.md (3,506 B)

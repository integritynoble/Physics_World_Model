# Comprehensive Benchmark QA Check — Cone-Beam Computed Tomography
...
**Display Name:** Cone-Beam Computed Tomography

**Physics Class:** tomographic
**Forward Model:** cone_beam_projection
**Noise Model:** poisson
...
5. **Define mismatch modes** — cone_beam_artifact, scatter, truncation etc.
...
*Automated 6-point review on 2026-03-03 — Cone-Beam Computed Tomography*

# Differential Interference Contrast (DIC) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Differential Interference Contrast (DIC)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/dic.yaml` |

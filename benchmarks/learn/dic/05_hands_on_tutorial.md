# 05 — Hands-On Tutorial: Differential Interference Contrast (DIC)

This tutorial walks through running the PWM benchmark for Differential Interference Contrast (DIC),
...
config_path = ROOT / "benchmarks" / "configs" / "dic.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality dic
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("dic_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/dic.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/dic_expanded.yaml`

# 03 — Reconstruction Algorithms: Differential Interference Contrast (DIC)
...
The default solver for Differential Interference Contrast (DIC) is **`dic_gradient_integration`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/dic.yaml`

# 02 — Forward Model: Differential Interference Contrast (DIC)
...
The PWM benchmark for Differential Interference Contrast (DIC) uses:

- **Forward model**: `microscopy_psf` with `linear_operator` operator
- **Default solver**: `dic_gradient_integration`
- **Metrics**: ['psnr', 'ssim']
- **Primary metric**: psnr

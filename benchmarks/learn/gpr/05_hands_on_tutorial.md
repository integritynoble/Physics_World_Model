# 05 — Hands-On Tutorial: Ground-Penetrating Radar (GPR)

This tutorial walks through running the PWM benchmark for Ground-Penetrating Radar (GPR),
...
config_path = ROOT / "benchmarks" / "configs" / "gpr.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("gpr_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/gpr.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/gpr_expanded.yaml`

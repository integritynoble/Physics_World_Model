# 03 — Reconstruction Algorithms: Ground-Penetrating Radar (GPR)
...
The default solver for Ground-Penetrating Radar (GPR) is **`migration`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/gpr.yaml`

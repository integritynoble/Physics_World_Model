# 05 — Hands-On Tutorial: Fiber Bundle Endoscopy

This tutorial walks through running the PWM benchmark for Fiber Bundle Endoscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "endoscopy.yaml"
...
try:
    ...
    print("Solver loaded: FISTA-L2 (endoscopy)")
except ImportError:
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality endoscopy
...
solvers_to_test = {
    "FISTA-L2 (endoscopy)": ("pwm_core.recon.classical", "run_fista_l2"),
...
# axes[1].set_title("FISTA-L2 (endoscopy)")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Best Quality")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("endoscopy_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/endoscopy.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/endoscopy_expanded.yaml`

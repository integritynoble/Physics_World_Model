# Fiber Bundle Endoscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Fiber Bundle Endoscopy**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/endoscopy.yaml` |

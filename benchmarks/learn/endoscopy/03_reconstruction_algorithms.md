# 03 — Reconstruction Algorithms: Fiber Bundle Endoscopy
...
The default solver for Fiber Bundle Endoscopy is **`tv_fista`**.
...
### Traditional Cpu: FISTA-L2 (endoscopy)
...
3. Add the solver tier to the modality config in `benchmarks/configs/endoscopy.yaml`

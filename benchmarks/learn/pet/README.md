# Positron Emission Tomography (PET) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Positron Emission Tomography (PET)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/pet.yaml` |

# 03 — Reconstruction Algorithms: Positron Emission Tomography (PET)
...
The default solver for Positron Emission Tomography (PET) is **`mlem`**.
...
### Traditional Cpu: FBP (emission tomography)
...
3. Add the solver tier to the modality config in `benchmarks/configs/pet.yaml`

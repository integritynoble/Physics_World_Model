# Structured-Light Depth Camera — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Structured-Light Depth Camera**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/structured_light.yaml` |

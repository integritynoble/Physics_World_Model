# 03 — Reconstruction Algorithms: Structured-Light Depth Camera
...
The default solver for Structured-Light Depth Camera is **`phase_unwrap`**.
...
|------|------|--------|----------|-----|-----------|
| traditional_cpu | FISTA-L2 (phase unwrap) | `pwm_core.recon.classical` | `run_fista_l2` | No |  |
...
### Traditional Cpu: FISTA-L2 (phase unwrap)
...
3. Add the solver tier to the modality config in `benchmarks/configs/structured_light.yaml`

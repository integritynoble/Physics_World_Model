# Correlative Light-Electron Microscopy (CLEM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Correlative Light-Electron Microscopy (CLEM)**.
...
| Default Solver | `overlay_registration` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/clem.yaml` |

# 03 — Reconstruction Algorithms: Correlative Light-Electron Microscopy (CLEM)
...
The default solver for Correlative Light-Electron Microscopy (CLEM) is **`overlay_registration`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/clem.yaml`

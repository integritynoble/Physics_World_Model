# Entangled Photon Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Entangled Photon Microscopy**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `entangled_photon` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/entangled_photon.yaml` |

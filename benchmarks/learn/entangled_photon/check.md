...
- Methods: Ghost-ViT + gradient, QGI-Net + gradient, CS-TVAL3 + gradient, TVAL3 + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Entangled Photon Microscopy — Physics World Model
- [x] Description: Entangled Photon Microscopy
...
- [x] Learn: README.md (1,459 B)
- [x] Learn: 01_physics_fundamentals.md (2,123 B)
- [x] Learn: 02_forward_model.md (2,720 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,038 B)
- [x] Learn: 04_pwm_benchmark.md (2,405 B)
- [x] Learn: 05_hands_on_tutorial.md (3,548 B)

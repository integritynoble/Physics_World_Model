# 05 — Hands-On Tutorial: Entangled Photon Microscopy

This tutorial walks through running the PWM benchmark for Entangled Photon Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "entangled_photon.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality entangled_photon
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("entangled_photon_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/entangled_photon.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/entangled_photon_expanded.yaml`

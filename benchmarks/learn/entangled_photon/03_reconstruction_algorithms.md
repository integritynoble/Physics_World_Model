# 03 — Reconstruction Algorithms: Entangled Photon Microscopy
...
The default solver for Entangled Photon Microscopy is **`coincidence_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/entangled_photon.yaml`

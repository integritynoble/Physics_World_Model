# Quality Check: `talbot_lau`

**Checked:** 2026-03-03T14:11:18.678872+00:00
...
- [x] Page title: Talbot-Lau X-ray Grating Interferometry — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: M → P → D
- [x] Description: Talbot-Lau X-ray Grating Interferometry
...
- [x] Learn file README.md exists (1467 bytes)
- [x] Learn file 01_physics_fundamentals.md exists (2061 bytes)
- [x] Learn file 02_forward_model.md exists (2751 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2053 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2425 bytes)
- [x] Learn file 05_hands_on_tutorial.md exists (3542 bytes)

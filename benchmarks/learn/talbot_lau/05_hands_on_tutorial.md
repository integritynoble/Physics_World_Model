# 05 — Hands-On Tutorial: Talbot-Lau X-ray Grating Interferometry

This tutorial walks through running the PWM benchmark for Talbot-Lau X-ray Grating Interferometry,
...
config_path = ROOT / "benchmarks" / "configs" / "talbot_lau.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("talbot_lau_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/talbot_lau.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/talbot_lau_expanded.yaml`

# 03 — Reconstruction Algorithms: Talbot-Lau X-ray Grating Interferometry
...
The default solver for Talbot-Lau X-ray Grating Interferometry is **`phase_stepping`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/talbot_lau.yaml`

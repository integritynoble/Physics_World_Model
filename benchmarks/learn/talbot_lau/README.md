# Talbot-Lau X-ray Grating Interferometry — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Talbot-Lau X-ray Grating Interferometry**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `talbot_lau` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/talbot_lau.yaml` |

# 03 — Reconstruction Algorithms: Confocal Live-Cell Microscopy
...
The default solver for Confocal Live-Cell Microscopy is **`richardson_lucy`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/confocal_livecell.yaml`

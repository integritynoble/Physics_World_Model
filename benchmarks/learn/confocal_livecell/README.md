# Confocal Live-Cell Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Confocal Live-Cell Microscopy**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/confocal_livecell.yaml` |

...
- Page size: 56,629 bytes
- Methods: SwinIR + gradient, WaveNet + gradient, PnP-RED + gradient, FISTA + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Full-Waveform Inversion (FWI) — Physics World Model
- [x] Description: Full-Waveform Inversion (FWI)
- [x] Spec notation: P → D
...
- [x] Learn: 01_physics_fundamentals.md (1,948 B)
- [x] Learn: 02_forward_model.md (2,723 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,025 B)
- [x] Learn: 04_pwm_benchmark.md (2,372 B)
- [x] Learn: 05_hands_on_tutorial.md (3,487 B)

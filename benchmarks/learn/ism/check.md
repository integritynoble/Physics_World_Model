...
- Methods: ANNA-PALM + gradient, DECODE + gradient, SPARCOM + gradient, SOFI + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: Image Scanning Microscopy (ISM) — Physics World Model
- [x] Description: Image Scanning Microscopy (ISM)
- [x] Spec notation: C → D
...
- [x] Learn: 01_physics_fundamentals.md (2,210 B)
- [x] Learn: 02_forward_model.md (2,652 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,134 B)
- [x] Learn: 04_pwm_benchmark.md (2,265 B)

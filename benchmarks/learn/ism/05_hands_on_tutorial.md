# 05 — Hands-On Tutorial: Image Scanning Microscopy (ISM)

This tutorial walks through running the PWM benchmark for Image Scanning Microscopy (ISM),
...
config_path = ROOT / "benchmarks" / "configs" / "ism.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality ism
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ism_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ism.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ism_expanded.yaml`

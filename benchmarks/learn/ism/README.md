# Image Scanning Microscopy (ISM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Image Scanning Microscopy (ISM)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/ism.yaml` |

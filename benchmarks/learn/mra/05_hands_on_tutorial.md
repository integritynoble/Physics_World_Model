# 05 — Hands-On Tutorial: MR Angiography (MRA)

This tutorial walks through running the PWM benchmark for MR Angiography (MRA),
...
config_path = ROOT / "benchmarks" / "configs" / "mra.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality mra
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("mra_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/mra.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/mra_expanded.yaml`

# Brachytherapy Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Brachytherapy Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `brachytherapy_img` |
| Category | Medical Imaging |
| Carrier | Gamma/X-ray |
| Forward Model | nonlinear_operator |
| Default Solver | `tg43_dose` |
| Maturity | M0 |
| Tier | A |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of Gamma/X-ray imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/brachytherapy_img.yaml` |

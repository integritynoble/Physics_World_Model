# 03 — Reconstruction Algorithms: Brachytherapy Imaging
...
The default solver for Brachytherapy Imaging is **`tg43_dose`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/brachytherapy_img.yaml`

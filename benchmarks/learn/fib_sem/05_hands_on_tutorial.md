# 05 — Hands-On Tutorial: Focused Ion Beam SEM (FIB-SEM)

This tutorial walks through running the PWM benchmark for Focused Ion Beam SEM (FIB-SEM),
...
config_path = ROOT / "benchmarks" / "configs" / "fib_sem.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality fib_sem
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("fib_sem_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/fib_sem.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/fib_sem_expanded.yaml`

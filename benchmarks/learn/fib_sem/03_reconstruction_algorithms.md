# 03 — Reconstruction Algorithms: Focused Ion Beam SEM (FIB-SEM)
...
The default solver for Focused Ion Beam SEM (FIB-SEM) is **`stack_alignment`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/fib_sem.yaml`

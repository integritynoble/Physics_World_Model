# 02 — Forward Model: Focused Ion Beam SEM (FIB-SEM)
...
This modality uses the **`electron_ctf`** category module:
Contrast transfer function / electron optics.
...
The PWM benchmark for Focused Ion Beam SEM (FIB-SEM) uses:

- **Forward model**: `electron_ctf` with `nonlinear_operator` operator
- **Default solver**: `stack_alignment`
- **Metrics**: ['psnr', 'ssim']
- **Primary metric**: psnr

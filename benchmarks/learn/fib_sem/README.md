# Focused Ion Beam SEM (FIB-SEM) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Focused Ion Beam SEM (FIB-SEM)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/fib_sem.yaml` |

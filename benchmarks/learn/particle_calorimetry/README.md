# Particle Calorimetry — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Particle Calorimetry**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `particle_calorimetry` |
| Category | Broader Experimental Science |
| Carrier | Particle |
| Forward Model | nonlinear_operator |
| Default Solver | `energy_recon` |
| Maturity | M0 |
| Tier | A |
...
| # | File | Topic | Est. Time |
|---|------|-------|-----------|
| 1 | [01_physics_fundamentals.md](01_physics_fundamentals.md) | Physics of Particle imaging, key equations, hardware | 30 min |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/particle_calorimetry.yaml` |

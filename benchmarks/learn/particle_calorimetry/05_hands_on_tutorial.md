# 05 — Hands-On Tutorial: Particle Calorimetry

This tutorial walks through running the PWM benchmark for Particle Calorimetry,
...
config_path = ROOT / "benchmarks" / "configs" / "particle_calorimetry.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("particle_calorimetry_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/particle_calorimetry.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/particle_calorimetry_expanded.yaml`

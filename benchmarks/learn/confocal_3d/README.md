# Confocal 3D Z-Stack — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Confocal 3D Z-Stack**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/confocal_3d.yaml` |

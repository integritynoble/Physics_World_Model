# Dark-Field Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Dark-Field Microscopy**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `dark_field` |
| Category | Microscopy |
| Carrier | Photon |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/dark_field.yaml` |

# 05 — Hands-On Tutorial: Dark-Field Microscopy

This tutorial walks through running the PWM benchmark for Dark-Field Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "dark_field.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("dark_field_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/dark_field.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/dark_field_expanded.yaml`

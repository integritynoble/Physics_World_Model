# Panorama Multi-Focus Fusion — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Panorama Multi-Focus Fusion**.
...
| Default Solver | `laplacian_pyramid_fusion` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/panorama.yaml` |

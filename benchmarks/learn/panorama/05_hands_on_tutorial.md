# 05 — Hands-On Tutorial: Panorama Multi-Focus Fusion

This tutorial walks through running the PWM benchmark for Panorama Multi-Focus Fusion,
...
config_path = ROOT / "benchmarks" / "configs" / "panorama.yaml"
...
try:
    ...
    print("Solver loaded: Laplacian Pyramid Fusion")
except ImportError:
...
solvers_to_test = {
    "Laplacian Pyramid Fusion": ("pwm_core.recon.panorama_solver", "run_panorama_fusion"),
    "Guided Filter Fusion": ("pwm_core.recon.panorama_solver", "multifocus_fusion_guided"),
}
...
# axes[1].set_title("Laplacian Pyramid Fusion")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Guided Filter Fusion")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("panorama_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/panorama.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/panorama_expanded.yaml`

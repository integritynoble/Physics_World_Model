# Electron Holography — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Electron Holography**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/electron_holography.yaml` |

# 05 — Hands-On Tutorial: Eddy Current Imaging

This tutorial walks through running the PWM benchmark for Eddy Current Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "eddy_current.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("eddy_current_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/eddy_current.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/eddy_current_expanded.yaml`

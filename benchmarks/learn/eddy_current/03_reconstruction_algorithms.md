# 03 — Reconstruction Algorithms: Eddy Current Imaging
...
The default solver for Eddy Current Imaging is **`impedance_inversion`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/eddy_current.yaml`

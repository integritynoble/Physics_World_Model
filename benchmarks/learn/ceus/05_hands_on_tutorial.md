# 05 — Hands-On Tutorial: Contrast-Enhanced Ultrasound (CEUS)

This tutorial walks through running the PWM benchmark for Contrast-Enhanced Ultrasound (CEUS),
...
config_path = ROOT / "benchmarks" / "configs" / "ceus.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality ceus
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ceus_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ceus.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ceus_expanded.yaml`

# 03 — Reconstruction Algorithms: Contrast-Enhanced Ultrasound (CEUS)
...
The default solver for Contrast-Enhanced Ultrasound (CEUS) is **`contrast_specific`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/ceus.yaml`

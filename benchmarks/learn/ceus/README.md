# Contrast-Enhanced Ultrasound (CEUS) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Contrast-Enhanced Ultrasound (CEUS)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/ceus.yaml` |

# 05 — Hands-On Tutorial: X-ray Crystallography

This tutorial walks through running the PWM benchmark for X-ray Crystallography,
...
config_path = ROOT / "benchmarks" / "configs" / "xray_crystallography.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("xray_crystallography_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/xray_crystallography.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/xray_crystallography_expanded.yaml`

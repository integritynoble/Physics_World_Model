# 03 — Reconstruction Algorithms: X-ray Crystallography
...
The default solver for X-ray Crystallography is **`direct_methods`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/xray_crystallography.yaml`

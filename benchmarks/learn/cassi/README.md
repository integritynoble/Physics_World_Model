# Coded Aperture Snapshot Spectral Imaging (CASSI) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Coded Aperture Snapshot Spectral Imaging (CASSI)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/cassi.yaml` |

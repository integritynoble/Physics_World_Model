# 03 — Reconstruction Algorithms: DESI Mass Spectrometry Imaging
...
The default solver for DESI Mass Spectrometry Imaging is **`mass_image_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/desi.yaml`

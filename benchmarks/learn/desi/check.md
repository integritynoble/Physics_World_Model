...
- Page size: 56,736 bytes
- Methods: Cascade-UNet + gradient, RamanNet + gradient, PnP-DnCNN + gradient, MCR-ALS + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: DESI Mass Spectrometry Imaging — Physics World Model
- [x] Description: DESI Mass Spectrometry Imaging
- [x] Spec notation: S → D
...
- [x] Learn: README.md (1,450 B)
- [x] Learn: 01_physics_fundamentals.md (1,924 B)
- [x] Learn: 02_forward_model.md (2,744 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,031 B)
- [x] Learn: 04_pwm_benchmark.md (2,378 B)

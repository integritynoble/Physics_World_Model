# 05 — Hands-On Tutorial: DESI Mass Spectrometry Imaging

This tutorial walks through running the PWM benchmark for DESI Mass Spectrometry Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "desi.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality desi
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("desi_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/desi.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/desi_expanded.yaml`

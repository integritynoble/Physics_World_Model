# 03 — Reconstruction Algorithms: Quantum Illumination
...
The default solver for Quantum Illumination is **`quantum_detector`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/quantum_illumination.yaml`

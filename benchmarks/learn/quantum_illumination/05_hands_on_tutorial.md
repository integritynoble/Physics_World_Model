# 05 — Hands-On Tutorial: Quantum Illumination

This tutorial walks through running the PWM benchmark for Quantum Illumination,
...
config_path = ROOT / "benchmarks" / "configs" / "quantum_illumination.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("quantum_illumination_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/quantum_illumination.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/quantum_illumination_expanded.yaml`

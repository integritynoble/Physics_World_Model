# Quantum Illumination — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Quantum Illumination**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `quantum_illumination` |
| Category | Quantum Imaging |
| Carrier | Photon |
| Forward Model | nonlinear_operator |
| Default Solver | `quantum_detector` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/quantum_illumination.yaml` |

# Quality Check: `photometric_stereo`

**Checked:** 2026-03-03T14:14:40.766880+00:00
...
- [x] Page title: Photometric Stereo — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: M → C → D
- [x] Description: Photometric Stereo
...
- [x] Learn file README.md exists (1443 bytes)
- [x] Learn file 01_physics_fundamentals.md exists (2196 bytes)
- [x] Learn file 02_forward_model.md exists (2724 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2022 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2426 bytes)
- [x] Learn file 05_hands_on_tutorial.md exists (3540 bytes)

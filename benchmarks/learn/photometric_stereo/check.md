# Benchmark QA Check — photometric_stereo

**URL:** https://pwm.platformai.org/benchmark/photometric_stereo
**HTTP Status:** 200
**Page Size:** 57,421 bytes
...
- 🔵 **INFO**: GCS image reference: /gcs/challenge-data/v1.0/photometric_stereo_challenge_public.h5 — verify it loads
- 🔵 **INFO**: GCS image reference: /gcs/challenge-data/v1.0/photometric_stereo_challenge_dev.h5 — verify it loads

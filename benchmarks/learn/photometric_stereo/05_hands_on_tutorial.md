# 05 — Hands-On Tutorial: Photometric Stereo

This tutorial walks through running the PWM benchmark for Photometric Stereo,
...
config_path = ROOT / "benchmarks" / "configs" / "photometric_stereo.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("photometric_stereo_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/photometric_stereo.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/photometric_stereo_expanded.yaml`

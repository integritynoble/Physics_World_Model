# 03 — Reconstruction Algorithms: Photometric Stereo
...
The default solver for Photometric Stereo is **`normal_estimation`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/photometric_stereo.yaml`

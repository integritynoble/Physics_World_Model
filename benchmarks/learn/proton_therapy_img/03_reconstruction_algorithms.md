# 03 — Reconstruction Algorithms: Proton Therapy Imaging
...
The default solver for Proton Therapy Imaging is **`back_projection`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/proton_therapy_img.yaml`

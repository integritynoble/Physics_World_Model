# 05 — Hands-On Tutorial: Proton Therapy Imaging

This tutorial walks through running the PWM benchmark for Proton Therapy Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "proton_therapy_img.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality proton_therapy_img
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("proton_therapy_img_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/proton_therapy_img.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/proton_therapy_img_expanded.yaml`

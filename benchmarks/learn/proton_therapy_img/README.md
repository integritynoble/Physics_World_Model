# Proton Therapy Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Proton Therapy Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `proton_therapy_img` |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/proton_therapy_img.yaml` |

# Ultrasound B-mode Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Ultrasound B-mode Imaging**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/ultrasound.yaml` |

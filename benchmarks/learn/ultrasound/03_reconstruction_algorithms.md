# 03 — Reconstruction Algorithms: Ultrasound B-mode Imaging
...
The default solver for Ultrasound B-mode Imaging is **`das_beamform`**.
...
|------|------|--------|----------|-----|-----------|
| traditional_cpu | FISTA-L2 (ultrasound) | `pwm_core.recon.classical` | `run_fista_l2` | No |  |
...
### Traditional Cpu: FISTA-L2 (ultrasound)
...
3. Add the solver tier to the modality config in `benchmarks/configs/ultrasound.yaml`

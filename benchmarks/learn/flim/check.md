...
- Page size: 112,449 bytes
- Methods: PolScope-Former + gradient, PnP-BM3D + gradient, FLIM-Net + gradient, Phasor-FLIM + gradient

## Passed Checks

- [x] Main page loads (HTTP 200)
- [x] Title: FLIM — Physics World Model
- [x] Description: Fluorescence Lifetime Imaging
- [x] Spec notation: C(PSF) → Σ_t → D(g, η₃)
...
- [x] Learn: 01_physics_fundamentals.md (3,376 B)
- [x] Learn: 02_forward_model.md (2,698 B)
- [x] Learn: 03_reconstruction_algorithms.md (2,669 B)
- [x] Learn: 04_pwm_benchmark.md (2,531 B)
- [x] Learn: 05_hands_on_tutorial.md (3,532 B)

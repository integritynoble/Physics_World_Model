# 4D-STEM Electron Diffraction — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **4D-STEM Electron Diffraction**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/electron_diffraction.yaml` |

# 03 — Reconstruction Algorithms: 4D-STEM Electron Diffraction
...
The default solver for 4D-STEM Electron Diffraction is **`ptychography_epie`**.
...
### Traditional Cpu: ePIE (electron ptychography)
...
3. Add the solver tier to the modality config in `benchmarks/configs/electron_diffraction.yaml`

# 05 — Hands-On Tutorial: Intravascular Ultrasound (IVUS)

This tutorial walks through running the PWM benchmark for Intravascular Ultrasound (IVUS),
...
config_path = ROOT / "benchmarks" / "configs" / "ivus.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality ivus
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("ivus_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/ivus.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/ivus_expanded.yaml`

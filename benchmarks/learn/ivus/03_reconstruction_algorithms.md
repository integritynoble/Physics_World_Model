# 03 — Reconstruction Algorithms: Intravascular Ultrasound (IVUS)
...
The default solver for Intravascular Ultrasound (IVUS) is **`polar_recon`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/ivus.yaml`

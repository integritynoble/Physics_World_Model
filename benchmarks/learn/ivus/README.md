# Intravascular Ultrasound (IVUS) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Intravascular Ultrasound (IVUS)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/ivus.yaml` |

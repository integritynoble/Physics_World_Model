# Machine Vision / AOI — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Machine Vision / AOI**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `machine_vision` |
| Category | Industrial Inspection |
| Carrier | Photon |
| Forward Model | linear_operator |
| Default Solver | `defect_detection` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/machine_vision.yaml` |

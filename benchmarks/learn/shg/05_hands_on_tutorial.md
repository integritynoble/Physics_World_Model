# 05 — Hands-On Tutorial: Second Harmonic Generation (SHG) Microscopy

This tutorial walks through running the PWM benchmark for Second Harmonic Generation (SHG) Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "shg.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("shg_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/shg.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/shg_expanded.yaml`

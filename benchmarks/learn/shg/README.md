# Second Harmonic Generation (SHG) Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Second Harmonic Generation (SHG) Microscopy**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/shg.yaml` |

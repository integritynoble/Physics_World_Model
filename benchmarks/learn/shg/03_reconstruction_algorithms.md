# 03 — Reconstruction Algorithms: Second Harmonic Generation (SHG) Microscopy
...
The default solver for Second Harmonic Generation (SHG) Microscopy is **`pnp_hqs`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/shg.yaml`

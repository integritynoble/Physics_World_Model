# Phase Contrast Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Phase Contrast Microscopy**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `phase_contrast` |
| Category | Microscopy |
| Carrier | Photon |
| Forward Model | linear_operator |
| Default Solver | `halo_removal` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/phase_contrast.yaml` |

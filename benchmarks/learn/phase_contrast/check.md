# Quality Check: `phase_contrast`

**Checked:** 2026-03-03T14:14:42.375887+00:00
...
- [x] Page title: Phase Contrast Microscopy — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: C → D
- [x] Description: Phase Contrast Microscopy
...
- [x] Learn file README.md exists (1438 bytes)
- [x] Learn file 01_physics_fundamentals.md exists (2198 bytes)
- [x] Learn file 02_forward_model.md exists (2689 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (2127 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2352 bytes)
- [x] Learn file 05_hands_on_tutorial.md exists (3584 bytes)

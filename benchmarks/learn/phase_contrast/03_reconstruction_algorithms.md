# 03 — Reconstruction Algorithms: Phase Contrast Microscopy
...
The default solver for Phase Contrast Microscopy is **`halo_removal`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/phase_contrast.yaml`

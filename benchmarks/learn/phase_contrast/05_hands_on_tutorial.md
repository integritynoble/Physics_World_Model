# 05 — Hands-On Tutorial: Phase Contrast Microscopy

This tutorial walks through running the PWM benchmark for Phase Contrast Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "phase_contrast.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("phase_contrast_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/phase_contrast.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/phase_contrast_expanded.yaml`

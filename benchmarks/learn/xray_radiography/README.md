# X-ray Radiography — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **X-ray Radiography**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/xray_radiography.yaml` |

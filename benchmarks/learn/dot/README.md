# Diffuse Optical Tomography (DOT) — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Diffuse Optical Tomography (DOT)**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/dot.yaml` |

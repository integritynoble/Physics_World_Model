# 03 — Reconstruction Algorithms: Diffuse Optical Tomography (DOT)
...
The default solver for Diffuse Optical Tomography (DOT) is **`born_approx`**.
...
| best_quality | L-BFGS-TV | `pwm_core.recon.dot_solver` | `lbfgs_tv_recon` | No | Schweiger & Arridge 2005, PMB |
| pnp_baseline | PnP-Diffusion | `pwm_core.recon.dot_solver` | `pnp_diffusion_recon` | Yes |  |
...
### Traditional Cpu: Born Approximation
...
3. Add the solver tier to the modality config in `benchmarks/configs/dot.yaml`

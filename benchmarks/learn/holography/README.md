# Digital Holographic Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Digital Holographic Microscopy**.
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/holography.yaml` |

# 05 — Hands-On Tutorial: Digital Holographic Microscopy

This tutorial walks through running the PWM benchmark for Digital Holographic Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "holography.yaml"
...
try:
    ...
    print("Solver loaded: Angular Spectrum")
except ImportError:
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality holography
...
solvers_to_test = {
    "Angular Spectrum": ("pwm_core.recon.holography_solver", "run_holography_reconstruction"),
    "PhaseNet": ("pwm_core.recon.phasenet", "phasenet_reconstruct"),
}
...
# axes[2].set_title("PhaseNet")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("holography_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/holography.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/holography_expanded.yaml`

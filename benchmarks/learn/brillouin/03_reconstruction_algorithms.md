# 03 — Reconstruction Algorithms: Brillouin Microscopy
...
The default solver for Brillouin Microscopy is **`lorentz_fit`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/brillouin.yaml`

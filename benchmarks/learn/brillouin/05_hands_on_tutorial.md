# 05 — Hands-On Tutorial: Brillouin Microscopy

This tutorial walks through running the PWM benchmark for Brillouin Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "brillouin.yaml"
...
# Command-line usage:
# python benchmarks/runners/run_expanded.py --modality brillouin
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("brillouin_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/brillouin.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/brillouin_expanded.yaml`

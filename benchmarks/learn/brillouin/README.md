# Brillouin Microscopy — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **Brillouin Microscopy**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `brillouin` |
| Category | Spectroscopy & Spectral Imaging |
| Carrier | Photon |
| Forward Model | nonlinear_operator |
| Default Solver | `lorentz_fit` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/brillouin.yaml` |

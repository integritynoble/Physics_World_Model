# 05 — Hands-On Tutorial: High Dynamic Range (HDR) Imaging

This tutorial walks through running the PWM benchmark for High Dynamic Range (HDR) Imaging,
...
config_path = ROOT / "benchmarks" / "configs" / "hdr_imaging.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("hdr_imaging_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/hdr_imaging.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/hdr_imaging_expanded.yaml`

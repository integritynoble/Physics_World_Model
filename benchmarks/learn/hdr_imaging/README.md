# High Dynamic Range (HDR) Imaging — Learning Materials

A self-contained curriculum for understanding the physics, forward model,
reconstruction algorithms, and PWM benchmark for **High Dynamic Range (HDR) Imaging**.

## Quick Facts

| Property | Value |
|----------|-------|
| Modality ID | `hdr_imaging` |
| Category | Computational Photography |
| Carrier | Photon |
| Forward Model | nonlinear_operator |
| Default Solver | `hdr_merge` |
| Maturity | M0 |
| Tier | A |
...
| Module | Path |
|--------|------|
| Benchmark config | `benchmarks/configs/hdr_imaging.yaml` |

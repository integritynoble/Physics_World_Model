# 03 — Reconstruction Algorithms: High Dynamic Range (HDR) Imaging
...
The default solver for High Dynamic Range (HDR) Imaging is **`hdr_merge`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/hdr_imaging.yaml`

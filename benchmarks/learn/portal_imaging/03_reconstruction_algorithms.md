# 03 — Reconstruction Algorithms: Portal Imaging (EPID)
...
The default solver for Portal Imaging (EPID) is **`back_projection`**.
...
3. Add the solver tier to the modality config in `benchmarks/configs/portal_imaging.yaml`

# Quality Check: `portal_imaging`

**Checked:** 2026-03-03T14:14:39.118734+00:00
...
- [x] Page title: Portal Imaging (EPID) — Physics World Model
- [x] Challenge Leaderboard section present
- [x] Leaderboard has 4 entries
- [x] Spec notation present: Π → D
- [x] Description: Portal Imaging (EPID)
...
- [x] Learn file README.md exists (1430 bytes)
- [x] Learn file 01_physics_fundamentals.md exists (1958 bytes)
- [x] Learn file 02_forward_model.md exists (2734 bytes)
- [x] Learn file 03_reconstruction_algorithms.md exists (1998 bytes)
- [x] Learn file 04_pwm_benchmark.md exists (2368 bytes)
- [x] Learn file 05_hands_on_tutorial.md exists (3498 bytes)

# 05 — Hands-On Tutorial: Portal Imaging (EPID)

This tutorial walks through running the PWM benchmark for Portal Imaging (EPID),
...
config_path = ROOT / "benchmarks" / "configs" / "portal_imaging.yaml"
...
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("portal_imaging_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/portal_imaging.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/portal_imaging_expanded.yaml`

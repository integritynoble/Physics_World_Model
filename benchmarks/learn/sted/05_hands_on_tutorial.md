# 05 — Hands-On Tutorial: STED Microscopy

This tutorial walks through running the PWM benchmark for STED Microscopy,
...
config_path = ROOT / "benchmarks" / "configs" / "sted.yaml"
...
try:
    ...
    print("Solver loaded: Richardson-Lucy (STED)")
except ImportError:
...
solvers_to_test = {
    "Richardson-Lucy (STED)": ("pwm_core.recon.richardson_lucy", "run_richardson_lucy"),
...
# axes[1].set_title("Richardson-Lucy (STED)")
# axes[2].imshow(x_hat_best, cmap="gray")
# axes[2].set_title("Best Quality")
# for ax in axes:
#     ax.axis("off")
# plt.tight_layout()
# plt.savefig("sted_comparison.png", dpi=150)
# plt.show()
```
...
- Read the full config: `benchmarks/configs/sted.yaml`
- Explore the expanded config: `benchmarks/expanded_configs/sted_expanded.yaml`

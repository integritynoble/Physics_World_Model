# 03 — Reconstruction Algorithms: STED Microscopy
...
The default solver for STED Microscopy is **`richardson_lucy`**.
...
### Traditional Cpu: Richardson-Lucy (STED)
...
3. Add the solver tier to the modality config in `benchmarks/configs/sted.yaml`

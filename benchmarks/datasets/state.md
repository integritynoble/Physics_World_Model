...
| pet_mr | done | done | pending | pending | Combined PET/MRI, 12/20/20, MR k-space+PET Radon |
| spect_ct | done | done | pending | pending | Combined SPECT/CT, 6/20/20, SPECT+CT attenuation |
| spectral_ct | done | done | pending | pending | Dual-energy CT, 12/20/20, material decomposition |
| industrial_ct | done | done | pending | pending | Industrial CT, 12/20/20, beam hardening+metal artifacts |

...
Last updated: 2026-03-11T12:00Z (audit: datasets done, benchmarks in-progress for remote sensing)
...
| phase_retrieval | done | in-progress | GS alternating projection |
| fpm | done | in-progress | Fourier ptychographic microscopy |
| odt | done | in-progress | Optical diffraction tomography |
| ghost_imaging | done | in-progress | Computational ghost imaging |

## Priority 4 — Spectroscopy & Remote Sensing

| Modality | Dataset | Benchmark | Notes |
|----------|---------|-----------|-------|
| raman_imaging | done | in-progress | Raman spectroscopy |
| ftir_imaging | done | in-progress | FTIR imaging |
| sar | done | in-progress | Synthetic aperture radar |
| lidar | done | in-progress | LiDAR point cloud |
| hyperspectral_remote | done | in-progress | Hyperspectral satellite |
| insar | done | in-progress | Interferometric SAR |

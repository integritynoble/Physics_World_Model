...
class TestCasePackStem:
    """CasePack acceptance tests for the stem modality."""
    ...
    def test_template_compiles(self):
        ...
        tpl_clean["metadata"]["modality"] = "stem"
        spec = OperatorGraphSpec.model_validate({"graph_id": "stem_graph_v2", **tpl_clean})

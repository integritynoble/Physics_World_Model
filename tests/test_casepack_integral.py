"""Tests for CasePack: Integral.

Template: integral_graph_v2
...
class TestCasePackIntegral:
    """CasePack acceptance tests for the integral modality."""

    def test_template_compiles(self):
        """integral_graph_v2 template compiles without error."""
        tpl = _load_template("integral_graph_v2")
        tpl_clean = dict(tpl)
        tpl_clean.pop("description", None)
        spec = OperatorGraphSpec.model_validate({"graph_id": "integral_graph_v2", **tpl_clean})

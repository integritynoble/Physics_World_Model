"""Tests for CasePack: MRS.

Template: mrs_graph_v2
...
class TestCasePackMrs:
    """CasePack acceptance tests for the mrs modality."""

    def test_template_compiles(self):
        """mrs_graph_v2 template compiles without error."""
        tpl = _load_template("mrs_graph_v2")
        tpl_clean = dict(tpl)
        tpl_clean.pop("description", None)
        spec = OperatorGraphSpec.model_validate({"graph_id": "mrs_graph_v2", **tpl_clean})

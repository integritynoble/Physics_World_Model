"""Tests for CasePack: Light Field.

Template: light_field_graph_v2
...
class TestCasePackLightField:
    """CasePack acceptance tests for the light_field modality."""

    def test_template_compiles(self):
        """light_field_graph_v2 template compiles without error."""
        tpl = _load_template("light_field_graph_v2")
        tpl_clean = dict(tpl)
        tpl_clean.pop("description", None)
        spec = OperatorGraphSpec.model_validate({"graph_id": "light_field_graph_v2", **tpl_clean})

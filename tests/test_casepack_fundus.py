"""Tests for CasePack: Fundus.

Template: fundus_graph_v2
...
class TestCasePackFundus:
    """CasePack acceptance tests for the fundus modality."""

    def test_template_compiles(self):
        """fundus_graph_v2 template compiles without error."""
        tpl = _load_template("fundus_graph_v2")
        tpl_clean = dict(tpl)
        tpl_clean.pop("description", None)
        spec = OperatorGraphSpec.model_validate({"graph_id": "fundus_graph_v2", **tpl_clean})

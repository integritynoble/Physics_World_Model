"""Tests for CasePack: Electron Tomography.
...
class TestCasePackElectronTomography:
    """CasePack acceptance tests for the electron_tomography modality."""
    ...
    def test_template_compiles(self):
        ...
        spec = OperatorGraphSpec.model_validate({"graph_id": "electron_tomography_graph_v2", **tpl_clean})

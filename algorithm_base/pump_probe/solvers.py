...
# Solver registry for pump_probe
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'pp_dl']
...
def run_pp_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """PumpProbe-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("pp_dl", y, operator, cfg)

...
# Solver registry for weather_radar
SOLVERS = {
    "traditional_cpu": {
        "name": "RDA [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'weather_dl']
...
def run_weather_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """NowcastNet [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("weather_dl", y, operator, cfg)

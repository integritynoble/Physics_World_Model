...
# Solver registry for event_camera
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'event_dl']
...
def run_event_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """E2VID+ [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("event_dl", y, operator, cfg)

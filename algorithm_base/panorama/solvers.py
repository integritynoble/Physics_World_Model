...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.panorama.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class PanoramaOperator:
    """Generic PSF-convolution operator for Panorama Multi-Focus Fusion."""
    ...
    def info(self):
        return {"modality": "panorama", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return PanoramaOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for panorama."""
    ...
    try:
        if spec["module"] == "algorithm_base.panorama.solvers":

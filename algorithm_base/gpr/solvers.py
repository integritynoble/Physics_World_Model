...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'gpr_dl']
...
def run_gpr_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """GPR-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("gpr_dl", y, operator, cfg)

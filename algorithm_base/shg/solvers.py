...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.shg.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class ShgOperator:
    """Generic PSF-convolution operator for Second Harmonic Generation (SHG) Microscopy."""
    ...
    def info(self):
        return {"modality": "shg", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return ShgOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    try:
        if spec["module"] == "algorithm_base.shg.solvers":

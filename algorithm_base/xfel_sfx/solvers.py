"""Solvers for XFEL Serial Femtosecond Crystallography (SFX) (xfel_sfx).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.xfel_sfx.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class XfelSfxOperator:
    """Generic PSF-convolution operator for XFEL Serial Femtosecond Crystallography (SFX)."""
    ...
    def info(self):
        return {"modality": "xfel_sfx", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return XfelSfxOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for xfel_sfx."""
    ...
    try:
        if spec["module"] == "algorithm_base.xfel_sfx.solvers":
...
def list_solvers():
    """List all available solvers for xfel_sfx."""

"""Solvers for Quantum Illumination (quantum_illumination).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.quantum_illumination.solvers",
        "function": "run_wiener",
        "gpu": False,
    ...
    "dl_reconnet": {
        ...
        "gpu": True,
        "reference": "DL for CS reconstruction, 2016",
    },
    "dl_unrolled": {
        "name": "Unrolled-Net",
        "module": "algorithm_base.quantum_illumination.solvers",
        ...
        "gpu": True,
        "reference": "Deep unrolling for CS, 2020",
    },
    "dl_transformer": {
        "name": "CS-Transformer",
        "module": "algorithm_base.quantum_illumination.solvers",
        ...
        "gpu": True,
        "reference": "Transformer for CS, 2023",
    },
    "dl_diffusion": {
        "name": "CS-Diffusion",
        "module": "algorithm_base.quantum_illumination.solvers",
        ...
        "gpu": True,
        "reference": "Diffusion for CS, 2025",
    },
}
...
class QuantumIlluminationOperator:
    """Generic PSF-convolution operator for Quantum Illumination."""
    ...
    def info(self):
        return {"modality": "quantum_illumination", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return QuantumIlluminationOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for quantum_illumination."""
    ...
    try:
        if spec["module"] == "algorithm_base.quantum_illumination.solvers":
...
def list_solvers():
    """List all available solvers for quantum_illumination."""

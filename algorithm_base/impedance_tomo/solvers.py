...
# Solver registry for impedance_tomo
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'eit_dl']
...
def run_eit_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """EIT-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("eit_dl", y, operator, cfg)

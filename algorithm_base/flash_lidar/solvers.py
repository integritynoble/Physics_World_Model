...
# Solver registry for flash_lidar
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'flash_dl']
...
def run_flash_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """FlashLiDAR-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("flash_dl", y, operator, cfg)

...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'cest_dl']
...
def run_cest_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """CEST-Net [proxy]. CPU only.
    """
    return run_solver("cest_dl", y, operator, cfg)

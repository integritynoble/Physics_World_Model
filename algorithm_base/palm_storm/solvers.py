...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.palm_storm.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class PalmStormOperator:
    """Generic PSF-convolution operator for PALM/STORM Single-Molecule Localization."""
    ...
    def info(self):
        return {"modality": "palm_storm", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return PalmStormOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for palm_storm."""
    ...
    try:
        if spec["module"] == "algorithm_base.palm_storm.solvers":

"""Solvers for Integral Photography (integral).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.integral.solvers",
        "function": "run_wiener",
        "gpu": False,
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    try:
        if spec["module"] == "algorithm_base.integral.solvers":
...
def list_solvers():
    """List all available solvers for integral."""

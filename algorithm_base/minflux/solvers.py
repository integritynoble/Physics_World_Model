...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'minflux_dl']
...
def run_minflux_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """MINFLUX-Net. GPU required.
    Reference: Gwosch, K.C. et al. (2020) MINFLUX nanoscopy 3D, Nature Methods 17:217
    """
    return run_solver("minflux_dl", y, operator, cfg)

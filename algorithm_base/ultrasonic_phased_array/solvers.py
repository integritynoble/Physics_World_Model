"""Solvers for Ultrasonic Phased Array (TFM/FMC) (ultrasonic_phased_array).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.ultrasonic_phased_array.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class UltrasonicPhasedArrayOperator:
    """Generic PSF-convolution operator for Ultrasonic Phased Array (TFM/FMC)."""
    ...
    def info(self):
        return {"modality": "ultrasonic_phased_array", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return UltrasonicPhasedArrayOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for ultrasonic_phased_array."""
    ...
    try:
        if spec["module"] == "algorithm_base.ultrasonic_phased_array.solvers":
...
def list_solvers():
    """List all available solvers for ultrasonic_phased_array."""

...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.widefield_lowdose.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class WidefieldLowdoseOperator:
    """Generic PSF-convolution operator for Low-Dose Widefield Microscopy."""
    ...
    def info(self):
        return {"modality": "widefield_lowdose", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return WidefieldLowdoseOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for widefield_lowdose."""
    ...
    try:
        if spec["module"] == "algorithm_base.widefield_lowdose.solvers":

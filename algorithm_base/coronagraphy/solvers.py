...
# Solver registry for coronagraphy
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'speckle_null_dl']
...
def run_speckle_null_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """DL-SpeckleNull [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("speckle_null_dl", y, operator, cfg)

"""Solvers for X-ray Crystallography (xray_crystallography).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.xray_crystallography.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class XrayCrystallographyOperator:
    """Generic PSF-convolution operator for X-ray Crystallography."""
    ...
    def info(self):
        return {"modality": "xray_crystallography", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return XrayCrystallographyOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for xray_crystallography."""
    ...
    try:
        if spec["module"] == "algorithm_base.xray_crystallography.solvers":
...
def list_solvers():
    """List all available solvers for xray_crystallography."""

"""Solvers for X-ray Radiography (xray_radiography).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.xray_radiography.solvers",
        "function": "run_wiener",
        "gpu": False,
    ...
    "dl_unet": {
        ...
        "gpu": True,
        "reference": "U-Net for X-ray, 2018",
    },
    "dl_swinir": {
        "name": "XR-SwinIR",
        "module": "algorithm_base.xray_radiography.solvers",
        ...
        "gpu": True,
        "reference": "SwinIR for X-ray, 2022",
    },
    "dl_diffusion": {
        "name": "XR-Diffusion",
        "module": "algorithm_base.xray_radiography.solvers",
        ...
        "gpu": True,
        "reference": "Diffusion for X-ray, 2024",
    },
    "dl_mamba": {
        "name": "XR-Mamba",
        "module": "algorithm_base.xray_radiography.solvers",
...
class XrayRadiographyOperator:
    """Generic PSF-convolution operator for X-ray Radiography."""
    ...
    def info(self):
        return {"modality": "xray_radiography", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return XrayRadiographyOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for xray_radiography."""
    ...
    try:
        if spec["module"] == "algorithm_base.xray_radiography.solvers":
...
def list_solvers():
    """List all available solvers for xray_radiography."""

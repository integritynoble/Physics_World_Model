...
# Solver registry for cathodoluminescence
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'cl_dl']
...
def run_cl_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """CL-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("cl_dl", y, operator, cfg)

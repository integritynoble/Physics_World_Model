"""Solvers for Confocal 3D Z-Stack (confocal_3d).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.confocal_3d.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class Confocal3DOperator:
    """Generic PSF-convolution operator for Confocal 3D Z-Stack."""
    ...
    def info(self):
        return {"modality": "confocal_3d", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return Confocal3DOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for confocal_3d."""
    ...
    try:
        if spec["module"] == "algorithm_base.confocal_3d.solvers":
...
def list_solvers():
    """List all available solvers for confocal_3d."""

...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.dark_field.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class DarkFieldOperator:
    """Generic PSF-convolution operator for Dark-Field Microscopy."""
    ...
    def info(self):
        return {"modality": "dark_field", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return DarkFieldOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for dark_field."""
    ...
    try:
        if spec["module"] == "algorithm_base.dark_field.solvers":

...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.fundus.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class FundusOperator:
    """Generic PSF-convolution operator for Fundus Camera."""
    ...
    def info(self):
        return {"modality": "fundus", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return FundusOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for fundus."""
    ...
    try:
        if spec["module"] == "algorithm_base.fundus.solvers":

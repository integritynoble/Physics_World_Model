...
# Solver registry for coded_exposure
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'coded_dl']
...
def run_coded_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """FlowNet-Coded [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("coded_dl", y, operator, cfg)

"""Solvers for Coded Exposure / Flutter Shutter (coded_exposure).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.coded_exposure.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class CodedExposureOperator:
    """Generic PSF-convolution operator for Coded Exposure / Flutter Shutter."""
    ...
    def info(self):
        return {"modality": "coded_exposure", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return CodedExposureOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for coded_exposure."""
    ...
    try:
        if spec["module"] == "algorithm_base.coded_exposure.solvers":
...
def list_solvers():
    """List all available solvers for coded_exposure."""

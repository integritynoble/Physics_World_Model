...
# Solver registry for shearography
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'shear_dl']
...
def run_shear_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """ShearNet [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("shear_dl", y, operator, cfg)

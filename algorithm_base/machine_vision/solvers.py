"""Solvers for Machine Vision / AOI (machine_vision).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.machine_vision.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class MachineVisionOperator:
    """Generic PSF-convolution operator for Machine Vision / AOI."""
    ...
    def info(self):
        return {"modality": "machine_vision", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return MachineVisionOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for machine_vision."""
    ...
    try:
        if spec["module"] == "algorithm_base.machine_vision.solvers":
...
def list_solvers():
    """List all available solvers for machine_vision."""

"""Solvers for Radio Aperture Synthesis (radio_astronomy).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.radio_astronomy.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class RadioAstronomyOperator:
    """Generic PSF-convolution operator for Radio Aperture Synthesis."""
    ...
    def info(self):
        return {"modality": "radio_astronomy", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return RadioAstronomyOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for radio_astronomy."""
    ...
    try:
        if spec["module"] == "algorithm_base.radio_astronomy.solvers":
...
def list_solvers():
    """List all available solvers for radio_astronomy."""

...
# Solver registry for adaptive_optics
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'deep_ao']
...
def run_deep_ao(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """Deep-AO [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("deep_ao", y, operator, cfg)

...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.brachytherapy_img.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class BrachytherapyImgOperator:
    """Generic PSF-convolution operator for Brachytherapy Imaging."""
    ...
    def info(self):
        return {"modality": "brachytherapy_img", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return BrachytherapyImgOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for brachytherapy_img."""
    ...
    try:
        if spec["module"] == "algorithm_base.brachytherapy_img.solvers":

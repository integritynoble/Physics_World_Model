...
class PetCtOperator:
    """Generic PSF-convolution operator for PET/CT Fusion."""
    ...
    def info(self):
        return {"modality": "pet_ct", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return PetCtOperator(y.shape[:2], sigma)

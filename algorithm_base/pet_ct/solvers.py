...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'petct_dl']
    ...
    # PET/CT benchmark y is a sinogram (n_angles, n_det). Apply FBP to reconstruct.
...
def run_petct_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:

...
# Solver registry for radio_interferometry
SOLVERS = {
    "traditional_cpu": {
        "name": "RDA [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'ri_dl']
...
def run_ri_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """R2D2 (interferometry) [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("ri_dl", y, operator, cfg)

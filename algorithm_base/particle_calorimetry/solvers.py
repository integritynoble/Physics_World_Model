...
# Solver registry for particle_calorimetry
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'cal_dl']
...
def run_cal_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """CaloDiffusion [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("cal_dl", y, operator, cfg)

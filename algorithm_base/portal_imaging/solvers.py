...
# Solver registry for portal_imaging
SOLVERS = {
    "traditional_cpu": {
        "name": "FBP [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'portal_dl']
...
def run_portal_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """PortalDL [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("portal_dl", y, operator, cfg)

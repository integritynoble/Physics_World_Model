...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.doppler_ultrasound.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class DopplerUltrasoundOperator:
    """Generic PSF-convolution operator for Doppler Ultrasound."""
    ...
    def info(self):
        return {"modality": "doppler_ultrasound", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return DopplerUltrasoundOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for doppler_ultrasound."""
    ...
    try:
        if spec["module"] == "algorithm_base.doppler_ultrasound.solvers":

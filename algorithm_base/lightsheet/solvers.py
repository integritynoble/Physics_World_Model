...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.lightsheet.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class LightsheetOperator:
    """Generic PSF-convolution operator for Light-Sheet Fluorescence Microscopy (LSFM)."""
    ...
    def info(self):
        return {"modality": "lightsheet", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return LightsheetOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for lightsheet."""
    ...
    try:
        if spec["module"] == "algorithm_base.lightsheet.solvers":

...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'relion_dl']
...
def run_relion_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """CryoDRGN [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("relion_dl", y, operator, cfg)

...
class SpectralCtOperator:
    """Generic PSF-convolution operator for Photon-Counting Spectral CT."""
    ...
    def info(self):
        return {"modality": "spectral_ct", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return SpectralCtOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for spectral_ct."""

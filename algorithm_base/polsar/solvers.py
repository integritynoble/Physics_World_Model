...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'polsar_dl']
...
def run_polsar_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """PolSAR-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("polsar_dl", y, operator, cfg)

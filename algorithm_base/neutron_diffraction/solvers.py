...
# Solver registry for neutron_diffraction
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'nd_dl']
...
def run_nd_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """NeutronDiff-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("nd_dl", y, operator, cfg)

"""Solvers for Multispectral Satellite Imaging (multispectral_sat).
...
SOLVERS = {
    ...
    # Original
    "ms_dl": {
        "name": "MS-Pansharpening-DL [proxy]",
        "module": "pwm_core.recon.richardson_lucy",
        "function": "run_richardson_lucy",
        "gpu": False,
        "reference": "Richardson 1972, JOSA",
    ...
    "wiener": {
        ...
        "module": "algorithm_base.multispectral_sat.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class MultispectralSatOperator:
    """Generic PSF-convolution operator for Multispectral Satellite Imaging."""
    ...
    def info(self):
        return {"modality": "multispectral_sat", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return MultispectralSatOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for multispectral_sat."""
    ...
    try:
        if spec["module"] == "algorithm_base.multispectral_sat.solvers":
...
def list_solvers():
    """List all available solvers for multispectral_sat."""

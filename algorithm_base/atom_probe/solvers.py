...
# Solver registry for atom_probe
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'apt_dl']
...
def run_apt_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """APT-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("apt_dl", y, operator, cfg)

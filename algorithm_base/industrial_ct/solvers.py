...
# Solver registry for industrial_ct
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'ict_dl']
...
def run_ict_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """IndustrialCT-Net [proxy]. CPU only.
    Reference: Shepp & Logan 1974
    """
    return run_solver("ict_dl", y, operator, cfg)

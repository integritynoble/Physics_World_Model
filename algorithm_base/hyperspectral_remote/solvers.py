"""Solvers for Hyperspectral Remote Sensing (hyperspectral_remote).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.hyperspectral_remote.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class HyperspectralRemoteOperator:
    """Generic PSF-convolution operator for Hyperspectral Remote Sensing."""
    ...
    def info(self):
        return {"modality": "hyperspectral_remote", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return HyperspectralRemoteOperator(y.shape[:2], sigma)
...
def list_solvers():
    """List all available solvers for hyperspectral_remote."""

...
class PetMrOperator:
    """Generic PSF-convolution operator for PET/MR Fusion."""
    ...
    def info(self):
        return {"modality": "pet_mr", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return PetMrOperator(y.shape[:2], sigma)

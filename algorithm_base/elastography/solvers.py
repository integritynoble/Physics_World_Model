"""Solvers for Shear-Wave Elastography (elastography).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.elastography.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class ElastographyOperator:
    """Generic PSF-convolution operator for Shear-Wave Elastography."""
    ...
    def info(self):
        return {"modality": "elastography", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return ElastographyOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for elastography."""
    ...
    try:
        if spec["module"] == "algorithm_base.elastography.solvers":
...
def list_solvers():
    """List all available solvers for elastography."""

"""Solvers for Gravitational Wave Detection (gravitational_wave).
...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.gravitational_wave.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class GravitationalWaveOperator:
    """Generic PSF-convolution operator for Gravitational Wave Detection."""
    ...
    def info(self):
        return {"modality": "gravitational_wave", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return GravitationalWaveOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for gravitational_wave."""
    ...
    try:
        if spec["module"] == "algorithm_base.gravitational_wave.solvers":
...
def list_solvers():
    """List all available solvers for gravitational_wave."""

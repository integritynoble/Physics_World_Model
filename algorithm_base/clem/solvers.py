...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'clem_dl']
...
def run_clem_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """CLEM-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("clem_dl", y, operator, cfg)

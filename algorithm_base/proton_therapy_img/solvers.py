...
# Solver registry for proton_therapy_img
SOLVERS = {
    "traditional_cpu": {
        "name": "FBP [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'proton_therapy_dl']
...
def run_proton_therapy_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """ProtonTherapy-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("proton_therapy_dl", y, operator, cfg)

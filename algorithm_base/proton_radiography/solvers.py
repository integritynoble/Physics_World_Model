...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.proton_radiography.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class ProtonRadiographyOperator:
    """Generic PSF-convolution operator for Proton Radiography."""
    ...
    def info(self):
        return {"modality": "proton_radiography", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return ProtonRadiographyOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for proton_radiography."""
    ...
    try:
        if spec["module"] == "algorithm_base.proton_radiography.solvers":

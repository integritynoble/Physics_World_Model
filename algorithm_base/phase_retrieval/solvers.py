...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.phase_retrieval.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class PhaseRetrievalOperator:
    """Generic PSF-convolution operator for Coherent Diffractive Imaging / Phase Retrieval."""
    ...
    def info(self):
        return {"modality": "phase_retrieval", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return PhaseRetrievalOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for phase_retrieval."""
    ...
    try:
        if spec["module"] == "algorithm_base.phase_retrieval.solvers":

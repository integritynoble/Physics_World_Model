...
SOLVERS = {
    ...
    "wiener": {
        ...
        "module": "algorithm_base.us_mri.solvers",
        "function": "run_wiener",
        "gpu": False,
...
class UsMriOperator:
    """Generic PSF-convolution operator for US/MRI Fusion."""
    ...
    def info(self):
        return {"modality": "us_mri", "x_shape": self.x_shape, "psf_sigma": self.psf_sigma}


def _make_operator(y, cfg):
    cfg = cfg or {}
    sigma = cfg.get("psf_sigma", 2.0)
    return UsMriOperator(y.shape[:2], sigma)
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    """Run a solver by key for us_mri."""
    ...
    try:
        if spec["module"] == "algorithm_base.us_mri.solvers":

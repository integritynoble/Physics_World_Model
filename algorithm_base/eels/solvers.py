"""Solvers for Electron Energy Loss Spectroscopy (EELS) (eels).
...
# Solver registry for eels
SOLVERS = {
    "traditional_cpu": {
        "name": "FISTA-L2 (Fourier ratio) [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'famous_dl', 'eels_dl']

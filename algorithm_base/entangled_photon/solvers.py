...
# Solver registry for entangled_photon
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'qgi_dl']
...
def run_qgi_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """QGI-DL [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("qgi_dl", y, operator, cfg)

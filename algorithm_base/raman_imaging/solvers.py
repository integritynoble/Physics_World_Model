...
# Solver registry for raman_imaging
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'raman_dl']
...
def run_raman_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """RamanNet [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("raman_dl", y, operator, cfg)

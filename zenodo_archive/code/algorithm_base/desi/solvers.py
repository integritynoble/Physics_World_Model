...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'desi_dl']
...
def run_desi_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """DESI-SegNet [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("desi_dl", y, operator, cfg)

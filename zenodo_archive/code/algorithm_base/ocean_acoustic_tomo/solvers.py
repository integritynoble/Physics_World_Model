...
# Solver registry for ocean_acoustic_tomo
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'oat_dl']
...
def run_oat_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """OAT-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("oat_dl", y, operator, cfg)

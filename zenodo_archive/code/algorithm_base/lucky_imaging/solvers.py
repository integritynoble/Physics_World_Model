...
# Solver registry for lucky_imaging
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'lucky_dl']
...
def run_lucky_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """Lucky-DL [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("lucky_dl", y, operator, cfg)

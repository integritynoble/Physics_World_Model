...
# Solver registry for acoustic_microscopy
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'saft_dl']
...
def run_saft_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """SAFT-DL [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("saft_dl", y, operator, cfg)

...
# Solver registry for bioluminescence_tomo
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'blt_dl']
...
def run_blt_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """BLT-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("blt_dl", y, operator, cfg)

...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'ndt_dl']
...
def run_ndt_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """NDT-DefectNet [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("ndt_dl", y, operator, cfg)

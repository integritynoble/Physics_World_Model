...
# Solver registry for ct_fluorescence
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'xfct_dl']
...
def run_xfct_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """XFCT-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("xfct_dl", y, operator, cfg)

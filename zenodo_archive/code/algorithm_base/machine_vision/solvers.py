...
# Solver registry for machine_vision
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'mv_dl']
...
def run_mv_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """PatchCore [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("mv_dl", y, operator, cfg)

...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'waxs_dl']
...
def run_waxs_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """WAXS-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """

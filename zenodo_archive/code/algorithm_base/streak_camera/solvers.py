...
# Solver registry for streak_camera
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'streak_dl']
...
def run_streak_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """StreakNet [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("streak_dl", y, operator, cfg)

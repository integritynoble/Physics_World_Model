...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'mra_dl']
...
def run_mra_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """MRA-VesselNet [proxy]. CPU only.
    """
    return run_solver("mra_dl", y, operator, cfg)

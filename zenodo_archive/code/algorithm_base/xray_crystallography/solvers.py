...
# Solver registry for xray_crystallography
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'xtal_dl']
...
def run_xtal_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """AlphaFold-SF [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("xtal_dl", y, operator, cfg)

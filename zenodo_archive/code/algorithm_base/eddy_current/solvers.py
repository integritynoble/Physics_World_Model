...
# Solver registry for eddy_current
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'ec_dl']
...
def run_ec_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """ECT-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("ec_dl", y, operator, cfg)

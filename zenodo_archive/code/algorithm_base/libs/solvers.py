...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'libs_dl']
...
def run_libs_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """LIBS-CNN [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("libs_dl", y, operator, cfg)

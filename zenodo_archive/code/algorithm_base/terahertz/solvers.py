...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'thz_dl']
...
def run_thz_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """THz-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("thz_dl", y, operator, cfg)

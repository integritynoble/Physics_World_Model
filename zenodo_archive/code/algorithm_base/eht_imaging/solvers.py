...
# Solver registry for eht_imaging
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'eht_dl']
...
def run_eht_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """EHT-PRIMO [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("eht_dl", y, operator, cfg)

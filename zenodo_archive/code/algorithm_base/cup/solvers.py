...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'e2e_cup']
...
def run_e2e_cup(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """E2E-CUP [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("e2e_cup", y, operator, cfg)

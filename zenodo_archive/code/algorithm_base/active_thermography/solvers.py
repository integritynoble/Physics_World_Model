...
# Solver registry for active_thermography
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'pulsed_phase_tv']
...
def run_pulsed_phase_tv(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """Pulsed-Phase TV [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("pulsed_phase_tv", y, operator, cfg)

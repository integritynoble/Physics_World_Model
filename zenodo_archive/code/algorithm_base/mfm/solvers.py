...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'mfm_dl']
...
def run_mfm_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """MFM-UNet. GPU required.
    Reference: Kim, M. et al. (2021) DL for magnetic force microscopy, npj Comput. Mater. 7:87
    """
    return run_solver("mfm_dl", y, operator, cfg)

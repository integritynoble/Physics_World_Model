...
# Solver registry for ocean_color
SOLVERS = {
    "traditional_cpu": {
        "name": "RDA [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'oc_dl']
...
def run_oc_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """OC-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("oc_dl", y, operator, cfg)

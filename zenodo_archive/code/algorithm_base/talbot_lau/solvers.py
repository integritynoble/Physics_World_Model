...
# Solver registry for talbot_lau
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'talbot_dl']
...
def run_talbot_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """Talbot-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("talbot_dl", y, operator, cfg)

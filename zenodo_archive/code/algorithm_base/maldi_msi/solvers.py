...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'msi_dl']
...
def run_msi_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """MSI-UNet [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("msi_dl", y, operator, cfg)

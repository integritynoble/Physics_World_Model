...
# Solver registry for nirs_brain
SOLVERS = {
    "traditional_cpu": {
        "name": "FBP [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'nirs_dl']
...
def run_nirs_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """fNIRS-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("nirs_dl", y, operator, cfg)

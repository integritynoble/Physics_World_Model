...
% ============================================================================
\begin{abstract}
Operator mismatch---the discrepancy between assumed and true forward measurement operators---degrades compressive imaging reconstruction by 10--21\,dB, yet no existing benchmark measures this effect.
...
We discover an inverse performance--robustness relationship: methods achieving the highest ideal PSNR suffer the largest mismatch degradation.
...
All reconstruction arrays, per-scene metrics, and analysis code are publicly released to enable reproducible operator-mismatch research.

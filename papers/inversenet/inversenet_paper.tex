...
The spatial-only mismatch produces negligible real-data degradation ($\leq$0.22\,dB), contrasting with 3--14\,dB in simulation.
This is expected: (1)~hardware masks already contain uncorrected registration errors; (2)~simulation mismatch includes dispersion perturbation (the dominant CASSI degradation source), absent here.

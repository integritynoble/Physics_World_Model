...
\textbf{PnP-DRUNet}~\cite{zhang2021drunet}: plug-and-play FISTA with DRUNet denoiser and sigma annealing (100 iterations, row-normalized operator);
...
PnP-DRUNet~\cite{zhang2021drunet}
 & 28.06{\scriptsize$\pm$5.26} / .880
 & 16.08{\scriptsize$\pm$0.89} / .402
 & 22.35{\scriptsize$\pm$2.67} / .645
 & 11.99 & 6.28 & 52.4\% \\
...
\paragraph{Key findings.}
Gain drift compresses all methods to 16.08--19.40\,dB under Scenario~II despite a ${\sim}$3\,dB ideal spread.
\textbf{HATNet} achieves the highest recovery ($\rho = 89.6\%$), followed by \textbf{FISTA-TV} ($\rho = 80.7\%$).
\textbf{PnP-DRUNet} ($\rho = 52.4\%$) shows that the DRUNet denoiser prior, while effective for ideal conditions (28.06\,dB), is more fragile under gain drift mismatch, as the denoiser amplifies gain-corrupted measurement artifacts.
...
\midrule
CASSI  & 5 & 3.38--12.78 & 0.00--6.50 & 56.8\% & .574$\to$.702 & PnP-HSICNN \\
CACTI  & 8 & 10.94--20.58 & 10.21--13.96 & 93.3\% & .305$\to$.794 & GAP-TV \\
SPC    & 2 & 9.55--12.83 & 6.28--10.38 & 89.6\% & .648$\to$.807 & HATNet \\
\bottomrule
\end{tabular}
\end{table}

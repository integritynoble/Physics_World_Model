...
\begin{enumerate}
    ...
    \item \textbf{Open dataset.} We publicly release all reconstruction arrays, per-scene metrics (PSNR, SSIM, SAM), and analysis code at \url{https://github.com/integritynoble/Physics_World_Model} to enable reproducible operator-mismatch research. All underlying test data come from existing public datasets.
\end{enumerate}
...
All InverseNet benchmark data---including 240+ reconstruction arrays (NPZ format), per-scene metrics (PSNR, SSIM, SAM), mismatch parameter configurations, and figure-generation scripts---are publicly available at \url{https://github.com/integritynoble/Physics_World_Model} under the \texttt{papers/inversenet/} directory.

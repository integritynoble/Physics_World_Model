...
GAP-TV shows a modest $1.8\times$ residual increase vs.\ PnP-HSICNN's $1.1\times$---the denoiser partially masks forward-model inconsistency.
...
For SPC, TV minimisation (\cref{eq:scenario_iv_tv}) with grid search over $\alpha \in [0, 0.005]$ estimates $\hat{\alpha} = 0.00125$ vs.\ true $0.0015$, recovering 86--92\% of the oracle bound (see supplementary for per-method results).

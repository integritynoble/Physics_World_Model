...
The PWM agent system comprises 7 specialist agents, 1 optional hybrid agent,
...
\varphi_d = -0.316^\circ)$.
Solvers evaluated include TwIST~\cite{bioucasdias2007twist}, GAP-TV~\cite{yuan2016gaptv}, DGSMP~\cite{huang2021dgsmp}, MST-L~\cite{cai2022mst}, and CST-L~\cite{cai2022cst}, all of which receive the same operator and differ only in their reconstruction algorithm. The supplementary per-scene analysis additionally includes DeSCI and HDNet~\cite{hu2022hdnet}.

...
variation ($\Delta g$, \%).  Nine ACR-aligned metrics are computed
automatically: CT number accuracy (5 materials), geometric accuracy
($\pm 2$\,mm tolerance), slice thickness ($\pm 1.5$\,mm), uniformity
($\leq 5$\,HU), noise standard deviation, spatial resolution
($\geq 5$\,lp/cm), low-contrast detectability ($\geq 4$ targets), and
artifact score.

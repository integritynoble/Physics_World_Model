...
The \texttt{graph\_templates.yaml} registry contains templates
organized across 26 registered modalities (7 with full end-to-end correction
validation, 1 with Scenario~I baseline, 18 with template-level validation),
grouped by physical carrier:
...
These mismatch parameter values were determined through systematic characterization of realistic CASSI assembly errors (Supplementary Note~9). The true mismatch parameters are
...
using the ACR CT accreditation phantom (Gammex 464)~\cite{chen2017redcnn}.

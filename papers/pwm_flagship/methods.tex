...
\end{equation}
which lies in $[0, 1]$ under standard convexity conditions (see Supplementary Note~S1 for formal analysis; values $\recoveryratio > 1$ are possible when the corrected operator provides beneficial regularization).
...
These mismatch parameter values were determined through systematic characterization of realistic CASSI assembly errors (Supplementary Note~S12). The true mismatch parameters are

...
For MRI, the paper validates on fastMRI data with coil sensitivity mismatch (5--15\% multiplicative deviation).  A 5\% coil sensitivity error produces $6.94$\,dB degradation; PWM correction recovers \textbf{$+48.25$\,dB}, the largest correction gain among all modalities.
...
\begin{itemize}
  ...
  \item MRI correction: $+48.25$\,dB (largest gain), CT correction: $+10.68$\,dB
\end{itemize}

...
\begin{itemize}
  \item \textbf{CASSI}: Estimated $(\hat{dx}, \hat{dy}) = (0.4, 0.2)$\,px (true: $0.5, 0.3$\,px), achieving \textbf{78\%} of oracle correction in 1,234\,s.
  \item \textbf{CACTI}: Estimated $(\hat{dx}, \hat{dy}) = (0.5, 0.25)$\,px, recovering \textbf{100\%} of oracle correction in 64\,s.
\end{itemize}
...
\begin{itemize}
  ...
  \item Correction gains: $+0.76$ to $+48.25$\,dB across modalities
\end{itemize}

...
IV  & Oracle Mask & $\mathbf{H}$ & $\mathbf{H}_{\mathrm{true}}$
    & Correction ceiling: true operator applied to mismatched data,
      providing the upper bound on what any correction can achieve. \\
\bottomrule
\end{tabular}
\end{table}
...
The true operator $\mathbf{H}_{\mathrm{true}}$ is used for
...
\emph{irreducible} loss due to mismatch-induced measurement
degradation.

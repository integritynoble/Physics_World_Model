...
--- from the heavily ill-posed computed tomography (CT,
25.46~dB) to phase retrieval, where the analytically invertible
forward model yields an identity reconstruction
(100.00~dB, a numerical ceiling rather than a measured value).  The average of ${\approx}\,38.2$~dB confirms that the
...
SPC\textsuperscript{$\dagger$} & gain\_bias   & 11.14 & 23.35 & $+$12.21 \\

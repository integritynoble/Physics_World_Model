...
operator).  Improvements range from $+0.54$ to $+48.25$\,dB.  Phase~2
...
CASSI (Alg~2, GAP-TV) & mask\_geo+dispersion  & 20.96 & 21.72 & $+$0.76  \\
...
\smallskip
{\footnotesize $\S$~Oracle Mask values represent reconstruction with the true operator applied to mismatched data (InverseNet Scenario~III / this work's Scenario~IV), providing an upper bound on what any correction algorithm can achieve.}

...
\cref{eq:recovery}; the range varies widely by modality (e.g., CASSI GAP-TV $\approx 0.22$ with Oracle Mask correction, reflecting the challenging nature of CASSI mismatch correction---notably below the 0.30 safety brake threshold, which applies to arena submissions rather than inherent modality limitations; CACTI $> 1.0$).  \textbf{Oracle gap} is the PSNR difference between Scenario~I

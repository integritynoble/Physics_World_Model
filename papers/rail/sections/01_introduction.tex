...
represents the culmination of more than a decade of algorithmic progress in
hyperspectral image reconstruction.
Yet when the coded aperture mask is shifted by half a pixel with
0.1\textdegree{} rotation and 1\% dispersion drift---a perturbation well
...
A sub-pixel operator mismatch erases more than a decade of
algorithmic improvement.

This is not an isolated failure.
Across modalities---coded aperture snapshot spectral imaging (CASSI),
coded aperture compressive temporal imaging (CACTI)~\cite{llull2013cacti}, single-pixel

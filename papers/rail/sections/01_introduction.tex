...
of \textbf{16.72\,dB}.
Under a 1-pixel-shift-plus-rotation model, deep-learning solvers (HDNet, MST-S, MST-L) lose
10--17\,dB (\cref{tab:sensitivity}).
To put this in perspective, the entire history of
CASSI reconstruction---from GAP-TV~\cite{yuan2016gaptv} at 24.22\,dB to MST-L~\cite{cai2022mst} at 34.81\,dB---spans only 10.59\,dB.

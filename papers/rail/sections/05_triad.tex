...
real-world systems}.  Consider CASSI spectral imaging: a single-pixel
mask shift degrades MST-L from 34.81~dB (Scenario~I, ideal operator) to
18.09~dB (Scenario~II, mismatched operator) --- a loss of
\textbf{16.72~dB}.  By contrast, upgrading from the classical solver
GAP-TV (24.22~dB) to the state-of-the-art MST-L (34.81~dB) under ideal

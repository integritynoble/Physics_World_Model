...
\smallskip
{\footnotesize Scenario~IV (Oracle) reproduces Scenario~I by design and is omitted for brevity.  Calibration gain for InverseNet-validated methods uses Scenario~III (Oracle Mask) PSNR.}
\end{table}

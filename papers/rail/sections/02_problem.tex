...
\smallskip
{\footnotesize Scenario~IV (Oracle) reproduces Scenario~I by design and is omitted for brevity.  Calibration gain for InverseNet-validated methods uses Oracle Mask PSNR (true operator applied to mismatched data), representing the upper bound on correction performance.}
\end{table}

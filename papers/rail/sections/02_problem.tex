...
PnP-HSICNN$^\dagger$~\cite{wang2017adaptive}
...
HDNet~\cite{hu2022hdnet}
  & 34.66  & \best{24.18}  & \worst{$-10.48$}  & $+0.05$ \\
\bottomrule
\end{tabular}

\smallskip
{\footnotesize $\dagger$~We use the adaptive nonlocal sparse representation method of Wang et al.\ as a plug-and-play baseline, referred to as PnP-HSICNN following common usage in the CASSI literature.}

\smallskip
{\footnotesize Scenario~IV (Oracle) reproduces Scenario~I by construction and is omitted for brevity.}
\end{table}
...
(34.66\,dB) with smaller degradation ($-10.48$\,dB), retaining

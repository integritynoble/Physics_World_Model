...
\smallskip
{\footnotesize Oracle Gain for InverseNet-validated methods uses Scenario~IV (Oracle Mask) PSNR---the true operator applied to mismatched data---representing the upper bound on correction performance.}
\end{table}
...
However, its Oracle Gain is zero ($+0.00$\,dB), indicating

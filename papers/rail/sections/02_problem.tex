...
\smallskip
{\footnotesize Scenario~IV (Oracle) reproduces Scenario~I by construction and is omitted for brevity.  Calibration gain for InverseNet-validated methods uses Scenario~III (Oracle Mask) PSNR.}
\end{table}

...
protocol. InverseNet's Ideal, Mismatch, and Oracle scenarios correspond to this work's Scenarios~I, II, and IV respectively; Scenario~III (Corrected) is a new contribution of the present work. The protocol was validated across three modalities (CASSI, CACTI, SPC).

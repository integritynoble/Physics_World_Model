...
The SolveEverything.org framework~\cite{wissner2024solveeverything} identifies a
...
\hfill---SolveEverything.org~\cite{wissner2024solveeverything}
\end{quote}
...
\Cref{fig:stack} visualizes the stack, and \cref{tab:stack_mapping}
provides the detailed mapping to PWM.
...
The InverseNet benchmark~\cite{yang2024inversenet} established L1 by
demonstrating that mismatch is measurable and defining a 3-scenario
protocol across three modalities (CASSI, CACTI, SPC).
PWM extends this to a 4-scenario protocol across 64 modalities and

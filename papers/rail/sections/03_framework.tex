...
The SolveEverything.org framework~\cite{solveeverything} identifies a
...
\hfill---SolveEverything.org~\cite{solveeverything}
\end{quote}
...
The InverseNet benchmark~\cite{inversenet} established L1 by

...
\quad 3D Lensless & $C \to \Sigma \to D$ & Photon & $9.8 \pm 1.0$ & 280 & 0.85 & \textbf{Synth.}$^*$ \\
...
\quad 4D Spectral-Depth & $W_\lambda \to C \to \Sigma \to D$ & Photon & $11.6 \pm 2.8$ & 220 & 0.78 & \textbf{Synth.}$^*$ \\
\quad 4D Temporal DMD & $M \to C \to \Sigma \to D$ & Photon & $15.6 \pm 0.4$ & 200 & 0.76 & \textbf{Synth.}$^*$ \\
\quad 4D Temporal Streak & $W_t \to C \to \Sigma \to D$ & Photon & $9.3 \pm 1.0$ & 210 & 0.75 & \textbf{Synth.}$^*$ \\
\quad 5D Full DMD & $M \to W_\lambda \to C \to \Sigma \to D$ & Photon & $15.4 \pm 4.0$ & 180 & 0.74 & \textbf{Synth.}$^*$ \\
\quad 5D Full Streak & $W_\lambda \to W_t \to C \to \Sigma \to D$ & Photon & $14.5 \pm 4.4$ & 170 & 0.72 & \textbf{Synth.}$^*$ \\
...
\textbf{4D Spectral-Depth}$^*$ & 11.6 & 10.5 & 20\,min & 5\,d & 110.5\% & 15 vs 400 \\
\textbf{4D Temporal DMD}$^*$ & 15.6 & 10.1 & 22\,min & 6\,d & 154.5\% & 15 vs 420 \\
\textbf{4D Temporal Streak}$^*$ & 9.3 & 9.0 & 20\,min & 5\,d & 103.3\% & 14 vs 380 \\
\textbf{5D Full DMD}$^*$ & 15.4 & 14.0 & 25\,min & 8\,d & 110.0\% & 16 vs 500 \\
\textbf{5D Full Streak}$^*$ & 14.5 & 14.1 & 24\,min & 7\,d & 102.8\% & 15 vs 480 \\
...
Mean quality ratio: $111.0 \pm 14.5$\%.  Agent specifications: 10--16 lines; expert code: 180--680 lines.  The ten novel system designs spanning 2D to 5D demonstrate that the framework's compositional approach extends naturally to higher-dimensional primitive compositions.  Active modulation (DMD) consistently outperforms passive dispersion (streak) at the same compression ratio (e.g., 4D DMD 15.6\,dB vs 4D streak 9.3\,dB at 16:1).
...
3D Lensless & Imaging & Photon & 1--2 & $C \to \Sigma \to D$ & FV & No & $\eps_{\text{param}}$ \\
...
\begin{tabular}{@{}llccccc@{}}
\toprule
& & \multicolumn{2}{c}{\textbf{SIM ($M{\to}C{\to}D$)}} & \multicolumn{2}{c}{\textbf{3D Lensless ($C{\to}\Sigma{\to}D$)}} \\
\cmidrule(lr){3-4}\cmidrule(lr){5-6}
\textbf{Method} & \textbf{Algorithm} & \textbf{PSNR} & \textbf{Time} & \textbf{PSNR} & \textbf{Time} \\
\midrule

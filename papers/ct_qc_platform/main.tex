...
with a minimum denominator of 10 to avoid inflated percentages
for near-zero metrics.
...
\addplot[mark=*, mark size=1.5pt, pwmBlue!80!black]
  coordinates {
    ...
    (11,4.65) (12,4.70) (13,4.75) (14,4.80) (15,4.85)
    (16,4.92) (17,4.98) (18,5.04) (19,5.10) (20,5.18)
  };
...
deviations reflect systematic measurement differences rather than
statistical noise.
...
(3)~The platform is for research/internal QA use; deployment as
a Software as a Medical Device would require FDA 510(k) and
IEC~62304 compliance~\cite{iec62304,samd_fda}.
(4)~Low-contrast detectability uses a simplified CNR criterion;
model-observer approaches~\cite{solomon2014lcd} could improve
correlation with human observer performance.

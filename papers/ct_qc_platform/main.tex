...
\caption{%
  ...
  Unif $\pm 5$~HU, Noise $\pm 1.0$~HU.
  All continuous metrics fall within $\pm 10\%$ of their tolerances.
...
CT number of water deviated by 0.3~HU ($\pm 5$~HU criterion),
geometric accuracy by 0.15~mm ($\pm 2$~mm), slice thickness by
0.08~mm ($\pm 1.5$~mm), and uniformity measured 1.2~HU ($\leq 5$~HU).

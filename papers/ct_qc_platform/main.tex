...
% Deviations as percentage of ACR tolerance
% Water: 0.3/5=6%, Bone: 1.2/~20=6%, Air: 0.8/~20=4%,
% Acrylic: 0.5/~10=5%, Poly: 0.4/~10=4%,
% Geom: 0.15/2=7.5%, Slice: 0.08/1.5=5.3%, Unif: 0.2/5=4%,
% Noise: 0.1/baseline~10%, SpatRes: 0.2/5=4%
...
% ACR tolerance at 100%
\draw[pwmRed, dashed, line width=0.6pt]
  (axis cs:Water,100) -- (axis cs:SpatRes,100);
\draw[pwmRed, dashed, line width=0.6pt]
  (axis cs:Water,-100) -- (axis cs:SpatRes,-100);
...
\end{tikzpicture}
\caption{%
  Metric deviations from reference values on an ACR CT~464 phantom
  scan (GE Revolution Apex, 120~kVp, 5~mm axial), expressed as
  percentage of the respective ACR tolerance for each metric.
  All continuous metrics fall within $\pm 8\%$ of their tolerances.
...
correlation with human observer performance~\cite{solomon2014lcd}.

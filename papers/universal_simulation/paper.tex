...
% --- Gate annotations (placed to the SIDE of nodes, not below, to avoid overlap) ---
\node[annot, above=0.15cm of judgepre] {\itshape Pre-gates: well-posedness,\\stability, Lipschitz, cost};
\node[annot, left=0.3cm of judgepost] {\itshape Post-audit: conservation,\\monotonicity, symmetry, bounds};
\end{tikzpicture}%
}% end resizebox

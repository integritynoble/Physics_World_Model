...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'fibsem_dl']
...
def run_fibsem_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """FIB-SEM-Net. GPU required.
    Reference: Heinrich, L. et al. (2021) Whole-cell organelle segmentation in volume EM, Nature 599:141
    """
    return run_solver("fibsem_dl", y, operator, cfg)

...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'srs_dl']
...
def run_srs_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """SRS-DeepSpec [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("srs_dl", y, operator, cfg)

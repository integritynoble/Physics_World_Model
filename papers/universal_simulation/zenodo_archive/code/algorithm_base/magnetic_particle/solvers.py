...
# Solver registry for magnetic_particle
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'mpi_dl']
...
def run_mpi_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """MPI-Net [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("mpi_dl", y, operator, cfg)

...
# Solver registry for gravitational_wave
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'matched_filter_dl']
...
def run_matched_filter_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """GW-DL (PyCBC-ML) [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("matched_filter_dl", y, operator, cfg)

...
# Solver registry for radio_astronomy
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'clean_dl']
...
def run_clean_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """RadioAST-DL [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("clean_dl", y, operator, cfg)

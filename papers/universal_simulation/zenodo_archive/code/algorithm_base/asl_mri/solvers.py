...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'asl_dl']
...
def run_asl_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """ASL-Net [proxy]. CPU only.
    """
    return run_solver("asl_dl", y, operator, cfg)

...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'dna_paint_dl']
...
def run_dna_paint_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """DECODE-PAINT. GPU required.
    Reference: Speiser, A. et al. (2021) DL for dense SMLM, Nature Methods 18:1090
    """
    return run_solver("dna_paint_dl", y, operator, cfg)

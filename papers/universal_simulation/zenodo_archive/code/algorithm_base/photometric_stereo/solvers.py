...
# Solver registry for photometric_stereo
SOLVERS = {
    "traditional_cpu": {
        "name": "Adjoint [proxy]",
...
def run_solver(solver_key: str, y: np.ndarray, operator: Any = None,
    ...
    Args:
        solver_key: One of ['traditional_cpu', 'best_quality', 'ps_dl']
...
def run_ps_dl(y: np.ndarray, operator: Any = None, cfg: Optional[Dict] = None) -> np.ndarray:
    """PS-FCN [proxy]. CPU only.
    Reference: Richardson 1972, JOSA
    """
    return run_solver("ps_dl", y, operator, cfg)

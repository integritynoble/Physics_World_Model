...
\node[annot, below=0.3cm of judgepost] {\itshape Post-audit: conservation,\\monotonicity, symmetry,\\bounds, residuals, archetype};
\end{tikzpicture}%
}% end resizebox
...
\toprule
& \multicolumn{2}{c|}{\textbf{Full pipeline}} & \multicolumn{2}{c|}{\textbf{No $\Agent_J$}} & \multicolumn{2}{c|}{\textbf{Claude Opus 4.6+spec}} & \multicolumn{2}{c|}{\textbf{Claude Opus 4.6 raw}} & \textbf{PINN} \\

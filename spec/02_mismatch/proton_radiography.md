# Proton Radiography — Mismatch Correction + Reconstruct
...
from algorithm_base.proton_radiography.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('proton_radiography_corrected.png'); plt.show()
```

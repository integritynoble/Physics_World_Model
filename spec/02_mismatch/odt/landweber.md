# Optical Diffraction Tomography (ODT) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_landweber_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

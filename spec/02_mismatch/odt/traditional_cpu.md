# Optical Diffraction Tomography (ODT) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

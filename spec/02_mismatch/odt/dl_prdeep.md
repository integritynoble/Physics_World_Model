# Optical Diffraction Tomography (ODT) — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — prDeep + gradient` corresponds to the leaderboard entry at

# Optical Diffraction Tomography (ODT) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Optical Diffraction Tomography (ODT) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

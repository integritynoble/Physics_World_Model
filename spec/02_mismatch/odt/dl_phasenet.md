# Optical Diffraction Tomography (ODT) — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — PhaseNet + gradient` corresponds to the leaderboard entry at

# Optical Diffraction Tomography (ODT) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Optical Diffraction Tomography (ODT) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Optical Diffraction Tomography (ODT) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Optical Diffraction Tomography (ODT) — Phase-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: holograms (angles × H × W, complex64)
...
plt.tight_layout(); plt.savefig('odt_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — Phase-Transformer + gradient` corresponds to the leaderboard entry at

# Optical Diffraction Tomography (ODT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

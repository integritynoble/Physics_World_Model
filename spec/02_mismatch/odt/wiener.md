# Optical Diffraction Tomography (ODT) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_wiener_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

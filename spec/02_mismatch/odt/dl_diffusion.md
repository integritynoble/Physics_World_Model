# Optical Diffraction Tomography (ODT) — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('odt_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Optical Diffraction Tomography (ODT) — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

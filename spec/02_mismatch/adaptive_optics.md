# Adaptive Optics (AO) Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.adaptive_optics.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('adaptive_optics_corrected.png'); plt.show()
```

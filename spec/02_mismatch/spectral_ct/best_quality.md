# Photon-Counting Spectral CT — DL-Recon [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spectral_ct_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Photon-Counting Spectral CT — DL-Recon [proxy] + gradient` corresponds to the leaderboard entry at

# Photon-Counting Spectral CT — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spectral_ct_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Photon-Counting Spectral CT — FBP [proxy] + gradient` corresponds to the leaderboard entry at

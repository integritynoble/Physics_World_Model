# Photon-Counting Spectral CT — SpectralCT-Net [proxy] + Gradient
...
x_wrong = run_solver('spectral_ct_dl', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('spectral_ct_dl', y, cfg=calib_cfg)        # corrected

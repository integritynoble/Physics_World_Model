# Three-Photon Microscopy — Mismatch Correction + Reconstruct
...
from algorithm_base.three_photon.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('three_photon_corrected.png'); plt.show()
```

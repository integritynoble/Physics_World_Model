# Small-Angle X-ray Scattering (SAXS) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_landweber_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Small-Angle X-ray Scattering (SAXS) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Small-Angle X-ray Scattering (SAXS) — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — PhaseNet + gradient` corresponds to the leaderboard entry at

# Small-Angle X-ray Scattering (SAXS) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_wiener_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

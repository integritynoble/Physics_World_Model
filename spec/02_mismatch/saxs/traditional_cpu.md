# Small-Angle X-ray Scattering (SAXS) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

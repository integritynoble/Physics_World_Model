# Small-Angle X-ray Scattering (SAXS) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Small-Angle X-ray Scattering (SAXS) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

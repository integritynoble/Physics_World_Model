# Small-Angle X-ray Scattering (SAXS) — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

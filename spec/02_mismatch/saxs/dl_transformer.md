# Small-Angle X-ray Scattering (SAXS) — Phase-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: scattering pattern (H × W, float32)
...
plt.tight_layout(); plt.savefig('saxs_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — Phase-Transformer + gradient` corresponds to the leaderboard entry at

# Small-Angle X-ray Scattering (SAXS) — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — prDeep + gradient` corresponds to the leaderboard entry at

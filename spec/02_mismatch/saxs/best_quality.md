# Small-Angle X-ray Scattering (SAXS) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

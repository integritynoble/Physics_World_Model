# Small-Angle X-ray Scattering (SAXS) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

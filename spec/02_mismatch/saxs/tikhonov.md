# Small-Angle X-ray Scattering (SAXS) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('saxs_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Small-Angle X-ray Scattering (SAXS) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

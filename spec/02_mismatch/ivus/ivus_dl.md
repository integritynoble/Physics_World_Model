# Intravascular Ultrasound (IVUS) — IVUS-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('ivus_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ivus_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ivus_ivus_dl_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — IVUS-Net [proxy] + gradient` corresponds to the leaderboard entry at

# Intravascular Ultrasound (IVUS) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — Med-UNet + gradient` corresponds to the leaderboard entry at

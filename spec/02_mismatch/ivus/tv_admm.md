# Intravascular Ultrasound (IVUS) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — TV-ADMM + gradient` corresponds to the leaderboard entry at

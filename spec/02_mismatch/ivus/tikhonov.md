# Intravascular Ultrasound (IVUS) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

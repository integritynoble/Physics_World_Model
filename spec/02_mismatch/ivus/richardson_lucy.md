# Intravascular Ultrasound (IVUS) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Intravascular Ultrasound (IVUS) — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — FBP [proxy] + gradient` corresponds to the leaderboard entry at

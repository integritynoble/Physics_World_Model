# Intravascular Ultrasound (IVUS) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_landweber_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Intravascular Ultrasound (IVUS) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

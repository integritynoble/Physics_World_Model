# Intravascular Ultrasound (IVUS) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — MedMamba + gradient` corresponds to the leaderboard entry at

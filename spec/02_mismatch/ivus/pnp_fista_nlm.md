# Intravascular Ultrasound (IVUS) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Intravascular Ultrasound (IVUS) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_wiener_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

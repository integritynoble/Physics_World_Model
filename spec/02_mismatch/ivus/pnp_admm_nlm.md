# Intravascular Ultrasound (IVUS) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

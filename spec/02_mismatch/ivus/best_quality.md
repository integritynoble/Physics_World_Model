# Intravascular Ultrasound (IVUS) — DL-Recon [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ivus_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Intravascular Ultrasound (IVUS) — DL-Recon [proxy] + gradient` corresponds to the leaderboard entry at

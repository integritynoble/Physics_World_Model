# Quantum Illumination — Mismatch Correction + Reconstruct
...
from algorithm_base.quantum_illumination.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('quantum_illumination_corrected.png'); plt.show()
```

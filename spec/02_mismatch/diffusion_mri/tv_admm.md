# Diffusion MRI (DTI) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — TV-ADMM + gradient` corresponds to the leaderboard entry at

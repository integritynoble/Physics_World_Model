# Diffusion MRI (DTI) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — MedMamba + gradient` corresponds to the leaderboard entry at

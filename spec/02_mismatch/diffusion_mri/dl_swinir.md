# Diffusion MRI (DTI) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

# Diffusion MRI (DTI) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

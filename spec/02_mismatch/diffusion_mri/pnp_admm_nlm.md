# Diffusion MRI (DTI) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

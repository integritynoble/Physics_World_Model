# Diffusion MRI (DTI) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

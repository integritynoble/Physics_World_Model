# Diffusion MRI (DTI) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — Med-UNet + gradient` corresponds to the leaderboard entry at

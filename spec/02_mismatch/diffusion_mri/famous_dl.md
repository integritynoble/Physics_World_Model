# Diffusion MRI (DTI) — SHORE-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — SHORE-Net [proxy] + gradient` corresponds to the leaderboard entry at

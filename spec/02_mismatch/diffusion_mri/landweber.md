# Diffusion MRI (DTI) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_landweber_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Diffusion MRI (DTI) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_wiener_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Diffusion MRI (DTI) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('diffusion_mri_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Diffusion MRI (DTI) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

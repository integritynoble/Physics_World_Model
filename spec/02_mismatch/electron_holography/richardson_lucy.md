# Electron Holography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

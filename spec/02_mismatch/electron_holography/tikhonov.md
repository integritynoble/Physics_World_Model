# Electron Holography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Electron Holography — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — PhaseNet + gradient` corresponds to the leaderboard entry at

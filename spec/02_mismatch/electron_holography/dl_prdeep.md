# Electron Holography — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — prDeep + gradient` corresponds to the leaderboard entry at

# Electron Holography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Electron Holography — Phase-Sideband [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — Phase-Sideband [proxy] + gradient` corresponds to the leaderboard entry at

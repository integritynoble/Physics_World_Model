# Electron Holography — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

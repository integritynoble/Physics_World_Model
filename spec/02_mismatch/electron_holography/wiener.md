# Electron Holography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_wiener_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

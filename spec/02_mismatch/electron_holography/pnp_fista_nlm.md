# Electron Holography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Electron Holography — Phase Retrieval (HIO) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — Phase Retrieval (HIO) + gradient` corresponds to the leaderboard entry at

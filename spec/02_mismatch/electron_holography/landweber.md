# Electron Holography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_landweber_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

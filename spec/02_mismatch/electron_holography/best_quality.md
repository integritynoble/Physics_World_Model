# Electron Holography — EH-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — EH-Net [proxy] + gradient` corresponds to the leaderboard entry at

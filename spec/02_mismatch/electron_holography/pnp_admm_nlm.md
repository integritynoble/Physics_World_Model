# Electron Holography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_holography_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

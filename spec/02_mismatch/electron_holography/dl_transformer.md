# Electron Holography — Phase-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: hologram (H × W, float32)
...
plt.tight_layout(); plt.savefig('electron_holography_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Electron Holography — Phase-Transformer + gradient` corresponds to the leaderboard entry at

# Adaptive Optics (AO) Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_wiener_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

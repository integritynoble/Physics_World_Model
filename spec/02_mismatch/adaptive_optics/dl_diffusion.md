# Adaptive Optics (AO) Imaging — DL-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — DL-Diffusion + gradient` corresponds to the leaderboard entry at

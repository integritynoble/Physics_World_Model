# Adaptive Optics (AO) Imaging — DL-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: wavefront sensor (H × W, float32)
...
plt.tight_layout(); plt.savefig('adaptive_optics_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — DL-Transformer + gradient` corresponds to the leaderboard entry at

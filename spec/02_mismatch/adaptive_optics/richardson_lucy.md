# Adaptive Optics (AO) Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

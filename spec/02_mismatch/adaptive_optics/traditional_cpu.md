# Adaptive Optics (AO) Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Adaptive Optics (AO) Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_landweber_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

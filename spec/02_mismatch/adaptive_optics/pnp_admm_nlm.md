# Adaptive Optics (AO) Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Adaptive Optics (AO) Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

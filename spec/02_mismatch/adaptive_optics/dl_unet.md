# Adaptive Optics (AO) Imaging — DL-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — DL-UNet + gradient` corresponds to the leaderboard entry at

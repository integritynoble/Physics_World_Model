# Adaptive Optics (AO) Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Adaptive Optics (AO) Imaging — DL-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — DL-Mamba + gradient` corresponds to the leaderboard entry at

# Adaptive Optics (AO) Imaging — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

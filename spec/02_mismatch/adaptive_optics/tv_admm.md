# Adaptive Optics (AO) Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('adaptive_optics_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Adaptive Optics (AO) Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

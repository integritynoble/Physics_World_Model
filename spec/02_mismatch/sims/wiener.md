# Secondary Ion Mass Spectrometry (SIMS) Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_wiener_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

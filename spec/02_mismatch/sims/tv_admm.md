# Secondary Ion Mass Spectrometry (SIMS) Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

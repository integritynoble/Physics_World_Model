# Secondary Ion Mass Spectrometry (SIMS) Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

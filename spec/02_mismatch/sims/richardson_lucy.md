# Secondary Ion Mass Spectrometry (SIMS) Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Secondary Ion Mass Spectrometry (SIMS) Imaging — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

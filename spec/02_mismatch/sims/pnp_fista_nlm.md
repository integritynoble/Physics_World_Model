# Secondary Ion Mass Spectrometry (SIMS) Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

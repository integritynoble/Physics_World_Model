# Secondary Ion Mass Spectrometry (SIMS) Imaging — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — Spec-CNN + gradient` corresponds to the leaderboard entry at

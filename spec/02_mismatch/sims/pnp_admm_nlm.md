# Secondary Ion Mass Spectrometry (SIMS) Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Secondary Ion Mass Spectrometry (SIMS) Imaging — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

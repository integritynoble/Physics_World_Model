# Secondary Ion Mass Spectrometry (SIMS) Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_landweber_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

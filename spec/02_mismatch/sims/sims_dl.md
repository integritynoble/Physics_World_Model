# Secondary Ion Mass Spectrometry (SIMS) Imaging — SIMS-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('sims_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('sims_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('sims_sims_dl_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — SIMS-Net [proxy] + gradient` corresponds to the leaderboard entry at

# Secondary Ion Mass Spectrometry (SIMS) Imaging — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: ion images (H × W × m/z, float32)
...
plt.tight_layout(); plt.savefig('sims_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — Spec-Transformer + gradient` corresponds to the leaderboard entry at

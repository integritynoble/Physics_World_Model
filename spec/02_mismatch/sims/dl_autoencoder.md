# Secondary Ion Mass Spectrometry (SIMS) Imaging — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — Spec-AE + gradient` corresponds to the leaderboard entry at

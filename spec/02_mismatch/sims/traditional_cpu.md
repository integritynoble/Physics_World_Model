# Secondary Ion Mass Spectrometry (SIMS) Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sims_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Secondary Ion Mass Spectrometry (SIMS) Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

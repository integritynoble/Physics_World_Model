# Passive Microwave Radiometry — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

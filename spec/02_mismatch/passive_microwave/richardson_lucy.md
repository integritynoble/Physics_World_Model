# Passive Microwave Radiometry — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Passive Microwave Radiometry — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

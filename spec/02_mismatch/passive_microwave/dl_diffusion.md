# Passive Microwave Radiometry — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — RS-Diffusion + gradient` corresponds to the leaderboard entry at

# Passive Microwave Radiometry — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — RS-CNN + gradient` corresponds to the leaderboard entry at

# Passive Microwave Radiometry — PM-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('pm_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('pm_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('passive_microwave_pm_dl_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — PM-Net [proxy] + gradient` corresponds to the leaderboard entry at

# Passive Microwave Radiometry — SAR-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — SAR-DL [proxy] + gradient` corresponds to the leaderboard entry at

# Passive Microwave Radiometry — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: brightness T (H × W × ch, float32)
...
plt.tight_layout(); plt.savefig('passive_microwave_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — RS-Transformer + gradient` corresponds to the leaderboard entry at

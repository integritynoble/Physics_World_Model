# Passive Microwave Radiometry — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_landweber_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Passive Microwave Radiometry — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_wiener_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

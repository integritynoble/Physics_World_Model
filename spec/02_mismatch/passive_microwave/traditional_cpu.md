# Passive Microwave Radiometry — RDA [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — RDA [proxy] + gradient` corresponds to the leaderboard entry at

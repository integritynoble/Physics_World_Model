# Passive Microwave Radiometry — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — RS-Mamba + gradient` corresponds to the leaderboard entry at

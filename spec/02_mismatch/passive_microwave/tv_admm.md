# Passive Microwave Radiometry — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('passive_microwave_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Passive Microwave Radiometry — TV-ADMM + gradient` corresponds to the leaderboard entry at

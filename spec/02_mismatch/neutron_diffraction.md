# Neutron Diffraction — Mismatch Correction + Reconstruct
...
from algorithm_base.neutron_diffraction.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('neutron_diffraction_corrected.png'); plt.show()
```

# TIRF Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_landweber_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# TIRF Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_wiener_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

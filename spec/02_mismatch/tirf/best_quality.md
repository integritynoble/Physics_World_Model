# TIRF Microscopy — TIRF-Net (CARE) [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_best_quality_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — TIRF-Net (CARE) [proxy] + gradient` corresponds to the leaderboard entry at

# TIRF Microscopy — TIRF-SRRF [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — TIRF-SRRF [proxy] + gradient` corresponds to the leaderboard entry at

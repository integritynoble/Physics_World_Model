# TIRF Microscopy — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — Noise2Void + gradient` corresponds to the leaderboard entry at

# TIRF Microscopy — DiffusionMicro + Gradient Mismatch Correction

**Device**: GPU  **Input**: TIRF frames (T × H × W, float32)
...
plt.tight_layout(); plt.savefig('tirf_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — DiffusionMicro + gradient` corresponds to the leaderboard entry at

# TIRF Microscopy — Richardson-Lucy (TIRF) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — Richardson-Lucy (TIRF) + gradient` corresponds to the leaderboard entry at

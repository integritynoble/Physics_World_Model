# TIRF Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

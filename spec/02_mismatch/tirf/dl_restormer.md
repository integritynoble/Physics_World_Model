# TIRF Microscopy — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — Restormer + gradient` corresponds to the leaderboard entry at

# TIRF Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

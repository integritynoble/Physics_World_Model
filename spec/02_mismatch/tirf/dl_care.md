# TIRF Microscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_dl_care_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — CARE + gradient` corresponds to the leaderboard entry at

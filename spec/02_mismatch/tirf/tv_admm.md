# TIRF Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tirf_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`TIRF Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Integral Photography — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: integral image (H × W, float32)
...
plt.tight_layout(); plt.savefig('integral_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — CS-Transformer + gradient` corresponds to the leaderboard entry at

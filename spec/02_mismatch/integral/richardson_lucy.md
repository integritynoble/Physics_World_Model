# Integral Photography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

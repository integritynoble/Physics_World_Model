# Integral Photography — Depth Estimation + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — Depth Estimation + gradient` corresponds to the leaderboard entry at

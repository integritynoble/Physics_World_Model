# Integral Photography — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — CS-Diffusion + gradient` corresponds to the leaderboard entry at

# Integral Photography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_wiener_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

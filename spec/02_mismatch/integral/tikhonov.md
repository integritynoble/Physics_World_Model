# Integral Photography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

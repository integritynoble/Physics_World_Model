# Integral Photography — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — Unrolled-Net + gradient` corresponds to the leaderboard entry at

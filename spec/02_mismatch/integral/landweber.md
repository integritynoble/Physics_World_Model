# Integral Photography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_landweber_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

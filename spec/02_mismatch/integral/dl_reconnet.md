# Integral Photography — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — ReconNet + gradient` corresponds to the leaderboard entry at

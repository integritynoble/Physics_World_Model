# Integral Photography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

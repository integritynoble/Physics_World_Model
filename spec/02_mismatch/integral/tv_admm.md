# Integral Photography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Integral Photography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

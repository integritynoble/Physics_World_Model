# Integral Photography — DIBR [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — DIBR [proxy] + gradient` corresponds to the leaderboard entry at

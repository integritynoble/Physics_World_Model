# Integral Photography — EPINet [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('integral_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Integral Photography — EPINet [proxy] + gradient` corresponds to the leaderboard entry at

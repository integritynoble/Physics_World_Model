# Ground-Penetrating Radar (GPR) — Mismatch Correction + Reconstruct
...
from algorithm_base.gpr.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('gpr_corrected.png'); plt.show()
```

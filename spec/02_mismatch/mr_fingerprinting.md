# MR Fingerprinting (MRF) — Mismatch Correction + Reconstruct
...
from algorithm_base.mr_fingerprinting.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('mr_fingerprinting_corrected.png'); plt.show()
```

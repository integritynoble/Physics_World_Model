# Secondary Ion Mass Spectrometry (SIMS) Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.sims.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('sims_corrected.png'); plt.show()
```

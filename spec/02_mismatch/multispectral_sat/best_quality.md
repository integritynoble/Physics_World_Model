# Multispectral Satellite Imaging — SAR-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('multispectral_sat_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Multispectral Satellite Imaging — SAR-DL [proxy] + gradient` corresponds to the leaderboard entry at

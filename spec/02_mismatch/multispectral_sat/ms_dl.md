# Multispectral Satellite Imaging — MS-Pansharpening-DL [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('ms_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ms_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('multispectral_sat_ms_dl_corrected.png'); plt.show()
```

## Benchmark

`Multispectral Satellite Imaging — MS-Pansharpening-DL [proxy] + gradient` corresponds to the leaderboard entry at

# Multispectral Satellite Imaging — MS-Pansharpening-DL [proxy] + Gradient
...
x_wrong = run_solver('ms_dl', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('ms_dl', y, cfg=calib_cfg)        # corrected

# Multispectral Satellite Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('multispectral_sat_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Multispectral Satellite Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Multispectral Satellite Imaging — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('multispectral_sat_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Multispectral Satellite Imaging — RS-CNN + gradient` corresponds to the leaderboard entry at

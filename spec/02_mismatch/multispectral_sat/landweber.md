# Multispectral Satellite Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('multispectral_sat_landweber_corrected.png'); plt.show()
```

## Benchmark

`Multispectral Satellite Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Multispectral Satellite Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('multispectral_sat_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Multispectral Satellite Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

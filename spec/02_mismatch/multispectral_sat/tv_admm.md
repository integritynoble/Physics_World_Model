# Multispectral Satellite Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('multispectral_sat_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Multispectral Satellite Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

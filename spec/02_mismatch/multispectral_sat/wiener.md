# Multispectral Satellite Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('multispectral_sat_wiener_corrected.png'); plt.show()
```

## Benchmark

`Multispectral Satellite Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

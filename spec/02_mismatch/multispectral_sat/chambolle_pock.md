# Multispectral Satellite Imaging — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('multispectral_sat_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Multispectral Satellite Imaging — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

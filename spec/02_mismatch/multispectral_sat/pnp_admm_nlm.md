# Multispectral Satellite Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('multispectral_sat_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Multispectral Satellite Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

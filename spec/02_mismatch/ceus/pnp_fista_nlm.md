# Contrast-Enhanced Ultrasound (CEUS) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

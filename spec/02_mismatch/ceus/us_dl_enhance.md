# Contrast-Enhanced Ultrasound (CEUS) — US-DeepSight [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('us_dl_enhance', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('us_dl_enhance', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ceus_us_dl_enhance_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — US-DeepSight [proxy] + gradient` corresponds to the leaderboard entry at

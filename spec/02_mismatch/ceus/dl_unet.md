# Contrast-Enhanced Ultrasound (CEUS) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — Med-UNet + gradient` corresponds to the leaderboard entry at

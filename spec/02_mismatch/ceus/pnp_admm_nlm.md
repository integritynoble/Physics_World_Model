# Contrast-Enhanced Ultrasound (CEUS) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

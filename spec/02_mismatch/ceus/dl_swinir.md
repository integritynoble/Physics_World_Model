# Contrast-Enhanced Ultrasound (CEUS) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

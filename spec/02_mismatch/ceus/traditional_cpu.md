# Contrast-Enhanced Ultrasound (CEUS) — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — FBP [proxy] + gradient` corresponds to the leaderboard entry at

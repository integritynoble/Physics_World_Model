# Contrast-Enhanced Ultrasound (CEUS) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_landweber_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

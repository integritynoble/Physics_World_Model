# Contrast-Enhanced Ultrasound (CEUS) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

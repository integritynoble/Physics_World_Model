# Contrast-Enhanced Ultrasound (CEUS) — DL-Recon [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — DL-Recon [proxy] + gradient` corresponds to the leaderboard entry at

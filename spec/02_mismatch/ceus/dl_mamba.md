# Contrast-Enhanced Ultrasound (CEUS) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — MedMamba + gradient` corresponds to the leaderboard entry at

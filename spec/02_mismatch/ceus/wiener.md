# Contrast-Enhanced Ultrasound (CEUS) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_wiener_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

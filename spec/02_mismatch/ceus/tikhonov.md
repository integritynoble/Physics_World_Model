# Contrast-Enhanced Ultrasound (CEUS) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Contrast-Enhanced Ultrasound (CEUS) — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: contrast frames (T × H × W, float32)
...
plt.tight_layout(); plt.savefig('ceus_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — DiffusionMed + gradient` corresponds to the leaderboard entry at

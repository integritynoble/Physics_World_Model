# Contrast-Enhanced Ultrasound (CEUS) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ceus_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Contrast-Enhanced Ultrasound (CEUS) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Coded Exposure / Flutter Shutter — Mismatch Correction + Reconstruct
...
from algorithm_base.coded_exposure.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('coded_exposure_corrected.png'); plt.show()
```

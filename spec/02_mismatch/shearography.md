# Shearography — Mismatch Correction + Reconstruct
...
from algorithm_base.shearography.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('shearography_corrected.png'); plt.show()
```

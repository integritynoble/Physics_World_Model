# Light-Sheet Fluorescence Microscopy (LSFM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

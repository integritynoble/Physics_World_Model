# Light-Sheet Fluorescence Microscopy (LSFM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

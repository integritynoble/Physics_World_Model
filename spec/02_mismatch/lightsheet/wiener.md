# Light-Sheet Fluorescence Microscopy (LSFM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_wiener_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Light-Sheet Fluorescence Microscopy (LSFM) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

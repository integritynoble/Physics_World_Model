# Light-Sheet Fluorescence Microscopy (LSFM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

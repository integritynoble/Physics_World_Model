# Light-Sheet Fluorescence Microscopy (LSFM) — VSNR + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — VSNR + gradient` corresponds to the leaderboard entry at

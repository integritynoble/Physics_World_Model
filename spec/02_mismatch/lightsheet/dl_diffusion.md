# Light-Sheet Fluorescence Microscopy (LSFM) — DiffusionMicro + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — DiffusionMicro + gradient` corresponds to the leaderboard entry at

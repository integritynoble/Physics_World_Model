# Light-Sheet Fluorescence Microscopy (LSFM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Light-Sheet Fluorescence Microscopy (LSFM) — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — Noise2Void + gradient` corresponds to the leaderboard entry at

# Light-Sheet Fluorescence Microscopy (LSFM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_landweber_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

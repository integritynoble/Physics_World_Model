# Light-Sheet Fluorescence Microscopy (LSFM) — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lightsheet_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Light-Sheet Fluorescence Microscopy (LSFM) — Restormer + gradient` corresponds to the leaderboard entry at

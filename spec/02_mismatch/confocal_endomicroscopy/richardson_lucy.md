# Confocal Laser Endomicroscopy (CLE) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Confocal Laser Endomicroscopy (CLE) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

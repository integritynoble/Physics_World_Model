# Confocal Laser Endomicroscopy (CLE) — Noise2Void + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_n2v', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_n2v', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Confocal Laser Endomicroscopy (CLE) — Noise2Void + gradient` corresponds to the leaderboard entry at

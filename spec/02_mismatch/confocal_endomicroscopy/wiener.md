# Confocal Laser Endomicroscopy (CLE) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_wiener_corrected.png'); plt.show()
```

## Benchmark

`Confocal Laser Endomicroscopy (CLE) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

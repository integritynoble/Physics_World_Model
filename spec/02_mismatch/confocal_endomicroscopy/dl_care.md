# Confocal Laser Endomicroscopy (CLE) — CARE + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_care', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_care', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Confocal Laser Endomicroscopy (CLE) — CARE + gradient` corresponds to the leaderboard entry at

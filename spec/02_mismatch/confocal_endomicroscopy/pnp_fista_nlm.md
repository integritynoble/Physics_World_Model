# Confocal Laser Endomicroscopy (CLE) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Confocal Laser Endomicroscopy (CLE) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

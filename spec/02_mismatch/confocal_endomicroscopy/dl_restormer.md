# Confocal Laser Endomicroscopy (CLE) — Restormer + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_restormer', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_restormer', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Confocal Laser Endomicroscopy (CLE) — Restormer + gradient` corresponds to the leaderboard entry at

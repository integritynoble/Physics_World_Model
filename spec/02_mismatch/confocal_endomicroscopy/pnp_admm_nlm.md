# Confocal Laser Endomicroscopy (CLE) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Confocal Laser Endomicroscopy (CLE) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

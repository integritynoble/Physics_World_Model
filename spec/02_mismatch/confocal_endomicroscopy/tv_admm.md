# Confocal Laser Endomicroscopy (CLE) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Confocal Laser Endomicroscopy (CLE) — TV-ADMM + gradient` corresponds to the leaderboard entry at

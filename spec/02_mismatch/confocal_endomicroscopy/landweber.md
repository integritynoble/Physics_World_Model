# Confocal Laser Endomicroscopy (CLE) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_landweber_corrected.png'); plt.show()
```

## Benchmark

`Confocal Laser Endomicroscopy (CLE) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Functional MRI (BOLD fMRI) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fmri_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Functional MRI (BOLD fMRI) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

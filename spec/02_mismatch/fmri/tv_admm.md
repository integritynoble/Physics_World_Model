# Functional MRI (BOLD fMRI) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fmri_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Functional MRI (BOLD fMRI) — TV-ADMM + gradient` corresponds to the leaderboard entry at

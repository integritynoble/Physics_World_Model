# Functional MRI (BOLD fMRI) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fmri_landweber_corrected.png'); plt.show()
```

## Benchmark

`Functional MRI (BOLD fMRI) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

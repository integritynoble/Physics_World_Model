# Functional MRI (BOLD fMRI) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fmri_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Functional MRI (BOLD fMRI) — MedMamba + gradient` corresponds to the leaderboard entry at

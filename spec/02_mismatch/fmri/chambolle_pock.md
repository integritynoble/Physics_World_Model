# Functional MRI (BOLD fMRI) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fmri_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Functional MRI (BOLD fMRI) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

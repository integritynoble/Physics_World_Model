# Functional MRI (BOLD fMRI) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fmri_wiener_corrected.png'); plt.show()
```

## Benchmark

`Functional MRI (BOLD fMRI) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Functional MRI (BOLD fMRI) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fmri_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Functional MRI (BOLD fMRI) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Functional MRI (BOLD fMRI) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fmri_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Functional MRI (BOLD fMRI) — Med-UNet + gradient` corresponds to the leaderboard entry at

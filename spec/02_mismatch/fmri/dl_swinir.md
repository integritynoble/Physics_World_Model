# Functional MRI (BOLD fMRI) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fmri_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Functional MRI (BOLD fMRI) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

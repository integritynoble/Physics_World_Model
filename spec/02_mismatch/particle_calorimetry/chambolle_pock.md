# Particle Calorimetry — Chambolle-Pock + Gradient Mismatch Correction
...
import h5py
with h5py.File('particle_calorimetry_public.h5', 'r') as f:   # GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/particle_calorimetry/public/
...
plt.tight_layout(); plt.savefig('particle_calorimetry_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — Chambolle-Pock + gradient` corresponds to the leaderboard entry at
`https://pwm.platformai.org/benchmark/particle_calorimetry` (mismatch correction tier).

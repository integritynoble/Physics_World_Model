# Particle Calorimetry — DL-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — DL-Diffusion + gradient` corresponds to the leaderboard entry at

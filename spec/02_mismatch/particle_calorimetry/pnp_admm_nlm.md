# Particle Calorimetry — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

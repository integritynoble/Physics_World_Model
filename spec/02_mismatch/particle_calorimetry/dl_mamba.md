# Particle Calorimetry — DL-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — DL-Mamba + gradient` corresponds to the leaderboard entry at

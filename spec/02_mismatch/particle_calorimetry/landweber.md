# Particle Calorimetry — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_landweber_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Particle Calorimetry — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

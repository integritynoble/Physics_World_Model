# Particle Calorimetry — DL-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — DL-UNet + gradient` corresponds to the leaderboard entry at

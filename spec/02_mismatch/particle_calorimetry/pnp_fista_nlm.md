# Particle Calorimetry — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

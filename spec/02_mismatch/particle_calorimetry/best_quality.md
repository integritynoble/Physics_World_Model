# Particle Calorimetry — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

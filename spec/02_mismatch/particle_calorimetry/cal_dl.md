# Particle Calorimetry — CaloDiffusion [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('cal_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('cal_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('particle_calorimetry_cal_dl_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — CaloDiffusion [proxy] + gradient` corresponds to the leaderboard entry at

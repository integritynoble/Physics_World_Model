# Particle Calorimetry — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_wiener_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Particle Calorimetry — DL-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: deposits (N × 5, float32)
...
plt.tight_layout(); plt.savefig('particle_calorimetry_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — DL-Transformer + gradient` corresponds to the leaderboard entry at

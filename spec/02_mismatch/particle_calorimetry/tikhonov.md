# Particle Calorimetry — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Particle Calorimetry — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

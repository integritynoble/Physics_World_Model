# Particle Calorimetry — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('particle_calorimetry_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Particle Calorimetry — TV-ADMM + gradient` corresponds to the leaderboard entry at

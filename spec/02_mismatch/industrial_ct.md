# Industrial X-ray CT — Mismatch Correction + Reconstruct
...
|-----------|-------|---------------|-------------------|
| center-of-rotation (CoR) offset | `[-10, +10] px` | ±2 px | sinogram symmetry calibration |
...
plt.tight_layout(); plt.savefig('industrial_ct_corrected.png'); plt.show()
```

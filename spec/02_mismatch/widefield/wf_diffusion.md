# Widefield Fluorescence Microscopy — WF-Diffusion (PnP-PGD DRUNet) + Gradient Mismatch Correction
...
x_wrong = run_solver('wf_diffusion', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('wf_diffusion', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('widefield_wf_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — WF-Diffusion (PnP-PGD DRUNet) + gradient` corresponds to the leaderboard entry at

# Widefield Fluorescence Microscopy — PnP-FISTA (NLM denoiser) + Gradient Mismatch Correction
...
x_wrong = run_solver('pnp_fista_nlm', y, cfg={})
...
plt.tight_layout(); plt.savefig('widefield_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — PnP-FISTA (NLM denoiser) + gradient` corresponds to the leaderboard entry at

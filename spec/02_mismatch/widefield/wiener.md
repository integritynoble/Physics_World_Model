# Widefield Fluorescence Microscopy — Wiener Filter + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_wiener_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — Wiener Filter + gradient` corresponds to the leaderboard entry at

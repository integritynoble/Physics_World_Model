# Widefield Fluorescence Microscopy — CSBDeep (DnCNN denoise) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — CSBDeep (DnCNN denoise) + gradient` corresponds to the leaderboard entry at

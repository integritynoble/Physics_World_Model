# Widefield Fluorescence Microscopy — Gold Deconvolution + Gradient Mismatch Correction
...
cfg.update({})
x_corrected = run_solver('gold', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('widefield_gold_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — Gold Deconvolution + gradient` corresponds to the leaderboard entry at

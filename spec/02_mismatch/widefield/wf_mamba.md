# Widefield Fluorescence Microscopy — WF-Mamba (RED DRUNet) + Gradient
...
x_wrong = run_solver('wf_mamba', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('wf_mamba', y, cfg=calib_cfg)        # corrected

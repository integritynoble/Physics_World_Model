# Widefield Fluorescence Microscopy — WF-Mamba (RED DRUNet) + Gradient Mismatch Correction
...
x_wrong = run_solver('wf_mamba', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('wf_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('widefield_wf_mamba_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — WF-Mamba (RED DRUNet) + gradient` corresponds to the leaderboard entry at

# Widefield Fluorescence Microscopy — Tikhonov Regularisation + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — Tikhonov Regularisation + gradient` corresponds to the leaderboard entry at

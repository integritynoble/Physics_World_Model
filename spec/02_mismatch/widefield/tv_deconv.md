# Widefield Fluorescence Microscopy — Total Variation Deconvolution + Gradient Mismatch Correction
...
x_wrong = run_solver('tv_deconv', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('tv_deconv', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('widefield_tv_deconv_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — Total Variation Deconvolution + gradient` corresponds to the leaderboard entry at

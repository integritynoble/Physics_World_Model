# Widefield Fluorescence Microscopy — Richardson-Lucy Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — Richardson-Lucy Deconvolution + gradient` corresponds to the leaderboard entry at

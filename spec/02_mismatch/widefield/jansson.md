# Widefield Fluorescence Microscopy — Jansson-van Cittert Iteration + Gradient Mismatch Correction
...
x_wrong = run_solver('jansson', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('jansson', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('widefield_jansson_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — Jansson-van Cittert Iteration + gradient` corresponds to the leaderboard entry at

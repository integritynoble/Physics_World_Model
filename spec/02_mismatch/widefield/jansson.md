# Widefield Fluorescence Microscopy — Jansson-van Cittert Iteration + Gradient
...
x_wrong = run_solver('jansson', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('jansson', y, cfg=calib_cfg)        # corrected

# Widefield Fluorescence Microscopy — CARE (PnP-PGD DRUNet) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — CARE (PnP-PGD DRUNet) + gradient` corresponds to the leaderboard entry at

# Widefield Fluorescence Microscopy — DeepCAD-RT (PnP-DRS DRUNet) + Gradient Mismatch Correction
...
x_wrong = run_solver('deepcad_rt', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('deepcad_rt', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('widefield_deepcad_rt_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — DeepCAD-RT (PnP-DRS DRUNet) + gradient` corresponds to the leaderboard entry at

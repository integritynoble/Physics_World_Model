# Widefield Fluorescence Microscopy — PnP-ADMM (NLM denoiser) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — PnP-ADMM (NLM denoiser) + gradient` corresponds to the leaderboard entry at

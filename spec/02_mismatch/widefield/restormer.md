# Widefield Fluorescence Microscopy — Restormer (PnP-HQS DRUNet) + Gradient
...
x_wrong = run_solver('restormer', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('restormer', y, cfg=calib_cfg)        # corrected

# Widefield Fluorescence Microscopy — Restormer (PnP-HQS DRUNet) + Gradient Mismatch Correction
...
x_wrong = run_solver('restormer', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('restormer', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('widefield_restormer_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — Restormer (PnP-HQS DRUNet) + gradient` corresponds to the leaderboard entry at

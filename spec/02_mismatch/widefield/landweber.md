# Widefield Fluorescence Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
x_wrong = run_solver('landweber', y, cfg={})
...
plt.tight_layout(); plt.savefig('widefield_landweber_corrected.png'); plt.show()
```

## Benchmark

`Widefield Fluorescence Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

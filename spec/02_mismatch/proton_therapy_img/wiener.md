# Proton Therapy Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_therapy_img_wiener_corrected.png'); plt.show()
```

## Benchmark

`Proton Therapy Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Proton Therapy Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_therapy_img_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Proton Therapy Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Proton Therapy Imaging — ProtonTherapy-Net [proxy] + Gradient
...
x_wrong = run_solver('proton_therapy_dl', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('proton_therapy_dl', y, cfg=calib_cfg)        # corrected

# Proton Therapy Imaging — ProtonTherapy-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('proton_therapy_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('proton_therapy_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('proton_therapy_img_proton_therapy_dl_corrected.png'); plt.show()
```

## Benchmark

`Proton Therapy Imaging — ProtonTherapy-Net [proxy] + gradient` corresponds to the leaderboard entry at

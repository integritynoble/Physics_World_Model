# Proton Therapy Imaging — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_therapy_img_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Proton Therapy Imaging — DiffusionRecon + gradient` corresponds to the leaderboard entry at

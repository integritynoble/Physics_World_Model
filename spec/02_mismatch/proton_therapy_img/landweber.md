# Proton Therapy Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_therapy_img_landweber_corrected.png'); plt.show()
```

## Benchmark

`Proton Therapy Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

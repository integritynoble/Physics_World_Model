# Proton Therapy Imaging — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_therapy_img_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Proton Therapy Imaging — FBP [proxy] + gradient` corresponds to the leaderboard entry at

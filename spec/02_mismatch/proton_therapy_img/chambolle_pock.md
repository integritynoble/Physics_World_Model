# Proton Therapy Imaging — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_therapy_img_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Proton Therapy Imaging — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

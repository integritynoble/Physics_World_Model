# Proton Therapy Imaging — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_therapy_img_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Proton Therapy Imaging — U-Net Recon + gradient` corresponds to the leaderboard entry at

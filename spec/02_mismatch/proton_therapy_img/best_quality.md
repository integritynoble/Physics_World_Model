# Proton Therapy Imaging — DL-Recon [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_therapy_img_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Proton Therapy Imaging — DL-Recon [proxy] + gradient` corresponds to the leaderboard entry at

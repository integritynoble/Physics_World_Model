# Proton Therapy Imaging — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_therapy_img_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Proton Therapy Imaging — TransCT + gradient` corresponds to the leaderboard entry at

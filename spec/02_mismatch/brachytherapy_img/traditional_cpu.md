# Brachytherapy Imaging — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brachytherapy_img_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Brachytherapy Imaging — FBP [proxy] + gradient` corresponds to the leaderboard entry at

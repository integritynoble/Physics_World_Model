# Brachytherapy Imaging — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brachytherapy_img_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Brachytherapy Imaging — TransCT + gradient` corresponds to the leaderboard entry at

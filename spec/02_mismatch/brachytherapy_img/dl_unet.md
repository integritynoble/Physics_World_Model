# Brachytherapy Imaging — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brachytherapy_img_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Brachytherapy Imaging — U-Net Recon + gradient` corresponds to the leaderboard entry at

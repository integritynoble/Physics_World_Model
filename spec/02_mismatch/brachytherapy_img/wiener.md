# Brachytherapy Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brachytherapy_img_wiener_corrected.png'); plt.show()
```

## Benchmark

`Brachytherapy Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Brachytherapy Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brachytherapy_img_landweber_corrected.png'); plt.show()
```

## Benchmark

`Brachytherapy Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

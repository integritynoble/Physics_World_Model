# Brachytherapy Imaging — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brachytherapy_img_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Brachytherapy Imaging — DiffusionRecon + gradient` corresponds to the leaderboard entry at

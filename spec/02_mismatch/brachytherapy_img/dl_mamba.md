# Brachytherapy Imaging — MambaRecon + Gradient Mismatch Correction

**Device**: GPU  **Input**: dose map (H × W × D, float32)
...
plt.tight_layout(); plt.savefig('brachytherapy_img_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Brachytherapy Imaging — MambaRecon + gradient` corresponds to the leaderboard entry at

# Brachytherapy Imaging — BrachyNet [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('brachy_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('brachy_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('brachytherapy_img_brachy_dl_corrected.png'); plt.show()
```

## Benchmark

`Brachytherapy Imaging — BrachyNet [proxy] + gradient` corresponds to the leaderboard entry at

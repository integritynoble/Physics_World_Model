# Single-Pixel Camera (SPC) — Mismatch Correction + Reconstruct

**Input**: photon counts (T × H × W, uint16)
**Benchmark**: `gs://pwm-benchmark-datasets/datasets/Benchmark/spc/public/`
**Algorithms**: 15 CPU, 10 GPU — reconstruct with `run_solver(key, y)`
...
plt.tight_layout(); plt.savefig('spc_corrected.png'); plt.show()
```

# Photometric Stereo — PS-FCN [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('ps_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ps_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('photometric_stereo_ps_dl_corrected.png'); plt.show()
```

## Benchmark

`Photometric Stereo — PS-FCN [proxy] + gradient` corresponds to the leaderboard entry at

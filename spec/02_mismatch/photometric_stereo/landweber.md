# Photometric Stereo — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photometric_stereo_landweber_corrected.png'); plt.show()
```

## Benchmark

`Photometric Stereo — Landweber Iteration + gradient` corresponds to the leaderboard entry at

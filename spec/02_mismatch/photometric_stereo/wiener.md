# Photometric Stereo — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photometric_stereo_wiener_corrected.png'); plt.show()
```

## Benchmark

`Photometric Stereo — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

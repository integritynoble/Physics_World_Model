# Photometric Stereo — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photometric_stereo_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Photometric Stereo — TV-ADMM + gradient` corresponds to the leaderboard entry at

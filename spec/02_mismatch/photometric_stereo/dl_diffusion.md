# Photometric Stereo — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photometric_stereo_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Photometric Stereo — CS-Diffusion + gradient` corresponds to the leaderboard entry at

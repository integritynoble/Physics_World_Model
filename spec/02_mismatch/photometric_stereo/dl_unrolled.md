# Photometric Stereo — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photometric_stereo_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Photometric Stereo — Unrolled-Net + gradient` corresponds to the leaderboard entry at

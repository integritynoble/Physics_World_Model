# Photometric Stereo — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photometric_stereo_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Photometric Stereo — ReconNet + gradient` corresponds to the leaderboard entry at

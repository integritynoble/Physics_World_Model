# Single-Pixel Camera (SPC) — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spc_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — ReconNet + gradient` corresponds to the leaderboard entry at

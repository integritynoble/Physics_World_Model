# Single-Pixel Camera (SPC) — ADMM-L1 + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spc_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — ADMM-L1 + gradient` corresponds to the leaderboard entry at

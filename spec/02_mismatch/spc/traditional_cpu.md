# Single-Pixel Camera (SPC) — TVAL3 + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spc_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — TVAL3 + gradient` corresponds to the leaderboard entry at

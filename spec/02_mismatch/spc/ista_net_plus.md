# Single-Pixel Camera (SPC) — ISTA-Net+ v2 + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spc_ista_net_plus_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — ISTA-Net+ v2 + gradient` corresponds to the leaderboard entry at

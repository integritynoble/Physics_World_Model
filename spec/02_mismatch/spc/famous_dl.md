# Single-Pixel Camera (SPC) — ISTA-Net+ + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spc_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — ISTA-Net+ + gradient` corresponds to the leaderboard entry at

# Single-Pixel Camera (SPC) — Wiener Filter + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spc_wiener_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — Wiener Filter + gradient` corresponds to the leaderboard entry at

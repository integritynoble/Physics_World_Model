# Single-Pixel Camera (SPC) — GAP-TV + Gradient Mismatch Correction
...
x_wrong = run_solver('gap_tv', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('gap_tv', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('spc_gap_tv_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — GAP-TV + gradient` corresponds to the leaderboard entry at

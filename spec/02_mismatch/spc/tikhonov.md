# Single-Pixel Camera (SPC) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spc_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

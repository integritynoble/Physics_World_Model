# Single-Pixel Camera (SPC) — DPIR + Gradient Mismatch Correction
...
x_wrong = run_solver('dpir_spc', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dpir_spc', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('spc_dpir_spc_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — DPIR + gradient` corresponds to the leaderboard entry at

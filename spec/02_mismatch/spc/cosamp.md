# Single-Pixel Camera (SPC) — CoSaMP + Gradient Mismatch Correction
...
x_wrong = run_solver('cosamp', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('cosamp', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('spc_cosamp_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — CoSaMP + gradient` corresponds to the leaderboard entry at

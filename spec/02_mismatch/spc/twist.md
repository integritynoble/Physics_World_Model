# Single-Pixel Camera (SPC) — TwIST + Gradient Mismatch Correction
...
x_wrong = run_solver('twist', y, cfg={})
...
plt.tight_layout(); plt.savefig('spc_twist_corrected.png'); plt.show()
```

## Benchmark

`Single-Pixel Camera (SPC) — TwIST + gradient` corresponds to the leaderboard entry at

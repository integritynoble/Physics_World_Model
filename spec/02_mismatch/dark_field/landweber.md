# Dark-Field Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dark_field_landweber_corrected.png'); plt.show()
```

## Benchmark

`Dark-Field Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

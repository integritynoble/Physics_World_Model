# Dark-Field Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dark_field_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Dark-Field Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

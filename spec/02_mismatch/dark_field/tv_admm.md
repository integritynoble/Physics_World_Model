# Dark-Field Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dark_field_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Dark-Field Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

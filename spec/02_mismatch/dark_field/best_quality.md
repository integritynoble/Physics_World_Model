# Dark-Field Microscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dark_field_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Dark-Field Microscopy — CARE + gradient` corresponds to the leaderboard entry at

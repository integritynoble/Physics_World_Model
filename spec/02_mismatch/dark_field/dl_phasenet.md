# Dark-Field Microscopy — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dark_field_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`Dark-Field Microscopy — PhaseNet + gradient` corresponds to the leaderboard entry at

# Dark-Field Microscopy — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dark_field_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`Dark-Field Microscopy — prDeep + gradient` corresponds to the leaderboard entry at

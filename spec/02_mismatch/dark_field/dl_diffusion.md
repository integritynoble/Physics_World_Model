# Dark-Field Microscopy — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dark_field_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Dark-Field Microscopy — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

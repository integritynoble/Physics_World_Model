# Dark-Field Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dark_field_wiener_corrected.png'); plt.show()
```

## Benchmark

`Dark-Field Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

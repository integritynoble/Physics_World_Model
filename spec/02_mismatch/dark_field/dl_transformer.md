# Dark-Field Microscopy — Phase-Transformer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dark_field_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Dark-Field Microscopy — Phase-Transformer + gradient` corresponds to the leaderboard entry at

# Cryo-Electron Tomography (Cryo-ET) — MambaRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_et_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Cryo-Electron Tomography (Cryo-ET) — MambaRecon + gradient` corresponds to the leaderboard entry at

# Cryo-Electron Tomography (Cryo-ET) — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_et_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Cryo-Electron Tomography (Cryo-ET) — U-Net Recon + gradient` corresponds to the leaderboard entry at

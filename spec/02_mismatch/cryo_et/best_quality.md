# Cryo-Electron Tomography (Cryo-ET) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_et_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Cryo-Electron Tomography (Cryo-ET) — CARE + gradient` corresponds to the leaderboard entry at

# Cryo-Electron Tomography (Cryo-ET) — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_et_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Cryo-Electron Tomography (Cryo-ET) — TransCT + gradient` corresponds to the leaderboard entry at

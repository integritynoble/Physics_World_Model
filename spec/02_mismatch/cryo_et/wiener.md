# Cryo-Electron Tomography (Cryo-ET) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_et_wiener_corrected.png'); plt.show()
```

## Benchmark

`Cryo-Electron Tomography (Cryo-ET) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Cryo-Electron Tomography (Cryo-ET) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_et_landweber_corrected.png'); plt.show()
```

## Benchmark

`Cryo-Electron Tomography (Cryo-ET) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Cryo-Electron Tomography (Cryo-ET) — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_et_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Cryo-Electron Tomography (Cryo-ET) — DiffusionRecon + gradient` corresponds to the leaderboard entry at

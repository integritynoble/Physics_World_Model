# Cryo-Electron Tomography (Cryo-ET) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_et_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Cryo-Electron Tomography (Cryo-ET) — TV-ADMM + gradient` corresponds to the leaderboard entry at

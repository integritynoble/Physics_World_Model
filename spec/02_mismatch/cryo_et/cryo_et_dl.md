# Cryo-Electron Tomography (Cryo-ET) — CryoCARE + Gradient Mismatch Correction
...
x_wrong = run_solver('cryo_et_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('cryo_et_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cryo_et_cryo_et_dl_corrected.png'); plt.show()
```

## Benchmark

`Cryo-Electron Tomography (Cryo-ET) — CryoCARE + gradient` corresponds to the leaderboard entry at

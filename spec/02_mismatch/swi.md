# Susceptibility-Weighted Imaging (SWI) — Mismatch Correction + Reconstruct
...
from algorithm_base.swi.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('swi_corrected.png'); plt.show()
```

# Interferometric SAR (InSAR) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — TV-ADMM + gradient` corresponds to the leaderboard entry at

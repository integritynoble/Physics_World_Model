# Interferometric SAR (InSAR) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

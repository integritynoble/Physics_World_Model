# Interferometric SAR (InSAR) — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — RS-Diffusion + gradient` corresponds to the leaderboard entry at

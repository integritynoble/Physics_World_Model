# Interferometric SAR (InSAR) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_landweber_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Interferometric SAR (InSAR) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Interferometric SAR (InSAR) — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — RS-CNN + gradient` corresponds to the leaderboard entry at

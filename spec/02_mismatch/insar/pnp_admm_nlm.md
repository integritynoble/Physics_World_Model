# Interferometric SAR (InSAR) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Interferometric SAR (InSAR) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

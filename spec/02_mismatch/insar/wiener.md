# Interferometric SAR (InSAR) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_wiener_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

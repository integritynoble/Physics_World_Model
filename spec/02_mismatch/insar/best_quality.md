# Interferometric SAR (InSAR) — SAR-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — SAR-DL [proxy] + gradient` corresponds to the leaderboard entry at

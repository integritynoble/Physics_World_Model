# Interferometric SAR (InSAR) — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — RS-Mamba + gradient` corresponds to the leaderboard entry at

# Interferometric SAR (InSAR) — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: interferometric phase (H × W, float32)
...
plt.tight_layout(); plt.savefig('insar_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — RS-Transformer + gradient` corresponds to the leaderboard entry at

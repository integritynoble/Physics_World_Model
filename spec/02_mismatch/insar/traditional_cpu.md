# Interferometric SAR (InSAR) — RDA [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('insar_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Interferometric SAR (InSAR) — RDA [proxy] + gradient` corresponds to the leaderboard entry at

# Ghost Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.ghost_imaging.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('ghost_imaging_corrected.png'); plt.show()
```

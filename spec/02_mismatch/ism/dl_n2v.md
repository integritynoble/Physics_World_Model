# Image Scanning Microscopy (ISM) — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ism_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — Noise2Void + gradient` corresponds to the leaderboard entry at

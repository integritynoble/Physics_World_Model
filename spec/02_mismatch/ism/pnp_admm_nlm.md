# Image Scanning Microscopy (ISM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ism_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

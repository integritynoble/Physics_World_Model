# Image Scanning Microscopy (ISM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ism_landweber_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

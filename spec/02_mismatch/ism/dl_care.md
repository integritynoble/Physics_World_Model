# Image Scanning Microscopy (ISM) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ism_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — CARE + gradient` corresponds to the leaderboard entry at

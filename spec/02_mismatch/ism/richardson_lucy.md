# Image Scanning Microscopy (ISM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ism_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

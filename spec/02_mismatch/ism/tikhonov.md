# Image Scanning Microscopy (ISM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ism_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Image Scanning Microscopy (ISM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ism_wiener_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

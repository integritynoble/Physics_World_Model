# Image Scanning Microscopy (ISM) — ISM-Reassignment-Net + Gradient Mismatch Correction
...
x_wrong = run_solver('ism_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ism_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ism_ism_dl_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — ISM-Reassignment-Net + gradient` corresponds to the leaderboard entry at

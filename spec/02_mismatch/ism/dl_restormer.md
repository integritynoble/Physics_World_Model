# Image Scanning Microscopy (ISM) — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ism_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — Restormer + gradient` corresponds to the leaderboard entry at

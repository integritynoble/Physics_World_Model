# Image Scanning Microscopy (ISM) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ism_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

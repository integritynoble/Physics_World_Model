# Image Scanning Microscopy (ISM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ism_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Image Scanning Microscopy (ISM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

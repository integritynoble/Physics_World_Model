# Radio Aperture Synthesis — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Radio Aperture Synthesis — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — RS-Diffusion + gradient` corresponds to the leaderboard entry at

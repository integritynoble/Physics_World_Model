# Radio Aperture Synthesis — RadioAST-DL [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('clean_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('clean_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('radio_astronomy_clean_dl_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — RadioAST-DL [proxy] + gradient` corresponds to the leaderboard entry at

# Radio Aperture Synthesis — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — RS-CNN + gradient` corresponds to the leaderboard entry at

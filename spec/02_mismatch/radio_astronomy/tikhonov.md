# Radio Aperture Synthesis — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Radio Aperture Synthesis — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: visibilities (baselines × freq × T, complex64)
...
plt.tight_layout(); plt.savefig('radio_astronomy_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — RS-Transformer + gradient` corresponds to the leaderboard entry at

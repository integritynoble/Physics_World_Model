# Radio Aperture Synthesis — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

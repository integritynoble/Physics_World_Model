# Radio Aperture Synthesis — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Radio Aperture Synthesis — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Radio Aperture Synthesis — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_landweber_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — Landweber Iteration + gradient` corresponds to the leaderboard entry at

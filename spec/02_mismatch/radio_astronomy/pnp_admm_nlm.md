# Radio Aperture Synthesis — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

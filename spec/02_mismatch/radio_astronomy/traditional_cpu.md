# Radio Aperture Synthesis — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

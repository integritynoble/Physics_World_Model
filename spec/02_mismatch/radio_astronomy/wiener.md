# Radio Aperture Synthesis — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_wiener_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

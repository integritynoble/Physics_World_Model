# Radio Aperture Synthesis — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_astronomy_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Radio Aperture Synthesis — RS-Mamba + gradient` corresponds to the leaderboard entry at

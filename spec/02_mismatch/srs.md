# Stimulated Raman Scattering (SRS) Microscopy — Mismatch Correction + Reconstruct
...
from algorithm_base.srs.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('srs_corrected.png'); plt.show()
```

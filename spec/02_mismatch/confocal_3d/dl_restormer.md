# Confocal 3D Z-Stack — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_3d_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Confocal 3D Z-Stack — Restormer + gradient` corresponds to the leaderboard entry at

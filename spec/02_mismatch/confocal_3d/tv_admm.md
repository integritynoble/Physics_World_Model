# Confocal 3D Z-Stack — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_3d_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Confocal 3D Z-Stack — TV-ADMM + gradient` corresponds to the leaderboard entry at

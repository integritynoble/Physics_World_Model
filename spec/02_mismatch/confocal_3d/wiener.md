# Confocal 3D Z-Stack — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_3d_wiener_corrected.png'); plt.show()
```

## Benchmark

`Confocal 3D Z-Stack — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

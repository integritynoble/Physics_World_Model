# Confocal 3D Z-Stack — 3D Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_3d_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Confocal 3D Z-Stack — 3D Richardson-Lucy + gradient` corresponds to the leaderboard entry at

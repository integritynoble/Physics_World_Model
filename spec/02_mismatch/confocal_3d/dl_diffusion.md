# Confocal 3D Z-Stack — DiffusionMicro + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_3d_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Confocal 3D Z-Stack — DiffusionMicro + gradient` corresponds to the leaderboard entry at

# Confocal 3D Z-Stack — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_3d_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Confocal 3D Z-Stack — Noise2Void + gradient` corresponds to the leaderboard entry at

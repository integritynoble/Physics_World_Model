# Confocal 3D Z-Stack — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_3d_landweber_corrected.png'); plt.show()
```

## Benchmark

`Confocal 3D Z-Stack — Landweber Iteration + gradient` corresponds to the leaderboard entry at

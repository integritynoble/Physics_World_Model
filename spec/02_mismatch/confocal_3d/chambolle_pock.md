# Confocal 3D Z-Stack — Chambolle-Pock + Gradient Mismatch Correction
...
import h5py
with h5py.File('confocal_3d_public.h5', 'r') as f:   # GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/confocal_3d/public/
...
plt.tight_layout(); plt.savefig('confocal_3d_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Confocal 3D Z-Stack — Chambolle-Pock + gradient` corresponds to the leaderboard entry at
`https://pwm.platformai.org/benchmark/confocal_3d` (mismatch correction tier).

# Wide-Angle X-ray Scattering (WAXS) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

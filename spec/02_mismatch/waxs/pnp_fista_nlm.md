# Wide-Angle X-ray Scattering (WAXS) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

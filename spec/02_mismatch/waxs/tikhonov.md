# Wide-Angle X-ray Scattering (WAXS) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

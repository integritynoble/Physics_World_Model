# Wide-Angle X-ray Scattering (WAXS) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

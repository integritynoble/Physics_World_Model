# Wide-Angle X-ray Scattering (WAXS) — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — PhaseNet + gradient` corresponds to the leaderboard entry at

# Wide-Angle X-ray Scattering (WAXS) — Phase-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: wide-angle pattern (H × W, float32)
...
plt.tight_layout(); plt.savefig('waxs_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — Phase-Transformer + gradient` corresponds to the leaderboard entry at

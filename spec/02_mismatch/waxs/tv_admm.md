# Wide-Angle X-ray Scattering (WAXS) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — TV-ADMM + gradient` corresponds to the leaderboard entry at

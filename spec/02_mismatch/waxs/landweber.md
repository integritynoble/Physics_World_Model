# Wide-Angle X-ray Scattering (WAXS) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_landweber_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

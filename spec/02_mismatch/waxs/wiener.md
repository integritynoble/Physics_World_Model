# Wide-Angle X-ray Scattering (WAXS) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_wiener_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Wide-Angle X-ray Scattering (WAXS) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Wide-Angle X-ray Scattering (WAXS) — WAXS-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('waxs_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('waxs_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('waxs_waxs_dl_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — WAXS-Net [proxy] + gradient` corresponds to the leaderboard entry at

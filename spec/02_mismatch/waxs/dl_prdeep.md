# Wide-Angle X-ray Scattering (WAXS) — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — prDeep + gradient` corresponds to the leaderboard entry at

# Wide-Angle X-ray Scattering (WAXS) — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

# Wide-Angle X-ray Scattering (WAXS) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('waxs_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Wide-Angle X-ray Scattering (WAXS) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

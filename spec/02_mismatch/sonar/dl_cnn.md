# Sonar Imaging — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sonar_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Sonar Imaging — RS-CNN + gradient` corresponds to the leaderboard entry at

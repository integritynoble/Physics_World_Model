# Sonar Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sonar_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Sonar Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Sonar Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sonar_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Sonar Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

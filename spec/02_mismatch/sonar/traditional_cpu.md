# Sonar Imaging — FISTA-L2 (DAS) [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sonar_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Sonar Imaging — FISTA-L2 (DAS) [proxy] + gradient` corresponds to the leaderboard entry at

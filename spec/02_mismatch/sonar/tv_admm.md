# Sonar Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sonar_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Sonar Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

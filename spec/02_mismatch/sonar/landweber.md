# Sonar Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sonar_landweber_corrected.png'); plt.show()
```

## Benchmark

`Sonar Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

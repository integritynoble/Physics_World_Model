# Sonar Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sonar_wiener_corrected.png'); plt.show()
```

## Benchmark

`Sonar Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

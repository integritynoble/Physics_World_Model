# Sonar Imaging — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: echo data (elements × samples, float32)
...
plt.tight_layout(); plt.savefig('sonar_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Sonar Imaging — RS-Transformer + gradient` corresponds to the leaderboard entry at

# Sonar Imaging — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sonar_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Sonar Imaging — RS-Diffusion + gradient` corresponds to the leaderboard entry at

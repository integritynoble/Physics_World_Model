# Sonar Imaging — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sonar_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Sonar Imaging — RS-Mamba + gradient` corresponds to the leaderboard entry at

# X-ray Fluorescence Tomography — Mismatch Correction + Reconstruct
...
from algorithm_base.xrf_tomo.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('xrf_tomo_corrected.png'); plt.show()
```

# Portal Imaging (EPID) — MambaRecon + Gradient Mismatch Correction

**Device**: GPU  **Input**: EPID projection (H × W, float32)
...
plt.tight_layout(); plt.savefig('portal_imaging_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — MambaRecon + gradient` corresponds to the leaderboard entry at

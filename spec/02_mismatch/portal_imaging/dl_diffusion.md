# Portal Imaging (EPID) — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — DiffusionRecon + gradient` corresponds to the leaderboard entry at

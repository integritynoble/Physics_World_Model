# Portal Imaging (EPID) — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — TransCT + gradient` corresponds to the leaderboard entry at

# Portal Imaging (EPID) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

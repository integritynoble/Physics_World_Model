# Portal Imaging (EPID) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_landweber_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

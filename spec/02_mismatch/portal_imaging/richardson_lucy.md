# Portal Imaging (EPID) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

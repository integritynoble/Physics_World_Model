# Portal Imaging (EPID) — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — U-Net Recon + gradient` corresponds to the leaderboard entry at

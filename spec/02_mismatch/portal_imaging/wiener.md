# Portal Imaging (EPID) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_wiener_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Portal Imaging (EPID) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

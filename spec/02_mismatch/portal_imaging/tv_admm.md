# Portal Imaging (EPID) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Portal Imaging (EPID) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

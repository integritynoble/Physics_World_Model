# Portal Imaging (EPID) — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — FBP [proxy] + gradient` corresponds to the leaderboard entry at

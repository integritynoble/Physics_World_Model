# Portal Imaging (EPID) — DL-Recon [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('portal_imaging_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Portal Imaging (EPID) — DL-Recon [proxy] + gradient` corresponds to the leaderboard entry at

# Time-of-Flight Depth Camera — Mismatch Correction + Reconstruct
...
from algorithm_base.tof_camera.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('tof_camera_corrected.png'); plt.show()
```

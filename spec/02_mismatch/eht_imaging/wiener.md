# Event Horizon Telescope (EHT) Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eht_imaging_wiener_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Event Horizon Telescope (EHT) Imaging — EHT-PRIMO [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('eht_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('eht_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('eht_imaging_eht_dl_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — EHT-PRIMO [proxy] + gradient` corresponds to the leaderboard entry at

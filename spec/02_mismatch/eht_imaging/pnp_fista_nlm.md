# Event Horizon Telescope (EHT) Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eht_imaging_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

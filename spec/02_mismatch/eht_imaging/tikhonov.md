# Event Horizon Telescope (EHT) Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eht_imaging_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

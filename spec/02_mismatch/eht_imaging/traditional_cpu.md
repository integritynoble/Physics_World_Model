# Event Horizon Telescope (EHT) Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eht_imaging_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Event Horizon Telescope (EHT) Imaging — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: hologram (H × W, complex64)
...
plt.tight_layout(); plt.savefig('eht_imaging_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — RS-Transformer + gradient` corresponds to the leaderboard entry at

# Event Horizon Telescope (EHT) Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eht_imaging_landweber_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

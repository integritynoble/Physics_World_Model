# Event Horizon Telescope (EHT) Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eht_imaging_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

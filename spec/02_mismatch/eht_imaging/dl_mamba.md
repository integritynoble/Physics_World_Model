# Event Horizon Telescope (EHT) Imaging — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eht_imaging_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — RS-Mamba + gradient` corresponds to the leaderboard entry at

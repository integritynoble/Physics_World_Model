# Event Horizon Telescope (EHT) Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eht_imaging_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

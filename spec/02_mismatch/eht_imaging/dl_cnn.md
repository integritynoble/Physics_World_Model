# Event Horizon Telescope (EHT) Imaging — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eht_imaging_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — RS-CNN + gradient` corresponds to the leaderboard entry at

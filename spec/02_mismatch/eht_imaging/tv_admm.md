# Event Horizon Telescope (EHT) Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eht_imaging_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Event Horizon Telescope (EHT) Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

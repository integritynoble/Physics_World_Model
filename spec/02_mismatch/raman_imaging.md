# Raman Imaging / Microscopy — Mismatch Correction + Reconstruct
...
from algorithm_base.raman_imaging.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('raman_imaging_corrected.png'); plt.show()
```

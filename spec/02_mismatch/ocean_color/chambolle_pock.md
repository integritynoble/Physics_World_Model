# Ocean Color Remote Sensing — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_color_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Ocean Color Remote Sensing — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

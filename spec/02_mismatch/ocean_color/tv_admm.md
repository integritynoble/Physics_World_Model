# Ocean Color Remote Sensing — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_color_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Ocean Color Remote Sensing — TV-ADMM + gradient` corresponds to the leaderboard entry at

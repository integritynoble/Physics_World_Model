# Ocean Color Remote Sensing — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_color_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ocean Color Remote Sensing — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

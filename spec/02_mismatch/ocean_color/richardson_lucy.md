# Ocean Color Remote Sensing — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_color_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Ocean Color Remote Sensing — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

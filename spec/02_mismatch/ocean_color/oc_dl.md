# Ocean Color Remote Sensing — OC-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('oc_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('oc_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ocean_color_oc_dl_corrected.png'); plt.show()
```

## Benchmark

`Ocean Color Remote Sensing — OC-Net [proxy] + gradient` corresponds to the leaderboard entry at

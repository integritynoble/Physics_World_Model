# Ocean Color Remote Sensing — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_color_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Ocean Color Remote Sensing — RS-Mamba + gradient` corresponds to the leaderboard entry at

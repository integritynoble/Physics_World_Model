# Ocean Color Remote Sensing — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_color_wiener_corrected.png'); plt.show()
```

## Benchmark

`Ocean Color Remote Sensing — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Ocean Color Remote Sensing — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_color_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ocean Color Remote Sensing — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

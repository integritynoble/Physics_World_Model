# Ultrasound B-mode Imaging — Delay-Multiply-and-Sum + Gradient Mismatch Correction
...
cfg = {"c0": float(sos)}
cfg.update({})
x_corrected = run_solver('dmas', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ultrasound_dmas_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — Delay-Multiply-and-Sum + gradient` corresponds to the leaderboard entry at

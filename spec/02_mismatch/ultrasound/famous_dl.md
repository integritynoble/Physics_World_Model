# Ultrasound B-mode Imaging — US-UNet (PnP-PGD DRUNet) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasound_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — US-UNet (PnP-PGD DRUNet) + gradient` corresponds to the leaderboard entry at

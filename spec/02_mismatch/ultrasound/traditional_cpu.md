# Ultrasound B-mode Imaging — DAS (Delay-and-Sum) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasound_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — DAS (Delay-and-Sum) + gradient` corresponds to the leaderboard entry at

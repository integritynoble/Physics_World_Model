# Ultrasound B-mode Imaging — Minimum-Variance Capon Beamformer + Gradient

**CPU**  **Mismatch**: speed of sound `[1400, 1600] m/s`
...
x_wrong = run_solver('mv_capon', y)           # no correction
c0 = ultrasound_calibrate_sos(y)
calib_cfg = {"c0": float(c0)}
x = run_solver('mv_capon', y, cfg=calib_cfg)        # corrected

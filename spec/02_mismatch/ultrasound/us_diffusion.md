# Ultrasound B-mode Imaging — US-Diffusion (PnP-PGD DRUNet) + Gradient
...
x_wrong = run_solver('us_diffusion', y)           # no correction
c0 = ultrasound_calibrate_sos(y)
calib_cfg = {"c0": float(c0)}
x = run_solver('us_diffusion', y, cfg=calib_cfg)        # corrected

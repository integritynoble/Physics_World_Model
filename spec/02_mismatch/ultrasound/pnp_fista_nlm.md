# Ultrasound B-mode Imaging — PnP-FISTA (NLM denoiser) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasound_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — PnP-FISTA (NLM denoiser) + gradient` corresponds to the leaderboard entry at

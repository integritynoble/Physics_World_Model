# Ultrasound B-mode Imaging — Total Variation ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasound_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — Total Variation ADMM + gradient` corresponds to the leaderboard entry at

# Ultrasound B-mode Imaging — PnP-ADMM (NLM denoiser) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasound_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — PnP-ADMM (NLM denoiser) + gradient` corresponds to the leaderboard entry at

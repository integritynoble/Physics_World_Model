# Ultrasound B-mode Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
x_wrong = run_solver('richardson_lucy', y, cfg={})
...
plt.tight_layout(); plt.savefig('ultrasound_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

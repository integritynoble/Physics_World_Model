# Ultrasound B-mode Imaging — DAS + NLM Post-filter + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasound_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — DAS + NLM Post-filter + gradient` corresponds to the leaderboard entry at

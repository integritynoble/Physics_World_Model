# Ultrasound B-mode Imaging — Wiener Filter + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasound_wiener_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — Wiener Filter + gradient` corresponds to the leaderboard entry at

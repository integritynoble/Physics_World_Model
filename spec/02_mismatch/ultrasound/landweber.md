# Ultrasound B-mode Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasound_landweber_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

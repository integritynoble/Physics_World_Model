# Ultrasound B-mode Imaging — Tikhonov Regularisation + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasound_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Ultrasound B-mode Imaging — Tikhonov Regularisation + gradient` corresponds to the leaderboard entry at

# Cryo-EM Single Particle Analysis — Mismatch Correction + Reconstruct

**Input**: particle images (N × H × W, float32)
**Benchmark**: `gs://pwm-benchmark-datasets/datasets/Benchmark/cryo_em/public/`
**Algorithms**: 8 CPU, 9 GPU — reconstruct with `run_solver(key, y)`
...
plt.tight_layout(); plt.savefig('cryo_em_corrected.png'); plt.show()
```

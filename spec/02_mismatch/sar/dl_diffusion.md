# Synthetic Aperture Radar (SAR) — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sar_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Synthetic Aperture Radar (SAR) — RS-Diffusion + gradient` corresponds to the leaderboard entry at

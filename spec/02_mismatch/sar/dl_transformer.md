# Synthetic Aperture Radar (SAR) — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: raw data (range × azimuth, complex64)
...
plt.tight_layout(); plt.savefig('sar_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Synthetic Aperture Radar (SAR) — RS-Transformer + gradient` corresponds to the leaderboard entry at

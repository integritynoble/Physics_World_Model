# Synthetic Aperture Radar (SAR) — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sar_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Synthetic Aperture Radar (SAR) — RS-Mamba + gradient` corresponds to the leaderboard entry at

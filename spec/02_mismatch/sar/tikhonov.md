# Synthetic Aperture Radar (SAR) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sar_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Synthetic Aperture Radar (SAR) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

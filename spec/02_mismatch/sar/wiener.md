# Synthetic Aperture Radar (SAR) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sar_wiener_corrected.png'); plt.show()
```

## Benchmark

`Synthetic Aperture Radar (SAR) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

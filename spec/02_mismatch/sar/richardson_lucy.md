# Synthetic Aperture Radar (SAR) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sar_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Synthetic Aperture Radar (SAR) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

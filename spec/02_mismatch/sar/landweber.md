# Synthetic Aperture Radar (SAR) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sar_landweber_corrected.png'); plt.show()
```

## Benchmark

`Synthetic Aperture Radar (SAR) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

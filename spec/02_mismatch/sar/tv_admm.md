# Synthetic Aperture Radar (SAR) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sar_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Synthetic Aperture Radar (SAR) — TV-ADMM + gradient` corresponds to the leaderboard entry at

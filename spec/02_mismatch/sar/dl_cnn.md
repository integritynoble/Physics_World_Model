# Synthetic Aperture Radar (SAR) — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sar_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Synthetic Aperture Radar (SAR) — RS-CNN + gradient` corresponds to the leaderboard entry at

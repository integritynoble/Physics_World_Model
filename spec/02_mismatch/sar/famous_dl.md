# Synthetic Aperture Radar (SAR) — SAR-CNN [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sar_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Synthetic Aperture Radar (SAR) — SAR-CNN [proxy] + gradient` corresponds to the leaderboard entry at

# Electron Tomography — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — TransCT + gradient` corresponds to the leaderboard entry at

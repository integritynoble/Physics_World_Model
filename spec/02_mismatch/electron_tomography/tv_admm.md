# Electron Tomography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — TV-ADMM + gradient` corresponds to the leaderboard entry at

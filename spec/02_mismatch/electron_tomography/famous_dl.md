# Electron Tomography — SIRT-3D [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — SIRT-3D [proxy] + gradient` corresponds to the leaderboard entry at

# Electron Tomography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Electron Tomography — IMOD-SIRT-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — IMOD-SIRT-DL [proxy] + gradient` corresponds to the leaderboard entry at

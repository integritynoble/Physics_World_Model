# Electron Tomography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

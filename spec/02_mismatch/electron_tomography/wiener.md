# Electron Tomography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_wiener_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

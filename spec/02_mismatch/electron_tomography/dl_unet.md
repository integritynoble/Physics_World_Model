# Electron Tomography — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — U-Net Recon + gradient` corresponds to the leaderboard entry at

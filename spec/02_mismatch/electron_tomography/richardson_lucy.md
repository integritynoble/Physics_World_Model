# Electron Tomography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

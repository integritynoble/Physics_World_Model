# Electron Tomography — MambaRecon + Gradient Mismatch Correction

**Device**: GPU  **Input**: tilt series (angles × H × W, float32)
...
plt.tight_layout(); plt.savefig('electron_tomography_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — MambaRecon + gradient` corresponds to the leaderboard entry at

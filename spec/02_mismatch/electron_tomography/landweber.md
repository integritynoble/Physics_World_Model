# Electron Tomography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_landweber_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

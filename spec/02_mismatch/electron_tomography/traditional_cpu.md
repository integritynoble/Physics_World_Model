# Electron Tomography — FBP (SIRT baseline) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_tomography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Electron Tomography — FBP (SIRT baseline) + gradient` corresponds to the leaderboard entry at

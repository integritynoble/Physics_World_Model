# X-ray Fluorescence (XRF) Imaging — XR-SwinIR + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — XR-SwinIR + gradient` corresponds to the leaderboard entry at

# X-ray Fluorescence (XRF) Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_landweber_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

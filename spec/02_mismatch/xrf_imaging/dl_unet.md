# X-ray Fluorescence (XRF) Imaging — XR-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — XR-UNet + gradient` corresponds to the leaderboard entry at

# X-ray Fluorescence (XRF) Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

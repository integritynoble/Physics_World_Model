# X-ray Fluorescence (XRF) Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_wiener_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

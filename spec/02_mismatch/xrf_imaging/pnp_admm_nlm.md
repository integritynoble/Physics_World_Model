# X-ray Fluorescence (XRF) Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

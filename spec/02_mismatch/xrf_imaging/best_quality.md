# X-ray Fluorescence (XRF) Imaging — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_best_quality_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

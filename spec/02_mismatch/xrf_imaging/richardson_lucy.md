# X-ray Fluorescence (XRF) Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

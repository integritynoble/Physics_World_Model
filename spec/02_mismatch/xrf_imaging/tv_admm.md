# X-ray Fluorescence (XRF) Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

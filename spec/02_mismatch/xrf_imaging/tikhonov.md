# X-ray Fluorescence (XRF) Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

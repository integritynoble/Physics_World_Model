# X-ray Fluorescence (XRF) Imaging — XR-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — XR-Mamba + gradient` corresponds to the leaderboard entry at

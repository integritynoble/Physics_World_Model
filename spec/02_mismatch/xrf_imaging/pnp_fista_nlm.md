# X-ray Fluorescence (XRF) Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_imaging_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence (XRF) Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

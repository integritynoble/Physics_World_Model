# Proton Therapy Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.proton_therapy_img.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('proton_therapy_img_corrected.png'); plt.show()
```

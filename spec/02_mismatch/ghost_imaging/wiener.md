# Ghost Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ghost_imaging_wiener_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Ghost Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ghost_imaging_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

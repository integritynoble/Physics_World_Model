# Ghost Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ghost_imaging_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Ghost Imaging — GI-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('gi_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('gi_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ghost_imaging_gi_dl_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — GI-Net [proxy] + gradient` corresponds to the leaderboard entry at

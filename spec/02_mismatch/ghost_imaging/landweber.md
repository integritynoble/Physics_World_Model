# Ghost Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ghost_imaging_landweber_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

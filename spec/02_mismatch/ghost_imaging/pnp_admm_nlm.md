# Ghost Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ghost_imaging_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

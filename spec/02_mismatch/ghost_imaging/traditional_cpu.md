# Ghost Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ghost_imaging_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

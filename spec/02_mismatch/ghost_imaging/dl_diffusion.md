# Ghost Imaging — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ghost_imaging_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — CS-Diffusion + gradient` corresponds to the leaderboard entry at

# Ghost Imaging — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ghost_imaging_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — Unrolled-Net + gradient` corresponds to the leaderboard entry at

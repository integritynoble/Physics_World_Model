# Ghost Imaging — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: bucket signal (N_patterns, float32)
...
plt.tight_layout(); plt.savefig('ghost_imaging_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — CS-Transformer + gradient` corresponds to the leaderboard entry at

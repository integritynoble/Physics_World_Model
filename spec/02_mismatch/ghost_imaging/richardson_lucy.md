# Ghost Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ghost_imaging_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

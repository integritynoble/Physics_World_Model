# Ghost Imaging — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ghost_imaging_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Ghost Imaging — ReconNet + gradient` corresponds to the leaderboard entry at

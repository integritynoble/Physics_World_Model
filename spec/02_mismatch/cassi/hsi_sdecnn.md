# Coded Aperture Snapshot Spectral Imaging (CASSI) — PnP-HSICNN + Gradient Mismatch Correction
...
x_wrong = run_solver('hsi_sdecnn', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('hsi_sdecnn', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cassi_hsi_sdecnn_corrected.png'); plt.show()
```

## Benchmark

`Coded Aperture Snapshot Spectral Imaging (CASSI) — PnP-HSICNN + gradient` corresponds to the leaderboard entry at

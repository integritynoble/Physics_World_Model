# Coded Aperture Snapshot Spectral Imaging (CASSI) — GAP-Net + Gradient
...
x_wrong = run_solver('gap_net', y)           # no correction
disp = cassi_calibrate_step(y)
calib_cfg = {"disp_step": float(disp)}
x = run_solver('gap_net', y, cfg={**calib_cfg, **{'model_key': 'gap_net'}})        # corrected

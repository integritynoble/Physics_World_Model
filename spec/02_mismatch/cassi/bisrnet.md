# Coded Aperture Snapshot Spectral Imaging (CASSI) — BiSRNet + Gradient
...
x_wrong = run_solver('bisrnet', y)           # no correction
disp = cassi_calibrate_step(y)
calib_cfg = {"disp_step": float(disp)}
x = run_solver('bisrnet', y, cfg={**calib_cfg, **{'model_key': 'bisrnet'}})        # corrected

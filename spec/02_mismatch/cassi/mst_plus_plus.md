# Coded Aperture Snapshot Spectral Imaging (CASSI) — MST++ + Gradient

**GPU**  **PSNR**: ~36.0 dB  **Mismatch**: dispersion step `[1, 5] px`
...
x_wrong = run_solver('mst_plus_plus', y)           # no correction
disp = cassi_calibrate_step(y)
calib_cfg = {"disp_step": float(disp)}
x = run_solver('mst_plus_plus', y, cfg={**calib_cfg, **{'model_key': 'mst_plus_plus'}})        # corrected

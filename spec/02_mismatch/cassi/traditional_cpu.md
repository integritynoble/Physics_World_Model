# Coded Aperture Snapshot Spectral Imaging (CASSI) — GAP-TV + Gradient Mismatch Correction
...
x_wrong = run_solver('traditional_cpu', y, cfg={'iters': 100, 'lam': 0.1, 'tv_iter': 5})
...
cfg.update({'iters': 100, 'lam': 0.1, 'tv_iter': 5})
...
plt.tight_layout(); plt.savefig('cassi_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Coded Aperture Snapshot Spectral Imaging (CASSI) — GAP-TV + gradient` corresponds to the leaderboard entry at

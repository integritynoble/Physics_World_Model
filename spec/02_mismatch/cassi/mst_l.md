# Coded Aperture Snapshot Spectral Imaging (CASSI) — MST-L + Gradient Mismatch Correction
...
x_wrong = run_solver('mst_l', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('mst_l', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cassi_mst_l_corrected.png'); plt.show()
```

## Benchmark

`Coded Aperture Snapshot Spectral Imaging (CASSI) — MST-L + gradient` corresponds to the leaderboard entry at

# Coded Aperture Snapshot Spectral Imaging (CASSI) — PADUT-3stg + Gradient Mismatch Correction
...
x_wrong = run_solver('padut_3stg', y, cfg={'model_key': 'padut_3stg'})
...
cfg.update({'model_key': 'padut_3stg'})
x_corrected = run_solver('padut_3stg', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cassi_padut_3stg_corrected.png'); plt.show()
```

## Benchmark

`Coded Aperture Snapshot Spectral Imaging (CASSI) — PADUT-3stg + gradient` corresponds to the leaderboard entry at

# Coded Aperture Snapshot Spectral Imaging (CASSI) — PADUT-3stg + Gradient

**GPU**  **PSNR**: ~36.95 dB  **Mismatch**: dispersion step `[1, 5] px`
...
x_wrong = run_solver('padut_3stg', y)           # no correction
disp = cassi_calibrate_step(y)
calib_cfg = {"disp_step": float(disp)}
x = run_solver('padut_3stg', y, cfg={**calib_cfg, **{'model_key': 'padut_3stg'}})        # corrected

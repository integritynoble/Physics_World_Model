# Coded Aperture Snapshot Spectral Imaging (CASSI) — GAP-TV (200 iter) + Gradient

**CPU**  **PSNR**: ~24.9 dB  **Mismatch**: dispersion step `[1, 5] px`
...
x = run_solver('best_quality', y, cfg={**calib_cfg, **{'iters': 200, 'lam': 0.01, 'tv_iter': 5}})        # corrected

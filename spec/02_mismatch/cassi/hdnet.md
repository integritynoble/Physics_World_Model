# Coded Aperture Snapshot Spectral Imaging (CASSI) — HDNet + Gradient Mismatch Correction
...
x_wrong = run_solver('hdnet', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('hdnet', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cassi_hdnet_corrected.png'); plt.show()
```

## Benchmark

`Coded Aperture Snapshot Spectral Imaging (CASSI) — HDNet + gradient` corresponds to the leaderboard entry at

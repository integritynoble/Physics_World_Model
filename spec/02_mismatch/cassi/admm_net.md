# Coded Aperture Snapshot Spectral Imaging (CASSI) — ADMM-Net + Gradient

**GPU**  **PSNR**: ~29.1 dB  **Mismatch**: dispersion step `[1, 5] px`
...
x_wrong = run_solver('admm_net', y)           # no correction
disp = cassi_calibrate_step(y)
calib_cfg = {"disp_step": float(disp)}
x = run_solver('admm_net', y, cfg={**calib_cfg, **{'model_key': 'admm_net'}})        # corrected

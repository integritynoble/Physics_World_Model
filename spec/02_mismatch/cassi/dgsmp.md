# Coded Aperture Snapshot Spectral Imaging (CASSI) — DGSMP + Gradient

**GPU**  **PSNR**: ~32.6 dB  **Mismatch**: dispersion step `[1, 5] px`
...
x_wrong = run_solver('dgsmp', y)           # no correction
disp = cassi_calibrate_step(y)
calib_cfg = {"disp_step": float(disp)}
x = run_solver('dgsmp', y, cfg={**calib_cfg, **{'model_key': 'dgsmp'}})        # corrected

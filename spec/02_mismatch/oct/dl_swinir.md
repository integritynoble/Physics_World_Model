# Optical Coherence Tomography (OCT) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('oct_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Optical Coherence Tomography (OCT) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

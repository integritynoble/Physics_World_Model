# Optical Coherence Tomography (OCT) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('oct_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Optical Coherence Tomography (OCT) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

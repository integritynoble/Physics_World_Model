# Optical Coherence Tomography (OCT) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('oct_landweber_corrected.png'); plt.show()
```

## Benchmark

`Optical Coherence Tomography (OCT) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

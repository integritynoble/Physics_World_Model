# Optical Coherence Tomography (OCT) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('oct_wiener_corrected.png'); plt.show()
```

## Benchmark

`Optical Coherence Tomography (OCT) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Optical Coherence Tomography (OCT) — OCT Denoising Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('oct_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Optical Coherence Tomography (OCT) — OCT Denoising Net + gradient` corresponds to the leaderboard entry at

# Optical Coherence Tomography (OCT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('oct_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Optical Coherence Tomography (OCT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

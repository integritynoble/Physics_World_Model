# Optical Coherence Tomography (OCT) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('oct_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Optical Coherence Tomography (OCT) — Med-UNet + gradient` corresponds to the leaderboard entry at

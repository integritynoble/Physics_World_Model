# Optical Coherence Tomography (OCT) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('oct_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Optical Coherence Tomography (OCT) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

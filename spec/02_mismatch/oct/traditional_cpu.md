# Optical Coherence Tomography (OCT) — FFT Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('oct_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Optical Coherence Tomography (OCT) — FFT Recon + gradient` corresponds to the leaderboard entry at

# Optical Coherence Tomography (OCT) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('oct_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Optical Coherence Tomography (OCT) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

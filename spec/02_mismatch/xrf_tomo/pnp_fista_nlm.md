# X-ray Fluorescence Tomography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

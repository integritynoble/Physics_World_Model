# X-ray Fluorescence Tomography — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_best_quality_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

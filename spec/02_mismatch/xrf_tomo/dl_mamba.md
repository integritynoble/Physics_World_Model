# X-ray Fluorescence Tomography — MambaRecon + Gradient Mismatch Correction

**Device**: GPU  **Input**: XRF sinograms (elem × angles × det, float32)
...
plt.tight_layout(); plt.savefig('xrf_tomo_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — MambaRecon + gradient` corresponds to the leaderboard entry at

# X-ray Fluorescence Tomography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

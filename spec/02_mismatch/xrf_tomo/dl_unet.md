# X-ray Fluorescence Tomography — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — U-Net Recon + gradient` corresponds to the leaderboard entry at

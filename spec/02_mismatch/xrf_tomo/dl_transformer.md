# X-ray Fluorescence Tomography — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — TransCT + gradient` corresponds to the leaderboard entry at

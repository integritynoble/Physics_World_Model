# X-ray Fluorescence Tomography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

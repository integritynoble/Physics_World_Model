# X-ray Fluorescence Tomography — XRFT-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('xrft_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('xrft_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('xrf_tomo_xrft_dl_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — XRFT-Net [proxy] + gradient` corresponds to the leaderboard entry at

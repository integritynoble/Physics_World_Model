# X-ray Fluorescence Tomography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_wiener_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

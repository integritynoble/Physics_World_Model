# X-ray Fluorescence Tomography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — TV-ADMM + gradient` corresponds to the leaderboard entry at

# X-ray Fluorescence Tomography — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — DiffusionRecon + gradient` corresponds to the leaderboard entry at

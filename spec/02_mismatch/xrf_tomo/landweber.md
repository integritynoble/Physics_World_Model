# X-ray Fluorescence Tomography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_landweber_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

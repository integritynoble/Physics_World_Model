# X-ray Fluorescence Tomography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

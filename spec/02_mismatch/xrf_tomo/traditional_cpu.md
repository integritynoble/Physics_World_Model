# X-ray Fluorescence Tomography — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xrf_tomo_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`X-ray Fluorescence Tomography — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

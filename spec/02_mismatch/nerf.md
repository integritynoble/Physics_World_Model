# Neural Radiance Fields (NeRF) — Mismatch Correction + Reconstruct

**Input**: posed images (N × H × W × 3, float32)
**Benchmark**: `gs://pwm-benchmark-datasets/datasets/Benchmark/nerf/public/`
**Algorithms**: 5 CPU, 1 GPU — reconstruct with `run_solver(key, y)`
...
plt.tight_layout(); plt.savefig('nerf_corrected.png'); plt.show()
```

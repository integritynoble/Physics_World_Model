# Brillouin Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brillouin_landweber_corrected.png'); plt.show()
```

## Benchmark

`Brillouin Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

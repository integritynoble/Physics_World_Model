# Brillouin Microscopy — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: spectral shift map (H × W, float32)
...
plt.tight_layout(); plt.savefig('brillouin_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Brillouin Microscopy — Spec-Transformer + gradient` corresponds to the leaderboard entry at

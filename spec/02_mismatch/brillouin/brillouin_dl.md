# Brillouin Microscopy — Brillouin-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('brillouin_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('brillouin_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('brillouin_brillouin_dl_corrected.png'); plt.show()
```

## Benchmark

`Brillouin Microscopy — Brillouin-Net [proxy] + gradient` corresponds to the leaderboard entry at

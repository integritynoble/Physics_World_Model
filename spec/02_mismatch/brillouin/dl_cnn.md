# Brillouin Microscopy — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brillouin_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Brillouin Microscopy — Spec-CNN + gradient` corresponds to the leaderboard entry at

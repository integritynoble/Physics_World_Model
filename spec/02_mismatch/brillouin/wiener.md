# Brillouin Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brillouin_wiener_corrected.png'); plt.show()
```

## Benchmark

`Brillouin Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

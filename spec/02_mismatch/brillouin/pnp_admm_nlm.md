# Brillouin Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brillouin_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Brillouin Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

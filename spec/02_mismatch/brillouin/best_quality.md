# Brillouin Microscopy — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brillouin_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Brillouin Microscopy — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Brillouin Microscopy — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brillouin_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Brillouin Microscopy — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

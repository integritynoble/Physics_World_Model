# Brillouin Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brillouin_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Brillouin Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Brillouin Microscopy — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('brillouin_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`Brillouin Microscopy — Spec-AE + gradient` corresponds to the leaderboard entry at

# Lucky Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lucky_imaging_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Lucky Imaging — DL-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lucky_imaging_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — DL-UNet + gradient` corresponds to the leaderboard entry at

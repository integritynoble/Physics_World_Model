# Lucky Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lucky_imaging_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

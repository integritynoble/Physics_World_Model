# Lucky Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lucky_imaging_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

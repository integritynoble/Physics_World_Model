# Lucky Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lucky_imaging_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Lucky Imaging — Lucky-DL [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('lucky_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('lucky_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lucky_imaging_lucky_dl_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — Lucky-DL [proxy] + gradient` corresponds to the leaderboard entry at

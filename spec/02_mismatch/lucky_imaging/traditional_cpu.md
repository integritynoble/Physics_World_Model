# Lucky Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lucky_imaging_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

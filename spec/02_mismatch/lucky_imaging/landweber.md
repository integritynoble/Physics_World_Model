# Lucky Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lucky_imaging_landweber_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

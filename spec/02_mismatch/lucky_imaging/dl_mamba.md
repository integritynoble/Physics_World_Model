# Lucky Imaging — DL-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lucky_imaging_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — DL-Mamba + gradient` corresponds to the leaderboard entry at

# Lucky Imaging — DL-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: speckle frames (N × H × W, float32)
...
plt.tight_layout(); plt.savefig('lucky_imaging_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — DL-Transformer + gradient` corresponds to the leaderboard entry at

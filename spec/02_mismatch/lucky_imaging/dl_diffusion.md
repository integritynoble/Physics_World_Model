# Lucky Imaging — DL-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lucky_imaging_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — DL-Diffusion + gradient` corresponds to the leaderboard entry at

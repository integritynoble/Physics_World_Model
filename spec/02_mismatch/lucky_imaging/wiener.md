# Lucky Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lucky_imaging_wiener_corrected.png'); plt.show()
```

## Benchmark

`Lucky Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

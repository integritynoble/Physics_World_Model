# Fiber Bundle Endoscopy — EndoMapper-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — EndoMapper-Net + gradient` corresponds to the leaderboard entry at

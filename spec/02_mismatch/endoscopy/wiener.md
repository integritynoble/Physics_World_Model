# Fiber Bundle Endoscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_wiener_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

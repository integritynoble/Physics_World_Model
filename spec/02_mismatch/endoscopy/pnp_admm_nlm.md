# Fiber Bundle Endoscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

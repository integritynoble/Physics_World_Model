# Fiber Bundle Endoscopy — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — Med-UNet + gradient` corresponds to the leaderboard entry at

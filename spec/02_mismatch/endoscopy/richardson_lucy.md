# Fiber Bundle Endoscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

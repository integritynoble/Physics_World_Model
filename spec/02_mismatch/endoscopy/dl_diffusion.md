# Fiber Bundle Endoscopy — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: image (H × W × 3, uint8)
...
plt.tight_layout(); plt.savefig('endoscopy_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — DiffusionMed + gradient` corresponds to the leaderboard entry at

# Fiber Bundle Endoscopy — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — SwinIR-Med + gradient` corresponds to the leaderboard entry at

# Fiber Bundle Endoscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

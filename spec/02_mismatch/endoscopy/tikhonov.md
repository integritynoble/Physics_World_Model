# Fiber Bundle Endoscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

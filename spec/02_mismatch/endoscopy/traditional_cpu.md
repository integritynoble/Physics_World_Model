# Fiber Bundle Endoscopy — FISTA-L2 (endoscopy) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — FISTA-L2 (endoscopy) + gradient` corresponds to the leaderboard entry at

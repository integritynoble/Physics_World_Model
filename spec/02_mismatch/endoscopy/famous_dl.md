# Fiber Bundle Endoscopy — AF-SfMLearner + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — AF-SfMLearner + gradient` corresponds to the leaderboard entry at

# Fiber Bundle Endoscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

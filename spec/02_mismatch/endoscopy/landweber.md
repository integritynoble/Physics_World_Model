# Fiber Bundle Endoscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_landweber_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

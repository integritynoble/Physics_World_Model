# Fiber Bundle Endoscopy — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('endoscopy_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — MedMamba + gradient` corresponds to the leaderboard entry at

# Fiber Bundle Endoscopy — Chambolle-Pock + Gradient Mismatch Correction
...
import h5py
with h5py.File('endoscopy_public.h5', 'r') as f:   # GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/endoscopy/public/
...
plt.tight_layout(); plt.savefig('endoscopy_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Fiber Bundle Endoscopy — Chambolle-Pock + gradient` corresponds to the leaderboard entry at
`https://pwm.platformai.org/benchmark/endoscopy` (mismatch correction tier).

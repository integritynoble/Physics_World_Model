# Raman Imaging / Microscopy — RamanNet [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('raman_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('raman_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('raman_imaging_raman_dl_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — RamanNet [proxy] + gradient` corresponds to the leaderboard entry at

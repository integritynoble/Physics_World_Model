# Raman Imaging / Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_landweber_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Raman Imaging / Microscopy — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

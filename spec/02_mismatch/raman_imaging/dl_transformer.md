# Raman Imaging / Microscopy — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: Raman spectra (H × W × wn, float32)
...
plt.tight_layout(); plt.savefig('raman_imaging_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — Spec-Transformer + gradient` corresponds to the leaderboard entry at

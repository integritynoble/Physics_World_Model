# Raman Imaging / Microscopy — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — Spec-CNN + gradient` corresponds to the leaderboard entry at

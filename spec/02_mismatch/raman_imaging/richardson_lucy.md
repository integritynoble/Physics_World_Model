# Raman Imaging / Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

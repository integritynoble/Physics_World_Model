# Raman Imaging / Microscopy — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Raman Imaging / Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

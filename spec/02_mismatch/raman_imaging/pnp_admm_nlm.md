# Raman Imaging / Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

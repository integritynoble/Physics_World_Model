# Raman Imaging / Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

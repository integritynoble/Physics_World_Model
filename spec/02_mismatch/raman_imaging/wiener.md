# Raman Imaging / Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_wiener_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

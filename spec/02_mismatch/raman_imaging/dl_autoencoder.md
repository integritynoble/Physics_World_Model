# Raman Imaging / Microscopy — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — Spec-AE + gradient` corresponds to the leaderboard entry at

# Raman Imaging / Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

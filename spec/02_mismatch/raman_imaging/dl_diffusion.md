# Raman Imaging / Microscopy — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('raman_imaging_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Raman Imaging / Microscopy — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

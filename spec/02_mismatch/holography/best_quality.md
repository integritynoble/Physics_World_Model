# Digital Holographic Microscopy — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('holography_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — PhaseNet + gradient` corresponds to the leaderboard entry at

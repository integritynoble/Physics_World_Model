# Digital Holographic Microscopy — HoloNet + Gradient Mismatch Correction
...
x_wrong = run_solver('holonet', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('holonet', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_holonet_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — HoloNet + gradient` corresponds to the leaderboard entry at

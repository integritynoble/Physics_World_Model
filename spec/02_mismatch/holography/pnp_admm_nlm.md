# Digital Holographic Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('holography_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Digital Holographic Microscopy — RAAR + Gradient Mismatch Correction
...
cfg.update({})
x_corrected = run_solver('raar', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_raar_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — RAAR + gradient` corresponds to the leaderboard entry at

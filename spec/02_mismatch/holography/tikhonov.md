# Digital Holographic Microscopy — Tikhonov Regularisation + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('holography_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — Tikhonov Regularisation + gradient` corresponds to the leaderboard entry at

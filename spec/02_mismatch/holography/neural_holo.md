# Digital Holographic Microscopy — NeuralHolo + Gradient Mismatch Correction
...
x_wrong = run_solver('neural_holo', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('neural_holo', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_neural_holo_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — NeuralHolo + gradient` corresponds to the leaderboard entry at

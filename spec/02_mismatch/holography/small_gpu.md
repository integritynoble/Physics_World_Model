# Digital Holographic Microscopy — PhaseGAN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('holography_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — PhaseGAN + gradient` corresponds to the leaderboard entry at

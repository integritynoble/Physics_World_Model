# Digital Holographic Microscopy — TV-Phase Retrieval + Gradient Mismatch Correction
...
x_wrong = run_solver('tv_phase', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('tv_phase', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_tv_phase_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — TV-Phase Retrieval + gradient` corresponds to the leaderboard entry at

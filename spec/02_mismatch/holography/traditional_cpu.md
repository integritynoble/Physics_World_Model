# Digital Holographic Microscopy — Angular Spectrum Method + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('holography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — Angular Spectrum Method + gradient` corresponds to the leaderboard entry at

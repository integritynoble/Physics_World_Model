# Digital Holographic Microscopy — DeepDIH + Gradient Mismatch Correction
...
x_wrong = run_solver('deep_dih', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('deep_dih', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_deep_dih_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — DeepDIH + gradient` corresponds to the leaderboard entry at

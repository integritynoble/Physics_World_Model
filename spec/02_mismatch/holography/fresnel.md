# Digital Holographic Microscopy — Fresnel Propagation + Gradient Mismatch Correction
...
x_wrong = run_solver('fresnel', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('fresnel', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_fresnel_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — Fresnel Propagation + gradient` corresponds to the leaderboard entry at

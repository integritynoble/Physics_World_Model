# Digital Holographic Microscopy — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('holography_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — prDeep + gradient` corresponds to the leaderboard entry at

# Digital Holographic Microscopy — Error Reduction + Gradient Mismatch Correction
...
x_wrong = run_solver('error_reduction', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('error_reduction', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_error_reduction_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — Error Reduction + gradient` corresponds to the leaderboard entry at

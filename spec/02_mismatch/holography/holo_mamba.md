# Digital Holographic Microscopy — HoloMamba + Gradient Mismatch Correction
...
x_wrong = run_solver('holo_mamba', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('holo_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_holo_mamba_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — HoloMamba + gradient` corresponds to the leaderboard entry at

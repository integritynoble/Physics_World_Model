# Digital Holographic Microscopy — HoloDiffusion + Gradient Mismatch Correction
...
x_wrong = run_solver('holo_diffusion', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('holo_diffusion', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_holo_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Digital Holographic Microscopy — HoloDiffusion + gradient` corresponds to the leaderboard entry at

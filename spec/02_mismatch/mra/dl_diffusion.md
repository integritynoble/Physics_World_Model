# MR Angiography (MRA) — DiffusionMed + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — DiffusionMed + gradient` corresponds to the leaderboard entry at

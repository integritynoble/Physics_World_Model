# MR Angiography (MRA) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — TV-ADMM + gradient` corresponds to the leaderboard entry at

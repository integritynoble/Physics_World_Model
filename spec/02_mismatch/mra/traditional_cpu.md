# MR Angiography (MRA) — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — FBP [proxy] + gradient` corresponds to the leaderboard entry at

# MR Angiography (MRA) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

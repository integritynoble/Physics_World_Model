# MR Angiography (MRA) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_wiener_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

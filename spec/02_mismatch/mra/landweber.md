# MR Angiography (MRA) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_landweber_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

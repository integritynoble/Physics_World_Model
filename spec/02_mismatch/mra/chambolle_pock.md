# MR Angiography (MRA) — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: k-space (kx × ky × kz, complex64)
...
plt.tight_layout(); plt.savefig('mra_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

# MR Angiography (MRA) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# MR Angiography (MRA) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

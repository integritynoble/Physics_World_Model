# MR Angiography (MRA) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — MedMamba + gradient` corresponds to the leaderboard entry at

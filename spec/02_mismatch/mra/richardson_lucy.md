# MR Angiography (MRA) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

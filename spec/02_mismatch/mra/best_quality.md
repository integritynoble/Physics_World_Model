# MR Angiography (MRA) — DL-Recon [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_best_quality_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — DL-Recon [proxy] + gradient` corresponds to the leaderboard entry at

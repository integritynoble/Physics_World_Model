# MR Angiography (MRA) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mra_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`MR Angiography (MRA) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

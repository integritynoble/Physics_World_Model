# Ultrasonic Phased Array (TFM/FMC) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Ultrasonic Phased Array (TFM/FMC) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

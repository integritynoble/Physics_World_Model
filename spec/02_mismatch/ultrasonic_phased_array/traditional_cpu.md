# Ultrasonic Phased Array (TFM/FMC) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Ultrasonic Phased Array (TFM/FMC) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

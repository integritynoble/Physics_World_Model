# Ultrasonic Phased Array (TFM/FMC) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Ultrasonic Phased Array (TFM/FMC) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

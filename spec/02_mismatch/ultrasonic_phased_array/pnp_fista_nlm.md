# Ultrasonic Phased Array (TFM/FMC) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ultrasonic Phased Array (TFM/FMC) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

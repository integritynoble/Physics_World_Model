# Ultrasonic Phased Array (TFM/FMC) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ultrasonic Phased Array (TFM/FMC) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

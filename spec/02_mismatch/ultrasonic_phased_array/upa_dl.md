# Ultrasonic Phased Array (TFM/FMC) — TFM-DL [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('upa_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('upa_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_upa_dl_corrected.png'); plt.show()
```

## Benchmark

`Ultrasonic Phased Array (TFM/FMC) — TFM-DL [proxy] + gradient` corresponds to the leaderboard entry at

# Ultrasonic Phased Array (TFM/FMC) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Ultrasonic Phased Array (TFM/FMC) — Med-UNet + gradient` corresponds to the leaderboard entry at

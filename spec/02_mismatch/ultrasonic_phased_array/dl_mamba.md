# Ultrasonic Phased Array (TFM/FMC) — MedMamba + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_mamba', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Ultrasonic Phased Array (TFM/FMC) — MedMamba + gradient` corresponds to the leaderboard entry at

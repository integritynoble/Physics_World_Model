# Ultrasonic Phased Array (TFM/FMC) — SwinIR-Med + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_swinir', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_swinir', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Ultrasonic Phased Array (TFM/FMC) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

# Ultrasonic Phased Array (TFM/FMC) — Landweber Iteration + Gradient Mismatch Correction
...
x_wrong = run_solver('landweber', y, cfg={'iters': 50, 'step': 0.5})
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_landweber_corrected.png'); plt.show()
```

## Benchmark

`Ultrasonic Phased Array (TFM/FMC) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

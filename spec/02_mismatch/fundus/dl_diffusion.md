# Fundus Camera — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: photograph (H × W × 3, uint8)
...
plt.tight_layout(); plt.savefig('fundus_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — DiffusionMed + gradient` corresponds to the leaderboard entry at

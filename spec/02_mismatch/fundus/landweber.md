# Fundus Camera — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_landweber_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — Landweber Iteration + gradient` corresponds to the leaderboard entry at

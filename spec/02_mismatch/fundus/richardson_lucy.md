# Fundus Camera — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

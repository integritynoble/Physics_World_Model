# Fundus Camera — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — MedMamba + gradient` corresponds to the leaderboard entry at

# Fundus Camera — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — Med-UNet + gradient` corresponds to the leaderboard entry at

# Fundus Camera — DR-Grade-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — DR-Grade-Net + gradient` corresponds to the leaderboard entry at

# Fundus Camera — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — SwinIR-Med + gradient` corresponds to the leaderboard entry at

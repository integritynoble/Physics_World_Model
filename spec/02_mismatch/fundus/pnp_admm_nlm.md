# Fundus Camera — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

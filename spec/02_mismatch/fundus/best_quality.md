# Fundus Camera — RETFound + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — RETFound + gradient` corresponds to the leaderboard entry at

# Fundus Camera — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_wiener_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Fundus Camera — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — TV-ADMM + gradient` corresponds to the leaderboard entry at

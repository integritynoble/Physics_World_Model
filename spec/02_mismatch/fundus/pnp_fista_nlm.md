# Fundus Camera — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

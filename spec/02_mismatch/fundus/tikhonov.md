# Fundus Camera — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fundus_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Fundus Camera — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

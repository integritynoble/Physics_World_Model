# Diffuse Optical Tomography (DOT) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dot_landweber_corrected.png'); plt.show()
```

## Benchmark

`Diffuse Optical Tomography (DOT) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Diffuse Optical Tomography (DOT) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dot_wiener_corrected.png'); plt.show()
```

## Benchmark

`Diffuse Optical Tomography (DOT) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

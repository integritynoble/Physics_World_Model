# Diffuse Optical Tomography (DOT) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dot_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Diffuse Optical Tomography (DOT) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Diffuse Optical Tomography (DOT) — L-BFGS-TV [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dot_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Diffuse Optical Tomography (DOT) — L-BFGS-TV [proxy] + gradient` corresponds to the leaderboard entry at

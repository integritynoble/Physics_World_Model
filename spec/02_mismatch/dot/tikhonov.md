# Diffuse Optical Tomography (DOT) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dot_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Diffuse Optical Tomography (DOT) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

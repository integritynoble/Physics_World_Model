# Diffuse Optical Tomography (DOT) — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dot_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Diffuse Optical Tomography (DOT) — DiffusionRecon + gradient` corresponds to the leaderboard entry at

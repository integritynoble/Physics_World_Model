# Diffuse Optical Tomography (DOT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dot_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Diffuse Optical Tomography (DOT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

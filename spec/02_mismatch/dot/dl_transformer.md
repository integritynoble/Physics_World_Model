# Diffuse Optical Tomography (DOT) — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dot_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Diffuse Optical Tomography (DOT) — TransCT + gradient` corresponds to the leaderboard entry at

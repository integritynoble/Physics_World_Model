# Diffuse Optical Tomography (DOT) — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dot_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Diffuse Optical Tomography (DOT) — U-Net Recon + gradient` corresponds to the leaderboard entry at

# Diffuse Optical Tomography (DOT) — Born Approximation + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dot_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Diffuse Optical Tomography (DOT) — Born Approximation + gradient` corresponds to the leaderboard entry at

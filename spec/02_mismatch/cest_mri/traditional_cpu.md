# CEST MRI — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cest_mri_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`CEST MRI — FBP [proxy] + gradient` corresponds to the leaderboard entry at

# CEST MRI — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: Z-spectrum (offsets × H × W, float32)
...
plt.tight_layout(); plt.savefig('cest_mri_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`CEST MRI — DiffusionMed + gradient` corresponds to the leaderboard entry at

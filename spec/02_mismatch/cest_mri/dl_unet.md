# CEST MRI — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cest_mri_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`CEST MRI — Med-UNet + gradient` corresponds to the leaderboard entry at

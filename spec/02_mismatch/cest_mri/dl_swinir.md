# CEST MRI — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cest_mri_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`CEST MRI — SwinIR-Med + gradient` corresponds to the leaderboard entry at

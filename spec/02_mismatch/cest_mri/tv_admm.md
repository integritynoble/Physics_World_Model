# CEST MRI — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cest_mri_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`CEST MRI — TV-ADMM + gradient` corresponds to the leaderboard entry at

# CEST MRI — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cest_mri_wiener_corrected.png'); plt.show()
```

## Benchmark

`CEST MRI — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

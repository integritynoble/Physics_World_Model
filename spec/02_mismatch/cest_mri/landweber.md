# CEST MRI — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cest_mri_landweber_corrected.png'); plt.show()
```

## Benchmark

`CEST MRI — Landweber Iteration + gradient` corresponds to the leaderboard entry at

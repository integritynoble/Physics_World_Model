# CEST MRI — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cest_mri_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`CEST MRI — MedMamba + gradient` corresponds to the leaderboard entry at

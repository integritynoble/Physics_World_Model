# CEST MRI — CEST-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('cest_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('cest_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cest_mri_cest_dl_corrected.png'); plt.show()
```

## Benchmark

`CEST MRI — CEST-Net [proxy] + gradient` corresponds to the leaderboard entry at

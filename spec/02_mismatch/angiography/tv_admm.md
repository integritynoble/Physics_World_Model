# X-ray Angiography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — TV-ADMM + gradient` corresponds to the leaderboard entry at

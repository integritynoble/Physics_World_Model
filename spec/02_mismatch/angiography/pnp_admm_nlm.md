# X-ray Angiography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# X-ray Angiography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_wiener_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# X-ray Angiography — FBP (DSA baseline) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — FBP (DSA baseline) + gradient` corresponds to the leaderboard entry at

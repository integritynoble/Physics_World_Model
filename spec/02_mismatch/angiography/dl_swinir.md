# X-ray Angiography — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — SwinIR-Med + gradient` corresponds to the leaderboard entry at

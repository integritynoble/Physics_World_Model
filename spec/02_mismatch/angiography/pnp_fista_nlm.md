# X-ray Angiography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

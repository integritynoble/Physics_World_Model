# X-ray Angiography — DSA-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_best_quality_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — DSA-Net [proxy] + gradient` corresponds to the leaderboard entry at

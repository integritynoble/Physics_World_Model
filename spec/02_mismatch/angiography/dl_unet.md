# X-ray Angiography — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — Med-UNet + gradient` corresponds to the leaderboard entry at

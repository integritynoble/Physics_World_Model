# X-ray Angiography — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — MedMamba + gradient` corresponds to the leaderboard entry at

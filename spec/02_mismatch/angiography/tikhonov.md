# X-ray Angiography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

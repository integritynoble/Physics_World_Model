# X-ray Angiography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_landweber_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# X-ray Angiography — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: projection (H × W, float32)
...
plt.tight_layout(); plt.savefig('angiography_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — DiffusionMed + gradient` corresponds to the leaderboard entry at

# X-ray Angiography — VesselSegNet [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('angiography_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`X-ray Angiography — VesselSegNet [proxy] + gradient` corresponds to the leaderboard entry at

# PET/MR Fusion — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_mr_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`PET/MR Fusion — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

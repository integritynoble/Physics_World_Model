# PET/MR Fusion — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_mr_best_quality_corrected.png'); plt.show()
```

## Benchmark

`PET/MR Fusion — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

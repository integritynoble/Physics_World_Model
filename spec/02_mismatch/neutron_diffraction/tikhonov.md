# Neutron Diffraction — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Neutron Diffraction — 3D-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_dl_3dcnn_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — 3D-CNN + gradient` corresponds to the leaderboard entry at

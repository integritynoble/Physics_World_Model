# Neutron Diffraction — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

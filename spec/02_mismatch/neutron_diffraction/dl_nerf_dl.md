# Neutron Diffraction — NeRF-DL + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_dl_nerf_dl_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — NeRF-DL + gradient` corresponds to the leaderboard entry at

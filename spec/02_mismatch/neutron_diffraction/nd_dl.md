# Neutron Diffraction — NeutronDiff-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('nd_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('nd_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('neutron_diffraction_nd_dl_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — NeutronDiff-Net [proxy] + gradient` corresponds to the leaderboard entry at

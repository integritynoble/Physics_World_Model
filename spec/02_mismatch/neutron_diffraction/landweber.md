# Neutron Diffraction — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_landweber_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Neutron Diffraction — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — TV-ADMM + gradient` corresponds to the leaderboard entry at

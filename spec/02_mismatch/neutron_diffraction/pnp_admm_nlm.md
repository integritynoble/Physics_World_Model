# Neutron Diffraction — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

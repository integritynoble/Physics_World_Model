# Neutron Diffraction — 3D-Diffusion + Gradient Mismatch Correction

**Device**: GPU  **Input**: pattern (2θ × intensity, float32)
...
plt.tight_layout(); plt.savefig('neutron_diffraction_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — 3D-Diffusion + gradient` corresponds to the leaderboard entry at

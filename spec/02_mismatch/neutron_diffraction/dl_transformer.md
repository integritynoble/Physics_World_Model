# Neutron Diffraction — 3D-Transformer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — 3D-Transformer + gradient` corresponds to the leaderboard entry at

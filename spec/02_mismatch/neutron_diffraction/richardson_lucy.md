# Neutron Diffraction — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Neutron Diffraction — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

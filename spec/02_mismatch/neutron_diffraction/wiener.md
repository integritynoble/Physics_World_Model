# Neutron Diffraction — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_diffraction_wiener_corrected.png'); plt.show()
```

## Benchmark

`Neutron Diffraction — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

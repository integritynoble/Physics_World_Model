# Ground-Penetrating Radar (GPR) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

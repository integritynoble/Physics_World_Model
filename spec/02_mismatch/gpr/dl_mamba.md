# Ground-Penetrating Radar (GPR) — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — RS-Mamba + gradient` corresponds to the leaderboard entry at

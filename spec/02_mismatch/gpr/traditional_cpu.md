# Ground-Penetrating Radar (GPR) — RDA [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — RDA [proxy] + gradient` corresponds to the leaderboard entry at

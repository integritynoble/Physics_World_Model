# Ground-Penetrating Radar (GPR) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_landweber_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Ground-Penetrating Radar (GPR) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_wiener_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

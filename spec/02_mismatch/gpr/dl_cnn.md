# Ground-Penetrating Radar (GPR) — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — RS-CNN + gradient` corresponds to the leaderboard entry at

# Ground-Penetrating Radar (GPR) — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — RS-Diffusion + gradient` corresponds to the leaderboard entry at

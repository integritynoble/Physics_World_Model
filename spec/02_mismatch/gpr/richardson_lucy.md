# Ground-Penetrating Radar (GPR) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

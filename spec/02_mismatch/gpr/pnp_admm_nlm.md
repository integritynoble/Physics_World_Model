# Ground-Penetrating Radar (GPR) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

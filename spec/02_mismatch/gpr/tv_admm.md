# Ground-Penetrating Radar (GPR) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — TV-ADMM + gradient` corresponds to the leaderboard entry at

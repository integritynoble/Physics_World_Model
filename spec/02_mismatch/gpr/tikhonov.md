# Ground-Penetrating Radar (GPR) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

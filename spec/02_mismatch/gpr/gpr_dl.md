# Ground-Penetrating Radar (GPR) — GPR-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('gpr_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('gpr_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('gpr_gpr_dl_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — GPR-Net [proxy] + gradient` corresponds to the leaderboard entry at

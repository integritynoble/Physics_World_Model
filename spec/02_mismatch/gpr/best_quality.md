# Ground-Penetrating Radar (GPR) — SAR-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gpr_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Ground-Penetrating Radar (GPR) — SAR-DL [proxy] + gradient` corresponds to the leaderboard entry at

# MR Fingerprinting (MRF) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_fingerprinting_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`MR Fingerprinting (MRF) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

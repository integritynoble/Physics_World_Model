# MR Fingerprinting (MRF) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_fingerprinting_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`MR Fingerprinting (MRF) — MedMamba + gradient` corresponds to the leaderboard entry at

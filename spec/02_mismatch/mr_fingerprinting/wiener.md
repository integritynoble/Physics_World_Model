# MR Fingerprinting (MRF) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_fingerprinting_wiener_corrected.png'); plt.show()
```

## Benchmark

`MR Fingerprinting (MRF) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

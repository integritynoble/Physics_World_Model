# MR Fingerprinting (MRF) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_fingerprinting_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`MR Fingerprinting (MRF) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# MR Fingerprinting (MRF) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_fingerprinting_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`MR Fingerprinting (MRF) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

# MR Fingerprinting (MRF) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_fingerprinting_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`MR Fingerprinting (MRF) — TV-ADMM + gradient` corresponds to the leaderboard entry at

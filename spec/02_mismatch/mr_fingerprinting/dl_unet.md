# MR Fingerprinting (MRF) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_fingerprinting_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`MR Fingerprinting (MRF) — Med-UNet + gradient` corresponds to the leaderboard entry at

# MR Fingerprinting (MRF) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_fingerprinting_landweber_corrected.png'); plt.show()
```

## Benchmark

`MR Fingerprinting (MRF) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

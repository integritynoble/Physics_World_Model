# Atom Probe Tomography (APT) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

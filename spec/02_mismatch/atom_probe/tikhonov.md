# Atom Probe Tomography (APT) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

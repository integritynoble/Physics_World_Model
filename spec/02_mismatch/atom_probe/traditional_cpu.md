# Atom Probe Tomography (APT) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

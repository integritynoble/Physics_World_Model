# Atom Probe Tomography (APT) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

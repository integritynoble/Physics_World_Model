# Atom Probe Tomography (APT) — 3D-Transformer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — 3D-Transformer + gradient` corresponds to the leaderboard entry at

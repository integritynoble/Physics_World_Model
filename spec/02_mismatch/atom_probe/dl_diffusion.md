# Atom Probe Tomography (APT) — 3D-Diffusion + Gradient Mismatch Correction

**Device**: GPU  **Input**: hit positions (N × 3, float32)
...
plt.tight_layout(); plt.savefig('atom_probe_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — 3D-Diffusion + gradient` corresponds to the leaderboard entry at

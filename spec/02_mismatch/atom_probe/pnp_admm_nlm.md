# Atom Probe Tomography (APT) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

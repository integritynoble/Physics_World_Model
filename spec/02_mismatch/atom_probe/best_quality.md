# Atom Probe Tomography (APT) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

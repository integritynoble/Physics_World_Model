# Atom Probe Tomography (APT) — NeRF-DL + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_dl_nerf_dl_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — NeRF-DL + gradient` corresponds to the leaderboard entry at

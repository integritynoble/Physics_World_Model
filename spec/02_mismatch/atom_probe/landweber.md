# Atom Probe Tomography (APT) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_landweber_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

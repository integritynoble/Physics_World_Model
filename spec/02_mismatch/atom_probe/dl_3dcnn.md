# Atom Probe Tomography (APT) — 3D-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_dl_3dcnn_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — 3D-CNN + gradient` corresponds to the leaderboard entry at

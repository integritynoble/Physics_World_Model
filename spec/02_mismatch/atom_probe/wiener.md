# Atom Probe Tomography (APT) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_wiener_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Atom Probe Tomography (APT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('atom_probe_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Atom Probe Tomography (APT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

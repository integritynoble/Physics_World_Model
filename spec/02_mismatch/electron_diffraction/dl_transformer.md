# 4D-STEM Electron Diffraction — Phase-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: diffraction pattern (H × W, float32)
...
plt.tight_layout(); plt.savefig('electron_diffraction_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — Phase-Transformer + gradient` corresponds to the leaderboard entry at

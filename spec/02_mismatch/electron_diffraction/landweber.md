# 4D-STEM Electron Diffraction — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_diffraction_landweber_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# 4D-STEM Electron Diffraction — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_diffraction_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

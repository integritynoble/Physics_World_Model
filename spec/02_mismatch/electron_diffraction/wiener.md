# 4D-STEM Electron Diffraction — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_diffraction_wiener_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

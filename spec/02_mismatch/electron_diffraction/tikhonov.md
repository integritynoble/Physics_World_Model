# 4D-STEM Electron Diffraction — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_diffraction_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

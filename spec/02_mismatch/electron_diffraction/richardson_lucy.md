# 4D-STEM Electron Diffraction — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_diffraction_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

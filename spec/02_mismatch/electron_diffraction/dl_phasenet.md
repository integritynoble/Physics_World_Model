# 4D-STEM Electron Diffraction — PhaseNet + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_phasenet', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_phasenet', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('electron_diffraction_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — PhaseNet + gradient` corresponds to the leaderboard entry at

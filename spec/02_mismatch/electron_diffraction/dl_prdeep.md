# 4D-STEM Electron Diffraction — prDeep + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_prdeep', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_prdeep', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('electron_diffraction_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — prDeep + gradient` corresponds to the leaderboard entry at

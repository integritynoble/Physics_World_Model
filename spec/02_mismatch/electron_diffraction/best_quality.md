# 4D-STEM Electron Diffraction — ED-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_diffraction_best_quality_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — ED-Net [proxy] + gradient` corresponds to the leaderboard entry at

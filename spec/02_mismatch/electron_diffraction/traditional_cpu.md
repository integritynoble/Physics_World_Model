# 4D-STEM Electron Diffraction — ePIE (electron ptychography) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_diffraction_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — ePIE (electron ptychography) + gradient` corresponds to the leaderboard entry at

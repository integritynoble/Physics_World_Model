# 4D-STEM Electron Diffraction — CRISP-ED [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_diffraction_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — CRISP-ED [proxy] + gradient` corresponds to the leaderboard entry at

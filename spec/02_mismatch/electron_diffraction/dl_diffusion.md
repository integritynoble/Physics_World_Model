# 4D-STEM Electron Diffraction — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_diffraction_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

# 4D-STEM Electron Diffraction — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('electron_diffraction_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`4D-STEM Electron Diffraction — TV-ADMM + gradient` corresponds to the leaderboard entry at

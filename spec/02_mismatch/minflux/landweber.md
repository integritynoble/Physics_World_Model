# MINFLUX Nanoscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('minflux_landweber_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

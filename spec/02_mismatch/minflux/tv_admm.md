# MINFLUX Nanoscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('minflux_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

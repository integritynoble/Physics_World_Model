# MINFLUX Nanoscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('minflux_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# MINFLUX Nanoscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('minflux_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

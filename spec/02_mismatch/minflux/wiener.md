# MINFLUX Nanoscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('minflux_wiener_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# MINFLUX Nanoscopy — DiffusionMicro + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('minflux_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — DiffusionMicro + gradient` corresponds to the leaderboard entry at

# MINFLUX Nanoscopy — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: photon records (N × 5: t,x,y,z,id)
...
plt.tight_layout(); plt.savefig('minflux_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

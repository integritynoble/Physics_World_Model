# MINFLUX Nanoscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('minflux_dl_care_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — CARE + gradient` corresponds to the leaderboard entry at

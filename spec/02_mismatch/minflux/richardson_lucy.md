# MINFLUX Nanoscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('minflux_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

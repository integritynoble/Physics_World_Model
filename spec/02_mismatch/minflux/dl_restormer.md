# MINFLUX Nanoscopy — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('minflux_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — Restormer + gradient` corresponds to the leaderboard entry at

# MINFLUX Nanoscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('minflux_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`MINFLUX Nanoscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

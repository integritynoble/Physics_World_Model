# Weather / Doppler Radar — RDA [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — RDA [proxy] + gradient` corresponds to the leaderboard entry at

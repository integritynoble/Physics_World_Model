# Weather / Doppler Radar — NowcastNet [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('weather_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('weather_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('weather_radar_weather_dl_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — NowcastNet [proxy] + gradient` corresponds to the leaderboard entry at

# Weather / Doppler Radar — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Weather / Doppler Radar — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — RS-CNN + gradient` corresponds to the leaderboard entry at

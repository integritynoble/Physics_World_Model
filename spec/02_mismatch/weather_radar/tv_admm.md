# Weather / Doppler Radar — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — TV-ADMM + gradient` corresponds to the leaderboard entry at

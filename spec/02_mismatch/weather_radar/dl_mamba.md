# Weather / Doppler Radar — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — RS-Mamba + gradient` corresponds to the leaderboard entry at

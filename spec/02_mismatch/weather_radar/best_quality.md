# Weather / Doppler Radar — SAR-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — SAR-DL [proxy] + gradient` corresponds to the leaderboard entry at

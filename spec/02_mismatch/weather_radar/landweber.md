# Weather / Doppler Radar — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_landweber_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — Landweber Iteration + gradient` corresponds to the leaderboard entry at

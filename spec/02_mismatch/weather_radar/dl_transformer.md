# Weather / Doppler Radar — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: reflectivity (H × W, float32)
...
plt.tight_layout(); plt.savefig('weather_radar_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — RS-Transformer + gradient` corresponds to the leaderboard entry at

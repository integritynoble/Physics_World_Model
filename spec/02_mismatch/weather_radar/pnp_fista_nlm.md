# Weather / Doppler Radar — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Weather / Doppler Radar — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

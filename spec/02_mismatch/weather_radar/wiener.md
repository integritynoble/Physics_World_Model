# Weather / Doppler Radar — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_wiener_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

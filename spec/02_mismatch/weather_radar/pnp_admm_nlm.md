# Weather / Doppler Radar — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

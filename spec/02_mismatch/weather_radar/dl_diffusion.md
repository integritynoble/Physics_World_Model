# Weather / Doppler Radar — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('weather_radar_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Weather / Doppler Radar — RS-Diffusion + gradient` corresponds to the leaderboard entry at

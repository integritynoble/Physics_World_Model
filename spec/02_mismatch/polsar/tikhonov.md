# Polarimetric SAR (PolSAR) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

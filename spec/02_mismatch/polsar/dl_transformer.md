# Polarimetric SAR (PolSAR) — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: scattering matrix (H × W × 4, complex64)
...
plt.tight_layout(); plt.savefig('polsar_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — RS-Transformer + gradient` corresponds to the leaderboard entry at

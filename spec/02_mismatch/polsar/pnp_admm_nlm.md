# Polarimetric SAR (PolSAR) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

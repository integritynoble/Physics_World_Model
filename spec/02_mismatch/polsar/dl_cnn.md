# Polarimetric SAR (PolSAR) — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — RS-CNN + gradient` corresponds to the leaderboard entry at

# Polarimetric SAR (PolSAR) — RDA [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — RDA [proxy] + gradient` corresponds to the leaderboard entry at

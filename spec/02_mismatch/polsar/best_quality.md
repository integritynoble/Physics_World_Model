# Polarimetric SAR (PolSAR) — SAR-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — SAR-DL [proxy] + gradient` corresponds to the leaderboard entry at

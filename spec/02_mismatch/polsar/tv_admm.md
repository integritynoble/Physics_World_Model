# Polarimetric SAR (PolSAR) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — TV-ADMM + gradient` corresponds to the leaderboard entry at

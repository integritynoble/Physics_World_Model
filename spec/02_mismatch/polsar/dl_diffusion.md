# Polarimetric SAR (PolSAR) — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — RS-Diffusion + gradient` corresponds to the leaderboard entry at

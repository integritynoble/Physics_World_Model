# Polarimetric SAR (PolSAR) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_landweber_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

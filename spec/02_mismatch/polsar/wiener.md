# Polarimetric SAR (PolSAR) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_wiener_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Polarimetric SAR (PolSAR) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Polarimetric SAR (PolSAR) — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polsar_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Polarimetric SAR (PolSAR) — RS-Mamba + gradient` corresponds to the leaderboard entry at

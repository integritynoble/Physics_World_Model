# STED Microscopy — Mismatch Correction + Reconstruct
...
from algorithm_base.sted.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('sted_corrected.png'); plt.show()
```

# Eddy Current Imaging — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: induced voltage (coils × time, float32)
...
plt.tight_layout(); plt.savefig('eddy_current_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

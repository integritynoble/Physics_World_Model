# Eddy Current Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eddy_current_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

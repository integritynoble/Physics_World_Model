# Eddy Current Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eddy_current_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Eddy Current Imaging — Probe-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eddy_current_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — Probe-Diffusion + gradient` corresponds to the leaderboard entry at

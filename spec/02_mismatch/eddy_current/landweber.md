# Eddy Current Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eddy_current_landweber_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Eddy Current Imaging — ECT-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('ec_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ec_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('eddy_current_ec_dl_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — ECT-Net [proxy] + gradient` corresponds to the leaderboard entry at

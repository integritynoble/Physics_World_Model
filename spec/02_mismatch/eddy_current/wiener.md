# Eddy Current Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eddy_current_wiener_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

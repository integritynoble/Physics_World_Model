# Eddy Current Imaging — Probe-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eddy_current_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — Probe-CNN + gradient` corresponds to the leaderboard entry at

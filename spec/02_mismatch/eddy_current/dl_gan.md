# Eddy Current Imaging — Probe-GAN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eddy_current_dl_gan_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — Probe-GAN + gradient` corresponds to the leaderboard entry at

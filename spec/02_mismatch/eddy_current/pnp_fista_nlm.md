# Eddy Current Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eddy_current_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Eddy Current Imaging — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eddy_current_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Eddy Current Imaging — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

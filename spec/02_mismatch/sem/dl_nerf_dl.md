# Scanning Electron Microscopy (SEM) — NeRF-DL + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sem_dl_nerf_dl_corrected.png'); plt.show()
```

## Benchmark

`Scanning Electron Microscopy (SEM) — NeRF-DL + gradient` corresponds to the leaderboard entry at

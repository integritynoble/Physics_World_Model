# Scanning Electron Microscopy (SEM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sem_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Scanning Electron Microscopy (SEM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

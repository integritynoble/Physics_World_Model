# Scanning Electron Microscopy (SEM) — 3D-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sem_dl_3dcnn_corrected.png'); plt.show()
```

## Benchmark

`Scanning Electron Microscopy (SEM) — 3D-CNN + gradient` corresponds to the leaderboard entry at

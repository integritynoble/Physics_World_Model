# Scanning Electron Microscopy (SEM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sem_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Scanning Electron Microscopy (SEM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

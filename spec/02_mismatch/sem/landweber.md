# Scanning Electron Microscopy (SEM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sem_landweber_corrected.png'); plt.show()
```

## Benchmark

`Scanning Electron Microscopy (SEM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Scanning Electron Microscopy (SEM) — Richardson-Lucy (SEM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sem_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Scanning Electron Microscopy (SEM) — Richardson-Lucy (SEM) + gradient` corresponds to the leaderboard entry at

# Scanning Electron Microscopy (SEM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sem_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Scanning Electron Microscopy (SEM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

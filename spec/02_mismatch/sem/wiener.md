# Scanning Electron Microscopy (SEM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sem_wiener_corrected.png'); plt.show()
```

## Benchmark

`Scanning Electron Microscopy (SEM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Scanning Electron Microscopy (SEM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sem_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Scanning Electron Microscopy (SEM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

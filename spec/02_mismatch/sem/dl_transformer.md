# Scanning Electron Microscopy (SEM) — 3D-Transformer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sem_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Scanning Electron Microscopy (SEM) — 3D-Transformer + gradient` corresponds to the leaderboard entry at

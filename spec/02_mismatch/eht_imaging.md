# Event Horizon Telescope (EHT) Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.eht_imaging.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('eht_imaging_corrected.png'); plt.show()
```

# US/MRI Fusion — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('us_mri_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`US/MRI Fusion — Med-UNet + gradient` corresponds to the leaderboard entry at

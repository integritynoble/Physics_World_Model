# US/MRI Fusion — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('us_mri_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`US/MRI Fusion — TV-ADMM + gradient` corresponds to the leaderboard entry at

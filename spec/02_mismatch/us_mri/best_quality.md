# US/MRI Fusion — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('us_mri_best_quality_corrected.png'); plt.show()
```

## Benchmark

`US/MRI Fusion — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# US/MRI Fusion — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('us_mri_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`US/MRI Fusion — SwinIR-Med + gradient` corresponds to the leaderboard entry at

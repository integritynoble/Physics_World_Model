# US/MRI Fusion — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('us_mri_landweber_corrected.png'); plt.show()
```

## Benchmark

`US/MRI Fusion — Landweber Iteration + gradient` corresponds to the leaderboard entry at

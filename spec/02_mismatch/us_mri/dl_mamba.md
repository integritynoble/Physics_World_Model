# US/MRI Fusion — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('us_mri_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`US/MRI Fusion — MedMamba + gradient` corresponds to the leaderboard entry at

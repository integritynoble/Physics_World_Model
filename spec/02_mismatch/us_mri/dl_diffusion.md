# US/MRI Fusion — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: US + MRI combined data
...
plt.tight_layout(); plt.savefig('us_mri_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`US/MRI Fusion — DiffusionMed + gradient` corresponds to the leaderboard entry at

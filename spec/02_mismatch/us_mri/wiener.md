# US/MRI Fusion — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('us_mri_wiener_corrected.png'); plt.show()
```

## Benchmark

`US/MRI Fusion — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

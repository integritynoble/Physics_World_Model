# US/MRI Fusion — US-MRI-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('us_mri_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('us_mri_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('us_mri_us_mri_dl_corrected.png'); plt.show()
```

## Benchmark

`US/MRI Fusion — US-MRI-Net [proxy] + gradient` corresponds to the leaderboard entry at

# LiDAR Scanner — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# LiDAR Scanner — FISTA-L2 (depth) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — FISTA-L2 (depth) + gradient` corresponds to the leaderboard entry at

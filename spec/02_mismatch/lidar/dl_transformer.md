# LiDAR Scanner — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: point cloud (N × 3, float32)
...
plt.tight_layout(); plt.savefig('lidar_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — RS-Transformer + gradient` corresponds to the leaderboard entry at

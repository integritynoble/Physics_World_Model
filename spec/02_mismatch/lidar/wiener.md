# LiDAR Scanner — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_wiener_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

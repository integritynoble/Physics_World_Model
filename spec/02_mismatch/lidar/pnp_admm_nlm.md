# LiDAR Scanner — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# LiDAR Scanner — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# LiDAR Scanner — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — RS-Mamba + gradient` corresponds to the leaderboard entry at

# LiDAR Scanner — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — TV-ADMM + gradient` corresponds to the leaderboard entry at

# LiDAR Scanner — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_landweber_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — Landweber Iteration + gradient` corresponds to the leaderboard entry at

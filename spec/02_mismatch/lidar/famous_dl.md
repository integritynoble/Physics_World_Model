# LiDAR Scanner — PointNet++ [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — PointNet++ [proxy] + gradient` corresponds to the leaderboard entry at

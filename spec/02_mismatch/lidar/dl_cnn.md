# LiDAR Scanner — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — RS-CNN + gradient` corresponds to the leaderboard entry at

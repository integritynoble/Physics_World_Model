# LiDAR Scanner — PointNeXt [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lidar_best_quality_corrected.png'); plt.show()
```

## Benchmark

`LiDAR Scanner — PointNeXt [proxy] + gradient` corresponds to the leaderboard entry at

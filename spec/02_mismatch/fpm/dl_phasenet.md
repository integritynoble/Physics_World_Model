# Fourier Ptychographic Microscopy (FPM) — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — PhaseNet + gradient` corresponds to the leaderboard entry at

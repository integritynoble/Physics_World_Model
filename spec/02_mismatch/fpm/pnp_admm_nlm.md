# Fourier Ptychographic Microscopy (FPM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

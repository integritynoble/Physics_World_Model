# Fourier Ptychographic Microscopy (FPM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_wiener_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

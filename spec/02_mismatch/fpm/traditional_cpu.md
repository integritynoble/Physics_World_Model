# Fourier Ptychographic Microscopy (FPM) — Sequential Phase Retrieval + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — Sequential Phase Retrieval + gradient` corresponds to the leaderboard entry at

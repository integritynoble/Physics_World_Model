# Fourier Ptychographic Microscopy (FPM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

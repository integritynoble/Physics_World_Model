# Fourier Ptychographic Microscopy (FPM) — Phase-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: LED images (N_leds × H × W, float32)
...
plt.tight_layout(); plt.savefig('fpm_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — Phase-Transformer + gradient` corresponds to the leaderboard entry at

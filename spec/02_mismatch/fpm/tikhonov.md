# Fourier Ptychographic Microscopy (FPM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

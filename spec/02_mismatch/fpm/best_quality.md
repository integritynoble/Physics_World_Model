# Fourier Ptychographic Microscopy (FPM) — Gradient Descent FPM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — Gradient Descent FPM [proxy] + gradient` corresponds to the leaderboard entry at

# Fourier Ptychographic Microscopy (FPM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_landweber_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Fourier Ptychographic Microscopy (FPM) — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — prDeep + gradient` corresponds to the leaderboard entry at

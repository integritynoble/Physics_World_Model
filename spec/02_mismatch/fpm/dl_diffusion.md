# Fourier Ptychographic Microscopy (FPM) — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

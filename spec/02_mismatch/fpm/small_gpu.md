# Fourier Ptychographic Microscopy (FPM) — Fourier Ptychnet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — Fourier Ptychnet + gradient` corresponds to the leaderboard entry at

# Fourier Ptychographic Microscopy (FPM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fpm_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Fourier Ptychographic Microscopy (FPM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Expansion Microscopy (ExM) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('expansion_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — CARE + gradient` corresponds to the leaderboard entry at

# Expansion Microscopy (ExM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('expansion_wiener_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

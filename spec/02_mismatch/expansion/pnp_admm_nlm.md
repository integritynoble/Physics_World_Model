# Expansion Microscopy (ExM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('expansion_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

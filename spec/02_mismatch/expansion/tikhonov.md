# Expansion Microscopy (ExM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('expansion_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

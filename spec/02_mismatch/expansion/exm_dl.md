# Expansion Microscopy (ExM) — EXpansionNet + Gradient Mismatch Correction
...
x_wrong = run_solver('exm_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('exm_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('expansion_exm_dl_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — EXpansionNet + gradient` corresponds to the leaderboard entry at

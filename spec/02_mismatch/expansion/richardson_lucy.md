# Expansion Microscopy (ExM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('expansion_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

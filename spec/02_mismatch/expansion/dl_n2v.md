# Expansion Microscopy (ExM) — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('expansion_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — Noise2Void + gradient` corresponds to the leaderboard entry at

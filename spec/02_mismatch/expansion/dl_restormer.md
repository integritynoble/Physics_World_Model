# Expansion Microscopy (ExM) — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('expansion_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — Restormer + gradient` corresponds to the leaderboard entry at

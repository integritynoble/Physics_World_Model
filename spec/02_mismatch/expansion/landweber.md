# Expansion Microscopy (ExM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('expansion_landweber_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

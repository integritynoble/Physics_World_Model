# Expansion Microscopy (ExM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('expansion_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

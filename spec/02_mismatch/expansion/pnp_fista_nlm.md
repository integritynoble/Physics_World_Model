# Expansion Microscopy (ExM) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('expansion_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Expansion Microscopy (ExM) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Electron Energy Loss Spectroscopy (EELS) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eels_landweber_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

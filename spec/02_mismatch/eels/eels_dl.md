# Electron Energy Loss Spectroscopy (EELS) — EELS-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('eels_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('eels_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('eels_eels_dl_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — EELS-Net [proxy] + gradient` corresponds to the leaderboard entry at

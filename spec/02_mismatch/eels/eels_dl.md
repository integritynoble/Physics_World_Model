# Electron Energy Loss Spectroscopy (EELS) — EELS-Net [proxy] + Gradient
...
x_wrong = run_solver('eels_dl', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('eels_dl', y, cfg=calib_cfg)        # corrected

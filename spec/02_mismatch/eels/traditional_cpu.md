# Electron Energy Loss Spectroscopy (EELS) — FISTA-L2 (Fourier ratio) [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eels_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — FISTA-L2 (Fourier ratio) [proxy] + gradient` corresponds to the leaderboard entry at

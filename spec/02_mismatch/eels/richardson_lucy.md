# Electron Energy Loss Spectroscopy (EELS) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eels_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

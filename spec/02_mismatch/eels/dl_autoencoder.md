# Electron Energy Loss Spectroscopy (EELS) — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eels_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — Spec-AE + gradient` corresponds to the leaderboard entry at

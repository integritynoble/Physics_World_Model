# Electron Energy Loss Spectroscopy (EELS) — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eels_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — Spec-CNN + gradient` corresponds to the leaderboard entry at

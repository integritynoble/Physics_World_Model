# Electron Energy Loss Spectroscopy (EELS) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eels_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

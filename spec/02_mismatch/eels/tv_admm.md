# Electron Energy Loss Spectroscopy (EELS) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eels_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — TV-ADMM + gradient` corresponds to the leaderboard entry at

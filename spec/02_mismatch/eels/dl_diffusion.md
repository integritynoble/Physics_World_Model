# Electron Energy Loss Spectroscopy (EELS) — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eels_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

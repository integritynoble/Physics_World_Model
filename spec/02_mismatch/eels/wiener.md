# Electron Energy Loss Spectroscopy (EELS) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eels_wiener_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Electron Energy Loss Spectroscopy (EELS) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('eels_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

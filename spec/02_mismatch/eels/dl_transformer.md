# Electron Energy Loss Spectroscopy (EELS) — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: energy-loss spectrum (H × W × E, float32)
...
plt.tight_layout(); plt.savefig('eels_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Electron Energy Loss Spectroscopy (EELS) — Spec-Transformer + gradient` corresponds to the leaderboard entry at

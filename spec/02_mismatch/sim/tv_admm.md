# Structured Illumination Microscopy (SIM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Structured Illumination Microscopy (SIM) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — CARE + gradient` corresponds to the leaderboard entry at

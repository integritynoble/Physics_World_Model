# Structured Illumination Microscopy (SIM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Structured Illumination Microscopy (SIM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_landweber_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

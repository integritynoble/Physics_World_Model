# Structured Illumination Microscopy (SIM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_wiener_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

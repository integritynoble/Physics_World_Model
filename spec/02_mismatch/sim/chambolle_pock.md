# Structured Illumination Microscopy (SIM) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

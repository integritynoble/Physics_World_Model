# Structured Illumination Microscopy (SIM) — Wiener-SIM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — Wiener-SIM + gradient` corresponds to the leaderboard entry at

# Structured Illumination Microscopy (SIM) — HiFi-SIM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — HiFi-SIM + gradient` corresponds to the leaderboard entry at

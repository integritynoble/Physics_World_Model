# Structured Illumination Microscopy (SIM) — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — Restormer + gradient` corresponds to the leaderboard entry at

# Structured Illumination Microscopy (SIM) — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — Noise2Void + gradient` corresponds to the leaderboard entry at

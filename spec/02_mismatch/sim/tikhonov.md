# Structured Illumination Microscopy (SIM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sim_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Structured Illumination Microscopy (SIM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Shear-Wave Elastography — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — MedMamba + gradient` corresponds to the leaderboard entry at

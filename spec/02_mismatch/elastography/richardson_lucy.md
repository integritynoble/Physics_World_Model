# Shear-Wave Elastography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

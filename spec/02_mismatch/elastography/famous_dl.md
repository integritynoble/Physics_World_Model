# Shear-Wave Elastography — NLSI-Solver [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — NLSI-Solver [proxy] + gradient` corresponds to the leaderboard entry at

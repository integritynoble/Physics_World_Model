# Shear-Wave Elastography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — TV-ADMM + gradient` corresponds to the leaderboard entry at

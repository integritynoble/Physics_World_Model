# Shear-Wave Elastography — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: displacement (H × W × 3, float32)
...
plt.tight_layout(); plt.savefig('elastography_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — DiffusionMed + gradient` corresponds to the leaderboard entry at

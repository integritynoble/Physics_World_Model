# Shear-Wave Elastography — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — SwinIR-Med + gradient` corresponds to the leaderboard entry at

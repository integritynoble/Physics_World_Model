# Shear-Wave Elastography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_wiener_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Shear-Wave Elastography — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — Med-UNet + gradient` corresponds to the leaderboard entry at

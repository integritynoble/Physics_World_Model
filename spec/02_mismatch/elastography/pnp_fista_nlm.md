# Shear-Wave Elastography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

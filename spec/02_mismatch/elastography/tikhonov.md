# Shear-Wave Elastography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

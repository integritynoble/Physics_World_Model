# Shear-Wave Elastography — SENSE (displacement field) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — SENSE (displacement field) + gradient` corresponds to the leaderboard entry at

# Shear-Wave Elastography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

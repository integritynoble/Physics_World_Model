# Shear-Wave Elastography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_landweber_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Shear-Wave Elastography — MRE-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('elastography_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Shear-Wave Elastography — MRE-Net [proxy] + gradient` corresponds to the leaderboard entry at

# Acoustic Emission Testing (AE) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_emission_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — TV-ADMM + gradient` corresponds to the leaderboard entry at

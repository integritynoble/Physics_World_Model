# Acoustic Emission Testing (AE) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_emission_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Acoustic Emission Testing (AE) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_emission_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

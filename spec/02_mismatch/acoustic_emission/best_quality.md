# Acoustic Emission Testing (AE) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_emission_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

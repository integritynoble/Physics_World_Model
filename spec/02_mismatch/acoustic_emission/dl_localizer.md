# Acoustic Emission Testing (AE) — DeepAE-Net [proxy] + Gradient
...
x_wrong = run_solver('dl_localizer', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('dl_localizer', y, cfg=calib_cfg)        # corrected

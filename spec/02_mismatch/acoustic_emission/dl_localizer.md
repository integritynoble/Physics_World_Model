# Acoustic Emission Testing (AE) — DeepAE-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_localizer', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_localizer', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('acoustic_emission_dl_localizer_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — DeepAE-Net [proxy] + gradient` corresponds to the leaderboard entry at

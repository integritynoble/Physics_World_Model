# Acoustic Emission Testing (AE) — DL-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: waveform (samples, float32)
...
plt.tight_layout(); plt.savefig('acoustic_emission_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — DL-Transformer + gradient` corresponds to the leaderboard entry at

# Acoustic Emission Testing (AE) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_emission_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

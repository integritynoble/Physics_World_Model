# Acoustic Emission Testing (AE) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_emission_landweber_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

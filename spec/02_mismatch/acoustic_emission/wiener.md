# Acoustic Emission Testing (AE) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_emission_wiener_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

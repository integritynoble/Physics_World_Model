# Acoustic Emission Testing (AE) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_emission_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

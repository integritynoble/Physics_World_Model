# Acoustic Emission Testing (AE) — DL-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_emission_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Acoustic Emission Testing (AE) — DL-UNet + gradient` corresponds to the leaderboard entry at

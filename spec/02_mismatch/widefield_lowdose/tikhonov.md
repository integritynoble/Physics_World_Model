# Low-Dose Widefield Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

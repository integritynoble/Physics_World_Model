# Low-Dose Widefield Microscopy — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — Restormer + gradient` corresponds to the leaderboard entry at

# Low-Dose Widefield Microscopy — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — Noise2Void + gradient` corresponds to the leaderboard entry at

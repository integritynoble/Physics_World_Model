# Low-Dose Widefield Microscopy — BM3D + RL + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — BM3D + RL + gradient` corresponds to the leaderboard entry at

# Low-Dose Widefield Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

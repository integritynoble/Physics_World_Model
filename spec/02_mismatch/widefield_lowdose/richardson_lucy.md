# Low-Dose Widefield Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

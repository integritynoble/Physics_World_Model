# Low-Dose Widefield Microscopy — DiffusionMicro + Gradient Mismatch Correction

**Device**: GPU  **Input**: photon-limited image (H × W, float32)
...
plt.tight_layout(); plt.savefig('widefield_lowdose_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — DiffusionMicro + gradient` corresponds to the leaderboard entry at

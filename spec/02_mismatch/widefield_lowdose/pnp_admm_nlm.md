# Low-Dose Widefield Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

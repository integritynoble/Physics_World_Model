# Low-Dose Widefield Microscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — CARE + gradient` corresponds to the leaderboard entry at

# Low-Dose Widefield Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_landweber_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

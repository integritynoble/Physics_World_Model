# Low-Dose Widefield Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_wiener_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Low-Dose Widefield Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('widefield_lowdose_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Low-Dose Widefield Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Entangled Photon Microscopy — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Entangled Photon Microscopy — QGI-DL [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('qgi_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('qgi_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('entangled_photon_qgi_dl_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — QGI-DL [proxy] + gradient` corresponds to the leaderboard entry at

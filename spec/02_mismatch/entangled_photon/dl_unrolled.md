# Entangled Photon Microscopy — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — Unrolled-Net + gradient` corresponds to the leaderboard entry at

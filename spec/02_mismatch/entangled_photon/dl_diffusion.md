# Entangled Photon Microscopy — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — CS-Diffusion + gradient` corresponds to the leaderboard entry at

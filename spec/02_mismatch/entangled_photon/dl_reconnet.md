# Entangled Photon Microscopy — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — ReconNet + gradient` corresponds to the leaderboard entry at

# Entangled Photon Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_landweber_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

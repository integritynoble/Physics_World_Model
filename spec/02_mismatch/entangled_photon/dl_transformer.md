# Entangled Photon Microscopy — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: coincidence counts (H × W, float32)
...
plt.tight_layout(); plt.savefig('entangled_photon_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — CS-Transformer + gradient` corresponds to the leaderboard entry at

# Entangled Photon Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_wiener_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Entangled Photon Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Entangled Photon Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

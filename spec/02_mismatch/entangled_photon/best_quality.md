# Entangled Photon Microscopy — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Entangled Photon Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Entangled Photon Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('entangled_photon_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Entangled Photon Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

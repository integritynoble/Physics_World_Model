# Cone-Beam Computed Tomography (CBCT) — FDK + NLM Post-Processing + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cbct_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Cone-Beam Computed Tomography (CBCT) — FDK + NLM Post-Processing + gradient` corresponds to the leaderboard entry at

# Cone-Beam Computed Tomography (CBCT) — PnP-FISTA with NLM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cbct_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Cone-Beam Computed Tomography (CBCT) — PnP-FISTA with NLM + gradient` corresponds to the leaderboard entry at

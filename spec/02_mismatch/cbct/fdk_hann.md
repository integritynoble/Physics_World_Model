# Cone-Beam Computed Tomography (CBCT) — FDK Hann + Gradient Mismatch Correction
...
x_wrong = run_solver('fdk_hann', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('fdk_hann', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cbct_fdk_hann_corrected.png'); plt.show()
```

## Benchmark

`Cone-Beam Computed Tomography (CBCT) — FDK Hann + gradient` corresponds to the leaderboard entry at

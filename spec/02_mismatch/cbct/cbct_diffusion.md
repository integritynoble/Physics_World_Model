# Cone-Beam Computed Tomography (CBCT) — CBCT Diffusion (DL-PGD) + Gradient
...
x_wrong = run_solver('cbct_diffusion', y)           # no correction
geo = cbct_calibrate_offset(y)
calib_cfg = {"geometry_error": geo}
x = run_solver('cbct_diffusion', y, cfg=calib_cfg)        # corrected

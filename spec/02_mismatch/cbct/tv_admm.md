# Cone-Beam Computed Tomography (CBCT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cbct_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Cone-Beam Computed Tomography (CBCT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

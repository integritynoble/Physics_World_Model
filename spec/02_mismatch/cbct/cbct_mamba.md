# Cone-Beam Computed Tomography (CBCT) — CBCT-Mamba (RED-DRUNet) + Gradient
...
x_wrong = run_solver('cbct_mamba', y)           # no correction
geo = cbct_calibrate_offset(y)
calib_cfg = {"geometry_error": geo}
x = run_solver('cbct_mamba', y, cfg=calib_cfg)        # corrected

# Cone-Beam Computed Tomography (CBCT) — Chambolle-Pock Primal-Dual + Gradient Mismatch Correction
...
x_wrong = run_solver('chambolle_pock', y, cfg={})
...
plt.tight_layout(); plt.savefig('cbct_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Cone-Beam Computed Tomography (CBCT) — Chambolle-Pock Primal-Dual + gradient` corresponds to the leaderboard entry at

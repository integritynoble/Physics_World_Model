# Cone-Beam Computed Tomography (CBCT) — FDK Hamming + Gradient Mismatch Correction
...
x_wrong = run_solver('fdk_hamming', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('fdk_hamming', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cbct_fdk_hamming_corrected.png'); plt.show()
```

## Benchmark

`Cone-Beam Computed Tomography (CBCT) — FDK Hamming + gradient` corresponds to the leaderboard entry at

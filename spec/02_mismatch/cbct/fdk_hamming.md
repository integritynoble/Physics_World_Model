# Cone-Beam Computed Tomography (CBCT) — FDK Hamming + Gradient
...
x_wrong = run_solver('fdk_hamming', y)           # no correction
geo = cbct_calibrate_offset(y)
calib_cfg = {"geometry_error": geo}
x = run_solver('fdk_hamming', y, cfg=calib_cfg)        # corrected

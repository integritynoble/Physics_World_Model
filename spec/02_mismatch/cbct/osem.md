# Cone-Beam Computed Tomography (CBCT) — Ordered Subsets EM (OS-EM) + Gradient
...
x_wrong = run_solver('osem', y)           # no correction
geo = cbct_calibrate_offset(y)
calib_cfg = {"geometry_error": geo}
x = run_solver('osem', y, cfg=calib_cfg)        # corrected

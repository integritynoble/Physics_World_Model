# Cone-Beam Computed Tomography (CBCT) — FDK Ram-Lak + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cbct_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Cone-Beam Computed Tomography (CBCT) — FDK Ram-Lak + gradient` corresponds to the leaderboard entry at

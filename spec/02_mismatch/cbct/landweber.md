# Cone-Beam Computed Tomography (CBCT) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cbct_landweber_corrected.png'); plt.show()
```

## Benchmark

`Cone-Beam Computed Tomography (CBCT) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Cone-Beam Computed Tomography (CBCT) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cbct_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Cone-Beam Computed Tomography (CBCT) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

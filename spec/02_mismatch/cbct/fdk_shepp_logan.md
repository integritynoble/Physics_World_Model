# Cone-Beam Computed Tomography (CBCT) — FDK Shepp-Logan + Gradient Mismatch Correction
...
x_wrong = run_solver('fdk_shepp_logan', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('fdk_shepp_logan', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cbct_fdk_shepp_logan_corrected.png'); plt.show()
```

## Benchmark

`Cone-Beam Computed Tomography (CBCT) — FDK Shepp-Logan + gradient` corresponds to the leaderboard entry at

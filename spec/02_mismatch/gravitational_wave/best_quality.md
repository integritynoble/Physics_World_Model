# Gravitational Wave Detection — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gravitational_wave_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Gravitational Wave Detection — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Gravitational Wave Detection — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gravitational_wave_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Gravitational Wave Detection — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Gravitational Wave Detection — GW-DL (PyCBC-ML) [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('matched_filter_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('matched_filter_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('gravitational_wave_matched_filter_dl_corrected.png'); plt.show()
```

## Benchmark

`Gravitational Wave Detection — GW-DL (PyCBC-ML) [proxy] + gradient` corresponds to the leaderboard entry at

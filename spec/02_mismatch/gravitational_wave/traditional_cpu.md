# Gravitational Wave Detection — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gravitational_wave_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Gravitational Wave Detection — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

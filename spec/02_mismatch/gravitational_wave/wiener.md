# Gravitational Wave Detection — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gravitational_wave_wiener_corrected.png'); plt.show()
```

## Benchmark

`Gravitational Wave Detection — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

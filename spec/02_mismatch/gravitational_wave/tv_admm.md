# Gravitational Wave Detection — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gravitational_wave_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Gravitational Wave Detection — TV-ADMM + gradient` corresponds to the leaderboard entry at

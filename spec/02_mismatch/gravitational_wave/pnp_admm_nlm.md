# Gravitational Wave Detection — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gravitational_wave_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Gravitational Wave Detection — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

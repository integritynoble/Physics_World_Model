# Gravitational Wave Detection — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: strain (samples, float32)
...
plt.tight_layout(); plt.savefig('gravitational_wave_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Gravitational Wave Detection — RS-Transformer + gradient` corresponds to the leaderboard entry at

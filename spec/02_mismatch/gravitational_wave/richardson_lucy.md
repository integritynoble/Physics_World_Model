# Gravitational Wave Detection — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gravitational_wave_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Gravitational Wave Detection — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Gravitational Wave Detection — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gravitational_wave_landweber_corrected.png'); plt.show()
```

## Benchmark

`Gravitational Wave Detection — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Single Photon Emission CT (SPECT) — Mismatch Correction + Reconstruct
...
|-----------|-------|---------------|-------------------|
| scatter fraction | `[0.1, 0.4]` | ~0.25 in body imaging | triple-energy window (TEW) subtraction |
...
mismatch_cfg = {
    'scatter_frac': None,    # float if known; None = auto-estimate
    'search_range': '[0.1, 0.4]',
    'search_steps': 20,
}
```
...
plt.tight_layout(); plt.savefig('spect_corrected.png'); plt.show()
```

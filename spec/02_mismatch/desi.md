# DESI Mass Spectrometry Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.desi.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('desi_corrected.png'); plt.show()
```

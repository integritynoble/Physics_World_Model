# Bioluminescence Tomography (BLT) — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — DiffusionRecon + gradient` corresponds to the leaderboard entry at

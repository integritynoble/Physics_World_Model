# Bioluminescence Tomography (BLT) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

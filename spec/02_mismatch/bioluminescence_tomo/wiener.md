# Bioluminescence Tomography (BLT) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_wiener_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

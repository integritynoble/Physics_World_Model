# Bioluminescence Tomography (BLT) — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — U-Net Recon + gradient` corresponds to the leaderboard entry at

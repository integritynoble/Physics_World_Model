# Bioluminescence Tomography (BLT) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

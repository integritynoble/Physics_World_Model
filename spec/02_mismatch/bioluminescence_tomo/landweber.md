# Bioluminescence Tomography (BLT) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_landweber_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

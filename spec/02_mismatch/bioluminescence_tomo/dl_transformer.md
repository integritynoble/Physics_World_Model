# Bioluminescence Tomography (BLT) — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — TransCT + gradient` corresponds to the leaderboard entry at

# Bioluminescence Tomography (BLT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

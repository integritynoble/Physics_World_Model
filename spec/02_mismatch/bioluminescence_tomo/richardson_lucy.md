# Bioluminescence Tomography (BLT) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Bioluminescence Tomography (BLT) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

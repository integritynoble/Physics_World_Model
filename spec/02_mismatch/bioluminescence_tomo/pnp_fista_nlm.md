# Bioluminescence Tomography (BLT) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Bioluminescence Tomography (BLT) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Bioluminescence Tomography (BLT) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

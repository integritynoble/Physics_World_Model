# Photoacoustic Imaging — Mismatch Correction + Reconstruct
...
|-----------|-------|---------------|-------------------|
| speed of sound (m/s) | `[1480, 1560] m/s` | ±20 m/s in tissue | model-based estimation from time-of-flight |
...
plt.tight_layout(); plt.savefig('photoacoustic_corrected.png'); plt.show()
```

# Pump-Probe Microscopy — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — CS-Diffusion + gradient` corresponds to the leaderboard entry at

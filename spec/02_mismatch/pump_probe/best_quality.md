# Pump-Probe Microscopy — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

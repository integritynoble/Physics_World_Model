# Pump-Probe Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

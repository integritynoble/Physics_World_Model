# Pump-Probe Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Pump-Probe Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

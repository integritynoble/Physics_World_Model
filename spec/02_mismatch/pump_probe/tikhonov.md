# Pump-Probe Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

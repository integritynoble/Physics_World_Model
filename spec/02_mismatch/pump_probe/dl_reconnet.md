# Pump-Probe Microscopy — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — ReconNet + gradient` corresponds to the leaderboard entry at

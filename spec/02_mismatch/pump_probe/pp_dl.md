# Pump-Probe Microscopy — PumpProbe-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('pp_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('pp_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('pump_probe_pp_dl_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — PumpProbe-Net [proxy] + gradient` corresponds to the leaderboard entry at

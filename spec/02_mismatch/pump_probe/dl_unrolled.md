# Pump-Probe Microscopy — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — Unrolled-Net + gradient` corresponds to the leaderboard entry at

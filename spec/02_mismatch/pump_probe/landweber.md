# Pump-Probe Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_landweber_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Pump-Probe Microscopy — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: transient spectra (T × λ, float32)
...
plt.tight_layout(); plt.savefig('pump_probe_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — CS-Transformer + gradient` corresponds to the leaderboard entry at

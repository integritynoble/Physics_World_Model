# Pump-Probe Microscopy — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Pump-Probe Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pump_probe_wiener_corrected.png'); plt.show()
```

## Benchmark

`Pump-Probe Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

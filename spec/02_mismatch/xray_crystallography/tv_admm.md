# X-ray Crystallography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_crystallography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — TV-ADMM + gradient` corresponds to the leaderboard entry at

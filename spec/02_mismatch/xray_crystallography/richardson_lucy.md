# X-ray Crystallography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_crystallography_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# X-ray Crystallography — Phase-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: structure factors (hkl × F, float32)
...
plt.tight_layout(); plt.savefig('xray_crystallography_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — Phase-Transformer + gradient` corresponds to the leaderboard entry at

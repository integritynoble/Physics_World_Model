# X-ray Crystallography — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_crystallography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

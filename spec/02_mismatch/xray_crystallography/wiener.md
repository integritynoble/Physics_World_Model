# X-ray Crystallography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_crystallography_wiener_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# X-ray Crystallography — AlphaFold-SF [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('xtal_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('xtal_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('xray_crystallography_xtal_dl_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — AlphaFold-SF [proxy] + gradient` corresponds to the leaderboard entry at

# X-ray Crystallography — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_crystallography_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

# X-ray Crystallography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_crystallography_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

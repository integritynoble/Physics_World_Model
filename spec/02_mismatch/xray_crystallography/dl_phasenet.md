# X-ray Crystallography — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_crystallography_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — PhaseNet + gradient` corresponds to the leaderboard entry at

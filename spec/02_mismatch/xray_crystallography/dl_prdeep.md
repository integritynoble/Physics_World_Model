# X-ray Crystallography — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_crystallography_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — prDeep + gradient` corresponds to the leaderboard entry at

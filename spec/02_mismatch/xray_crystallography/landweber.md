# X-ray Crystallography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_crystallography_landweber_corrected.png'); plt.show()
```

## Benchmark

`X-ray Crystallography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

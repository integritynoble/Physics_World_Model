# Compressed Ultrafast Photography (CUP) — Mismatch Correction + Reconstruct
...
from algorithm_base.cup.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('cup_corrected.png'); plt.show()
```

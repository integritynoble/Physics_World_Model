# Ptychographic Imaging — Relaxed Averaged Alternating Reflections (RAAR) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ptychography_raar_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — Relaxed Averaged Alternating Reflections (RAAR) + gradient` corresponds to the leaderboard entry at

# Ptychographic Imaging — Relaxed Averaged Alternating Reflections (RAAR) + Gradient
...
x_wrong = run_solver('raar', y)           # no correction
pos_err = ptycho_calibrate_offset(y)
calib_cfg = {"pos_error": pos_err}
x = run_solver('raar', y, cfg=calib_cfg)        # corrected

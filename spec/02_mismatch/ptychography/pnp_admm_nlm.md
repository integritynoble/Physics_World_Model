# Ptychographic Imaging — PnP-ADMM with NLM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ptychography_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — PnP-ADMM with NLM + gradient` corresponds to the leaderboard entry at

# Ptychographic Imaging — Extended PIE (ePIE) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ptychography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — Extended PIE (ePIE) + gradient` corresponds to the leaderboard entry at

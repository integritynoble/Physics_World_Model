# Ptychographic Imaging — PtychoFormer (DL-DRS) + Gradient
...
x_wrong = run_solver('ptycho_former', y)           # no correction
pos_err = ptycho_calibrate_offset(y)
calib_cfg = {"pos_error": pos_err}
x = run_solver('ptycho_former', y, cfg=calib_cfg)        # corrected

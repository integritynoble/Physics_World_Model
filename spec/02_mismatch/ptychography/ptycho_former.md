# Ptychographic Imaging — PtychoFormer (DL-DRS) + Gradient Mismatch Correction
...
x_wrong = run_solver('ptycho_former', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ptycho_former', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ptychography_ptycho_former_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — PtychoFormer (DL-DRS) + gradient` corresponds to the leaderboard entry at

# Ptychographic Imaging — Ptychography Diffusion (DL-PGD) + Gradient Mismatch Correction
...
x_wrong = run_solver('ptycho_diffusion', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ptycho_diffusion', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ptychography_ptycho_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — Ptychography Diffusion (DL-PGD) + gradient` corresponds to the leaderboard entry at

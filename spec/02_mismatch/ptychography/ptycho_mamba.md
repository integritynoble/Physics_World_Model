# Ptychographic Imaging — PtychoMamba (RED-DRUNet) + Gradient
...
x_wrong = run_solver('ptycho_mamba', y)           # no correction
pos_err = ptycho_calibrate_offset(y)
calib_cfg = {"pos_error": pos_err}
x = run_solver('ptycho_mamba', y, cfg=calib_cfg)        # corrected

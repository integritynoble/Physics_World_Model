# Ptychographic Imaging — PtychoMamba (RED-DRUNet) + Gradient Mismatch Correction
...
x_wrong = run_solver('ptycho_mamba', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ptycho_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ptychography_ptycho_mamba_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — PtychoMamba (RED-DRUNet) + gradient` corresponds to the leaderboard entry at

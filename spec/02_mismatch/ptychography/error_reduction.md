# Ptychographic Imaging — Error Reduction (Fienup) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ptychography_error_reduction_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — Error Reduction (Fienup) + gradient` corresponds to the leaderboard entry at

# Ptychographic Imaging — PtychoNN (DL-PGD) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ptychography_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — PtychoNN (DL-PGD) + gradient` corresponds to the leaderboard entry at

# Ptychographic Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ptychography_landweber_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Ptychographic Imaging — PtychoNN 2.0 (DnCNN) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ptychography_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — PtychoNN 2.0 (DnCNN) + gradient` corresponds to the leaderboard entry at

# Ptychographic Imaging — AutoPhase (DL-PGD) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ptychography_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Ptychographic Imaging — AutoPhase (DL-PGD) + gradient` corresponds to the leaderboard entry at

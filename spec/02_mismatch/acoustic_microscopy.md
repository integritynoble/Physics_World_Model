# Scanning Acoustic Microscopy (SAM) — Mismatch Correction + Reconstruct
...
from algorithm_base.acoustic_microscopy.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_corrected.png'); plt.show()
```

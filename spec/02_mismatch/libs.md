# Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.libs.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('libs_corrected.png'); plt.show()
```

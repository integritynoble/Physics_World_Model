# Solar EUV/X-ray Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('solar_imaging_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Solar EUV/X-ray Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

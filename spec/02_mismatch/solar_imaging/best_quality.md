# Solar EUV/X-ray Imaging — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('solar_imaging_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Solar EUV/X-ray Imaging — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

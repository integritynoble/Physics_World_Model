# Solar EUV/X-ray Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('solar_imaging_wiener_corrected.png'); plt.show()
```

## Benchmark

`Solar EUV/X-ray Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

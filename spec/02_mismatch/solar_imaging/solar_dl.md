# Solar EUV/X-ray Imaging — SolarNet [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('solar_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('solar_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('solar_imaging_solar_dl_corrected.png'); plt.show()
```

## Benchmark

`Solar EUV/X-ray Imaging — SolarNet [proxy] + gradient` corresponds to the leaderboard entry at

# Solar EUV/X-ray Imaging — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('solar_imaging_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Solar EUV/X-ray Imaging — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

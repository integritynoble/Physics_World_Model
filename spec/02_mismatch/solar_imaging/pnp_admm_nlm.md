# Solar EUV/X-ray Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('solar_imaging_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Solar EUV/X-ray Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

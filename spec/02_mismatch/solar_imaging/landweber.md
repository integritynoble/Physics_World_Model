# Solar EUV/X-ray Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('solar_imaging_landweber_corrected.png'); plt.show()
```

## Benchmark

`Solar EUV/X-ray Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Solar EUV/X-ray Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('solar_imaging_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Solar EUV/X-ray Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

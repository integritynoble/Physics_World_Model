# Scanning Transmission Electron Microscopy (STEM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stem_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Scanning Transmission Electron Microscopy (STEM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

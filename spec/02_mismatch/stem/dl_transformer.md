# Scanning Transmission Electron Microscopy (STEM) — 3D-Transformer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stem_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Scanning Transmission Electron Microscopy (STEM) — 3D-Transformer + gradient` corresponds to the leaderboard entry at

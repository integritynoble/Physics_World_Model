# Scanning Transmission Electron Microscopy (STEM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stem_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Scanning Transmission Electron Microscopy (STEM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Scanning Transmission Electron Microscopy (STEM) — NeRF-DL + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stem_dl_nerf_dl_corrected.png'); plt.show()
```

## Benchmark

`Scanning Transmission Electron Microscopy (STEM) — NeRF-DL + gradient` corresponds to the leaderboard entry at

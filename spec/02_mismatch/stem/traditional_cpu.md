# Scanning Transmission Electron Microscopy (STEM) — Richardson-Lucy (STEM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stem_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Scanning Transmission Electron Microscopy (STEM) — Richardson-Lucy (STEM) + gradient` corresponds to the leaderboard entry at

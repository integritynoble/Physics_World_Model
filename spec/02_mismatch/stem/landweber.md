# Scanning Transmission Electron Microscopy (STEM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stem_landweber_corrected.png'); plt.show()
```

## Benchmark

`Scanning Transmission Electron Microscopy (STEM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

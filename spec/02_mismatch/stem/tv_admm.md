# Scanning Transmission Electron Microscopy (STEM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stem_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Scanning Transmission Electron Microscopy (STEM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

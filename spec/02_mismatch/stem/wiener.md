# Scanning Transmission Electron Microscopy (STEM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stem_wiener_corrected.png'); plt.show()
```

## Benchmark

`Scanning Transmission Electron Microscopy (STEM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Scanning Transmission Electron Microscopy (STEM) — 3D-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stem_dl_3dcnn_corrected.png'); plt.show()
```

## Benchmark

`Scanning Transmission Electron Microscopy (STEM) — 3D-CNN + gradient` corresponds to the leaderboard entry at

# Fluorescence Lifetime Imaging (FLIM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flim_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Fluorescence Lifetime Imaging (FLIM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

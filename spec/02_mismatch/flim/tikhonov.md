# Fluorescence Lifetime Imaging (FLIM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flim_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Fluorescence Lifetime Imaging (FLIM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

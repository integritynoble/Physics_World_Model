# Fluorescence Lifetime Imaging (FLIM) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flim_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Fluorescence Lifetime Imaging (FLIM) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Fluorescence Lifetime Imaging (FLIM) — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flim_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Fluorescence Lifetime Imaging (FLIM) — Noise2Void + gradient` corresponds to the leaderboard entry at

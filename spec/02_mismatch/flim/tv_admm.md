# Fluorescence Lifetime Imaging (FLIM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flim_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Fluorescence Lifetime Imaging (FLIM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

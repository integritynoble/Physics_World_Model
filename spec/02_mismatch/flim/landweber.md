# Fluorescence Lifetime Imaging (FLIM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flim_landweber_corrected.png'); plt.show()
```

## Benchmark

`Fluorescence Lifetime Imaging (FLIM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

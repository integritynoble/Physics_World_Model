# Fluorescence Lifetime Imaging (FLIM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flim_wiener_corrected.png'); plt.show()
```

## Benchmark

`Fluorescence Lifetime Imaging (FLIM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

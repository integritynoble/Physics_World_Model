# Fluorescence Lifetime Imaging (FLIM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flim_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Fluorescence Lifetime Imaging (FLIM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Fluorescence Lifetime Imaging (FLIM) — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flim_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Fluorescence Lifetime Imaging (FLIM) — Restormer + gradient` corresponds to the leaderboard entry at

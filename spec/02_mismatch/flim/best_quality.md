# Fluorescence Lifetime Imaging (FLIM) — MLE Fit + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flim_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Fluorescence Lifetime Imaging (FLIM) — MLE Fit + gradient` corresponds to the leaderboard entry at

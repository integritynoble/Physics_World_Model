# Industrial X-ray CT — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_landweber_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — Landweber Iteration + gradient` corresponds to the leaderboard entry at

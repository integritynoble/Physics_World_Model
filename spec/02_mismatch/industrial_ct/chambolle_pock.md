# Industrial X-ray CT — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

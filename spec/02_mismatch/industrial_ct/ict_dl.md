# Industrial X-ray CT — IndustrialCT-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('ict_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ict_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('industrial_ct_ict_dl_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — IndustrialCT-Net [proxy] + gradient` corresponds to the leaderboard entry at

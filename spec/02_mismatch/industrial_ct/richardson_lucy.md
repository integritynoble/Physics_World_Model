# Industrial X-ray CT — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

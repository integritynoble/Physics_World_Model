# Industrial X-ray CT — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

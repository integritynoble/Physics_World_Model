# Industrial X-ray CT — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_wiener_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Industrial X-ray CT — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — TransCT + gradient` corresponds to the leaderboard entry at

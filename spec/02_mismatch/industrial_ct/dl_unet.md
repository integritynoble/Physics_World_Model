# Industrial X-ray CT — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — U-Net Recon + gradient` corresponds to the leaderboard entry at

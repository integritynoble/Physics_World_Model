# Industrial X-ray CT — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

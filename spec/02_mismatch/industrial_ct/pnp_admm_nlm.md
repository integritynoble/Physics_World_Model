# Industrial X-ray CT — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Industrial X-ray CT — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

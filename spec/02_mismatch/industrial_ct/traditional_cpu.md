# Industrial X-ray CT — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('industrial_ct_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Industrial X-ray CT — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Scanning Tunneling Microscopy (STM) — Probe-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stm_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — Probe-CNN + gradient` corresponds to the leaderboard entry at

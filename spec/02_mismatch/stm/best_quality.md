# Scanning Tunneling Microscopy (STM) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stm_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — CARE + gradient` corresponds to the leaderboard entry at

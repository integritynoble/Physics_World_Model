# Scanning Tunneling Microscopy (STM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stm_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

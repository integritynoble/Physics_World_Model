# Scanning Tunneling Microscopy (STM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stm_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

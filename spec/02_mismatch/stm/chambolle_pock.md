# Scanning Tunneling Microscopy (STM) — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: tunneling map (H × W, float32)
...
plt.tight_layout(); plt.savefig('stm_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

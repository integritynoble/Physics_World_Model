# Scanning Tunneling Microscopy (STM) — Probe-GAN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stm_dl_gan_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — Probe-GAN + gradient` corresponds to the leaderboard entry at

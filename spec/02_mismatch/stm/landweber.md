# Scanning Tunneling Microscopy (STM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stm_landweber_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Scanning Tunneling Microscopy (STM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stm_wiener_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

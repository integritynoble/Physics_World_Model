# Scanning Tunneling Microscopy (STM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stm_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Scanning Tunneling Microscopy (STM) — Probe-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('stm_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — Probe-Diffusion + gradient` corresponds to the leaderboard entry at

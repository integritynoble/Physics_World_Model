# Scanning Tunneling Microscopy (STM) — STM-Net + Gradient Mismatch Correction
...
x_wrong = run_solver('stm_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('stm_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('stm_stm_dl_corrected.png'); plt.show()
```

## Benchmark

`Scanning Tunneling Microscopy (STM) — STM-Net + gradient` corresponds to the leaderboard entry at

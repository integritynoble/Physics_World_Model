# Solar EUV/X-ray Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.solar_imaging.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('solar_imaging_corrected.png'); plt.show()
```

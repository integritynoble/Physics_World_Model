# Flash LiDAR — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flash_lidar_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

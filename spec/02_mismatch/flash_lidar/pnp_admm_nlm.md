# Flash LiDAR — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flash_lidar_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Flash LiDAR — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flash_lidar_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Flash LiDAR — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flash_lidar_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

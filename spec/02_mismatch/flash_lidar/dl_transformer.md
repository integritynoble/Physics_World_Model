# Flash LiDAR — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: range + intensity (H × W × 2, float32)
...
plt.tight_layout(); plt.savefig('flash_lidar_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — RS-Transformer + gradient` corresponds to the leaderboard entry at

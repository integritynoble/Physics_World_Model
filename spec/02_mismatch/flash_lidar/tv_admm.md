# Flash LiDAR — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flash_lidar_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Flash LiDAR — FlashLiDAR-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('flash_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('flash_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('flash_lidar_flash_dl_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — FlashLiDAR-Net [proxy] + gradient` corresponds to the leaderboard entry at

# Flash LiDAR — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flash_lidar_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — RS-CNN + gradient` corresponds to the leaderboard entry at

# Flash LiDAR — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flash_lidar_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

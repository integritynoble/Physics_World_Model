# Flash LiDAR — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flash_lidar_wiener_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

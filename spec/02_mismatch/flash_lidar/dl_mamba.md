# Flash LiDAR — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flash_lidar_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — RS-Mamba + gradient` corresponds to the leaderboard entry at

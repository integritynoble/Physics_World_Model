# Flash LiDAR — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('flash_lidar_landweber_corrected.png'); plt.show()
```

## Benchmark

`Flash LiDAR — Landweber Iteration + gradient` corresponds to the leaderboard entry at

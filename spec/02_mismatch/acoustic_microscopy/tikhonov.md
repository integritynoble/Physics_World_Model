# Scanning Acoustic Microscopy (SAM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

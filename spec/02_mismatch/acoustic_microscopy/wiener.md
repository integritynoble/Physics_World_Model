# Scanning Acoustic Microscopy (SAM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_wiener_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

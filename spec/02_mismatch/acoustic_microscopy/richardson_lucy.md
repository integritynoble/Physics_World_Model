# Scanning Acoustic Microscopy (SAM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

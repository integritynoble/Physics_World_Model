# Scanning Acoustic Microscopy (SAM) — DL-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — DL-Diffusion + gradient` corresponds to the leaderboard entry at

# Scanning Acoustic Microscopy (SAM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

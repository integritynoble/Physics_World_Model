# Scanning Acoustic Microscopy (SAM) — DL-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — DL-Mamba + gradient` corresponds to the leaderboard entry at

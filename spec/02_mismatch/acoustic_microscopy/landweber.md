# Scanning Acoustic Microscopy (SAM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_landweber_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

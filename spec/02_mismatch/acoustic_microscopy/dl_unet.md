# Scanning Acoustic Microscopy (SAM) — DL-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — DL-UNet + gradient` corresponds to the leaderboard entry at

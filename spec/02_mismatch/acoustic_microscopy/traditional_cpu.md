# Scanning Acoustic Microscopy (SAM) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

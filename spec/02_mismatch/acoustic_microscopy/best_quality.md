# Scanning Acoustic Microscopy (SAM) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

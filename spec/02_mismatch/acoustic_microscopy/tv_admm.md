# Scanning Acoustic Microscopy (SAM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

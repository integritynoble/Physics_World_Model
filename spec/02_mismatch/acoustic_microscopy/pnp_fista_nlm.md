# Scanning Acoustic Microscopy (SAM) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Scanning Acoustic Microscopy (SAM) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

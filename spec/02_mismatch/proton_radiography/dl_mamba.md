# Proton Radiography — MambaRecon + Gradient Mismatch Correction

**Device**: GPU  **Input**: fluence map (H × W, float32)
...
plt.tight_layout(); plt.savefig('proton_radiography_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — MambaRecon + gradient` corresponds to the leaderboard entry at

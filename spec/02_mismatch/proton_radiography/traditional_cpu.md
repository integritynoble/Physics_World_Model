# Proton Radiography — FBP (proton radiography) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — FBP (proton radiography) + gradient` corresponds to the leaderboard entry at

# Proton Radiography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_landweber_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Proton Radiography — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — U-Net Recon + gradient` corresponds to the leaderboard entry at

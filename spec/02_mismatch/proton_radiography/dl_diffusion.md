# Proton Radiography — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — DiffusionRecon + gradient` corresponds to the leaderboard entry at

# Proton Radiography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Proton Radiography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

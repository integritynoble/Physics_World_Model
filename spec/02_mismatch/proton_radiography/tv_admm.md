# Proton Radiography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — TV-ADMM + gradient` corresponds to the leaderboard entry at

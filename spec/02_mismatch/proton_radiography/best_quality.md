# Proton Radiography — ProtonRecon-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — ProtonRecon-Net [proxy] + gradient` corresponds to the leaderboard entry at

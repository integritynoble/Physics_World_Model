# Proton Radiography — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — TransCT + gradient` corresponds to the leaderboard entry at

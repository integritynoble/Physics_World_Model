# Proton Radiography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Proton Radiography — FBP-Proton [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — FBP-Proton [proxy] + gradient` corresponds to the leaderboard entry at

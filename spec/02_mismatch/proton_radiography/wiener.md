# Proton Radiography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('proton_radiography_wiener_corrected.png'); plt.show()
```

## Benchmark

`Proton Radiography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

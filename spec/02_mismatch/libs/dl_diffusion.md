# Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('libs_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

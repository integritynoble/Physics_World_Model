# Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — LIBS-CNN [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('libs_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('libs_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('libs_libs_dl_corrected.png'); plt.show()
```

## Benchmark

`Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — LIBS-CNN [proxy] + gradient` corresponds to the leaderboard entry at

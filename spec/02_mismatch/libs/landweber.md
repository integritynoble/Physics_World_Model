# Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('libs_landweber_corrected.png'); plt.show()
```

## Benchmark

`Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

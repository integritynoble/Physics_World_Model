# Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('libs_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Spec-AE + gradient` corresponds to the leaderboard entry at

# Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('libs_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Spec-CNN + gradient` corresponds to the leaderboard entry at

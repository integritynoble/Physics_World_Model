# Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: emission spectrum (wavelengths, float32)
...
plt.tight_layout(); plt.savefig('libs_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — Spec-Transformer + gradient` corresponds to the leaderboard entry at

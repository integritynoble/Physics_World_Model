# Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('libs_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Laser-Induced Breakdown Spectroscopy (LIBS) Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Focused Ion Beam SEM (FIB-SEM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_landweber_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Focused Ion Beam SEM (FIB-SEM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_wiener_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

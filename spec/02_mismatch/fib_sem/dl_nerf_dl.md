# Focused Ion Beam SEM (FIB-SEM) — NeRF-DL + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_dl_nerf_dl_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — NeRF-DL + gradient` corresponds to the leaderboard entry at

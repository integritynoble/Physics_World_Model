# Focused Ion Beam SEM (FIB-SEM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

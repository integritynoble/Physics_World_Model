# Focused Ion Beam SEM (FIB-SEM) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — CARE + gradient` corresponds to the leaderboard entry at

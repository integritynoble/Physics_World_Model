# Focused Ion Beam SEM (FIB-SEM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

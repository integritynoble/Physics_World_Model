# Focused Ion Beam SEM (FIB-SEM) — 3D-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_dl_3dcnn_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — 3D-CNN + gradient` corresponds to the leaderboard entry at

# Focused Ion Beam SEM (FIB-SEM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

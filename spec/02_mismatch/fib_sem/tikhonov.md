# Focused Ion Beam SEM (FIB-SEM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Focused Ion Beam SEM (FIB-SEM) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

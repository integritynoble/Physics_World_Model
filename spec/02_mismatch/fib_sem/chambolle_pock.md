# Focused Ion Beam SEM (FIB-SEM) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fib_sem_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Focused Ion Beam SEM (FIB-SEM) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

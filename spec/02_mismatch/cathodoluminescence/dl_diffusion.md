# Cathodoluminescence (CL) Imaging — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

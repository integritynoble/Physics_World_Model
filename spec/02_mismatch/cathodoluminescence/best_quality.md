# Cathodoluminescence (CL) Imaging — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

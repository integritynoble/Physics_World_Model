# Cathodoluminescence (CL) Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

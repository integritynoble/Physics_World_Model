# Cathodoluminescence (CL) Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

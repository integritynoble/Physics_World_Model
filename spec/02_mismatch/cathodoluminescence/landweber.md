# Cathodoluminescence (CL) Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_landweber_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Cathodoluminescence (CL) Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

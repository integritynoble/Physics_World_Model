# Cathodoluminescence (CL) Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_wiener_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

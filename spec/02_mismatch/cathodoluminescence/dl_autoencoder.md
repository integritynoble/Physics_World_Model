# Cathodoluminescence (CL) Imaging — Spec-AE + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_autoencoder', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_autoencoder', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cathodoluminescence_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — Spec-AE + gradient` corresponds to the leaderboard entry at

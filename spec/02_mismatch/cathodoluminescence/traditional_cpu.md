# Cathodoluminescence (CL) Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Cathodoluminescence (CL) Imaging — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: spectrum image (H × W × λ, float32)
...
plt.tight_layout(); plt.savefig('cathodoluminescence_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — Spec-Transformer + gradient` corresponds to the leaderboard entry at

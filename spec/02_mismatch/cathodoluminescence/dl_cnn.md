# Cathodoluminescence (CL) Imaging — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — Spec-CNN + gradient` corresponds to the leaderboard entry at

# Cathodoluminescence (CL) Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

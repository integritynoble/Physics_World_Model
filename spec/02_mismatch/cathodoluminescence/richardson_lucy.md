# Cathodoluminescence (CL) Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cathodoluminescence_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Cathodoluminescence (CL) Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Structured-Light Depth Camera — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

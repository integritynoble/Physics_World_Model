# Structured-Light Depth Camera — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

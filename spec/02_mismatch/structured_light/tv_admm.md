# Structured-Light Depth Camera — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Structured-Light Depth Camera — Unrolled-Net + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_unrolled', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_unrolled', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('structured_light_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — Unrolled-Net + gradient` corresponds to the leaderboard entry at

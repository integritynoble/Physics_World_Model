# Structured-Light Depth Camera — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_wiener_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

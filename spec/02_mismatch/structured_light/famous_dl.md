# Structured-Light Depth Camera — FTPD [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — FTPD [proxy] + gradient` corresponds to the leaderboard entry at

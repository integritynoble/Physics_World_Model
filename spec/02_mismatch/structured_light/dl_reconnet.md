# Structured-Light Depth Camera — ReconNet + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_reconnet', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_reconnet', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('structured_light_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — ReconNet + gradient` corresponds to the leaderboard entry at

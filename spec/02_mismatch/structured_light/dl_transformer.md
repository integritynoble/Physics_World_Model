# Structured-Light Depth Camera — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: pattern images (N × H × W, float32)
...
plt.tight_layout(); plt.savefig('structured_light_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — CS-Transformer + gradient` corresponds to the leaderboard entry at

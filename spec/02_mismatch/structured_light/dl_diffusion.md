# Structured-Light Depth Camera — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — CS-Diffusion + gradient` corresponds to the leaderboard entry at

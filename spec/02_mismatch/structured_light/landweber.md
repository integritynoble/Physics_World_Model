# Structured-Light Depth Camera — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_landweber_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — Landweber Iteration + gradient` corresponds to the leaderboard entry at

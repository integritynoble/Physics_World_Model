# Structured-Light Depth Camera — FISTA-L2 (phase unwrap) [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — FISTA-L2 (phase unwrap) [proxy] + gradient` corresponds to the leaderboard entry at

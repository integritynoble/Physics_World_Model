# Structured-Light Depth Camera — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

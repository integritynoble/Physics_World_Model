# Structured-Light Depth Camera — SL-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — SL-Net [proxy] + gradient` corresponds to the leaderboard entry at

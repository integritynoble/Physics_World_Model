# Structured-Light Depth Camera — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('structured_light_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Structured-Light Depth Camera — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

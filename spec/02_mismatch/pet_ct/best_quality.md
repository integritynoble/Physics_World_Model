# PET/CT Fusion — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_ct_best_quality_corrected.png'); plt.show()
```

## Benchmark

`PET/CT Fusion — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Photoacoustic Imaging — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: time-series (elements × time, float32)
...
plt.tight_layout(); plt.savefig('photoacoustic_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — DiffusionMed + gradient` corresponds to the leaderboard entry at

# Photoacoustic Imaging — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — Med-UNet + gradient` corresponds to the leaderboard entry at

# Photoacoustic Imaging — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — SwinIR-Med + gradient` corresponds to the leaderboard entry at

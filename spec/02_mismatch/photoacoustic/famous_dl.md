# Photoacoustic Imaging — Deep-PAT [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — Deep-PAT [proxy] + gradient` corresponds to the leaderboard entry at

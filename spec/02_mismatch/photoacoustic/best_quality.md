# Photoacoustic Imaging — Time Reversal [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — Time Reversal [proxy] + gradient` corresponds to the leaderboard entry at

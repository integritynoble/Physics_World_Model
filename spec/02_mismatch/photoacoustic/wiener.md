# Photoacoustic Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_wiener_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

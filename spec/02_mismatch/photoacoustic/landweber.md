# Photoacoustic Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_landweber_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

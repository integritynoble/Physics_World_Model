# Photoacoustic Imaging — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — MedMamba + gradient` corresponds to the leaderboard entry at

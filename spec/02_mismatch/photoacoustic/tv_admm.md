# Photoacoustic Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Photoacoustic Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

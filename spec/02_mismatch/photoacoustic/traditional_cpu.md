# Photoacoustic Imaging — Back Projection + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — Back Projection + gradient` corresponds to the leaderboard entry at

# Photoacoustic Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

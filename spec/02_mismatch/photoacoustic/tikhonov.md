# Photoacoustic Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

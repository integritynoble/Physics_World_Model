# Photoacoustic Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('photoacoustic_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Photoacoustic Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

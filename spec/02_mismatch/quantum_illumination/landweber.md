# Quantum Illumination — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_landweber_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — Landweber Iteration + gradient` corresponds to the leaderboard entry at

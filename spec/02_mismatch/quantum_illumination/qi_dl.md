# Quantum Illumination — QI-DL [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('qi_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('qi_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('quantum_illumination_qi_dl_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — QI-DL [proxy] + gradient` corresponds to the leaderboard entry at

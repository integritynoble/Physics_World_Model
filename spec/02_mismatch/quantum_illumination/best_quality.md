# Quantum Illumination — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

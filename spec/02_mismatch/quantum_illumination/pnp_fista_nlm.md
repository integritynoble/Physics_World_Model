# Quantum Illumination — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

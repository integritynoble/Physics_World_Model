# Quantum Illumination — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_wiener_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

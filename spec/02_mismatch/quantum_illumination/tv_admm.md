# Quantum Illumination — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — TV-ADMM + gradient` corresponds to the leaderboard entry at

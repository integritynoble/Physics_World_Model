# Quantum Illumination — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — Unrolled-Net + gradient` corresponds to the leaderboard entry at

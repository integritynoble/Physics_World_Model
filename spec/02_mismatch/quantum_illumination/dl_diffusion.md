# Quantum Illumination — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — CS-Diffusion + gradient` corresponds to the leaderboard entry at

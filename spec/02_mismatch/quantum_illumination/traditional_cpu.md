# Quantum Illumination — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

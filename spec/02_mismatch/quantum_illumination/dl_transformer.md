# Quantum Illumination — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: coincidence image (H × W, float32)
...
plt.tight_layout(); plt.savefig('quantum_illumination_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — CS-Transformer + gradient` corresponds to the leaderboard entry at

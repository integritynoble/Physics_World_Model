# Quantum Illumination — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Quantum Illumination — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

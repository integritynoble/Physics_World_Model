# Quantum Illumination — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('quantum_illumination_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Quantum Illumination — ReconNet + gradient` corresponds to the leaderboard entry at

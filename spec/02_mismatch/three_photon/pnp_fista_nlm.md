# Three-Photon Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('three_photon_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Three-Photon Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

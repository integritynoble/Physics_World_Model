# Three-Photon Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('three_photon_wiener_corrected.png'); plt.show()
```

## Benchmark

`Three-Photon Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

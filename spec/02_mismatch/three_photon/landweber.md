# Three-Photon Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('three_photon_landweber_corrected.png'); plt.show()
```

## Benchmark

`Three-Photon Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Three-Photon Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('three_photon_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Three-Photon Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

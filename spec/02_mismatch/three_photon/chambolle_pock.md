# Three-Photon Microscopy — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('three_photon_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Three-Photon Microscopy — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

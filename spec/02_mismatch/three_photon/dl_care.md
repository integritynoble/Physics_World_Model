# Three-Photon Microscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('three_photon_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Three-Photon Microscopy — CARE + gradient` corresponds to the leaderboard entry at

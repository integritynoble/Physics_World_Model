# Three-Photon Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('three_photon_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Three-Photon Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

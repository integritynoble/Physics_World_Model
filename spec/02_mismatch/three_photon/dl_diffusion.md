# Three-Photon Microscopy — DiffusionMicro + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('three_photon_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Three-Photon Microscopy — DiffusionMicro + gradient` corresponds to the leaderboard entry at

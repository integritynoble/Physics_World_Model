# Three-Photon Microscopy — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('three_photon_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Three-Photon Microscopy — Restormer + gradient` corresponds to the leaderboard entry at

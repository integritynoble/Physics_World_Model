# Three-Photon Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('three_photon_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Three-Photon Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Lattice Light-Sheet Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

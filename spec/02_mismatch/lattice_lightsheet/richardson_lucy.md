# Lattice Light-Sheet Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

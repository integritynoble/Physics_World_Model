# Lattice Light-Sheet Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

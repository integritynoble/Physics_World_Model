# Lattice Light-Sheet Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_landweber_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Lattice Light-Sheet Microscopy — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: Z-stack (Z × H × W, float32)
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

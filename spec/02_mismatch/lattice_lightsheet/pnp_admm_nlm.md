# Lattice Light-Sheet Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

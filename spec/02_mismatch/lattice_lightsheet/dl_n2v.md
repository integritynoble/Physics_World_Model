# Lattice Light-Sheet Microscopy — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — Noise2Void + gradient` corresponds to the leaderboard entry at

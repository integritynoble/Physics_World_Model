# Lattice Light-Sheet Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_wiener_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Lattice Light-Sheet Microscopy — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — Restormer + gradient` corresponds to the leaderboard entry at

# Lattice Light-Sheet Microscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — CARE + gradient` corresponds to the leaderboard entry at

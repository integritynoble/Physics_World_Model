# Lattice Light-Sheet Microscopy — DiffusionMicro + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Lattice Light-Sheet Microscopy — DiffusionMicro + gradient` corresponds to the leaderboard entry at

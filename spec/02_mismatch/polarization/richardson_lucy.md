# Polarization Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polarization_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

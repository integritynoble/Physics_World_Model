# Polarization Microscopy — PolarNet [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polarization_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — PolarNet [proxy] + gradient` corresponds to the leaderboard entry at

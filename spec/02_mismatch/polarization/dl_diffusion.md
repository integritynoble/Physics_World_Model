# Polarization Microscopy — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polarization_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — CS-Diffusion + gradient` corresponds to the leaderboard entry at

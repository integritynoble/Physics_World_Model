# Polarization Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polarization_landweber_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

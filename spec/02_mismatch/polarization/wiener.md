# Polarization Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polarization_wiener_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

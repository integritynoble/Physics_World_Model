# Polarization Microscopy — PnP-HQS + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polarization_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — PnP-HQS + gradient` corresponds to the leaderboard entry at

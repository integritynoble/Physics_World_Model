# Polarization Microscopy — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: Stokes images (4 × H × W, float32)
...
plt.tight_layout(); plt.savefig('polarization_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — CS-Transformer + gradient` corresponds to the leaderboard entry at

# Polarization Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polarization_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Polarization Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polarization_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Polarization Microscopy — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polarization_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — ReconNet + gradient` corresponds to the leaderboard entry at

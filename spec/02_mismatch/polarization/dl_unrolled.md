# Polarization Microscopy — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('polarization_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Polarization Microscopy — Unrolled-Net + gradient` corresponds to the leaderboard entry at

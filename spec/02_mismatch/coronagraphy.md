# Stellar Coronagraphy — Mismatch Correction + Reconstruct
...
from algorithm_base.coronagraphy.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('coronagraphy_corrected.png'); plt.show()
```

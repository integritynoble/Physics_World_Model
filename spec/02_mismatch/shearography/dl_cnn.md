# Shearography — Probe-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Shearography — Probe-CNN + gradient` corresponds to the leaderboard entry at

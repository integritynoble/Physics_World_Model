# Shearography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Shearography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Shearography — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Shearography — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

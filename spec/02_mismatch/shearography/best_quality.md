# Shearography — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Shearography — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

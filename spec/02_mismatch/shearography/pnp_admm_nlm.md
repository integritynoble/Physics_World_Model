# Shearography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Shearography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

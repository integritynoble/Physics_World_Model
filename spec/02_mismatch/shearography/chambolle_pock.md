# Shearography — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: shearograms (2 × H × W, float32)
...
plt.tight_layout(); plt.savefig('shearography_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Shearography — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

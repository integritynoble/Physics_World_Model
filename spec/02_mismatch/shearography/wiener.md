# Shearography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_wiener_corrected.png'); plt.show()
```

## Benchmark

`Shearography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

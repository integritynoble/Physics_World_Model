# Shearography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Shearography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

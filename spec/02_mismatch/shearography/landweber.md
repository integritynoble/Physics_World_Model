# Shearography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_landweber_corrected.png'); plt.show()
```

## Benchmark

`Shearography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

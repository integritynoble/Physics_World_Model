# Shearography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Shearography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

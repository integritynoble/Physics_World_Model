# Shearography — Probe-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Shearography — Probe-Diffusion + gradient` corresponds to the leaderboard entry at

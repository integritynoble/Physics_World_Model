# Shearography — Probe-GAN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_dl_gan_corrected.png'); plt.show()
```

## Benchmark

`Shearography — Probe-GAN + gradient` corresponds to the leaderboard entry at

# Shearography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shearography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Shearography — TV-ADMM + gradient` corresponds to the leaderboard entry at

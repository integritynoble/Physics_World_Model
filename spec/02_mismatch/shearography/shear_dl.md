# Shearography — ShearNet [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('shear_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('shear_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('shearography_shear_dl_corrected.png'); plt.show()
```

## Benchmark

`Shearography — ShearNet [proxy] + gradient` corresponds to the leaderboard entry at

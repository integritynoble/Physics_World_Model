# Streak Camera Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.streak_camera.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('streak_camera_corrected.png'); plt.show()
```

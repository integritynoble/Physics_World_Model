# Full-Waveform Inversion (FWI) — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — RS-Diffusion + gradient` corresponds to the leaderboard entry at

# Full-Waveform Inversion (FWI) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_wiener_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Full-Waveform Inversion (FWI) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

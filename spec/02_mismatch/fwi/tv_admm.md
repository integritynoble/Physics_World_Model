# Full-Waveform Inversion (FWI) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — TV-ADMM + gradient` corresponds to the leaderboard entry at

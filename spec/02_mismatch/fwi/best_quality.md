# Full-Waveform Inversion (FWI) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

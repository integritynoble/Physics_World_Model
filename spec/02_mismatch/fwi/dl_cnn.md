# Full-Waveform Inversion (FWI) — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — RS-CNN + gradient` corresponds to the leaderboard entry at

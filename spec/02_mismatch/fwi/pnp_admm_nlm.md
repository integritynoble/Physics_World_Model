# Full-Waveform Inversion (FWI) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Full-Waveform Inversion (FWI) — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: seismic waveforms (receivers × time, float32)
...
plt.tight_layout(); plt.savefig('fwi_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — RS-Transformer + gradient` corresponds to the leaderboard entry at

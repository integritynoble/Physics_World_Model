# Full-Waveform Inversion (FWI) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_landweber_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

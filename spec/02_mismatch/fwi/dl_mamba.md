# Full-Waveform Inversion (FWI) — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — RS-Mamba + gradient` corresponds to the leaderboard entry at

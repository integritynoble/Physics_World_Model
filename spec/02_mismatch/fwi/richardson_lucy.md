# Full-Waveform Inversion (FWI) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

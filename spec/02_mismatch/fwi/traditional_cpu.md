# Full-Waveform Inversion (FWI) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Full-Waveform Inversion (FWI) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fwi_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Full-Waveform Inversion (FWI) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Near-field Scanning Optical Microscopy (NSOM) — Probe-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nsom_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Near-field Scanning Optical Microscopy (NSOM) — Probe-CNN + gradient` corresponds to the leaderboard entry at

# Near-field Scanning Optical Microscopy (NSOM) — Probe-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nsom_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Near-field Scanning Optical Microscopy (NSOM) — Probe-Diffusion + gradient` corresponds to the leaderboard entry at

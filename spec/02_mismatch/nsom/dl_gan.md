# Near-field Scanning Optical Microscopy (NSOM) — Probe-GAN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nsom_dl_gan_corrected.png'); plt.show()
```

## Benchmark

`Near-field Scanning Optical Microscopy (NSOM) — Probe-GAN + gradient` corresponds to the leaderboard entry at

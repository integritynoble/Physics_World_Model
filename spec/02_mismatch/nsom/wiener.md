# Near-field Scanning Optical Microscopy (NSOM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nsom_wiener_corrected.png'); plt.show()
```

## Benchmark

`Near-field Scanning Optical Microscopy (NSOM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

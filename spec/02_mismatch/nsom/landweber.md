# Near-field Scanning Optical Microscopy (NSOM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nsom_landweber_corrected.png'); plt.show()
```

## Benchmark

`Near-field Scanning Optical Microscopy (NSOM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

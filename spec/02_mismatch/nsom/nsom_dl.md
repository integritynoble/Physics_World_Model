# Near-field Scanning Optical Microscopy (NSOM) — NSOM-Net + Gradient Mismatch Correction
...
x_wrong = run_solver('nsom_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('nsom_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('nsom_nsom_dl_corrected.png'); plt.show()
```

## Benchmark

`Near-field Scanning Optical Microscopy (NSOM) — NSOM-Net + gradient` corresponds to the leaderboard entry at

# Near-field Scanning Optical Microscopy (NSOM) — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: near-field signal (H × W, float32)
...
plt.tight_layout(); plt.savefig('nsom_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Near-field Scanning Optical Microscopy (NSOM) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

# Near-field Scanning Optical Microscopy (NSOM) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nsom_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Near-field Scanning Optical Microscopy (NSOM) — CARE + gradient` corresponds to the leaderboard entry at

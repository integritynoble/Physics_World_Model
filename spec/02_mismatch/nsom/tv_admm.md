# Near-field Scanning Optical Microscopy (NSOM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nsom_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Near-field Scanning Optical Microscopy (NSOM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

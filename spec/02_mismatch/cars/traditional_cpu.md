# Coherent Anti-Stokes Raman (CARS) Microscopy — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

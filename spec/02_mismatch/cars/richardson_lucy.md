# Coherent Anti-Stokes Raman (CARS) Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Coherent Anti-Stokes Raman (CARS) Microscopy — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — Spec-CNN + gradient` corresponds to the leaderboard entry at

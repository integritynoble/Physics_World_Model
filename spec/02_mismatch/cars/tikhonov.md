# Coherent Anti-Stokes Raman (CARS) Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

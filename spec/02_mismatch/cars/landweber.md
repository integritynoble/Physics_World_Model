# Coherent Anti-Stokes Raman (CARS) Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_landweber_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

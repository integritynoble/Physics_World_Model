# Coherent Anti-Stokes Raman (CARS) Microscopy — CARS-DeepSpec [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('cars_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('cars_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cars_cars_dl_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — CARS-DeepSpec [proxy] + gradient` corresponds to the leaderboard entry at

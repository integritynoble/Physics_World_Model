# Coherent Anti-Stokes Raman (CARS) Microscopy — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: CARS spectrum cube (H × W × λ, float32)
...
plt.tight_layout(); plt.savefig('cars_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — Spec-Transformer + gradient` corresponds to the leaderboard entry at

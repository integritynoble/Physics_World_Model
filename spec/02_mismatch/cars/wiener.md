# Coherent Anti-Stokes Raman (CARS) Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_wiener_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

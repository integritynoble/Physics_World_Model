# Coherent Anti-Stokes Raman (CARS) Microscopy — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

# Coherent Anti-Stokes Raman (CARS) Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

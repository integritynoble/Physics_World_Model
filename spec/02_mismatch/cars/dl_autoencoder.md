# Coherent Anti-Stokes Raman (CARS) Microscopy — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — Spec-AE + gradient` corresponds to the leaderboard entry at

# Coherent Anti-Stokes Raman (CARS) Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

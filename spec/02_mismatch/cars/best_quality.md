# Coherent Anti-Stokes Raman (CARS) Microscopy — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

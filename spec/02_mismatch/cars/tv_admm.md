# Coherent Anti-Stokes Raman (CARS) Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cars_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Coherent Anti-Stokes Raman (CARS) Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Scanning Tunneling Microscopy (STM) — Mismatch Correction + Reconstruct
...
from algorithm_base.stm.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('stm_corrected.png'); plt.show()
```

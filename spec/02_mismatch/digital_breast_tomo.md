# Digital Breast Tomosynthesis (DBT) — Mismatch Correction + Reconstruct
...
from algorithm_base.digital_breast_tomo.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_corrected.png'); plt.show()
```

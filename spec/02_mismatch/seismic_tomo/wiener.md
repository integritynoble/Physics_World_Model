# Seismic Tomography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_wiener_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

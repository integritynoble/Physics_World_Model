# Seismic Tomography — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — RS-CNN + gradient` corresponds to the leaderboard entry at

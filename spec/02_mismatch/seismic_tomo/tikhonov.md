# Seismic Tomography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Seismic Tomography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Seismic Tomography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

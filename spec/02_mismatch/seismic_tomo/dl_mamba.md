# Seismic Tomography — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — RS-Mamba + gradient` corresponds to the leaderboard entry at

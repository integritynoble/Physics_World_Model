# Seismic Tomography — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

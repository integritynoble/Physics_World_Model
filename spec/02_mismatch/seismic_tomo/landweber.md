# Seismic Tomography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_landweber_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

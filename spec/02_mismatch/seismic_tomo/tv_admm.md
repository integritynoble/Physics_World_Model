# Seismic Tomography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — TV-ADMM + gradient` corresponds to the leaderboard entry at

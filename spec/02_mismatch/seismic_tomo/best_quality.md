# Seismic Tomography — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

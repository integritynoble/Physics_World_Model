# Seismic Tomography — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: travel times (src-recv, float32)
...
plt.tight_layout(); plt.savefig('seismic_tomo_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — RS-Transformer + gradient` corresponds to the leaderboard entry at

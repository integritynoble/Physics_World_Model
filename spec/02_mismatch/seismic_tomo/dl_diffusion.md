# Seismic Tomography — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — RS-Diffusion + gradient` corresponds to the leaderboard entry at

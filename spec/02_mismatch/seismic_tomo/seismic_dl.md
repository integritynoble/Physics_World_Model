# Seismic Tomography — SeisInversion-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('seismic_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('seismic_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('seismic_tomo_seismic_dl_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — SeisInversion-Net [proxy] + gradient` corresponds to the leaderboard entry at

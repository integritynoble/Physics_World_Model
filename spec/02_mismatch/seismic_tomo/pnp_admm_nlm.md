# Seismic Tomography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('seismic_tomo_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Seismic Tomography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

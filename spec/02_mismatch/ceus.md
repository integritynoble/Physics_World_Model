# Contrast-Enhanced Ultrasound (CEUS) — Mismatch Correction + Reconstruct
...
from algorithm_base.ceus.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('ceus_corrected.png'); plt.show()
```

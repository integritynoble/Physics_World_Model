# High Dynamic Range (HDR) Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hdr_imaging_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`High Dynamic Range (HDR) Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

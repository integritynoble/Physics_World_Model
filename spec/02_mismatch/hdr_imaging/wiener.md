# High Dynamic Range (HDR) Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hdr_imaging_wiener_corrected.png'); plt.show()
```

## Benchmark

`High Dynamic Range (HDR) Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

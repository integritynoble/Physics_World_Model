# High Dynamic Range (HDR) Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hdr_imaging_landweber_corrected.png'); plt.show()
```

## Benchmark

`High Dynamic Range (HDR) Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# High Dynamic Range (HDR) Imaging — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hdr_imaging_best_quality_corrected.png'); plt.show()
```

## Benchmark

`High Dynamic Range (HDR) Imaging — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

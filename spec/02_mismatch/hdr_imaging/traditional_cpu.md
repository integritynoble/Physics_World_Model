# High Dynamic Range (HDR) Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hdr_imaging_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`High Dynamic Range (HDR) Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

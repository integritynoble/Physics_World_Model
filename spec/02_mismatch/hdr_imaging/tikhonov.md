# High Dynamic Range (HDR) Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hdr_imaging_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`High Dynamic Range (HDR) Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

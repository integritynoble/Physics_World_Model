# High Dynamic Range (HDR) Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hdr_imaging_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`High Dynamic Range (HDR) Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

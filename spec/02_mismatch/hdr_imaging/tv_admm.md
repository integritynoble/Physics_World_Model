# High Dynamic Range (HDR) Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hdr_imaging_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`High Dynamic Range (HDR) Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

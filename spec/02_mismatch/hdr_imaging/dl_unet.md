# High Dynamic Range (HDR) Imaging — DL-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hdr_imaging_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`High Dynamic Range (HDR) Imaging — DL-UNet + gradient` corresponds to the leaderboard entry at

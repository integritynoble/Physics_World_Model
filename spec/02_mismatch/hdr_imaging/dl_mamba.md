# High Dynamic Range (HDR) Imaging — DL-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hdr_imaging_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`High Dynamic Range (HDR) Imaging — DL-Mamba + gradient` corresponds to the leaderboard entry at

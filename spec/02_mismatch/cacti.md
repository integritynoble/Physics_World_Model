# Coded Aperture Compressive Temporal Imaging (CACTI) — Mismatch Correction + Reconstruct

**Input**: coded frames (B × H × W, float32)
**Benchmark**: `gs://pwm-benchmark-datasets/datasets/Benchmark/cacti/public/`
**Algorithms**: 5 CPU, 2 GPU — reconstruct with `run_solver(key, y)`
...
plt.tight_layout(); plt.savefig('cacti_corrected.png'); plt.show()
```

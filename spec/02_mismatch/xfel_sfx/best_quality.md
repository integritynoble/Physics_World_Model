# XFEL Serial Femtosecond Crystallography (SFX) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_best_quality_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# XFEL Serial Femtosecond Crystallography (SFX) — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

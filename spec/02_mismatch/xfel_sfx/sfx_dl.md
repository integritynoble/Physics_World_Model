# XFEL Serial Femtosecond Crystallography (SFX) — SFX-Net [proxy] + Gradient
...
x_wrong = run_solver('sfx_dl', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('sfx_dl', y, cfg=calib_cfg)        # corrected

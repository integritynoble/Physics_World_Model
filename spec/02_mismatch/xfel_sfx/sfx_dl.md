# XFEL Serial Femtosecond Crystallography (SFX) — SFX-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('sfx_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('sfx_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('xfel_sfx_sfx_dl_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — SFX-Net [proxy] + gradient` corresponds to the leaderboard entry at

# XFEL Serial Femtosecond Crystallography (SFX) — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — PhaseNet + gradient` corresponds to the leaderboard entry at

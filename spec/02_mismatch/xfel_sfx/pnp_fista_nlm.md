# XFEL Serial Femtosecond Crystallography (SFX) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

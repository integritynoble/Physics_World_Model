# XFEL Serial Femtosecond Crystallography (SFX) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — TV-ADMM + gradient` corresponds to the leaderboard entry at

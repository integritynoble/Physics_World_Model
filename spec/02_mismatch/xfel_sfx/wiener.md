# XFEL Serial Femtosecond Crystallography (SFX) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_wiener_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

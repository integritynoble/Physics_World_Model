# XFEL Serial Femtosecond Crystallography (SFX) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

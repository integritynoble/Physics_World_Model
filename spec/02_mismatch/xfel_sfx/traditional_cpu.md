# XFEL Serial Femtosecond Crystallography (SFX) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# XFEL Serial Femtosecond Crystallography (SFX) — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — prDeep + gradient` corresponds to the leaderboard entry at

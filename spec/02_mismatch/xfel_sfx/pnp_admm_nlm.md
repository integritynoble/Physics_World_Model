# XFEL Serial Femtosecond Crystallography (SFX) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

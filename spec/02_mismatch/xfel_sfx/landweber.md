# XFEL Serial Femtosecond Crystallography (SFX) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xfel_sfx_landweber_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

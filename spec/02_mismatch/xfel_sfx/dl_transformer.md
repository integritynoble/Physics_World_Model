# XFEL Serial Femtosecond Crystallography (SFX) — Phase-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: diffraction patterns (N_shots × H × W, float32)
...
plt.tight_layout(); plt.savefig('xfel_sfx_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`XFEL Serial Femtosecond Crystallography (SFX) — Phase-Transformer + gradient` corresponds to the leaderboard entry at

# Streak Camera Imaging — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — ReconNet + gradient` corresponds to the leaderboard entry at

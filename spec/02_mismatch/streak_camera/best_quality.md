# Streak Camera Imaging — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

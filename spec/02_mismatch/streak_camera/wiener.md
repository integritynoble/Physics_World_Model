# Streak Camera Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_wiener_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

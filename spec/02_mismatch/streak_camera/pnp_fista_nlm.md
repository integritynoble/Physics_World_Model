# Streak Camera Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

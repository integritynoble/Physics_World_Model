# Streak Camera Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_landweber_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

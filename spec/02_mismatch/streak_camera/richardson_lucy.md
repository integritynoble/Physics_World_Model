# Streak Camera Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Streak Camera Imaging — StreakNet [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('streak_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('streak_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('streak_camera_streak_dl_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — StreakNet [proxy] + gradient` corresponds to the leaderboard entry at

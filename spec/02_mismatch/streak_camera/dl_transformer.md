# Streak Camera Imaging — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: streak image (time × space, float32)
...
plt.tight_layout(); plt.savefig('streak_camera_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — CS-Transformer + gradient` corresponds to the leaderboard entry at

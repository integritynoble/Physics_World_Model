# Streak Camera Imaging — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — Unrolled-Net + gradient` corresponds to the leaderboard entry at

# Streak Camera Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Streak Camera Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

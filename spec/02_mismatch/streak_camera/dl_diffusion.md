# Streak Camera Imaging — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — CS-Diffusion + gradient` corresponds to the leaderboard entry at

# Streak Camera Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

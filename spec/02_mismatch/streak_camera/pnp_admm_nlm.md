# Streak Camera Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('streak_camera_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Streak Camera Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

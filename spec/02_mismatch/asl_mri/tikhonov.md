# Arterial Spin Labeling (ASL) MRI — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('asl_mri_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Arterial Spin Labeling (ASL) MRI — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

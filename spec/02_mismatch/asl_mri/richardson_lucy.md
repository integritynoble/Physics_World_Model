# Arterial Spin Labeling (ASL) MRI — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('asl_mri_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Arterial Spin Labeling (ASL) MRI — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Arterial Spin Labeling (ASL) MRI — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('asl_mri_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Arterial Spin Labeling (ASL) MRI — FBP [proxy] + gradient` corresponds to the leaderboard entry at

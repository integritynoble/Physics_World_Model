# Arterial Spin Labeling (ASL) MRI — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('asl_mri_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Arterial Spin Labeling (ASL) MRI — SwinIR-Med + gradient` corresponds to the leaderboard entry at

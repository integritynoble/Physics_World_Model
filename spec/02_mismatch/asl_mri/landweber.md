# Arterial Spin Labeling (ASL) MRI — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('asl_mri_landweber_corrected.png'); plt.show()
```

## Benchmark

`Arterial Spin Labeling (ASL) MRI — Landweber Iteration + gradient` corresponds to the leaderboard entry at

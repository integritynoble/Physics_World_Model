# Arterial Spin Labeling (ASL) MRI — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('asl_mri_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Arterial Spin Labeling (ASL) MRI — Med-UNet + gradient` corresponds to the leaderboard entry at

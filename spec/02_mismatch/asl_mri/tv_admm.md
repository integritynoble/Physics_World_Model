# Arterial Spin Labeling (ASL) MRI — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('asl_mri_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Arterial Spin Labeling (ASL) MRI — TV-ADMM + gradient` corresponds to the leaderboard entry at

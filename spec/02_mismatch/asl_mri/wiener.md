# Arterial Spin Labeling (ASL) MRI — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('asl_mri_wiener_corrected.png'); plt.show()
```

## Benchmark

`Arterial Spin Labeling (ASL) MRI — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Arterial Spin Labeling (ASL) MRI — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('asl_mri_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Arterial Spin Labeling (ASL) MRI — MedMamba + gradient` corresponds to the leaderboard entry at

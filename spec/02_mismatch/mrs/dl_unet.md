# MR Spectroscopy (MRS) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — Med-UNet + gradient` corresponds to the leaderboard entry at

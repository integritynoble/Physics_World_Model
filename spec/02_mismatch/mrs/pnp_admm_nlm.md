# MR Spectroscopy (MRS) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

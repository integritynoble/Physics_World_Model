# MR Spectroscopy (MRS) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

# MR Spectroscopy (MRS) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

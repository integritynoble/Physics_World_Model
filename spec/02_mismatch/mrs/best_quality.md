# MR Spectroscopy (MRS) — MRS-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_best_quality_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — MRS-Net [proxy] + gradient` corresponds to the leaderboard entry at

# MR Spectroscopy (MRS) — HLSVD-MRS [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — HLSVD-MRS [proxy] + gradient` corresponds to the leaderboard entry at

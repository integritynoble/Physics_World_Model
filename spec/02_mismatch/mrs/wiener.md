# MR Spectroscopy (MRS) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_wiener_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

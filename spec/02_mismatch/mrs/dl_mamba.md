# MR Spectroscopy (MRS) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — MedMamba + gradient` corresponds to the leaderboard entry at

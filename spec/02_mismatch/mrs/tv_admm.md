# MR Spectroscopy (MRS) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# MR Spectroscopy (MRS) — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: FID (T, complex64)
...
plt.tight_layout(); plt.savefig('mrs_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — DiffusionMed + gradient` corresponds to the leaderboard entry at

# MR Spectroscopy (MRS) — SENSE (spectroscopy) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — SENSE (spectroscopy) + gradient` corresponds to the leaderboard entry at

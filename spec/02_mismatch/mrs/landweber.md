# MR Spectroscopy (MRS) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_landweber_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

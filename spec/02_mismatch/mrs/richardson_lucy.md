# MR Spectroscopy (MRS) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# MR Spectroscopy (MRS) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mrs_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`MR Spectroscopy (MRS) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Phase Contrast Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

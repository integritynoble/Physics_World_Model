# Phase Contrast Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_wiener_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

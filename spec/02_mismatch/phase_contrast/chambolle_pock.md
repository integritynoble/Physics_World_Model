# Phase Contrast Microscopy — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — Chambolle-Pock + gradient` corresponds to the leaderboard entry at
`https://pwm.platformai.org/benchmark/phase_contrast` (mismatch correction tier).

# Phase Contrast Microscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — CARE + gradient` corresponds to the leaderboard entry at

# Phase Contrast Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_landweber_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Phase Contrast Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

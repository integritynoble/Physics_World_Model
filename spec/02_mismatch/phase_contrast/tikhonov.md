# Phase Contrast Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

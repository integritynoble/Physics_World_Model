# Phase Contrast Microscopy — Phase-Transformer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — Phase-Transformer + gradient` corresponds to the leaderboard entry at

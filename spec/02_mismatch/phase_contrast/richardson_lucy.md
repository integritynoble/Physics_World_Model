# Phase Contrast Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

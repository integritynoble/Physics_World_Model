# Phase Contrast Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Phase Contrast Microscopy — PhaseNet + Gradient Mismatch Correction
...
x_wrong = run_solver('pc_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('pc_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('phase_contrast_pc_dl_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — PhaseNet + gradient` corresponds to the leaderboard entry at

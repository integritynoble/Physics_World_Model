# Phase Contrast Microscopy — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

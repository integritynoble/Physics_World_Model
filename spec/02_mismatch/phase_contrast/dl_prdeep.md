# Phase Contrast Microscopy — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_contrast_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`Phase Contrast Microscopy — prDeep + gradient` corresponds to the leaderboard entry at

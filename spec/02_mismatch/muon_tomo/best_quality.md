# Muon Tomography — POCA-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — POCA-DL [proxy] + gradient` corresponds to the leaderboard entry at

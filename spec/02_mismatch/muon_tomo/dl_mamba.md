# Muon Tomography — MambaRecon + Gradient Mismatch Correction

**Device**: GPU  **Input**: muon tracks (N × 6, float32)
...
plt.tight_layout(); plt.savefig('muon_tomo_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — MambaRecon + gradient` corresponds to the leaderboard entry at

# Muon Tomography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Muon Tomography — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — TransCT + gradient` corresponds to the leaderboard entry at

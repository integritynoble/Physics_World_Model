# Muon Tomography — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — DiffusionRecon + gradient` corresponds to the leaderboard entry at

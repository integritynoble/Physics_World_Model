# Muon Tomography — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — U-Net Recon + gradient` corresponds to the leaderboard entry at

# Muon Tomography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_landweber_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

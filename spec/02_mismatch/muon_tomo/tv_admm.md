# Muon Tomography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — TV-ADMM + gradient` corresponds to the leaderboard entry at

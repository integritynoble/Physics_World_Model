# Muon Tomography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Muon Tomography — EM-POCA [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — EM-POCA [proxy] + gradient` corresponds to the leaderboard entry at

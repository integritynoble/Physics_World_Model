# Muon Tomography — FBP (muon tomography) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — FBP (muon tomography) + gradient` corresponds to the leaderboard entry at

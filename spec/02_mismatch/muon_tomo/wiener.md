# Muon Tomography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_wiener_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Muon Tomography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('muon_tomo_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Muon Tomography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

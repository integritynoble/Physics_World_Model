# Confocal Live-Cell Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_livecell_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Confocal Live-Cell Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

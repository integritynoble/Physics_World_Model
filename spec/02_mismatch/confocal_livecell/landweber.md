# Confocal Live-Cell Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_livecell_landweber_corrected.png'); plt.show()
```

## Benchmark

`Confocal Live-Cell Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Confocal Live-Cell Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_livecell_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Confocal Live-Cell Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

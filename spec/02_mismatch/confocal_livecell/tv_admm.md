# Confocal Live-Cell Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_livecell_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Confocal Live-Cell Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Confocal Live-Cell Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_livecell_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Confocal Live-Cell Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

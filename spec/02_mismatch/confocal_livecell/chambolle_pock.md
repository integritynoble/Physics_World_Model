# Confocal Live-Cell Microscopy — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_livecell_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Confocal Live-Cell Microscopy — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

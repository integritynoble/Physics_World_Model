# Confocal Live-Cell Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_livecell_wiener_corrected.png'); plt.show()
```

## Benchmark

`Confocal Live-Cell Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

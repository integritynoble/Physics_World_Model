# Confocal Live-Cell Microscopy — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_livecell_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Confocal Live-Cell Microscopy — Restormer + gradient` corresponds to the leaderboard entry at

# Confocal Live-Cell Microscopy — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('confocal_livecell_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Confocal Live-Cell Microscopy — Noise2Void + gradient` corresponds to the leaderboard entry at

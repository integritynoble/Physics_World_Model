# Correlative Light-Electron Microscopy (CLEM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('clem_wiener_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Correlative Light-Electron Microscopy (CLEM) — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('clem_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — Noise2Void + gradient` corresponds to the leaderboard entry at

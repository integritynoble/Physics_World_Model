# Correlative Light-Electron Microscopy (CLEM) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('clem_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — CARE + gradient` corresponds to the leaderboard entry at

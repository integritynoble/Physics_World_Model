# Correlative Light-Electron Microscopy (CLEM) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('clem_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

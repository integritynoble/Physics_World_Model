# Correlative Light-Electron Microscopy (CLEM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('clem_landweber_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

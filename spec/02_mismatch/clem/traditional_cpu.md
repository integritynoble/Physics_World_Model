# Correlative Light-Electron Microscopy (CLEM) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('clem_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

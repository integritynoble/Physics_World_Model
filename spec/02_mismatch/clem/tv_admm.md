# Correlative Light-Electron Microscopy (CLEM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('clem_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Correlative Light-Electron Microscopy (CLEM) — CLEM-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('clem_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('clem_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('clem_clem_dl_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — CLEM-Net [proxy] + gradient` corresponds to the leaderboard entry at

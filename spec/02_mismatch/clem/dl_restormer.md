# Correlative Light-Electron Microscopy (CLEM) — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('clem_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — Restormer + gradient` corresponds to the leaderboard entry at

# Correlative Light-Electron Microscopy (CLEM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('clem_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

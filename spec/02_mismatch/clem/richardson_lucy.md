# Correlative Light-Electron Microscopy (CLEM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('clem_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Correlative Light-Electron Microscopy (CLEM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

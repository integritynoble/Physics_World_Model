# Machine Vision / AOI — Mismatch Correction + Reconstruct
...
from algorithm_base.machine_vision.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('machine_vision_corrected.png'); plt.show()
```

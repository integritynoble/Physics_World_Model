# Multispectral Satellite Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.multispectral_sat.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('multispectral_sat_corrected.png'); plt.show()
```

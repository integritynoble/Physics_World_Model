# Wide-Angle X-ray Scattering (WAXS) — Mismatch Correction + Reconstruct
...
from algorithm_base.waxs.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('waxs_corrected.png'); plt.show()
```

# MR Spectroscopy (MRS) — Mismatch Correction + Reconstruct
...
from algorithm_base.mrs.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('mrs_corrected.png'); plt.show()
```

# Magnetic Particle Imaging (MPI) — Mismatch Correction + Reconstruct
...
from algorithm_base.magnetic_particle.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('magnetic_particle_corrected.png'); plt.show()
```

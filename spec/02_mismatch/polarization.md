# Polarization Microscopy — Mismatch Correction + Reconstruct
...
from algorithm_base.polarization.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('polarization_corrected.png'); plt.show()
```

# Second Harmonic Generation (SHG) Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shg_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Second Harmonic Generation (SHG) Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

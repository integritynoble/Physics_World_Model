# Second Harmonic Generation (SHG) Microscopy — DiffusionMicro + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shg_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Second Harmonic Generation (SHG) Microscopy — DiffusionMicro + gradient` corresponds to the leaderboard entry at

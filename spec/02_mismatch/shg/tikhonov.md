# Second Harmonic Generation (SHG) Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shg_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Second Harmonic Generation (SHG) Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

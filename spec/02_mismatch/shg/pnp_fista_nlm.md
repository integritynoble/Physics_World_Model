# Second Harmonic Generation (SHG) Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shg_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Second Harmonic Generation (SHG) Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

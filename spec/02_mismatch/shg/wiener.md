# Second Harmonic Generation (SHG) Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shg_wiener_corrected.png'); plt.show()
```

## Benchmark

`Second Harmonic Generation (SHG) Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

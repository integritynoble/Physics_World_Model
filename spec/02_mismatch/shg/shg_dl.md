# Second Harmonic Generation (SHG) Microscopy — SHG-CARE + Gradient Mismatch Correction
...
x_wrong = run_solver('shg_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('shg_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('shg_shg_dl_corrected.png'); plt.show()
```

## Benchmark

`Second Harmonic Generation (SHG) Microscopy — SHG-CARE + gradient` corresponds to the leaderboard entry at

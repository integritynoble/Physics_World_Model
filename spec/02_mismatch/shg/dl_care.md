# Second Harmonic Generation (SHG) Microscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shg_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Second Harmonic Generation (SHG) Microscopy — CARE + gradient` corresponds to the leaderboard entry at

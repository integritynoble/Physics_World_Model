# Second Harmonic Generation (SHG) Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shg_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Second Harmonic Generation (SHG) Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Second Harmonic Generation (SHG) Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shg_landweber_corrected.png'); plt.show()
```

## Benchmark

`Second Harmonic Generation (SHG) Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

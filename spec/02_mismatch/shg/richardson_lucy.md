# Second Harmonic Generation (SHG) Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('shg_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Second Harmonic Generation (SHG) Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Radio Interferometry (VLBI) — RDA [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — RDA [proxy] + gradient` corresponds to the leaderboard entry at

# Radio Interferometry (VLBI) — RS-CNN + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_cnn', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_cnn', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('radio_interferometry_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — RS-CNN + gradient` corresponds to the leaderboard entry at

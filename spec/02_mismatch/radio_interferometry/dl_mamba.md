# Radio Interferometry (VLBI) — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — RS-Mamba + gradient` corresponds to the leaderboard entry at

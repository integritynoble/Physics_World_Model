# Radio Interferometry (VLBI) — SAR-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — SAR-DL [proxy] + gradient` corresponds to the leaderboard entry at

# Radio Interferometry (VLBI) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

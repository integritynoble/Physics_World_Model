# Radio Interferometry (VLBI) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

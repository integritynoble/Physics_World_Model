# Radio Interferometry (VLBI) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — TV-ADMM + gradient` corresponds to the leaderboard entry at

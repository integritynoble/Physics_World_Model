# Radio Interferometry (VLBI) — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: UV-plane data (N_baselines, complex64)
...
x_wrong = run_solver('dl_transformer', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_transformer', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('radio_interferometry_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — RS-Transformer + gradient` corresponds to the leaderboard entry at

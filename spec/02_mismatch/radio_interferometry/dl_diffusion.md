# Radio Interferometry (VLBI) — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — RS-Diffusion + gradient` corresponds to the leaderboard entry at

# Radio Interferometry (VLBI) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_landweber_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

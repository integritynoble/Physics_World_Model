# Radio Interferometry (VLBI) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

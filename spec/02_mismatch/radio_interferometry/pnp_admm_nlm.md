# Radio Interferometry (VLBI) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Radio Interferometry (VLBI) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('radio_interferometry_wiener_corrected.png'); plt.show()
```

## Benchmark

`Radio Interferometry (VLBI) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

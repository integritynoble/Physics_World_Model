# Fundus Camera — Mismatch Correction + Reconstruct
...
from algorithm_base.fundus.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('fundus_corrected.png'); plt.show()
```

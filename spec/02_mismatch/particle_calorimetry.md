# Particle Calorimetry — Mismatch Correction + Reconstruct
...
from algorithm_base.particle_calorimetry.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('particle_calorimetry_corrected.png'); plt.show()
```

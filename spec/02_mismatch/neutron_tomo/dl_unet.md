# Neutron Radiography / Tomography — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — U-Net Recon + gradient` corresponds to the leaderboard entry at

# Neutron Radiography / Tomography — NeuTomo-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — NeuTomo-DL [proxy] + gradient` corresponds to the leaderboard entry at

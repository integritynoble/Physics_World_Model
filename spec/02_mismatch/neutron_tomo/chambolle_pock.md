# Neutron Radiography / Tomography — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

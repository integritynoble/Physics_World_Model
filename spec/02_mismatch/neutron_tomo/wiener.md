# Neutron Radiography / Tomography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_wiener_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Neutron Radiography / Tomography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — TV-ADMM + gradient` corresponds to the leaderboard entry at

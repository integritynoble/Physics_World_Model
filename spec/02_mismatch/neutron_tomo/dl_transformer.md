# Neutron Radiography / Tomography — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — TransCT + gradient` corresponds to the leaderboard entry at

# Neutron Radiography / Tomography — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — DiffusionRecon + gradient` corresponds to the leaderboard entry at

# Neutron Radiography / Tomography — GRIDREC-Neutron [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — GRIDREC-Neutron [proxy] + gradient` corresponds to the leaderboard entry at

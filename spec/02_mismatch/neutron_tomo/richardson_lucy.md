# Neutron Radiography / Tomography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Neutron Radiography / Tomography — MambaRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — MambaRecon + gradient` corresponds to the leaderboard entry at
`https://pwm.platformai.org/benchmark/neutron_tomo` (mismatch correction tier).

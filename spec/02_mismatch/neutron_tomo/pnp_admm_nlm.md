# Neutron Radiography / Tomography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

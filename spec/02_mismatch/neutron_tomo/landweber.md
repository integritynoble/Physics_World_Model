# Neutron Radiography / Tomography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_landweber_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

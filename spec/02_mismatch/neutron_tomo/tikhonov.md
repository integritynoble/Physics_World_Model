# Neutron Radiography / Tomography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

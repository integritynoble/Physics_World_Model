# Neutron Radiography / Tomography — FBP (neutron tomography) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('neutron_tomo_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Neutron Radiography / Tomography — FBP (neutron tomography) + gradient` corresponds to the leaderboard entry at

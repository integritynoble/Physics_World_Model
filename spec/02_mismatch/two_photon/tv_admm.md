# Two-Photon / Multiphoton Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

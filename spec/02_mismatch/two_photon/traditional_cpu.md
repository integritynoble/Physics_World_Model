# Two-Photon / Multiphoton Microscopy — Richardson-Lucy (2P) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — Richardson-Lucy (2P) + gradient` corresponds to the leaderboard entry at

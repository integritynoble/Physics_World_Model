# Two-Photon / Multiphoton Microscopy — 2P-Net (CARE) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — 2P-Net (CARE) + gradient` corresponds to the leaderboard entry at

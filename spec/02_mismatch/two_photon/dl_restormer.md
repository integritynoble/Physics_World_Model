# Two-Photon / Multiphoton Microscopy — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — Restormer + gradient` corresponds to the leaderboard entry at

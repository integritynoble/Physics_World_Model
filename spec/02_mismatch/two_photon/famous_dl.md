# Two-Photon / Multiphoton Microscopy — 2P-DeepInterp + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — 2P-DeepInterp + gradient` corresponds to the leaderboard entry at

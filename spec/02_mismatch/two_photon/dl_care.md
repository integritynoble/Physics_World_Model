# Two-Photon / Multiphoton Microscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — CARE + gradient` corresponds to the leaderboard entry at

# Two-Photon / Multiphoton Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

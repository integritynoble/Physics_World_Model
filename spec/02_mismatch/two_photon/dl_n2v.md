# Two-Photon / Multiphoton Microscopy — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — Noise2Void + gradient` corresponds to the leaderboard entry at

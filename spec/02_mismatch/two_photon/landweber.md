# Two-Photon / Multiphoton Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_landweber_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

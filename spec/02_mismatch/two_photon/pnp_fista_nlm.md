# Two-Photon / Multiphoton Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Two-Photon / Multiphoton Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

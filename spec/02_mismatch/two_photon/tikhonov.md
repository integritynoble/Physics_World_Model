# Two-Photon / Multiphoton Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Two-Photon / Multiphoton Microscopy — DiffusionMicro + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — DiffusionMicro + gradient` corresponds to the leaderboard entry at

# Two-Photon / Multiphoton Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('two_photon_wiener_corrected.png'); plt.show()
```

## Benchmark

`Two-Photon / Multiphoton Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

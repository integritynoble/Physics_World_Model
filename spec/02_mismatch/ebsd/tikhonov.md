# Electron Backscatter Diffraction (EBSD) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

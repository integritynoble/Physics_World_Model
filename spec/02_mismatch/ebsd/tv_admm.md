# Electron Backscatter Diffraction (EBSD) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — TV-ADMM + gradient` corresponds to the leaderboard entry at

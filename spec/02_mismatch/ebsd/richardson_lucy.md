# Electron Backscatter Diffraction (EBSD) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

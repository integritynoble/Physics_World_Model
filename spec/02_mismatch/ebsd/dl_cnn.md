# Electron Backscatter Diffraction (EBSD) — Probe-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — Probe-CNN + gradient` corresponds to the leaderboard entry at

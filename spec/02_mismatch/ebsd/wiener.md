# Electron Backscatter Diffraction (EBSD) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_wiener_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

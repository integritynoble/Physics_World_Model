# Electron Backscatter Diffraction (EBSD) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Electron Backscatter Diffraction (EBSD) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_landweber_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

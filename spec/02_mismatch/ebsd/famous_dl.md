# Electron Backscatter Diffraction (EBSD) — EMsoft-EBSD [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — EMsoft-EBSD [proxy] + gradient` corresponds to the leaderboard entry at

# Electron Backscatter Diffraction (EBSD) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Electron Backscatter Diffraction (EBSD) — Probe-GAN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_dl_gan_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — Probe-GAN + gradient` corresponds to the leaderboard entry at

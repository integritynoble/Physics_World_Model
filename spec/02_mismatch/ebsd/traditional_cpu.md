# Electron Backscatter Diffraction (EBSD) — FISTA-L2 (Hough baseline) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — FISTA-L2 (Hough baseline) + gradient` corresponds to the leaderboard entry at

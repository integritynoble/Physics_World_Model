# Electron Backscatter Diffraction (EBSD) — Probe-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ebsd_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Electron Backscatter Diffraction (EBSD) — Probe-Diffusion + gradient` corresponds to the leaderboard entry at

# Widefield Fluorescence Microscopy — Mismatch Correction + Reconstruct

**Input**: fluorescence image (H × W, float32)
**Benchmark**: `gs://pwm-benchmark-datasets/datasets/Benchmark/widefield/public/`
**Algorithms**: 10 CPU, 7 GPU — reconstruct with `run_solver(key, y)`
...
plt.tight_layout(); plt.savefig('widefield_corrected.png'); plt.show()
```

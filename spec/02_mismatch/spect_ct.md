# SPECT/CT Fusion — Mismatch Correction + Reconstruct
...
from algorithm_base.spect_ct.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('spect_ct_corrected.png'); plt.show()
```

# Differential Interference Contrast (DIC) — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dic_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — Noise2Void + gradient` corresponds to the leaderboard entry at

# Differential Interference Contrast (DIC) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dic_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

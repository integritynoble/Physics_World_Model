# Differential Interference Contrast (DIC) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dic_wiener_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Differential Interference Contrast (DIC) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dic_landweber_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

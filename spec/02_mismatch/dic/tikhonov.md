# Differential Interference Contrast (DIC) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dic_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Differential Interference Contrast (DIC) — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dic_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — Restormer + gradient` corresponds to the leaderboard entry at

# Differential Interference Contrast (DIC) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dic_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

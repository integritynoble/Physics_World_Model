# Differential Interference Contrast (DIC) — DIC-Net + Gradient Mismatch Correction
...
x_wrong = run_solver('dic_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dic_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('dic_dic_dl_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — DIC-Net + gradient` corresponds to the leaderboard entry at

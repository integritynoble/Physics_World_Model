# Differential Interference Contrast (DIC) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dic_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — CARE + gradient` corresponds to the leaderboard entry at

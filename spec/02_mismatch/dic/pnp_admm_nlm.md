# Differential Interference Contrast (DIC) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dic_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

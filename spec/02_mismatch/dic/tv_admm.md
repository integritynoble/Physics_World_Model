# Differential Interference Contrast (DIC) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dic_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Differential Interference Contrast (DIC) — TV-ADMM + gradient` corresponds to the leaderboard entry at

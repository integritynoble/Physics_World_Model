# Atomic Force Microscopy (AFM) — Mismatch Correction + Reconstruct
...
from algorithm_base.afm.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('afm_corrected.png'); plt.show()
```

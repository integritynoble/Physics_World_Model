# Panorama Multi-Focus Fusion — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('panorama_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Panorama Multi-Focus Fusion — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

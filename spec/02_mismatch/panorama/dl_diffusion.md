# Panorama Multi-Focus Fusion — DL-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('panorama_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Panorama Multi-Focus Fusion — DL-Diffusion + gradient` corresponds to the leaderboard entry at

# Panorama Multi-Focus Fusion — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('panorama_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Panorama Multi-Focus Fusion — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Panorama Multi-Focus Fusion — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('panorama_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Panorama Multi-Focus Fusion — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

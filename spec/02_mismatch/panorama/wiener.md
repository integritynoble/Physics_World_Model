# Panorama Multi-Focus Fusion — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('panorama_wiener_corrected.png'); plt.show()
```

## Benchmark

`Panorama Multi-Focus Fusion — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

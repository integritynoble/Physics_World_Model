# Panorama Multi-Focus Fusion — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('panorama_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Panorama Multi-Focus Fusion — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

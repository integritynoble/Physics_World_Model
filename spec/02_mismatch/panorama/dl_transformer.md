# Panorama Multi-Focus Fusion — DL-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: images (N × H × W × 3, uint8)
...
plt.tight_layout(); plt.savefig('panorama_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Panorama Multi-Focus Fusion — DL-Transformer + gradient` corresponds to the leaderboard entry at

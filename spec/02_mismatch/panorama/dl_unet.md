# Panorama Multi-Focus Fusion — DL-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('panorama_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Panorama Multi-Focus Fusion — DL-UNet + gradient` corresponds to the leaderboard entry at

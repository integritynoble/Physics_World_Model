# Panorama Multi-Focus Fusion — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('panorama_landweber_corrected.png'); plt.show()
```

## Benchmark

`Panorama Multi-Focus Fusion — Landweber Iteration + gradient` corresponds to the leaderboard entry at

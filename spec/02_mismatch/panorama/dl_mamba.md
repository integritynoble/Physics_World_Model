# Panorama Multi-Focus Fusion — DL-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('panorama_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Panorama Multi-Focus Fusion — DL-Mamba + gradient` corresponds to the leaderboard entry at

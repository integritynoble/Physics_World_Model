# Photometric Stereo — Mismatch Correction + Reconstruct
...
from algorithm_base.photometric_stereo.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('photometric_stereo_corrected.png'); plt.show()
```

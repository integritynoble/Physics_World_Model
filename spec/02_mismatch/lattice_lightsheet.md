# Lattice Light-Sheet Microscopy — Mismatch Correction + Reconstruct
...
from algorithm_base.lattice_lightsheet.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_corrected.png'); plt.show()
```

# STED Microscopy — STED-Net (CARE) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_best_quality_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — STED-Net (CARE) + gradient` corresponds to the leaderboard entry at

# STED Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_landweber_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

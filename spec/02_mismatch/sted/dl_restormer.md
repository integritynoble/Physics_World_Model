# STED Microscopy — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — Restormer + gradient` corresponds to the leaderboard entry at

# STED Microscopy — Richardson-Lucy (STED) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — Richardson-Lucy (STED) + gradient` corresponds to the leaderboard entry at

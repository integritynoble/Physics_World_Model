# STED Microscopy — RCAN-STED + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — RCAN-STED + gradient` corresponds to the leaderboard entry at

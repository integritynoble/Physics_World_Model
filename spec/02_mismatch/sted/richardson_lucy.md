# STED Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

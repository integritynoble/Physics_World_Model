# STED Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# STED Microscopy — DiffusionMicro + Gradient Mismatch Correction

**Device**: GPU  **Input**: STED + confocal (2 × H × W, float32)
...
plt.tight_layout(); plt.savefig('sted_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — DiffusionMicro + gradient` corresponds to the leaderboard entry at

# STED Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# STED Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# STED Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_wiener_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

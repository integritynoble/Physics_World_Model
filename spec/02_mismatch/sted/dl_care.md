# STED Microscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_dl_care_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — CARE + gradient` corresponds to the leaderboard entry at

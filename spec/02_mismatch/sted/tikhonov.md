# STED Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('sted_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`STED Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

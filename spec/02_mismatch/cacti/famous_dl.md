# Coded Aperture Compressive Temporal Imaging (CACTI) — ELP-Unfolding + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cacti_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Coded Aperture Compressive Temporal Imaging (CACTI) — ELP-Unfolding + gradient` corresponds to the leaderboard entry at

# Coded Aperture Compressive Temporal Imaging (CACTI) — PnP-FFDNet + Gradient
...
x_wrong = run_solver('pnp_ffdnet', y)           # no correction
timing = cacti_calibrate_timing(y)
calib_cfg = {"timing_offset": timing}
x = run_solver('pnp_ffdnet', y, cfg=calib_cfg)        # corrected

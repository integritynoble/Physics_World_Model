# Coded Aperture Compressive Temporal Imaging (CACTI) — EfficientSCI-T + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cacti_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Coded Aperture Compressive Temporal Imaging (CACTI) — EfficientSCI-T + gradient` corresponds to the leaderboard entry at

# Coded Aperture Compressive Temporal Imaging (CACTI) — EfficientSCI + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cacti_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Coded Aperture Compressive Temporal Imaging (CACTI) — EfficientSCI + gradient` corresponds to the leaderboard entry at

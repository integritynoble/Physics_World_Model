# Coded Aperture Compressive Temporal Imaging (CACTI) — HiSViT-9 + Gradient
...
x_wrong = run_solver('hisvit9', y)           # no correction
timing = cacti_calibrate_timing(y)
calib_cfg = {"timing_offset": timing}
x = run_solver('hisvit9', y, cfg=calib_cfg)        # corrected

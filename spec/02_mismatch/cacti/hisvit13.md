# Coded Aperture Compressive Temporal Imaging (CACTI) — HiSViT-13 + Gradient

**GPU**  **Mismatch**: frame timing offset `[-1, +1] frames`
...
x_wrong = run_solver('hisvit13', y)           # no correction
timing = cacti_calibrate_timing(y)
calib_cfg = {"timing_offset": timing}
x = run_solver('hisvit13', y, cfg=calib_cfg)        # corrected

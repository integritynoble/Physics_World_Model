# Coded Aperture Compressive Temporal Imaging (CACTI) — HiSViT-13 + Gradient Mismatch Correction
...
x_wrong = run_solver('hisvit13', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('hisvit13', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cacti_hisvit13_corrected.png'); plt.show()
```

## Benchmark

`Coded Aperture Compressive Temporal Imaging (CACTI) — HiSViT-13 + gradient` corresponds to the leaderboard entry at

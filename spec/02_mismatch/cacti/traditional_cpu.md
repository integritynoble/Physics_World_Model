# Coded Aperture Compressive Temporal Imaging (CACTI) — GAP-TV + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cacti_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Coded Aperture Compressive Temporal Imaging (CACTI) — GAP-TV + gradient` corresponds to the leaderboard entry at

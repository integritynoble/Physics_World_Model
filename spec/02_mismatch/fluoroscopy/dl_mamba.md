# Fluoroscopy — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fluoroscopy_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — MedMamba + gradient` corresponds to the leaderboard entry at

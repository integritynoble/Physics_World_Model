# Fluoroscopy — FBP (fluoroscopy) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fluoroscopy_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — FBP (fluoroscopy) + gradient` corresponds to the leaderboard entry at

# Fluoroscopy — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fluoroscopy_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — SwinIR-Med + gradient` corresponds to the leaderboard entry at

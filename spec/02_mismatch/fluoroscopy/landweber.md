# Fluoroscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fluoroscopy_landweber_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

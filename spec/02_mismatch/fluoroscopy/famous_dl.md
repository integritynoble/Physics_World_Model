# Fluoroscopy — X-ray CNN [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fluoroscopy_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — X-ray CNN [proxy] + gradient` corresponds to the leaderboard entry at

# Fluoroscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fluoroscopy_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

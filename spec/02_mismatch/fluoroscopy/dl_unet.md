# Fluoroscopy — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fluoroscopy_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — Med-UNet + gradient` corresponds to the leaderboard entry at

# Fluoroscopy — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: X-ray frames (T × H × W, float32)
...
plt.tight_layout(); plt.savefig('fluoroscopy_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — DiffusionMed + gradient` corresponds to the leaderboard entry at

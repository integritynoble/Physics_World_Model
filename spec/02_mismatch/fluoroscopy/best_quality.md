# Fluoroscopy — FluoroNet [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fluoroscopy_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — FluoroNet [proxy] + gradient` corresponds to the leaderboard entry at

# Fluoroscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fluoroscopy_wiener_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

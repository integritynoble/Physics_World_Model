# Fluoroscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('fluoroscopy_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Fluoroscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

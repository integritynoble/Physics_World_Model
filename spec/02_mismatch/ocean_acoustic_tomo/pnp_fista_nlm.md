# Ocean Acoustic Tomography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Ocean Acoustic Tomography — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

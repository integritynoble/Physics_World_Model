# Ocean Acoustic Tomography — OAT-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('oat_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('oat_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_oat_dl_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — OAT-Net [proxy] + gradient` corresponds to the leaderboard entry at

# Ocean Acoustic Tomography — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: travel times (pairs, float32)
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — RS-Transformer + gradient` corresponds to the leaderboard entry at

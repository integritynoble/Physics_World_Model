# Ocean Acoustic Tomography — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — RS-Mamba + gradient` corresponds to the leaderboard entry at

# Ocean Acoustic Tomography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_landweber_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

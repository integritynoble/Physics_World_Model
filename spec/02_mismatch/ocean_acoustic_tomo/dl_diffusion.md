# Ocean Acoustic Tomography — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — RS-Diffusion + gradient` corresponds to the leaderboard entry at

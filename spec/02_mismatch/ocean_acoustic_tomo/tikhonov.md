# Ocean Acoustic Tomography — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Ocean Acoustic Tomography — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Ocean Acoustic Tomography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — TV-ADMM + gradient` corresponds to the leaderboard entry at

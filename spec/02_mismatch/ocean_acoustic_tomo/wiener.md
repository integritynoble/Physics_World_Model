# Ocean Acoustic Tomography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_wiener_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Ocean Acoustic Tomography — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — RS-CNN + gradient` corresponds to the leaderboard entry at

# Ocean Acoustic Tomography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Ocean Acoustic Tomography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

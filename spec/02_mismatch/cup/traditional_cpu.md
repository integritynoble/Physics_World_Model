# Compressed Ultrafast Photography (CUP) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

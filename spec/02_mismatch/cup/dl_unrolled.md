# Compressed Ultrafast Photography (CUP) — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — Unrolled-Net + gradient` corresponds to the leaderboard entry at

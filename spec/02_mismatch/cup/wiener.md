# Compressed Ultrafast Photography (CUP) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_wiener_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

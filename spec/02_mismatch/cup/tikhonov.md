# Compressed Ultrafast Photography (CUP) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

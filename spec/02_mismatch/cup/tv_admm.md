# Compressed Ultrafast Photography (CUP) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Compressed Ultrafast Photography (CUP) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_landweber_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

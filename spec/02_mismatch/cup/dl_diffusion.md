# Compressed Ultrafast Photography (CUP) — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — CS-Diffusion + gradient` corresponds to the leaderboard entry at

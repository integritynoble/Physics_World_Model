# Compressed Ultrafast Photography (CUP) — E2E-CUP [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('e2e_cup', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('e2e_cup', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cup_e2e_cup_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — E2E-CUP [proxy] + gradient` corresponds to the leaderboard entry at

# Compressed Ultrafast Photography (CUP) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Compressed Ultrafast Photography (CUP) — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — ReconNet + gradient` corresponds to the leaderboard entry at

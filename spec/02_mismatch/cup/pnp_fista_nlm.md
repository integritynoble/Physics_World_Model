# Compressed Ultrafast Photography (CUP) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

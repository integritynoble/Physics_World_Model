# Compressed Ultrafast Photography (CUP) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

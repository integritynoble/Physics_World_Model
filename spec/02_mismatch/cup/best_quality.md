# Compressed Ultrafast Photography (CUP) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cup_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Compressed Ultrafast Photography (CUP) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Positron Emission Tomography (PET) — NeuroLF-PET + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — NeuroLF-PET + gradient` corresponds to the leaderboard entry at

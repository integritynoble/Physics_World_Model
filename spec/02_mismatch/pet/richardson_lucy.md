# Positron Emission Tomography (PET) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

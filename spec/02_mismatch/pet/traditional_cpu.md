# Positron Emission Tomography (PET) — FBP (emission tomography) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — FBP (emission tomography) + gradient` corresponds to the leaderboard entry at

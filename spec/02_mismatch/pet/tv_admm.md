# Positron Emission Tomography (PET) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Positron Emission Tomography (PET) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

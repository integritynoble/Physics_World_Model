# Positron Emission Tomography (PET) — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — DiffusionRecon + gradient` corresponds to the leaderboard entry at

# Positron Emission Tomography (PET) — PET-DL (U-Net) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — PET-DL (U-Net) + gradient` corresponds to the leaderboard entry at

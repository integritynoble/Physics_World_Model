# Positron Emission Tomography (PET) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_wiener_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

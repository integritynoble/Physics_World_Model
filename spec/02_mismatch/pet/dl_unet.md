# Positron Emission Tomography (PET) — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — U-Net Recon + gradient` corresponds to the leaderboard entry at

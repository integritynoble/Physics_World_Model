# Positron Emission Tomography (PET) — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — TransCT + gradient` corresponds to the leaderboard entry at

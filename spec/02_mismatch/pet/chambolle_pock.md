# Positron Emission Tomography (PET) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

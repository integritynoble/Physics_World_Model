# Positron Emission Tomography (PET) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('pet_landweber_corrected.png'); plt.show()
```

## Benchmark

`Positron Emission Tomography (PET) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

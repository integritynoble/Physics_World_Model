# US/MRI Fusion — Mismatch Correction + Reconstruct
...
from algorithm_base.us_mri.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('us_mri_corrected.png'); plt.show()
```

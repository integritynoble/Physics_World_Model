# Machine Vision / AOI — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

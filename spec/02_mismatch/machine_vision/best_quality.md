# Machine Vision / AOI — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

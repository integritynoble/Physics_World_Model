# Machine Vision / AOI — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_wiener_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

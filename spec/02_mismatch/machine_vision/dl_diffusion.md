# Machine Vision / AOI — DL-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — DL-Diffusion + gradient` corresponds to the leaderboard entry at

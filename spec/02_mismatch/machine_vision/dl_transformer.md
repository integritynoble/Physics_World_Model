# Machine Vision / AOI — DL-Transformer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — DL-Transformer + gradient` corresponds to the leaderboard entry at

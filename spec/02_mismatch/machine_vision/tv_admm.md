# Machine Vision / AOI — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Machine Vision / AOI — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

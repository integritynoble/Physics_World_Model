# Machine Vision / AOI — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

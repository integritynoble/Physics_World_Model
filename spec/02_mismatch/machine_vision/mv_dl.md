# Machine Vision / AOI — PatchCore [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('mv_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('mv_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('machine_vision_mv_dl_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — PatchCore [proxy] + gradient` corresponds to the leaderboard entry at

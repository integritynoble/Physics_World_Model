# Machine Vision / AOI — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Machine Vision / AOI — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

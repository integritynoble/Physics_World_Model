# Machine Vision / AOI — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_landweber_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — Landweber Iteration + gradient` corresponds to the leaderboard entry at

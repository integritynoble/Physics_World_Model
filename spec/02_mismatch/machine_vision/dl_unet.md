# Machine Vision / AOI — DL-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('machine_vision_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Machine Vision / AOI — DL-UNet + gradient` corresponds to the leaderboard entry at

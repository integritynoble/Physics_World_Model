# Time-of-Flight Depth Camera — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — ReconNet + gradient` corresponds to the leaderboard entry at

# Time-of-Flight Depth Camera — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_landweber_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — Landweber Iteration + gradient` corresponds to the leaderboard entry at

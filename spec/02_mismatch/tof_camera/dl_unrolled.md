# Time-of-Flight Depth Camera — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — Unrolled-Net + gradient` corresponds to the leaderboard entry at

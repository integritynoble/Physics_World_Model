# Time-of-Flight Depth Camera — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Time-of-Flight Depth Camera — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

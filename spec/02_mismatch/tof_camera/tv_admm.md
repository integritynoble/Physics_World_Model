# Time-of-Flight Depth Camera — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Time-of-Flight Depth Camera — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: depth + amplitude (H × W × 2, float32)
...
plt.tight_layout(); plt.savefig('tof_camera_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — CS-Transformer + gradient` corresponds to the leaderboard entry at

# Time-of-Flight Depth Camera — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Time-of-Flight Depth Camera — FISTA-L2 (depth) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — FISTA-L2 (depth) + gradient` corresponds to the leaderboard entry at

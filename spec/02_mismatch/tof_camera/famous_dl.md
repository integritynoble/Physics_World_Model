# Time-of-Flight Depth Camera — ToF-MPI Deconv [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — ToF-MPI Deconv [proxy] + gradient` corresponds to the leaderboard entry at

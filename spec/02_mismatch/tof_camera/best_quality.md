# Time-of-Flight Depth Camera — ToF-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — ToF-Net [proxy] + gradient` corresponds to the leaderboard entry at

# Time-of-Flight Depth Camera — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_wiener_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Time-of-Flight Depth Camera — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

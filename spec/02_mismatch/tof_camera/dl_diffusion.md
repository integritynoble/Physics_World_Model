# Time-of-Flight Depth Camera — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tof_camera_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Time-of-Flight Depth Camera — CS-Diffusion + gradient` corresponds to the leaderboard entry at

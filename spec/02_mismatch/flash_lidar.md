# Flash LiDAR — Mismatch Correction + Reconstruct
...
from algorithm_base.flash_lidar.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('flash_lidar_corrected.png'); plt.show()
```

# Cryo-EM Single Particle Analysis — CryoMamba (RED DRUNet) + Gradient Mismatch Correction
...
x_wrong = run_solver('cryo_mamba', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('cryo_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cryo_em_cryo_mamba_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — CryoMamba (RED DRUNet) + gradient` corresponds to the leaderboard entry at

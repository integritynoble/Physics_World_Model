# Cryo-EM Single Particle Analysis — Back-Projection + Gradient Mismatch Correction
...
x_wrong = run_solver('back_projection', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('back_projection', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cryo_em_back_projection_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — Back-Projection + gradient` corresponds to the leaderboard entry at

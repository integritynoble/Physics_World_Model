# Cryo-EM Single Particle Analysis — Back-Projection + Gradient
...
x_wrong = run_solver('back_projection', y)           # no correction
defocus = cryoem_calibrate_defocus(y)
calib_cfg = {"defocus": float(defocus)}
x = run_solver('back_projection', y, cfg=calib_cfg)        # corrected

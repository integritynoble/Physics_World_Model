# Cryo-EM Single Particle Analysis — Wiener-CTF Correction + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_em_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — Wiener-CTF Correction + gradient` corresponds to the leaderboard entry at

# Cryo-EM Single Particle Analysis — Topaz-Denoise (DRUNet denoise) + Gradient Mismatch Correction
...
x_wrong = run_solver('topaz_denoise', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('topaz_denoise', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cryo_em_topaz_denoise_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — Topaz-Denoise (DRUNet denoise) + gradient` corresponds to the leaderboard entry at

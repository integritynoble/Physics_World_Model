# Cryo-EM Single Particle Analysis — CryoSTAR (PnP-DRS DRUNet) + Gradient Mismatch Correction
...
x_wrong = run_solver('cryostar', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('cryostar', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cryo_em_cryostar_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — CryoSTAR (PnP-DRS DRUNet) + gradient` corresponds to the leaderboard entry at

# Cryo-EM Single Particle Analysis — SIRT (Simultaneous Iterative) + Gradient Mismatch Correction
...
x_wrong = run_solver('sirt_3d', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('sirt_3d', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cryo_em_sirt_3d_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — SIRT (Simultaneous Iterative) + gradient` corresponds to the leaderboard entry at

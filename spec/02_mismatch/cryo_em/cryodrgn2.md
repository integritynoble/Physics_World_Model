# Cryo-EM Single Particle Analysis — CryoDRGN2 (PnP-HQS DRUNet) + Gradient Mismatch Correction
...
x_wrong = run_solver('cryodrgn2', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('cryodrgn2', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cryo_em_cryodrgn2_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — CryoDRGN2 (PnP-HQS DRUNet) + gradient` corresponds to the leaderboard entry at

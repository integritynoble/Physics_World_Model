# Cryo-EM Single Particle Analysis — CryoDRGN2 (PnP-HQS DRUNet) + Gradient
...
x_wrong = run_solver('cryodrgn2', y)           # no correction
defocus = cryoem_calibrate_defocus(y)
calib_cfg = {"defocus": float(defocus)}
x = run_solver('cryodrgn2', y, cfg=calib_cfg)        # corrected

# Cryo-EM Single Particle Analysis — RELION (PnP-PGD DRUNet) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_em_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — RELION (PnP-PGD DRUNet) + gradient` corresponds to the leaderboard entry at

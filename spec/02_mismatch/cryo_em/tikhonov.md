# Cryo-EM Single Particle Analysis — Tikhonov Regularisation + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_em_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — Tikhonov Regularisation + gradient` corresponds to the leaderboard entry at

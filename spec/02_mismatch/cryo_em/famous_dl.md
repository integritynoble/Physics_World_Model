# Cryo-EM Single Particle Analysis — CryoDRGN (PnP-PGD DRUNet) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_em_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — CryoDRGN (PnP-PGD DRUNet) + gradient` corresponds to the leaderboard entry at

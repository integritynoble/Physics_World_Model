# Cryo-EM Single Particle Analysis — Phase-Flip CTF Correction + Gradient
...
x_wrong = run_solver('phase_flip', y)           # no correction
defocus = cryoem_calibrate_defocus(y)
calib_cfg = {"defocus": float(defocus)}
x = run_solver('phase_flip', y, cfg=calib_cfg)        # corrected

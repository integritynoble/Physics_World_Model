# Cryo-EM Single Particle Analysis — Phase-Flip CTF Correction + Gradient Mismatch Correction
...
x_wrong = run_solver('phase_flip', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('phase_flip', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cryo_em_phase_flip_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — Phase-Flip CTF Correction + gradient` corresponds to the leaderboard entry at

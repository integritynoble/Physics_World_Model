# Cryo-EM Single Particle Analysis — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_em_landweber_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — Landweber Iteration + gradient` corresponds to the leaderboard entry at

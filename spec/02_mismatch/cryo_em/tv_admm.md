# Cryo-EM Single Particle Analysis — Total Variation ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_em_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — Total Variation ADMM + gradient` corresponds to the leaderboard entry at

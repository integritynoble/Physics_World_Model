# Cryo-EM Single Particle Analysis — CryoAI (DnCNN denoise) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('cryo_em_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Cryo-EM Single Particle Analysis — CryoAI (DnCNN denoise) + gradient` corresponds to the leaderboard entry at

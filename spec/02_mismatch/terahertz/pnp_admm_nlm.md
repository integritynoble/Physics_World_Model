# Terahertz Imaging (THz) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

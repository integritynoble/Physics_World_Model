# Terahertz Imaging (THz) — DL-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — DL-UNet + gradient` corresponds to the leaderboard entry at

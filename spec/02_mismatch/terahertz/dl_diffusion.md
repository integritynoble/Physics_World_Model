# Terahertz Imaging (THz) — DL-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — DL-Diffusion + gradient` corresponds to the leaderboard entry at

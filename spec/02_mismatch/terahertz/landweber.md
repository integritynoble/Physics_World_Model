# Terahertz Imaging (THz) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_landweber_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

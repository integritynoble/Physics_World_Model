# Terahertz Imaging (THz) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

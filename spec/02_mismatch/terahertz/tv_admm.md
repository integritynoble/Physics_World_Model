# Terahertz Imaging (THz) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — TV-ADMM + gradient` corresponds to the leaderboard entry at

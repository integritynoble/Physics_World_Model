# Terahertz Imaging (THz) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

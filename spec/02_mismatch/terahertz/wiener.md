# Terahertz Imaging (THz) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_wiener_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Terahertz Imaging (THz) — THz-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('thz_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('thz_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('terahertz_thz_dl_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — THz-Net [proxy] + gradient` corresponds to the leaderboard entry at

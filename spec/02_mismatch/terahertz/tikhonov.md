# Terahertz Imaging (THz) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

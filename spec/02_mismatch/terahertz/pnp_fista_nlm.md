# Terahertz Imaging (THz) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Terahertz Imaging (THz) — DL-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: THz waveform (T × H × W, float32)
...
plt.tight_layout(); plt.savefig('terahertz_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — DL-Transformer + gradient` corresponds to the leaderboard entry at

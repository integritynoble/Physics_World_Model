# Terahertz Imaging (THz) — DL-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — DL-Mamba + gradient` corresponds to the leaderboard entry at

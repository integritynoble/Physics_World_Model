# Terahertz Imaging (THz) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('terahertz_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Terahertz Imaging (THz) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

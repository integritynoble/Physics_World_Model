# Dual-Energy X-ray Absorptiometry (DEXA) — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — U-Net Recon + gradient` corresponds to the leaderboard entry at

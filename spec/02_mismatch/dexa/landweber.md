# Dual-Energy X-ray Absorptiometry (DEXA) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_landweber_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Dual-Energy X-ray Absorptiometry (DEXA) — MambaRecon + Gradient Mismatch Correction

**Device**: GPU  **Input**: dual-energy projections (2 × H × W, float32)
...
plt.tight_layout(); plt.savefig('dexa_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — MambaRecon + gradient` corresponds to the leaderboard entry at

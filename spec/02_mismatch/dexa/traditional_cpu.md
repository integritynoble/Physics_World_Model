# Dual-Energy X-ray Absorptiometry (DEXA) — FISTA-L2 (dual-energy) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — FISTA-L2 (dual-energy) + gradient` corresponds to the leaderboard entry at

# Dual-Energy X-ray Absorptiometry (DEXA) — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — TransCT + gradient` corresponds to the leaderboard entry at

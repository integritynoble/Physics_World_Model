# Dual-Energy X-ray Absorptiometry (DEXA) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Dual-Energy X-ray Absorptiometry (DEXA) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

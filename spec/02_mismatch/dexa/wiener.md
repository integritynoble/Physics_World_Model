# Dual-Energy X-ray Absorptiometry (DEXA) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_wiener_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

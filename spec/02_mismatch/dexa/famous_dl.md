# Dual-Energy X-ray Absorptiometry (DEXA) — DEXA-UNet [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — DEXA-UNet [proxy] + gradient` corresponds to the leaderboard entry at

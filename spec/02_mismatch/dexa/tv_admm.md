# Dual-Energy X-ray Absorptiometry (DEXA) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Dual-Energy X-ray Absorptiometry (DEXA) — DXA-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — DXA-Net [proxy] + gradient` corresponds to the leaderboard entry at

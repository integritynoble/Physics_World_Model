# Dual-Energy X-ray Absorptiometry (DEXA) — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dexa_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Dual-Energy X-ray Absorptiometry (DEXA) — DiffusionRecon + gradient` corresponds to the leaderboard entry at

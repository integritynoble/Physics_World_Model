# Portal Imaging (EPID) — Mismatch Correction + Reconstruct
...
from algorithm_base.portal_imaging.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('portal_imaging_corrected.png'); plt.show()
```

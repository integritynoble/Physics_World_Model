# DNA-PAINT Super-Resolution — DiffusionMicro + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — DiffusionMicro + gradient` corresponds to the leaderboard entry at

# DNA-PAINT Super-Resolution — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_landweber_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — Landweber Iteration + gradient` corresponds to the leaderboard entry at

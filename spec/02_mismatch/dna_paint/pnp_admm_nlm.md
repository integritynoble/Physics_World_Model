# DNA-PAINT Super-Resolution — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

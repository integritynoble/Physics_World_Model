# DNA-PAINT Super-Resolution — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_dl_care_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — CARE + gradient` corresponds to the leaderboard entry at

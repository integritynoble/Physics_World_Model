# DNA-PAINT Super-Resolution — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

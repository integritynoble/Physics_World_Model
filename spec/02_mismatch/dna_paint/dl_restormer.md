# DNA-PAINT Super-Resolution — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — Restormer + gradient` corresponds to the leaderboard entry at

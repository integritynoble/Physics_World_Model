# DNA-PAINT Super-Resolution — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: localisation list (N × 2, float32)
...
plt.tight_layout(); plt.savefig('dna_paint_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

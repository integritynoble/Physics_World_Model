# DNA-PAINT Super-Resolution — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_wiener_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

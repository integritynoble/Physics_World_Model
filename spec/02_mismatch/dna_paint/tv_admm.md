# DNA-PAINT Super-Resolution — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — TV-ADMM + gradient` corresponds to the leaderboard entry at

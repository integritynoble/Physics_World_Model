# DNA-PAINT Super-Resolution — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

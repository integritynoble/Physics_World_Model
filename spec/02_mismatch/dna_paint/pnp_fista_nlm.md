# DNA-PAINT Super-Resolution — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

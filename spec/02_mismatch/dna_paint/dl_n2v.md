# DNA-PAINT Super-Resolution — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('dna_paint_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`DNA-PAINT Super-Resolution — Noise2Void + gradient` corresponds to the leaderboard entry at

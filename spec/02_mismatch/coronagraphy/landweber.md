# Stellar Coronagraphy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_landweber_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

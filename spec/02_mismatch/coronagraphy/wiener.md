# Stellar Coronagraphy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_wiener_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

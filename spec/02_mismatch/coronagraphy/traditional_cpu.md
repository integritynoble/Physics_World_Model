# Stellar Coronagraphy — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

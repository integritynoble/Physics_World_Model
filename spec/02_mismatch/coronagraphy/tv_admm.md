# Stellar Coronagraphy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — TV-ADMM + gradient` corresponds to the leaderboard entry at

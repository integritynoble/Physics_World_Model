# Stellar Coronagraphy — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

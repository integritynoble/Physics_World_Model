# Stellar Coronagraphy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Stellar Coronagraphy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

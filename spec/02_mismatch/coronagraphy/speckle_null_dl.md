# Stellar Coronagraphy — DL-SpeckleNull [proxy] + Gradient
...
x_wrong = run_solver('speckle_null_dl', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('speckle_null_dl', y, cfg=calib_cfg)        # corrected

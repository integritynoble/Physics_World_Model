# Stellar Coronagraphy — DL-SpeckleNull [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('speckle_null_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('speckle_null_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('coronagraphy_speckle_null_dl_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — DL-SpeckleNull [proxy] + gradient` corresponds to the leaderboard entry at

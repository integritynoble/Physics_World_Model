# Stellar Coronagraphy — DL-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — DL-Diffusion + gradient` corresponds to the leaderboard entry at

# Stellar Coronagraphy — DL-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — DL-UNet + gradient` corresponds to the leaderboard entry at

# Stellar Coronagraphy — DL-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — DL-Mamba + gradient` corresponds to the leaderboard entry at

# Stellar Coronagraphy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Stellar Coronagraphy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coronagraphy_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

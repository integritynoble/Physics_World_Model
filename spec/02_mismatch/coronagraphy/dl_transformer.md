# Stellar Coronagraphy — DL-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: image (H × W, float32)
...
plt.tight_layout(); plt.savefig('coronagraphy_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Stellar Coronagraphy — DL-Transformer + gradient` corresponds to the leaderboard entry at

# STEM-EDX Elemental Mapping — Richardson-Lucy (DL baseline) + Gradient Mismatch Correction
...
x_wrong = run_solver('edx_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('edx_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('edx_mapping_edx_dl_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — Richardson-Lucy (DL baseline) + gradient` corresponds to the leaderboard entry at

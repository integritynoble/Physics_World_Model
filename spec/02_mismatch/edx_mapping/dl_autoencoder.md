# STEM-EDX Elemental Mapping — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — Spec-AE + gradient` corresponds to the leaderboard entry at

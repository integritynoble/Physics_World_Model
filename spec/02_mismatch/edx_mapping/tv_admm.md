# STEM-EDX Elemental Mapping — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — TV-ADMM + gradient` corresponds to the leaderboard entry at

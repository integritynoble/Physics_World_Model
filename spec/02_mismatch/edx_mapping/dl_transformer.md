# STEM-EDX Elemental Mapping — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: X-ray counts (H × W × channels, float32)
...
plt.tight_layout(); plt.savefig('edx_mapping_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — Spec-Transformer + gradient` corresponds to the leaderboard entry at

# STEM-EDX Elemental Mapping — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_wiener_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

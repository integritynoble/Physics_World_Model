# STEM-EDX Elemental Mapping — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — Spec-CNN + gradient` corresponds to the leaderboard entry at

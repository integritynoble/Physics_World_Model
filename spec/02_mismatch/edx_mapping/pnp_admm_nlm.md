# STEM-EDX Elemental Mapping — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

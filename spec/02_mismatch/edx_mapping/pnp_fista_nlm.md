# STEM-EDX Elemental Mapping — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

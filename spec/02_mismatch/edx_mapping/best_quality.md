# STEM-EDX Elemental Mapping — Richardson-Lucy (high quality) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_best_quality_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — Richardson-Lucy (high quality) + gradient` corresponds to the leaderboard entry at

# STEM-EDX Elemental Mapping — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# STEM-EDX Elemental Mapping — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_landweber_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — Landweber Iteration + gradient` corresponds to the leaderboard entry at

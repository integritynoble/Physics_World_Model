# STEM-EDX Elemental Mapping — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

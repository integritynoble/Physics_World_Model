# STEM-EDX Elemental Mapping — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('edx_mapping_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`STEM-EDX Elemental Mapping — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

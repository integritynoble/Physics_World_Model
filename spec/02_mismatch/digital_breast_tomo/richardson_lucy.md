# Digital Breast Tomosynthesis (DBT) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

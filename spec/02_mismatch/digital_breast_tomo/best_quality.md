# Digital Breast Tomosynthesis (DBT) — DL-Recon [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — DL-Recon [proxy] + gradient` corresponds to the leaderboard entry at

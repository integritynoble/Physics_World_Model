# Digital Breast Tomosynthesis (DBT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

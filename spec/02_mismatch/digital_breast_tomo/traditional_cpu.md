# Digital Breast Tomosynthesis (DBT) — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — FBP [proxy] + gradient` corresponds to the leaderboard entry at

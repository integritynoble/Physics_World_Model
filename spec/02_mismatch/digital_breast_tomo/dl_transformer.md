# Digital Breast Tomosynthesis (DBT) — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — TransCT + gradient` corresponds to the leaderboard entry at

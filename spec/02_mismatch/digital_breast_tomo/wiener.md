# Digital Breast Tomosynthesis (DBT) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_wiener_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

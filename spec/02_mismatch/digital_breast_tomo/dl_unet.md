# Digital Breast Tomosynthesis (DBT) — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — U-Net Recon + gradient` corresponds to the leaderboard entry at

# Digital Breast Tomosynthesis (DBT) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

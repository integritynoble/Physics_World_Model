# Digital Breast Tomosynthesis (DBT) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_landweber_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Digital Breast Tomosynthesis (DBT) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

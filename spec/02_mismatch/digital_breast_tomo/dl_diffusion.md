# Digital Breast Tomosynthesis (DBT) — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — DiffusionRecon + gradient` corresponds to the leaderboard entry at

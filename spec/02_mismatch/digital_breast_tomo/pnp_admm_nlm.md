# Digital Breast Tomosynthesis (DBT) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Digital Breast Tomosynthesis (DBT) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

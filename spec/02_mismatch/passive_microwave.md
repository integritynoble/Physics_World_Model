# Passive Microwave Radiometry — Mismatch Correction + Reconstruct
...
from algorithm_base.passive_microwave.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('passive_microwave_corrected.png'); plt.show()
```

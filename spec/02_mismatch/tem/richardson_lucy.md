# Transmission Electron Microscopy (TEM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

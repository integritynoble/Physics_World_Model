# Transmission Electron Microscopy (TEM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_wiener_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

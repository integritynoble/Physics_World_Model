# Transmission Electron Microscopy (TEM) — FISTA-L2 (CTF correction) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — FISTA-L2 (CTF correction) + gradient` corresponds to the leaderboard entry at

# Transmission Electron Microscopy (TEM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

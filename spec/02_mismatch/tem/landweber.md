# Transmission Electron Microscopy (TEM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_landweber_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

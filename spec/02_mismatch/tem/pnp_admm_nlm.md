# Transmission Electron Microscopy (TEM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

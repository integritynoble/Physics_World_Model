# Transmission Electron Microscopy (TEM) — 3D-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_dl_3dcnn_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — 3D-CNN + gradient` corresponds to the leaderboard entry at

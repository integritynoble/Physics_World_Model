# Transmission Electron Microscopy (TEM) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

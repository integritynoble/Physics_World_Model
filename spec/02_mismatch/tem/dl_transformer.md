# Transmission Electron Microscopy (TEM) — 3D-Transformer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — 3D-Transformer + gradient` corresponds to the leaderboard entry at

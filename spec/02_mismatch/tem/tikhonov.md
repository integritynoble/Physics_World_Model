# Transmission Electron Microscopy (TEM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

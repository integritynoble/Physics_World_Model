# Transmission Electron Microscopy (TEM) — TEM-UNet [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — TEM-UNet [proxy] + gradient` corresponds to the leaderboard entry at

# Transmission Electron Microscopy (TEM) — NeRF-DL + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('tem_dl_nerf_dl_corrected.png'); plt.show()
```

## Benchmark

`Transmission Electron Microscopy (TEM) — NeRF-DL + gradient` corresponds to the leaderboard entry at

# Magnetic Resonance Imaging (MRI) — Nuclear Norm (SVT) + Gradient
...
x_wrong = run_solver('nuclear_norm', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('nuclear_norm', y, cfg=calib_cfg)        # corrected

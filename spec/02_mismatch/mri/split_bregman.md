# Magnetic Resonance Imaging (MRI) — Split Bregman + Gradient Mismatch Correction
...
x_wrong = run_solver('split_bregman', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('split_bregman', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_split_bregman_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Split Bregman + gradient` corresponds to the leaderboard entry at

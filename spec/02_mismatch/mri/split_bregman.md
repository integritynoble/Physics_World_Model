# Magnetic Resonance Imaging (MRI) — Split Bregman + Gradient
...
x_wrong = run_solver('split_bregman', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('split_bregman', y, cfg=calib_cfg)        # corrected

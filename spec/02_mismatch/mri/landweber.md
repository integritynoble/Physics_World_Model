# Magnetic Resonance Imaging (MRI) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mri_landweber_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

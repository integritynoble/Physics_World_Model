# Magnetic Resonance Imaging (MRI) — DC-CNN + Gradient Mismatch Correction
...
x_wrong = run_solver('dccnn', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dccnn', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_dccnn_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — DC-CNN + gradient` corresponds to the leaderboard entry at

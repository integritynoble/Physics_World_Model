# Magnetic Resonance Imaging (MRI) — RED (Regularization by Denoising) + Gradient
...
x_wrong = run_solver('red_mri', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('red_mri', y, cfg=calib_cfg)        # corrected

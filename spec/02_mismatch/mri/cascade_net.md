# Magnetic Resonance Imaging (MRI) — CascadeNet + Gradient Mismatch Correction
...
x_wrong = run_solver('cascade_net', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('cascade_net', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_cascade_net_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — CascadeNet + gradient` corresponds to the leaderboard entry at

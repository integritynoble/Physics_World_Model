# Magnetic Resonance Imaging (MRI) — CS-MRI (Wavelet) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mri_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — CS-MRI (Wavelet) + gradient` corresponds to the leaderboard entry at

# Magnetic Resonance Imaging (MRI) — MoDL (5 unrolls) + Gradient Mismatch Correction
...
x_wrong = run_solver('small_gpu', y, cfg={'n_iter': 5})
...
plt.tight_layout(); plt.savefig('mri_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — MoDL (5 unrolls) + gradient` corresponds to the leaderboard entry at

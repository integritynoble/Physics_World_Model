# Magnetic Resonance Imaging (MRI) — GRAPPA-like + Gradient Mismatch Correction
...
x_wrong = run_solver('grappa_like', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('grappa_like', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_grappa_like_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — GRAPPA-like + gradient` corresponds to the leaderboard entry at

# Magnetic Resonance Imaging (MRI) — ISTA-Net+ + Gradient Mismatch Correction
...
x_wrong = run_solver('ista_net_plus', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ista_net_plus', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_ista_net_plus_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — ISTA-Net+ + gradient` corresponds to the leaderboard entry at

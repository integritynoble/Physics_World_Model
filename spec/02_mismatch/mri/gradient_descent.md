# Magnetic Resonance Imaging (MRI) — Gradient Descent + Gradient
...
x_wrong = run_solver('gradient_descent', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('gradient_descent', y, cfg=calib_cfg)        # corrected

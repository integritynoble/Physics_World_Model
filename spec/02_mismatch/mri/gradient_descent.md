# Magnetic Resonance Imaging (MRI) — Gradient Descent + Gradient Mismatch Correction
...
x_wrong = run_solver('gradient_descent', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('gradient_descent', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_gradient_descent_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Gradient Descent + gradient` corresponds to the leaderboard entry at

# Magnetic Resonance Imaging (MRI) — ESPIRiT + Gradient

**CPU**  **PSNR**: ~34.2 dB  **Mismatch**: coil sensitivity maps `[0.9, 1.1] gain per coil`
...
x_wrong = run_solver('espirit', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('espirit', y, cfg=calib_cfg)        # corrected

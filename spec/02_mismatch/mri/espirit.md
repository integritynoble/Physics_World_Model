# Magnetic Resonance Imaging (MRI) — ESPIRiT + Gradient Mismatch Correction
...
x_wrong = run_solver('espirit', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('espirit', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_espirit_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — ESPIRiT + gradient` corresponds to the leaderboard entry at

# Magnetic Resonance Imaging (MRI) — PnP-ADMM + Gradient Mismatch Correction
...
x_wrong = run_solver('pnp_admm', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('pnp_admm', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_pnp_admm_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — PnP-ADMM + gradient` corresponds to the leaderboard entry at

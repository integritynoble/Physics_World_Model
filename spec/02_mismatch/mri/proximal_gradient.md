# Magnetic Resonance Imaging (MRI) — Proximal Gradient Descent + Gradient Mismatch Correction
...
x_wrong = run_solver('proximal_gradient', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('proximal_gradient', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_proximal_gradient_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Proximal Gradient Descent + gradient` corresponds to the leaderboard entry at

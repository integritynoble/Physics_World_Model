# Magnetic Resonance Imaging (MRI) — Homodyne Detection + Gradient Mismatch Correction
...
x_wrong = run_solver('homodyne', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('homodyne', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_homodyne_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Homodyne Detection + gradient` corresponds to the leaderboard entry at

# Magnetic Resonance Imaging (MRI) — FISTA + Gradient Mismatch Correction
...
x_wrong = run_solver('fista_mri', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('fista_mri', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_fista_mri_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — FISTA + gradient` corresponds to the leaderboard entry at

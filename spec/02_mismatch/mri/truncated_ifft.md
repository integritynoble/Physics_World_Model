# Magnetic Resonance Imaging (MRI) — Truncated IFFT + Gradient
...
x_wrong = run_solver('truncated_ifft', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('truncated_ifft', y, cfg=calib_cfg)        # corrected

# Magnetic Resonance Imaging (MRI) — Truncated IFFT + Gradient Mismatch Correction
...
x_wrong = run_solver('truncated_ifft', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('truncated_ifft', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_truncated_ifft_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Truncated IFFT + gradient` corresponds to the leaderboard entry at

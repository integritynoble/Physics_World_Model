# Magnetic Resonance Imaging (MRI) — KIKI-Net + Gradient Mismatch Correction
...
x_wrong = run_solver('kiki_net', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('kiki_net', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_kiki_net_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — KIKI-Net + gradient` corresponds to the leaderboard entry at

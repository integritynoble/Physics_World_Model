# Magnetic Resonance Imaging (MRI) — E2E-VarNet + Gradient Mismatch Correction
...
x_wrong = run_solver('varnet', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('varnet', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_varnet_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — E2E-VarNet + gradient` corresponds to the leaderboard entry at

# Magnetic Resonance Imaging (MRI) — Conjugate Gradient + Gradient Mismatch Correction
...
x_wrong = run_solver('conjugate_gradient', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('conjugate_gradient', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_conjugate_gradient_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Conjugate Gradient + gradient` corresponds to the leaderboard entry at

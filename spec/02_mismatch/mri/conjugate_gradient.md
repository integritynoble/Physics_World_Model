# Magnetic Resonance Imaging (MRI) — Conjugate Gradient + Gradient
...
x_wrong = run_solver('conjugate_gradient', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('conjugate_gradient', y, cfg=calib_cfg)        # corrected

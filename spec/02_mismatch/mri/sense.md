# Magnetic Resonance Imaging (MRI) — SENSE + Gradient Mismatch Correction
...
x_wrong = run_solver('sense', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('sense', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_sense_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — SENSE + gradient` corresponds to the leaderboard entry at

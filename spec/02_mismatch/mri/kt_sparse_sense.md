# Magnetic Resonance Imaging (MRI) — k-t SPARSE-SENSE + Gradient Mismatch Correction
...
x_wrong = run_solver('kt_sparse_sense', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('kt_sparse_sense', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_kt_sparse_sense_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — k-t SPARSE-SENSE + gradient` corresponds to the leaderboard entry at

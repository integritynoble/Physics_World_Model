# Magnetic Resonance Imaging (MRI) — k-t SPARSE-SENSE + Gradient
...
x_wrong = run_solver('kt_sparse_sense', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('kt_sparse_sense', y, cfg=calib_cfg)        # corrected

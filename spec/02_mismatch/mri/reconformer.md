# Magnetic Resonance Imaging (MRI) — ReconFormer + Gradient

**GPU**  **PSNR**: ~40.1 dB  **Mismatch**: coil sensitivity maps `[0.9, 1.1] gain per coil`
...
x_wrong = run_solver('reconformer', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('reconformer', y, cfg=calib_cfg)        # corrected

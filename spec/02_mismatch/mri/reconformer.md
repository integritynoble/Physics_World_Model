# Magnetic Resonance Imaging (MRI) — ReconFormer + Gradient Mismatch Correction
...
x_wrong = run_solver('reconformer', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('reconformer', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_reconformer_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — ReconFormer + gradient` corresponds to the leaderboard entry at

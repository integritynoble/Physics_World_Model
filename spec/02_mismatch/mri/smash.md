# Magnetic Resonance Imaging (MRI) — SMASH + Gradient Mismatch Correction
...
x_wrong = run_solver('smash', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('smash', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_smash_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — SMASH + gradient` corresponds to the leaderboard entry at

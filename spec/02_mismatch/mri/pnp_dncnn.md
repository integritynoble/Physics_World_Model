# Magnetic Resonance Imaging (MRI) — PnP-DnCNN + Gradient Mismatch Correction
...
x_wrong = run_solver('pnp_dncnn', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('pnp_dncnn', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_pnp_dncnn_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — PnP-DnCNN + gradient` corresponds to the leaderboard entry at

# Magnetic Resonance Imaging (MRI) — SPIRiT-like + Gradient Mismatch Correction
...
x_wrong = run_solver('spirit_like', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('spirit_like', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_spirit_like_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — SPIRiT-like + gradient` corresponds to the leaderboard entry at

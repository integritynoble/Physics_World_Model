# Magnetic Resonance Imaging (MRI) — Score-MRI (diffusion) + Gradient
...
x_wrong = run_solver('score_mri', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('score_mri', y, cfg=calib_cfg)        # corrected

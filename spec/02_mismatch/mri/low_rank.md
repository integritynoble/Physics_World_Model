# Magnetic Resonance Imaging (MRI) — Low-Rank + Gradient Mismatch Correction
...
x_wrong = run_solver('low_rank', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('low_rank', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_low_rank_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Low-Rank + gradient` corresponds to the leaderboard entry at

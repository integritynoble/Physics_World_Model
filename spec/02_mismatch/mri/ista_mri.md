# Magnetic Resonance Imaging (MRI) — ISTA + Gradient Mismatch Correction
...
x_wrong = run_solver('ista_mri', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ista_mri', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_ista_mri_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — ISTA + gradient` corresponds to the leaderboard entry at

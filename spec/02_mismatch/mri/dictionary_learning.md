# Magnetic Resonance Imaging (MRI) — Dictionary Learning MRI + Gradient Mismatch Correction
...
x_wrong = run_solver('dictionary_learning', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dictionary_learning', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_dictionary_learning_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Dictionary Learning MRI + gradient` corresponds to the leaderboard entry at

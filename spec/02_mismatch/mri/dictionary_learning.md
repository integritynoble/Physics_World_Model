# Magnetic Resonance Imaging (MRI) — Dictionary Learning MRI + Gradient
...
x_wrong = run_solver('dictionary_learning', y)           # no correction
sens = mri_estimate_sensitivities_acs(y)
calib_cfg = {"sensitivities": sens}
x = run_solver('dictionary_learning', y, cfg=calib_cfg)        # corrected

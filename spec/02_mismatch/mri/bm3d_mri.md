# Magnetic Resonance Imaging (MRI) — BM3D-MRI + Gradient Mismatch Correction
...
x_wrong = run_solver('bm3d_mri', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('bm3d_mri', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_bm3d_mri_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — BM3D-MRI + gradient` corresponds to the leaderboard entry at

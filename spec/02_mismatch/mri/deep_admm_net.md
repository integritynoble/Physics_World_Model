# Magnetic Resonance Imaging (MRI) — Deep ADMM-Net + Gradient Mismatch Correction
...
x_wrong = run_solver('deep_admm_net', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('deep_admm_net', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_deep_admm_net_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Deep ADMM-Net + gradient` corresponds to the leaderboard entry at

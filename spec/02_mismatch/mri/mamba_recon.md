# Magnetic Resonance Imaging (MRI) — MambaRecon + Gradient Mismatch Correction
...
x_wrong = run_solver('mamba_recon', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('mamba_recon', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_mamba_recon_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — MambaRecon + gradient` corresponds to the leaderboard entry at

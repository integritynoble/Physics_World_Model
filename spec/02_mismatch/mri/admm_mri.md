# Magnetic Resonance Imaging (MRI) — ADMM + Gradient Mismatch Correction
...
x_wrong = run_solver('admm_mri', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('admm_mri', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_admm_mri_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — ADMM + gradient` corresponds to the leaderboard entry at

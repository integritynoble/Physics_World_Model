# Magnetic Resonance Imaging (MRI) — Zero-Filled IFFT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mri_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — Zero-Filled IFFT + gradient` corresponds to the leaderboard entry at

# Magnetic Resonance Imaging (MRI) — MoDL + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mri_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Resonance Imaging (MRI) — MoDL + gradient` corresponds to the leaderboard entry at

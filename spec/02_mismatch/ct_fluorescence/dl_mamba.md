# CT + Fluorescence (FLIT) — MambaRecon + Gradient Mismatch Correction

**Device**: GPU  **Input**: XRF sinogram (angles × detectors × ch, float32)
...
plt.tight_layout(); plt.savefig('ct_fluorescence_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — MambaRecon + gradient` corresponds to the leaderboard entry at

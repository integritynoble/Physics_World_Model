# CT + Fluorescence (FLIT) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

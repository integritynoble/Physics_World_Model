# CT + Fluorescence (FLIT) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# CT + Fluorescence (FLIT) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_best_quality_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

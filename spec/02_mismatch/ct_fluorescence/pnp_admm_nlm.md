# CT + Fluorescence (FLIT) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# CT + Fluorescence (FLIT) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_landweber_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# CT + Fluorescence (FLIT) — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — U-Net Recon + gradient` corresponds to the leaderboard entry at

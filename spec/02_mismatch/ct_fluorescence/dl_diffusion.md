# CT + Fluorescence (FLIT) — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — DiffusionRecon + gradient` corresponds to the leaderboard entry at

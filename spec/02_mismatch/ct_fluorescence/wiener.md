# CT + Fluorescence (FLIT) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_wiener_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# CT + Fluorescence (FLIT) — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — TransCT + gradient` corresponds to the leaderboard entry at

# CT + Fluorescence (FLIT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

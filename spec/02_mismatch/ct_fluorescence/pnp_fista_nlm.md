# CT + Fluorescence (FLIT) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

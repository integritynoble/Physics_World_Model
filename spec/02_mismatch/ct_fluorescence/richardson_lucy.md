# CT + Fluorescence (FLIT) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_fluorescence_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`CT + Fluorescence (FLIT) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

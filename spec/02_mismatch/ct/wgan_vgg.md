# X-ray Computed Tomography (CT) — WGAN-VGG + Gradient Mismatch Correction
...
x_wrong = run_solver('wgan_vgg', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('wgan_vgg', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ct_wgan_vgg_corrected.png'); plt.show()
```

## Benchmark

`X-ray Computed Tomography (CT) — WGAN-VGG + gradient` corresponds to the leaderboard entry at

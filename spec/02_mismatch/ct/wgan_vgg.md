# X-ray Computed Tomography (CT) — WGAN-VGG + Gradient

**GPU**  **PSNR**: ~34.1 dB  **Mismatch**: center-of-rotation offset `[-5, +5] px`
...
x_wrong = run_solver('wgan_vgg', y)           # no correction
cor_offset = ct_calibrate_cor(y, shift_range=5)
calib_cfg = {"cor_offset": float(cor_offset)}
x = run_solver('wgan_vgg', y, cfg=calib_cfg)        # corrected

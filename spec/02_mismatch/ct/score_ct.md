# X-ray Computed Tomography (CT) — Score-CT + Gradient Mismatch Correction
...
x_wrong = run_solver('score_ct', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('score_ct', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ct_score_ct_corrected.png'); plt.show()
```

## Benchmark

`X-ray Computed Tomography (CT) — Score-CT + gradient` corresponds to the leaderboard entry at

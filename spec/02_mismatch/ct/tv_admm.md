# X-ray Computed Tomography (CT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Computed Tomography (CT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

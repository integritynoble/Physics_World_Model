# X-ray Computed Tomography (CT) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`X-ray Computed Tomography (CT) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

# X-ray Computed Tomography (CT) — MLEM + Gradient Mismatch Correction
...
x_wrong = run_solver('mlem', y, cfg={'iters': 15})
...
plt.tight_layout(); plt.savefig('ct_mlem_corrected.png'); plt.show()
```

## Benchmark

`X-ray Computed Tomography (CT) — MLEM + gradient` corresponds to the leaderboard entry at

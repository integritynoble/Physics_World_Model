# X-ray Computed Tomography (CT) — RED-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ct_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`X-ray Computed Tomography (CT) — RED-CNN + gradient` corresponds to the leaderboard entry at

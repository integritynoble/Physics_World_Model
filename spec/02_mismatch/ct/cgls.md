# X-ray Computed Tomography (CT) — CGLS + Gradient Mismatch Correction
...
x_wrong = run_solver('cgls', y, cfg={'iters': 15})
...
plt.tight_layout(); plt.savefig('ct_cgls_corrected.png'); plt.show()
```

## Benchmark

`X-ray Computed Tomography (CT) — CGLS + gradient` corresponds to the leaderboard entry at

# X-ray Computed Tomography (CT) — CGLS + Gradient

**CPU**  **PSNR**: ~30.2 dB  **Mismatch**: center-of-rotation offset `[-5, +5] px`
...
x_wrong = run_solver('cgls', y)           # no correction
cor_offset = ct_calibrate_cor(y, shift_range=5)
calib_cfg = {"cor_offset": float(cor_offset)}
x = run_solver('cgls', y, cfg={**calib_cfg, **{'iters': 15}})        # corrected

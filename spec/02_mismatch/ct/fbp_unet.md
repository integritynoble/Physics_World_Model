# X-ray Computed Tomography (CT) — FBP + U-Net + Gradient

**GPU**  **PSNR**: ~35.8 dB  **Mismatch**: center-of-rotation offset `[-5, +5] px`
...
x_wrong = run_solver('fbp_unet', y)           # no correction
cor_offset = ct_calibrate_cor(y, shift_range=5)
calib_cfg = {"cor_offset": float(cor_offset)}
x = run_solver('fbp_unet', y, cfg=calib_cfg)        # corrected

# X-ray Computed Tomography (CT) — SART + Gradient

**CPU**  **PSNR**: ~29.1 dB  **Mismatch**: center-of-rotation offset `[-5, +5] px`
...
x_wrong = run_solver('sart', y)           # no correction
cor_offset = ct_calibrate_cor(y, shift_range=5)
calib_cfg = {"cor_offset": float(cor_offset)}
x = run_solver('sart', y, cfg={**calib_cfg, **{'iters': 10, 'relaxation': 0.25}})        # corrected

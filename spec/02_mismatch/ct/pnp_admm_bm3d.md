# X-ray Computed Tomography (CT) — PnP-ADMM (BM3D) + Gradient
...
x_wrong = run_solver('pnp_admm_bm3d', y)           # no correction
cor_offset = ct_calibrate_cor(y, shift_range=5)
calib_cfg = {"cor_offset": float(cor_offset)}
x = run_solver('pnp_admm_bm3d', y, cfg={**calib_cfg, **{'iters': 10, 'sigma': 0.05, 'rho': 0.5}})        # corrected

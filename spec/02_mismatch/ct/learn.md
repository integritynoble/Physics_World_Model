# X-ray Computed Tomography (CT) — LEARN + Gradient Mismatch Correction
...
x_wrong = run_solver('learn', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('learn', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ct_learn_corrected.png'); plt.show()
```

## Benchmark

`X-ray Computed Tomography (CT) — LEARN + gradient` corresponds to the leaderboard entry at

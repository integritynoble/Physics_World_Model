# Susceptibility-Weighted Imaging (SWI) — DL-Recon [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — DL-Recon [proxy] + gradient` corresponds to the leaderboard entry at

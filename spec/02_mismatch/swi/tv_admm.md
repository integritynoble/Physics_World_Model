# Susceptibility-Weighted Imaging (SWI) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Susceptibility-Weighted Imaging (SWI) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_wiener_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

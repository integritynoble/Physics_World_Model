# Susceptibility-Weighted Imaging (SWI) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — Med-UNet + gradient` corresponds to the leaderboard entry at

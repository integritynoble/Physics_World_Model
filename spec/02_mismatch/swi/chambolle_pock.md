# Susceptibility-Weighted Imaging (SWI) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

# Susceptibility-Weighted Imaging (SWI) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Susceptibility-Weighted Imaging (SWI) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

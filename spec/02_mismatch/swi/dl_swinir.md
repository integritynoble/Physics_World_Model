# Susceptibility-Weighted Imaging (SWI) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

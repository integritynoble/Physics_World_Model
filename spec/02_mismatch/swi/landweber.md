# Susceptibility-Weighted Imaging (SWI) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_landweber_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

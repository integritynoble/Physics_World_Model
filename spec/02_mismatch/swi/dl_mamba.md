# Susceptibility-Weighted Imaging (SWI) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — MedMamba + gradient` corresponds to the leaderboard entry at

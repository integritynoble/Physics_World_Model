# Susceptibility-Weighted Imaging (SWI) — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — FBP [proxy] + gradient` corresponds to the leaderboard entry at

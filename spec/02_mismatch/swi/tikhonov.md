# Susceptibility-Weighted Imaging (SWI) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

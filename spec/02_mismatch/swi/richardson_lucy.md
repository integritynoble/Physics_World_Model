# Susceptibility-Weighted Imaging (SWI) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('swi_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Susceptibility-Weighted Imaging (SWI) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

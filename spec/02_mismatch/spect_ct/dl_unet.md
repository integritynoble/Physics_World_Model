# SPECT/CT Fusion — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_ct_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`SPECT/CT Fusion — U-Net Recon + gradient` corresponds to the leaderboard entry at

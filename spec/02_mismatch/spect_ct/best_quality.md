# SPECT/CT Fusion — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_ct_best_quality_corrected.png'); plt.show()
```

## Benchmark

`SPECT/CT Fusion — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# SPECT/CT Fusion — SPECT-CT-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('spectct_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('spectct_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('spect_ct_spectct_dl_corrected.png'); plt.show()
```

## Benchmark

`SPECT/CT Fusion — SPECT-CT-Net [proxy] + gradient` corresponds to the leaderboard entry at

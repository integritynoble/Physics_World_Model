# SPECT/CT Fusion — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_ct_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`SPECT/CT Fusion — TransCT + gradient` corresponds to the leaderboard entry at

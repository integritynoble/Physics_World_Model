# SPECT/CT Fusion — MambaRecon + Gradient Mismatch Correction

**Device**: GPU  **Input**: SPECT proj + CT sino (both float32)
...
plt.tight_layout(); plt.savefig('spect_ct_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`SPECT/CT Fusion — MambaRecon + gradient` corresponds to the leaderboard entry at

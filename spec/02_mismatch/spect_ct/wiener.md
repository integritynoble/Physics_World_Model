# SPECT/CT Fusion — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_ct_wiener_corrected.png'); plt.show()
```

## Benchmark

`SPECT/CT Fusion — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

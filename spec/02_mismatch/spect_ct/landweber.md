# SPECT/CT Fusion — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_ct_landweber_corrected.png'); plt.show()
```

## Benchmark

`SPECT/CT Fusion — Landweber Iteration + gradient` corresponds to the leaderboard entry at

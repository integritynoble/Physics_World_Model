# SPECT/CT Fusion — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_ct_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`SPECT/CT Fusion — DiffusionRecon + gradient` corresponds to the leaderboard entry at

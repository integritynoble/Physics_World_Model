# SPECT/CT Fusion — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_ct_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`SPECT/CT Fusion — TV-ADMM + gradient` corresponds to the leaderboard entry at

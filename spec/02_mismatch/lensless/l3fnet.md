# Lensless (Diffuser Camera) Imaging — L3Fnet + Gradient Mismatch Correction
...
x_wrong = run_solver('l3fnet', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('l3fnet', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lensless_l3fnet_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — L3Fnet + gradient` corresponds to the leaderboard entry at

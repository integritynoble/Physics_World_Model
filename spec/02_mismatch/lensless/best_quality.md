# Lensless (Diffuser Camera) Imaging — FlatNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lensless_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — FlatNet + gradient` corresponds to the leaderboard entry at

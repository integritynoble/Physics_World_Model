# Lensless (Diffuser Camera) Imaging — Tikhonov Regularisation + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lensless_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — Tikhonov Regularisation + gradient` corresponds to the leaderboard entry at

# Lensless (Diffuser Camera) Imaging — LensMamba + Gradient Mismatch Correction
...
x_wrong = run_solver('lens_mamba', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('lens_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lensless_lens_mamba_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — LensMamba + gradient` corresponds to the leaderboard entry at

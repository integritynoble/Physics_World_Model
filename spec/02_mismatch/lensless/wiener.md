# Lensless (Diffuser Camera) Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
x_wrong = run_solver('wiener', y, cfg={})
...
plt.tight_layout(); plt.savefig('lensless_wiener_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Lensless (Diffuser Camera) Imaging — FlatNet-Lite + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lensless_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — FlatNet-Lite + gradient` corresponds to the leaderboard entry at

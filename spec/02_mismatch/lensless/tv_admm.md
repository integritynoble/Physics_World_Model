# Lensless (Diffuser Camera) Imaging — TV-ADMM Deconvolution + Gradient Mismatch Correction
...
x_wrong = run_solver('tv_admm', y, cfg={})
...
plt.tight_layout(); plt.savefig('lensless_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — TV-ADMM Deconvolution + gradient` corresponds to the leaderboard entry at

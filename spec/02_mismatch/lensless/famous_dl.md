# Lensless (Diffuser Camera) Imaging — Le-ADMM-U + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lensless_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — Le-ADMM-U + gradient` corresponds to the leaderboard entry at

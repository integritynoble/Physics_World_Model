# Lensless (Diffuser Camera) Imaging — FISTA Deconvolution + Gradient Mismatch Correction
...
x_wrong = run_solver('fista_deconv', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('fista_deconv', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lensless_fista_deconv_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — FISTA Deconvolution + gradient` corresponds to the leaderboard entry at

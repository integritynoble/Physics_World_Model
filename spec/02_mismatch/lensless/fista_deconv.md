# Lensless (Diffuser Camera) Imaging — FISTA Deconvolution + Gradient
...
x_wrong = run_solver('fista_deconv', y)           # no correction
shift = lensless_calibrate_shift(y)
calib_cfg = {"psf_shift": shift}
x = run_solver('fista_deconv', y, cfg=calib_cfg)        # corrected

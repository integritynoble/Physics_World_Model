# Lensless (Diffuser Camera) Imaging — Richardson-Lucy Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lensless_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — Richardson-Lucy Deconvolution + gradient` corresponds to the leaderboard entry at

# Lensless (Diffuser Camera) Imaging — LenslessFormer + Gradient

**GPU**  **Mismatch**: PSF shift `[-5, +5] px`
...
x_wrong = run_solver('lensless_former', y)           # no correction
shift = lensless_calibrate_shift(y)
calib_cfg = {"psf_shift": shift}
x = run_solver('lensless_former', y, cfg=calib_cfg)        # corrected

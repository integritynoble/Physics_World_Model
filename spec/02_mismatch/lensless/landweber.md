# Lensless (Diffuser Camera) Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('lensless_landweber_corrected.png'); plt.show()
```

## Benchmark

`Lensless (Diffuser Camera) Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

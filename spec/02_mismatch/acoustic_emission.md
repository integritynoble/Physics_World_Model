# Acoustic Emission Testing (AE) — Mismatch Correction + Reconstruct
...
from algorithm_base.acoustic_emission.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('acoustic_emission_corrected.png'); plt.show()
```

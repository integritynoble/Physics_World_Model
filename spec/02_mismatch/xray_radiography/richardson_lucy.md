# X-ray Radiography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_radiography_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`X-ray Radiography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

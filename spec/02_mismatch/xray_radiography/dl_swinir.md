# X-ray Radiography — XR-SwinIR + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_radiography_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`X-ray Radiography — XR-SwinIR + gradient` corresponds to the leaderboard entry at

# X-ray Radiography — XR-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_radiography_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`X-ray Radiography — XR-UNet + gradient` corresponds to the leaderboard entry at

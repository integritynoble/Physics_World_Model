# X-ray Radiography — XR-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_radiography_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`X-ray Radiography — XR-Mamba + gradient` corresponds to the leaderboard entry at

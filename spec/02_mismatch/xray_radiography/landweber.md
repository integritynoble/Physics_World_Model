# X-ray Radiography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_radiography_landweber_corrected.png'); plt.show()
```

## Benchmark

`X-ray Radiography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# X-ray Radiography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_radiography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`X-ray Radiography — TV-ADMM + gradient` corresponds to the leaderboard entry at

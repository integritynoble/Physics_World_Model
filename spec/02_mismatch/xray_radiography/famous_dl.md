# X-ray Radiography — X-ray UNet [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_radiography_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`X-ray Radiography — X-ray UNet [proxy] + gradient` corresponds to the leaderboard entry at

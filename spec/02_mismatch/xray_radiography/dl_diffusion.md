# X-ray Radiography — XR-Diffusion + Gradient Mismatch Correction

**Device**: GPU  **Input**: attenuation image (H × W, float32)
...
plt.tight_layout(); plt.savefig('xray_radiography_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`X-ray Radiography — XR-Diffusion + gradient` corresponds to the leaderboard entry at

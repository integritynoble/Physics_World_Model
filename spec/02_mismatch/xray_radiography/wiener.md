# X-ray Radiography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_radiography_wiener_corrected.png'); plt.show()
```

## Benchmark

`X-ray Radiography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

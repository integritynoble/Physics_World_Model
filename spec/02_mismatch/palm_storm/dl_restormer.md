# PALM/STORM Single-Molecule Localization — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — Restormer + gradient` corresponds to the leaderboard entry at

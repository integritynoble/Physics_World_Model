# PALM/STORM Single-Molecule Localization — DeepSTORM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — DeepSTORM + gradient` corresponds to the leaderboard entry at

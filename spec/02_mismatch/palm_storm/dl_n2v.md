# PALM/STORM Single-Molecule Localization — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — Noise2Void + gradient` corresponds to the leaderboard entry at

# PALM/STORM Single-Molecule Localization — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

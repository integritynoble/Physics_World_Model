# PALM/STORM Single-Molecule Localization — DiffusionMicro + Gradient Mismatch Correction

**Device**: GPU  **Input**: localisations (N × 4: x,y,σ,I)
...
plt.tight_layout(); plt.savefig('palm_storm_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — DiffusionMicro + gradient` corresponds to the leaderboard entry at

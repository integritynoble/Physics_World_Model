# PALM/STORM Single-Molecule Localization — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_dl_care_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — CARE + gradient` corresponds to the leaderboard entry at

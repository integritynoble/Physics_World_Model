# PALM/STORM Single-Molecule Localization — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

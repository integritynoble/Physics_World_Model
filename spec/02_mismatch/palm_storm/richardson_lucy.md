# PALM/STORM Single-Molecule Localization — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

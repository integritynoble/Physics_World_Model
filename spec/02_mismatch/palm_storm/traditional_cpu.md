# PALM/STORM Single-Molecule Localization — Richardson-Lucy (STORM/PALM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — Richardson-Lucy (STORM/PALM) + gradient` corresponds to the leaderboard entry at

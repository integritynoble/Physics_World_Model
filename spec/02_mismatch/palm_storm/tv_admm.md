# PALM/STORM Single-Molecule Localization — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — TV-ADMM + gradient` corresponds to the leaderboard entry at

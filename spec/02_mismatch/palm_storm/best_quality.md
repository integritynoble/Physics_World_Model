# PALM/STORM Single-Molecule Localization — DECODE-SMLM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_best_quality_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — DECODE-SMLM + gradient` corresponds to the leaderboard entry at

# PALM/STORM Single-Molecule Localization — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_wiener_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

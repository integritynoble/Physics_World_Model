# PALM/STORM Single-Molecule Localization — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# PALM/STORM Single-Molecule Localization — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('palm_storm_landweber_corrected.png'); plt.show()
```

## Benchmark

`PALM/STORM Single-Molecule Localization — Landweber Iteration + gradient` corresponds to the leaderboard entry at

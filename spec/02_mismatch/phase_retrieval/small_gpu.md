# Coherent Diffractive Imaging / Phase Retrieval — prDeep [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — prDeep [proxy] + gradient` corresponds to the leaderboard entry at

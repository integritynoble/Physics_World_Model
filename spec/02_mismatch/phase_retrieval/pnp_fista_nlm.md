# Coherent Diffractive Imaging / Phase Retrieval — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Coherent Diffractive Imaging / Phase Retrieval — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Coherent Diffractive Imaging / Phase Retrieval — RAAR [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — RAAR [proxy] + gradient` corresponds to the leaderboard entry at

# Coherent Diffractive Imaging / Phase Retrieval — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

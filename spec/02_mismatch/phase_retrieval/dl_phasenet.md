# Coherent Diffractive Imaging / Phase Retrieval — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — PhaseNet + gradient` corresponds to the leaderboard entry at

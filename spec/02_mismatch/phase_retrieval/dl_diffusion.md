# Coherent Diffractive Imaging / Phase Retrieval — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

# Coherent Diffractive Imaging / Phase Retrieval — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

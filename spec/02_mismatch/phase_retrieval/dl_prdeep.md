# Coherent Diffractive Imaging / Phase Retrieval — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — prDeep + gradient` corresponds to the leaderboard entry at

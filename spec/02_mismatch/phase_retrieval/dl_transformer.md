# Coherent Diffractive Imaging / Phase Retrieval — Phase-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: diffraction intensities (H × W, float32)
...
plt.tight_layout(); plt.savefig('phase_retrieval_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — Phase-Transformer + gradient` corresponds to the leaderboard entry at

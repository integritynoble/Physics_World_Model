# Coherent Diffractive Imaging / Phase Retrieval — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — TV-ADMM + gradient` corresponds to the leaderboard entry at

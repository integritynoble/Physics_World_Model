# Coherent Diffractive Imaging / Phase Retrieval — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_landweber_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Coherent Diffractive Imaging / Phase Retrieval — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: diffraction intensities (H × W, float32)
...
plt.tight_layout(); plt.savefig('phase_retrieval_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — Chambolle-Pock + gradient` corresponds to the leaderboard entry at
`https://pwm.platformai.org/benchmark/phase_retrieval` (mismatch correction tier).

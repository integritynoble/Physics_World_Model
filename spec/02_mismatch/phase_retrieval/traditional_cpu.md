# Coherent Diffractive Imaging / Phase Retrieval — HIO + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — HIO + gradient` corresponds to the leaderboard entry at

# Coherent Diffractive Imaging / Phase Retrieval — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('phase_retrieval_wiener_corrected.png'); plt.show()
```

## Benchmark

`Coherent Diffractive Imaging / Phase Retrieval — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

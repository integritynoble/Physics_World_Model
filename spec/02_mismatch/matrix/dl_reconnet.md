# Generic Matrix Sensing — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — ReconNet + gradient` corresponds to the leaderboard entry at

# Generic Matrix Sensing — LISTA + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — LISTA + gradient` corresponds to the leaderboard entry at

# Generic Matrix Sensing — FISTA-L1 (high quality) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — FISTA-L1 (high quality) + gradient` corresponds to the leaderboard entry at

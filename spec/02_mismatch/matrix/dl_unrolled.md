# Generic Matrix Sensing — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — Unrolled-Net + gradient` corresponds to the leaderboard entry at

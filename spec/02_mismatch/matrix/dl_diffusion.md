# Generic Matrix Sensing — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — CS-Diffusion + gradient` corresponds to the leaderboard entry at

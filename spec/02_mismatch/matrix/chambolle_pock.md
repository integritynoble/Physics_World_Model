# Generic Matrix Sensing — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

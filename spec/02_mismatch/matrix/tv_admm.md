# Generic Matrix Sensing — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — TV-ADMM + gradient` corresponds to the leaderboard entry at

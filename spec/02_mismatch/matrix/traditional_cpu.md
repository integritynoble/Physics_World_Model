# Generic Matrix Sensing — FISTA-L1 + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — FISTA-L1 + gradient` corresponds to the leaderboard entry at

# Generic Matrix Sensing — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Generic Matrix Sensing — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_landweber_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — Landweber Iteration + gradient` corresponds to the leaderboard entry at

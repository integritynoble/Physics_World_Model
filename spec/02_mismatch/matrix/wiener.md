# Generic Matrix Sensing — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_wiener_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

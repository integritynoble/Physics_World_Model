# Generic Matrix Sensing — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

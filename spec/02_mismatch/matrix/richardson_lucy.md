# Generic Matrix Sensing — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('matrix_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Generic Matrix Sensing — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

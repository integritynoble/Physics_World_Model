# Functional Near-Infrared Spectroscopy (fNIRS) — DL-Recon [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — DL-Recon [proxy] + gradient` corresponds to the leaderboard entry at

# Functional Near-Infrared Spectroscopy (fNIRS) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

# Functional Near-Infrared Spectroscopy (fNIRS) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_wiener_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Functional Near-Infrared Spectroscopy (fNIRS) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

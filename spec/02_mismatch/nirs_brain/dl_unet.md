# Functional Near-Infrared Spectroscopy (fNIRS) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — Med-UNet + gradient` corresponds to the leaderboard entry at

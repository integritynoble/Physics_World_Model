# Functional Near-Infrared Spectroscopy (fNIRS) — fNIRS-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('nirs_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('nirs_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('nirs_brain_nirs_dl_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — fNIRS-Net [proxy] + gradient` corresponds to the leaderboard entry at

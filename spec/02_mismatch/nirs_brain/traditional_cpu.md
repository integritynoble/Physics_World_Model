# Functional Near-Infrared Spectroscopy (fNIRS) — FBP [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — FBP [proxy] + gradient` corresponds to the leaderboard entry at

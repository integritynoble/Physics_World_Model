# Functional Near-Infrared Spectroscopy (fNIRS) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

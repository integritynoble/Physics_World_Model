# Functional Near-Infrared Spectroscopy (fNIRS) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — MedMamba + gradient` corresponds to the leaderboard entry at

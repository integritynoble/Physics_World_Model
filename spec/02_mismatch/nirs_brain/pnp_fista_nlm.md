# Functional Near-Infrared Spectroscopy (fNIRS) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

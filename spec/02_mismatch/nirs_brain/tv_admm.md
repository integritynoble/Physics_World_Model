# Functional Near-Infrared Spectroscopy (fNIRS) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — TV-ADMM + gradient` corresponds to the leaderboard entry at

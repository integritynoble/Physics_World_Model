# Functional Near-Infrared Spectroscopy (fNIRS) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

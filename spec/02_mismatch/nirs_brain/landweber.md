# Functional Near-Infrared Spectroscopy (fNIRS) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('nirs_brain_landweber_corrected.png'); plt.show()
```

## Benchmark

`Functional Near-Infrared Spectroscopy (fNIRS) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

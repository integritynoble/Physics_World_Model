# 3D Gaussian Splatting (3DGS) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gaussian_splatting_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`3D Gaussian Splatting (3DGS) — TV-ADMM + gradient` corresponds to the leaderboard entry at

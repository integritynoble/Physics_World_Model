# 3D Gaussian Splatting (3DGS) — 3D-CNN + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_3dcnn', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_3dcnn', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('gaussian_splatting_dl_3dcnn_corrected.png'); plt.show()
```

## Benchmark

`3D Gaussian Splatting (3DGS) — 3D-CNN + gradient` corresponds to the leaderboard entry at

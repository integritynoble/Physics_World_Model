# 3D Gaussian Splatting (3DGS) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gaussian_splatting_wiener_corrected.png'); plt.show()
```

## Benchmark

`3D Gaussian Splatting (3DGS) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# 3D Gaussian Splatting (3DGS) — 3DGS (full) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gaussian_splatting_best_quality_corrected.png'); plt.show()
```

## Benchmark

`3D Gaussian Splatting (3DGS) — 3DGS (full) + gradient` corresponds to the leaderboard entry at

# 3D Gaussian Splatting (3DGS) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gaussian_splatting_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`3D Gaussian Splatting (3DGS) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# 3D Gaussian Splatting (3DGS) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gaussian_splatting_landweber_corrected.png'); plt.show()
```

## Benchmark

`3D Gaussian Splatting (3DGS) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

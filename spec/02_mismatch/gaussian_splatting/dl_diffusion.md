# 3D Gaussian Splatting (3DGS) — 3D-Diffusion + Gradient Mismatch Correction

**Device**: GPU  **Input**: posed images (N × H × W × 3, float32)
...
plt.tight_layout(); plt.savefig('gaussian_splatting_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`3D Gaussian Splatting (3DGS) — 3D-Diffusion + gradient` corresponds to the leaderboard entry at

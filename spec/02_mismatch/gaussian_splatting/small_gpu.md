# 3D Gaussian Splatting (3DGS) — 3DGS (compact) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('gaussian_splatting_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`3D Gaussian Splatting (3DGS) — 3DGS (compact) + gradient` corresponds to the leaderboard entry at

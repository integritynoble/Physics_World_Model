# 3D Gaussian Splatting (3DGS) — NeRF-DL + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_nerf_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_nerf_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('gaussian_splatting_dl_nerf_dl_corrected.png'); plt.show()
```

## Benchmark

`3D Gaussian Splatting (3DGS) — NeRF-DL + gradient` corresponds to the leaderboard entry at

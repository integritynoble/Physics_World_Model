# Electrical Impedance Tomography (EIT) — Mismatch Correction + Reconstruct
...
from algorithm_base.impedance_tomo.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('impedance_tomo_corrected.png'); plt.show()
```

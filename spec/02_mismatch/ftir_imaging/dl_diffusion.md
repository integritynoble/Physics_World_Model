# FTIR Spectroscopic Imaging — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ftir_imaging_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`FTIR Spectroscopic Imaging — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

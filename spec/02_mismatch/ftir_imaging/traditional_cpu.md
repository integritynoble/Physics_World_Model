# FTIR Spectroscopic Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ftir_imaging_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`FTIR Spectroscopic Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# FTIR Spectroscopic Imaging — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: interferogram (H × W × OPD, float32)
...
plt.tight_layout(); plt.savefig('ftir_imaging_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`FTIR Spectroscopic Imaging — Spec-Transformer + gradient` corresponds to the leaderboard entry at

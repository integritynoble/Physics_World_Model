# FTIR Spectroscopic Imaging — FTIR-UNet [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('ftir_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('ftir_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ftir_imaging_ftir_dl_corrected.png'); plt.show()
```

## Benchmark

`FTIR Spectroscopic Imaging — FTIR-UNet [proxy] + gradient` corresponds to the leaderboard entry at

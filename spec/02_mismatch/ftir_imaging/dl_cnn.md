# FTIR Spectroscopic Imaging — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ftir_imaging_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`FTIR Spectroscopic Imaging — Spec-CNN + gradient` corresponds to the leaderboard entry at

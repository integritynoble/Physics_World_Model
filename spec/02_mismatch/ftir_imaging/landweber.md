# FTIR Spectroscopic Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ftir_imaging_landweber_corrected.png'); plt.show()
```

## Benchmark

`FTIR Spectroscopic Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# FTIR Spectroscopic Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ftir_imaging_wiener_corrected.png'); plt.show()
```

## Benchmark

`FTIR Spectroscopic Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# FTIR Spectroscopic Imaging — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ftir_imaging_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`FTIR Spectroscopic Imaging — Spec-AE + gradient` corresponds to the leaderboard entry at

# FTIR Spectroscopic Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('ftir_imaging_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`FTIR Spectroscopic Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

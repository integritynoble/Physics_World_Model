# Hyperspectral Remote Sensing — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_wiener_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

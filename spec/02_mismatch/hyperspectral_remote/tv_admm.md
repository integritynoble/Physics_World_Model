# Hyperspectral Remote Sensing — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — TV-ADMM + gradient` corresponds to the leaderboard entry at

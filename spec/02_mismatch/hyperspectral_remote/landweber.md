# Hyperspectral Remote Sensing — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_landweber_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — Landweber Iteration + gradient` corresponds to the leaderboard entry at

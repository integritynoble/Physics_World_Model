# Hyperspectral Remote Sensing — RS-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — RS-CNN + gradient` corresponds to the leaderboard entry at

# Hyperspectral Remote Sensing — SST-USRNet [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('hyper_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('hyper_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_hyper_dl_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — SST-USRNet [proxy] + gradient` corresponds to the leaderboard entry at

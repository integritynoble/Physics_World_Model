# Hyperspectral Remote Sensing — RDA [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — RDA [proxy] + gradient` corresponds to the leaderboard entry at

# Hyperspectral Remote Sensing — RS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: radiance cube (H × W × bands, float32)
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — RS-Transformer + gradient` corresponds to the leaderboard entry at

# Hyperspectral Remote Sensing — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Hyperspectral Remote Sensing — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

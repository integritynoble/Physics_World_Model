# Hyperspectral Remote Sensing — RS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — RS-Diffusion + gradient` corresponds to the leaderboard entry at

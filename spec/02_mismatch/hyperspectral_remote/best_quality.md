# Hyperspectral Remote Sensing — SAR-DL [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — SAR-DL [proxy] + gradient` corresponds to the leaderboard entry at

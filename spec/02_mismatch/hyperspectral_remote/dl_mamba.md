# Hyperspectral Remote Sensing — RS-Mamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — RS-Mamba + gradient` corresponds to the leaderboard entry at

# Hyperspectral Remote Sensing — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Hyperspectral Remote Sensing — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# Active Thermography (IR) — Pulsed-Phase TV [proxy] + Gradient
...
x_wrong = run_solver('pulsed_phase_tv', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('pulsed_phase_tv', y, cfg=calib_cfg)        # corrected

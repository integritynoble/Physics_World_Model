# Active Thermography (IR) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

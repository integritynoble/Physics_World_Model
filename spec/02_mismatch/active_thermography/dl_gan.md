# Active Thermography (IR) — Probe-GAN + Gradient Mismatch Correction
...
x_wrong = run_solver('dl_gan', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('dl_gan', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('active_thermography_dl_gan_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — Probe-GAN + gradient` corresponds to the leaderboard entry at

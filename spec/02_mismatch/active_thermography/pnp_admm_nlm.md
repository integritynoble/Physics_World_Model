# Active Thermography (IR) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Active Thermography (IR) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Active Thermography (IR) — Probe-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — Probe-Diffusion + gradient` corresponds to the leaderboard entry at

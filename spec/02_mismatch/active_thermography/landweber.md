# Active Thermography (IR) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_landweber_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Active Thermography (IR) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

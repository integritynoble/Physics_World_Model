# Active Thermography (IR) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Active Thermography (IR) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

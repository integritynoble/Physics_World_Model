# Active Thermography (IR) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Active Thermography (IR) — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: thermal sequence (T × H × W, float32)
...
plt.tight_layout(); plt.savefig('active_thermography_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

# Active Thermography (IR) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_wiener_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

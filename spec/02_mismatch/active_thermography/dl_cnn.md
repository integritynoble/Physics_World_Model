# Active Thermography (IR) — Probe-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('active_thermography_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Active Thermography (IR) — Probe-CNN + gradient` corresponds to the leaderboard entry at

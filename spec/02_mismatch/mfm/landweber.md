# Magnetic Force Microscopy (MFM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_landweber_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

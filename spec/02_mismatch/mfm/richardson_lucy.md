# Magnetic Force Microscopy (MFM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

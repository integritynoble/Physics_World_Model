# Magnetic Force Microscopy (MFM) — Probe-GAN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_dl_gan_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — Probe-GAN + gradient` corresponds to the leaderboard entry at

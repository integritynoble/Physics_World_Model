# Magnetic Force Microscopy (MFM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

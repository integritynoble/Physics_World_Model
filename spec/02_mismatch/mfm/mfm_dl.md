# Magnetic Force Microscopy (MFM) — MFM-UNet + Gradient Mismatch Correction
...
x_wrong = run_solver('mfm_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('mfm_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mfm_mfm_dl_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — MFM-UNet + gradient` corresponds to the leaderboard entry at

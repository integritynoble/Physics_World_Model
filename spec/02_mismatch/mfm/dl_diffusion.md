# Magnetic Force Microscopy (MFM) — Probe-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — Probe-Diffusion + gradient` corresponds to the leaderboard entry at

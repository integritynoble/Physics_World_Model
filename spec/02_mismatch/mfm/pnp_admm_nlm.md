# Magnetic Force Microscopy (MFM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Magnetic Force Microscopy (MFM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

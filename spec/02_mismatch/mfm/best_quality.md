# Magnetic Force Microscopy (MFM) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — CARE + gradient` corresponds to the leaderboard entry at

# Magnetic Force Microscopy (MFM) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

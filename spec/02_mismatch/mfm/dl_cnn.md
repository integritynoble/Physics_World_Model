# Magnetic Force Microscopy (MFM) — Probe-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — Probe-CNN + gradient` corresponds to the leaderboard entry at

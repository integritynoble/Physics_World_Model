# Magnetic Force Microscopy (MFM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mfm_wiener_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

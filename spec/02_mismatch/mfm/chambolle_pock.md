# Magnetic Force Microscopy (MFM) — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: magnetic force map (H × W, float32)
...
plt.tight_layout(); plt.savefig('mfm_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Force Microscopy (MFM) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

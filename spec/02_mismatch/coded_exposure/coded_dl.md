# Coded Exposure / Flutter Shutter — FlowNet-Coded [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('coded_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('coded_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('coded_exposure_coded_dl_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — FlowNet-Coded [proxy] + gradient` corresponds to the leaderboard entry at

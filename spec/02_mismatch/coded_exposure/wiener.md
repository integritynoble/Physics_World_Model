# Coded Exposure / Flutter Shutter — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_wiener_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

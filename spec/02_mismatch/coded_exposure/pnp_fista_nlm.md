# Coded Exposure / Flutter Shutter — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

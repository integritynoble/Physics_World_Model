# Coded Exposure / Flutter Shutter — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

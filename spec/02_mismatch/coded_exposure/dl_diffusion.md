# Coded Exposure / Flutter Shutter — CS-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — CS-Diffusion + gradient` corresponds to the leaderboard entry at

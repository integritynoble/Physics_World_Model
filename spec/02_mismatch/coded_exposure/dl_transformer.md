# Coded Exposure / Flutter Shutter — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: coded frames (N × H × W, float32)
...
plt.tight_layout(); plt.savefig('coded_exposure_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — CS-Transformer + gradient` corresponds to the leaderboard entry at

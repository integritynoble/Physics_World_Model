# Coded Exposure / Flutter Shutter — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — ReconNet + gradient` corresponds to the leaderboard entry at

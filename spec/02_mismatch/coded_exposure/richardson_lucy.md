# Coded Exposure / Flutter Shutter — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

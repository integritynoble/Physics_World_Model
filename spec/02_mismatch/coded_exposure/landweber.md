# Coded Exposure / Flutter Shutter — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_landweber_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — Landweber Iteration + gradient` corresponds to the leaderboard entry at

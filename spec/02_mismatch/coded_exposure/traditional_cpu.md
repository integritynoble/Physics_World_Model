# Coded Exposure / Flutter Shutter — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Coded Exposure / Flutter Shutter — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

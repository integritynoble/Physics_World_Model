# Coded Exposure / Flutter Shutter — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — TV-ADMM + gradient` corresponds to the leaderboard entry at

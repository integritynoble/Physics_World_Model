# Coded Exposure / Flutter Shutter — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

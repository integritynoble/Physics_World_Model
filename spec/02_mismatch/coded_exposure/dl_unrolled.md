# Coded Exposure / Flutter Shutter — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('coded_exposure_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Coded Exposure / Flutter Shutter — Unrolled-Net + gradient` corresponds to the leaderboard entry at

# Talbot-Lau X-ray Grating Interferometry — PhaseNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_dl_phasenet_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — PhaseNet + gradient` corresponds to the leaderboard entry at

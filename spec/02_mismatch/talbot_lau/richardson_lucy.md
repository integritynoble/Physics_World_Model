# Talbot-Lau X-ray Grating Interferometry — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Talbot-Lau X-ray Grating Interferometry — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

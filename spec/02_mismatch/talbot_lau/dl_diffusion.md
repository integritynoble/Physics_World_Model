# Talbot-Lau X-ray Grating Interferometry — Phase-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — Phase-Diffusion + gradient` corresponds to the leaderboard entry at

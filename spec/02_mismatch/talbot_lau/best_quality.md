# Talbot-Lau X-ray Grating Interferometry — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Talbot-Lau X-ray Grating Interferometry — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_wiener_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

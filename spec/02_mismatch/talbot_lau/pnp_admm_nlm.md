# Talbot-Lau X-ray Grating Interferometry — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

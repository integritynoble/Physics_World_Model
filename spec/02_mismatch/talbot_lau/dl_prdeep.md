# Talbot-Lau X-ray Grating Interferometry — prDeep + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_dl_prdeep_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — prDeep + gradient` corresponds to the leaderboard entry at

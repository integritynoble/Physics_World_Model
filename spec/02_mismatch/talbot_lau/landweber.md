# Talbot-Lau X-ray Grating Interferometry — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_landweber_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — Landweber Iteration + gradient` corresponds to the leaderboard entry at

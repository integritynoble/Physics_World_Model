# Talbot-Lau X-ray Grating Interferometry — Talbot-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('talbot_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('talbot_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('talbot_lau_talbot_dl_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — Talbot-Net [proxy] + gradient` corresponds to the leaderboard entry at

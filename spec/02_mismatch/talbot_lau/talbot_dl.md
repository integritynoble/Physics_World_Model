# Talbot-Lau X-ray Grating Interferometry — Talbot-Net [proxy] + Gradient
...
x_wrong = run_solver('talbot_dl', y)           # no correction
# auto-calibrate mismatch parameter
calib_cfg = {"mismatch_param": None}
x = run_solver('talbot_dl', y, cfg=calib_cfg)        # corrected

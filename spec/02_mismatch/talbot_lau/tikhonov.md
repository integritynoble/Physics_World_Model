# Talbot-Lau X-ray Grating Interferometry — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

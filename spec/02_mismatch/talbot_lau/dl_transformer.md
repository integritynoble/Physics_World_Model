# Talbot-Lau X-ray Grating Interferometry — Phase-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: stepping images (N_steps × H × W, float32)
...
plt.tight_layout(); plt.savefig('talbot_lau_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — Phase-Transformer + gradient` corresponds to the leaderboard entry at

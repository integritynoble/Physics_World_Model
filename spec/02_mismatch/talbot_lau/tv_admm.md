# Talbot-Lau X-ray Grating Interferometry — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('talbot_lau_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Talbot-Lau X-ray Grating Interferometry — TV-ADMM + gradient` corresponds to the leaderboard entry at

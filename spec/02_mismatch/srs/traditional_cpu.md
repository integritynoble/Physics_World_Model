# Stimulated Raman Scattering (SRS) Microscopy — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

# Stimulated Raman Scattering (SRS) Microscopy — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — Spec-CNN + gradient` corresponds to the leaderboard entry at

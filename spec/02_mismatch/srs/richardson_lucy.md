# Stimulated Raman Scattering (SRS) Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

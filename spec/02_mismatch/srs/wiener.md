# Stimulated Raman Scattering (SRS) Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_wiener_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

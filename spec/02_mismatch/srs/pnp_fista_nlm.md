# Stimulated Raman Scattering (SRS) Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

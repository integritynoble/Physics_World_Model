# Stimulated Raman Scattering (SRS) Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

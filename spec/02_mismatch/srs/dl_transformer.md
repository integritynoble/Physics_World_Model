# Stimulated Raman Scattering (SRS) Microscopy — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: SRS image (H × W, float32)
...
plt.tight_layout(); plt.savefig('srs_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — Spec-Transformer + gradient` corresponds to the leaderboard entry at

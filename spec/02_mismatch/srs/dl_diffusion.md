# Stimulated Raman Scattering (SRS) Microscopy — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

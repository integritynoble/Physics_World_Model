# Stimulated Raman Scattering (SRS) Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_landweber_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

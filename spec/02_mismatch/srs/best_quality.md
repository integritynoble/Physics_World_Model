# Stimulated Raman Scattering (SRS) Microscopy — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Stimulated Raman Scattering (SRS) Microscopy — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — Spec-AE + gradient` corresponds to the leaderboard entry at

# Stimulated Raman Scattering (SRS) Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('srs_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Stimulated Raman Scattering (SRS) Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

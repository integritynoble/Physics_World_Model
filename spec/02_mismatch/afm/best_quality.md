# Atomic Force Microscopy (AFM) — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — CARE + gradient` corresponds to the leaderboard entry at

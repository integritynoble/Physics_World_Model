# Atomic Force Microscopy (AFM) — Probe-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — Probe-Diffusion + gradient` corresponds to the leaderboard entry at

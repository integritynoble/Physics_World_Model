# Atomic Force Microscopy (AFM) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Atomic Force Microscopy (AFM) — Chambolle-Pock + Gradient Mismatch Correction

**Device**: CPU  **Input**: force-distance map (H × W, float32)
...
plt.tight_layout(); plt.savefig('afm_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

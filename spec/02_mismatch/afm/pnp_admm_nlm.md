# Atomic Force Microscopy (AFM) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Atomic Force Microscopy (AFM) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_landweber_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

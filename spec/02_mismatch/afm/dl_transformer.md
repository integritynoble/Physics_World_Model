# Atomic Force Microscopy (AFM) — Probe-Transformer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — Probe-Transformer + gradient` corresponds to the leaderboard entry at

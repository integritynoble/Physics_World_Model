# Atomic Force Microscopy (AFM) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

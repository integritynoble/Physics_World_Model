# Atomic Force Microscopy (AFM) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

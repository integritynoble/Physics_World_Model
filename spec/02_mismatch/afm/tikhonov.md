# Atomic Force Microscopy (AFM) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# Atomic Force Microscopy (AFM) — Probe-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — Probe-CNN + gradient` corresponds to the leaderboard entry at

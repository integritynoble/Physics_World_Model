# Atomic Force Microscopy (AFM) — Probe-GAN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_dl_gan_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — Probe-GAN + gradient` corresponds to the leaderboard entry at

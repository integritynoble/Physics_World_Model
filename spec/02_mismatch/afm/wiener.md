# Atomic Force Microscopy (AFM) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('afm_wiener_corrected.png'); plt.show()
```

## Benchmark

`Atomic Force Microscopy (AFM) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Doppler Ultrasound — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_wiener_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Doppler Ultrasound — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: IQ data (H × W × T, float32)
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — DiffusionMed + gradient` corresponds to the leaderboard entry at

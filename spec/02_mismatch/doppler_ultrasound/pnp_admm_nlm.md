# Doppler Ultrasound — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

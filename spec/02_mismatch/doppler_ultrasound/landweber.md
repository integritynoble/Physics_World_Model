# Doppler Ultrasound — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_landweber_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — Landweber Iteration + gradient` corresponds to the leaderboard entry at

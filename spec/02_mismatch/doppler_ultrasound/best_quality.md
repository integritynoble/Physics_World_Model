# Doppler Ultrasound — UDoppler-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — UDoppler-Net [proxy] + gradient` corresponds to the leaderboard entry at

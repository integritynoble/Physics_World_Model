# Doppler Ultrasound — Doppler CFAR [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — Doppler CFAR [proxy] + gradient` corresponds to the leaderboard entry at

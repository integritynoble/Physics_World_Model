# Doppler Ultrasound — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — MedMamba + gradient` corresponds to the leaderboard entry at

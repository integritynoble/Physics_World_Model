# Doppler Ultrasound — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

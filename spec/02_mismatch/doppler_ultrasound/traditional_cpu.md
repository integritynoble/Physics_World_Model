# Doppler Ultrasound — Back-Projection (Doppler) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — Back-Projection (Doppler) + gradient` corresponds to the leaderboard entry at

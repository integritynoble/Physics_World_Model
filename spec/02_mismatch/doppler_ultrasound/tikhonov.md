# Doppler Ultrasound — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

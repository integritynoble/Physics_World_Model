# Doppler Ultrasound — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — TV-ADMM + gradient` corresponds to the leaderboard entry at

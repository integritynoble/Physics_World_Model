# Doppler Ultrasound — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — SwinIR-Med + gradient` corresponds to the leaderboard entry at

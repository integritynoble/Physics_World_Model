# Doppler Ultrasound — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — Med-UNet + gradient` corresponds to the leaderboard entry at

# Doppler Ultrasound — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Doppler Ultrasound — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

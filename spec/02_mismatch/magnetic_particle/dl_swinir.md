# Magnetic Particle Imaging (MPI) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

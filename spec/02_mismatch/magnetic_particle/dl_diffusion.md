# Magnetic Particle Imaging (MPI) — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: system function (freq × ch, complex64)
...
plt.tight_layout(); plt.savefig('magnetic_particle_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — DiffusionMed + gradient` corresponds to the leaderboard entry at

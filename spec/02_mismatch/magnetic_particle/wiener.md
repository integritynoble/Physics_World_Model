# Magnetic Particle Imaging (MPI) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_wiener_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# Magnetic Particle Imaging (MPI) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

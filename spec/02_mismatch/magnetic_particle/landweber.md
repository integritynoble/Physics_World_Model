# Magnetic Particle Imaging (MPI) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_landweber_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

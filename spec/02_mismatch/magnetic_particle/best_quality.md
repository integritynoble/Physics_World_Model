# Magnetic Particle Imaging (MPI) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

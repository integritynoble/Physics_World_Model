# Magnetic Particle Imaging (MPI) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

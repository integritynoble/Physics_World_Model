# Magnetic Particle Imaging (MPI) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — MedMamba + gradient` corresponds to the leaderboard entry at

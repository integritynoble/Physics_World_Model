# Magnetic Particle Imaging (MPI) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

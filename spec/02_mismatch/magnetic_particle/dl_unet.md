# Magnetic Particle Imaging (MPI) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — Med-UNet + gradient` corresponds to the leaderboard entry at

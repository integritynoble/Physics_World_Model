# Magnetic Particle Imaging (MPI) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

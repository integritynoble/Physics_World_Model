# Magnetic Particle Imaging (MPI) — MPI-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('mpi_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('mpi_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('magnetic_particle_mpi_dl_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — MPI-Net [proxy] + gradient` corresponds to the leaderboard entry at

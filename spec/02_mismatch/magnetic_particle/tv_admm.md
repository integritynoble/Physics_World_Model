# Magnetic Particle Imaging (MPI) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — TV-ADMM + gradient` corresponds to the leaderboard entry at

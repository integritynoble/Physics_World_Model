# Magnetic Particle Imaging (MPI) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('magnetic_particle_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Magnetic Particle Imaging (MPI) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Event Camera / Dynamic Vision Sensor (DVS) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('event_camera_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Event Camera / Dynamic Vision Sensor (DVS) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

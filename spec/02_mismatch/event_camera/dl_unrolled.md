# Event Camera / Dynamic Vision Sensor (DVS) — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('event_camera_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Event Camera / Dynamic Vision Sensor (DVS) — Unrolled-Net + gradient` corresponds to the leaderboard entry at

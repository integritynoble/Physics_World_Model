# Event Camera / Dynamic Vision Sensor (DVS) — E2VID+ [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('event_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('event_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('event_camera_event_dl_corrected.png'); plt.show()
```

## Benchmark

`Event Camera / Dynamic Vision Sensor (DVS) — E2VID+ [proxy] + gradient` corresponds to the leaderboard entry at

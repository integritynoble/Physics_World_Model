# Event Camera / Dynamic Vision Sensor (DVS) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('event_camera_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Event Camera / Dynamic Vision Sensor (DVS) — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Event Camera / Dynamic Vision Sensor (DVS) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('event_camera_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Event Camera / Dynamic Vision Sensor (DVS) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

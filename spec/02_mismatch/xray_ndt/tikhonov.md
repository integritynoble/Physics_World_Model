# X-ray NDT (Radiography) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_ndt_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`X-ray NDT (Radiography) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

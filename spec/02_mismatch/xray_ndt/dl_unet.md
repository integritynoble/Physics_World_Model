# X-ray NDT (Radiography) — XR-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_ndt_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`X-ray NDT (Radiography) — XR-UNet + gradient` corresponds to the leaderboard entry at

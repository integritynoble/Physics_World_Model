# X-ray NDT (Radiography) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_ndt_landweber_corrected.png'); plt.show()
```

## Benchmark

`X-ray NDT (Radiography) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

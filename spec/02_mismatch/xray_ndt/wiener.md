# X-ray NDT (Radiography) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_ndt_wiener_corrected.png'); plt.show()
```

## Benchmark

`X-ray NDT (Radiography) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

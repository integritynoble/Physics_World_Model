# X-ray NDT (Radiography) — XR-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_ndt_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`X-ray NDT (Radiography) — XR-Diffusion + gradient` corresponds to the leaderboard entry at

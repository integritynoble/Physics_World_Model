# X-ray NDT (Radiography) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_ndt_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`X-ray NDT (Radiography) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

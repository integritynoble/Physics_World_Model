# X-ray NDT (Radiography) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_ndt_best_quality_corrected.png'); plt.show()
```

## Benchmark

`X-ray NDT (Radiography) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

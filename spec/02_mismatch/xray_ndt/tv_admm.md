# X-ray NDT (Radiography) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_ndt_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`X-ray NDT (Radiography) — TV-ADMM + gradient` corresponds to the leaderboard entry at

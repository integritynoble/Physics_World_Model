# X-ray NDT (Radiography) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('xray_ndt_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`X-ray NDT (Radiography) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

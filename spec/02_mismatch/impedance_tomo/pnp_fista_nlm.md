# Electrical Impedance Tomography (EIT) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

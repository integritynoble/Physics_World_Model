# Electrical Impedance Tomography (EIT) — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

# Electrical Impedance Tomography (EIT) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

# Electrical Impedance Tomography (EIT) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

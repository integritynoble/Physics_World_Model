# Electrical Impedance Tomography (EIT) — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

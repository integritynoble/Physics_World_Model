# Electrical Impedance Tomography (EIT) — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — U-Net Recon + gradient` corresponds to the leaderboard entry at

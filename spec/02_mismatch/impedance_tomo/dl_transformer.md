# Electrical Impedance Tomography (EIT) — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — TransCT + gradient` corresponds to the leaderboard entry at

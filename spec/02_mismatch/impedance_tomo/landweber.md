# Electrical Impedance Tomography (EIT) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_landweber_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

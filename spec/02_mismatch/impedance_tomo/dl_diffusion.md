# Electrical Impedance Tomography (EIT) — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — DiffusionRecon + gradient` corresponds to the leaderboard entry at

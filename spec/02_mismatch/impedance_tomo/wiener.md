# Electrical Impedance Tomography (EIT) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_wiener_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

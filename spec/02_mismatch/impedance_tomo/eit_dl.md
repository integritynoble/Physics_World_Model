# Electrical Impedance Tomography (EIT) — EIT-Net [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('eit_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('eit_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('impedance_tomo_eit_dl_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — EIT-Net [proxy] + gradient` corresponds to the leaderboard entry at

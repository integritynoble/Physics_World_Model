# Electrical Impedance Tomography (EIT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('impedance_tomo_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Electrical Impedance Tomography (EIT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

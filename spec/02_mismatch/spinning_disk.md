# Spinning Disk Confocal Microscopy — Mismatch Correction + Reconstruct
...
from algorithm_base.spinning_disk.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('spinning_disk_corrected.png'); plt.show()
```

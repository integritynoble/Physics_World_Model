# MALDI Mass Spectrometry Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# MALDI Mass Spectrometry Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

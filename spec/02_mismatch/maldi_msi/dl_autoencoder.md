# MALDI Mass Spectrometry Imaging — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — Spec-AE + gradient` corresponds to the leaderboard entry at

# MALDI Mass Spectrometry Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_landweber_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

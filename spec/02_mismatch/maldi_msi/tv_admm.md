# MALDI Mass Spectrometry Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

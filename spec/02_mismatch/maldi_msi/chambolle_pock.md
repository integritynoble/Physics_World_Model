# MALDI Mass Spectrometry Imaging — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — Chambolle-Pock + gradient` corresponds to the leaderboard entry at
`https://pwm.platformai.org/benchmark/maldi_msi` (mismatch correction tier).

# MALDI Mass Spectrometry Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# MALDI Mass Spectrometry Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

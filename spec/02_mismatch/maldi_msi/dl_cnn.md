# MALDI Mass Spectrometry Imaging — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — Spec-CNN + gradient` corresponds to the leaderboard entry at

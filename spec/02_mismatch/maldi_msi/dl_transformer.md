# MALDI Mass Spectrometry Imaging — Spec-Transformer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — Spec-Transformer + gradient` corresponds to the leaderboard entry at

# MALDI Mass Spectrometry Imaging — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_best_quality_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

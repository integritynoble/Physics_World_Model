# MALDI Mass Spectrometry Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_wiener_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# MALDI Mass Spectrometry Imaging — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

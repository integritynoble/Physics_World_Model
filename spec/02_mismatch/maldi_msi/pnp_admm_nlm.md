# MALDI Mass Spectrometry Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('maldi_msi_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`MALDI Mass Spectrometry Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

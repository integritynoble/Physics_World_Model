# Light Field Imaging — Unrolled-Net + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_dl_unrolled_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — Unrolled-Net + gradient` corresponds to the leaderboard entry at

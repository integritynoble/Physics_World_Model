# Light Field Imaging — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Light Field Imaging — Shift-and-Sum + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — Shift-and-Sum + gradient` corresponds to the leaderboard entry at

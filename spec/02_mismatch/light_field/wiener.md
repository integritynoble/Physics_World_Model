# Light Field Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_wiener_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

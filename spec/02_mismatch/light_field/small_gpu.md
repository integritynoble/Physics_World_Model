# Light Field Imaging — LFSSR + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_small_gpu_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — LFSSR + gradient` corresponds to the leaderboard entry at

# Light Field Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

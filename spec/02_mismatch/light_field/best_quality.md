# Light Field Imaging — LFBM5D + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — LFBM5D + gradient` corresponds to the leaderboard entry at

# Light Field Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

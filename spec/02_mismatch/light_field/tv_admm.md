# Light Field Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

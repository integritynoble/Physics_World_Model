# Light Field Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_landweber_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

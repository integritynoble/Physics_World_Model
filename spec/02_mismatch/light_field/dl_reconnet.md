# Light Field Imaging — ReconNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_dl_reconnet_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — ReconNet + gradient` corresponds to the leaderboard entry at

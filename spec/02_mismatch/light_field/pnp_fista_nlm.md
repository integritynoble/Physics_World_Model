# Light Field Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('light_field_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

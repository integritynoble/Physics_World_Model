# Light Field Imaging — CS-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: light field (u × v × s × t, float32)
...
plt.tight_layout(); plt.savefig('light_field_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Light Field Imaging — CS-Transformer + gradient` corresponds to the leaderboard entry at

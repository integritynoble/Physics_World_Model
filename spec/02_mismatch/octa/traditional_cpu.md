# OCT Angiography (OCTA) — FFT Recon (OCTA) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — FFT Recon (OCTA) + gradient` corresponds to the leaderboard entry at

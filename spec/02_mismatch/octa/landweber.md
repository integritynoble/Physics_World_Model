# OCT Angiography (OCTA) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_landweber_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

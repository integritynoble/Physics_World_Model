# OCT Angiography (OCTA) — OCTA-FF [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — OCTA-FF [proxy] + gradient` corresponds to the leaderboard entry at

# OCT Angiography (OCTA) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_wiener_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

# OCT Angiography (OCTA) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

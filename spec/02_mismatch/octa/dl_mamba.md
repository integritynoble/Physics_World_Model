# OCT Angiography (OCTA) — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — MedMamba + gradient` corresponds to the leaderboard entry at

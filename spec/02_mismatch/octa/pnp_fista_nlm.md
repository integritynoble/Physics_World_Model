# OCT Angiography (OCTA) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

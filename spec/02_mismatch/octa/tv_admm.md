# OCT Angiography (OCTA) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — TV-ADMM + gradient` corresponds to the leaderboard entry at

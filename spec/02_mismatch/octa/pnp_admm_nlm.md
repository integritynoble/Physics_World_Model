# OCT Angiography (OCTA) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# OCT Angiography (OCTA) — Chambolle-Pock + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_chambolle_pock_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — Chambolle-Pock + gradient` corresponds to the leaderboard entry at

# OCT Angiography (OCTA) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

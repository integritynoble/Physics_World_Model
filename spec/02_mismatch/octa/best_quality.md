# OCT Angiography (OCTA) — OCTA-Net [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_best_quality_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — OCTA-Net [proxy] + gradient` corresponds to the leaderboard entry at

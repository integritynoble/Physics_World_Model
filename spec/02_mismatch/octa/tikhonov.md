# OCT Angiography (OCTA) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# OCT Angiography (OCTA) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('octa_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`OCT Angiography (OCTA) — Med-UNet + gradient` corresponds to the leaderboard entry at

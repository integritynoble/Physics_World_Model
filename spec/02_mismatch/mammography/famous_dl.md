# Mammography — Mammo-ResNet [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Mammography — Mammo-ResNet [proxy] + gradient` corresponds to the leaderboard entry at

# Mammography — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`Mammography — SwinIR-Med + gradient` corresponds to the leaderboard entry at

# Mammography — MammoNet (GatorTron) [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Mammography — MammoNet (GatorTron) [proxy] + gradient` corresponds to the leaderboard entry at

# Mammography — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Mammography — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

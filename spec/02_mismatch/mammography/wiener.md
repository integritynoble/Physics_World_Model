# Mammography — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_wiener_corrected.png'); plt.show()
```

## Benchmark

`Mammography — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

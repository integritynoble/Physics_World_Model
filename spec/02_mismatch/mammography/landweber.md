# Mammography — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_landweber_corrected.png'); plt.show()
```

## Benchmark

`Mammography — Landweber Iteration + gradient` corresponds to the leaderboard entry at

# Mammography — MedMamba + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Mammography — MedMamba + gradient` corresponds to the leaderboard entry at

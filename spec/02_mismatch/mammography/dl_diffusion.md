# Mammography — DiffusionMed + Gradient Mismatch Correction

**Device**: GPU  **Input**: projection pair (2 × H × W, float32)
...
plt.tight_layout(); plt.savefig('mammography_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Mammography — DiffusionMed + gradient` corresponds to the leaderboard entry at

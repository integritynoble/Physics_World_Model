# Mammography — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Mammography — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

# Mammography — FBP (mammography) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Mammography — FBP (mammography) + gradient` corresponds to the leaderboard entry at

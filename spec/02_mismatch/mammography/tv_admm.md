# Mammography — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Mammography — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Mammography — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Mammography — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

# Mammography — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mammography_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Mammography — Med-UNet + gradient` corresponds to the leaderboard entry at

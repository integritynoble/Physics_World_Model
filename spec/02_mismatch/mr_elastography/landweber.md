# MR Elastography (MRE) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_elastography_landweber_corrected.png'); plt.show()
```

## Benchmark

`MR Elastography (MRE) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

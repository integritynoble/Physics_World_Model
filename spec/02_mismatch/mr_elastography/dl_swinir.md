# MR Elastography (MRE) — SwinIR-Med + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_elastography_dl_swinir_corrected.png'); plt.show()
```

## Benchmark

`MR Elastography (MRE) — SwinIR-Med + gradient` corresponds to the leaderboard entry at

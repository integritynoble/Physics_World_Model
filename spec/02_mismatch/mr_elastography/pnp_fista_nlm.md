# MR Elastography (MRE) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_elastography_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`MR Elastography (MRE) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

# MR Elastography (MRE) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_elastography_wiener_corrected.png'); plt.show()
```

## Benchmark

`MR Elastography (MRE) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

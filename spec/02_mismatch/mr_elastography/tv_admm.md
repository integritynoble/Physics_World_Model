# MR Elastography (MRE) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_elastography_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`MR Elastography (MRE) — TV-ADMM + gradient` corresponds to the leaderboard entry at

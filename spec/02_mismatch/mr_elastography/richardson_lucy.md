# MR Elastography (MRE) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_elastography_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`MR Elastography (MRE) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

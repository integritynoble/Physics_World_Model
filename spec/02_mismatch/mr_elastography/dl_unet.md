# MR Elastography (MRE) — Med-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_elastography_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`MR Elastography (MRE) — Med-UNet + gradient` corresponds to the leaderboard entry at

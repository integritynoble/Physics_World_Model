# MR Elastography (MRE) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('mr_elastography_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`MR Elastography (MRE) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

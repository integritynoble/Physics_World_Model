# Lucky Imaging — Mismatch Correction + Reconstruct
...
from algorithm_base.lucky_imaging.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('lucky_imaging_corrected.png'); plt.show()
```

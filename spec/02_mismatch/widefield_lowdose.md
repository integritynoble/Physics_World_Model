# Low-Dose Widefield Microscopy — Mismatch Correction + Reconstruct

**Input**: photon-limited image (H × W, float32)
**Benchmark**: `gs://pwm-benchmark-datasets/datasets/Benchmark/widefield_lowdose/public/`
**Algorithms**: 11 CPU, 5 GPU — reconstruct with `run_solver(key, y)`
...
plt.tight_layout(); plt.savefig('widefield_lowdose_corrected.png'); plt.show()
```

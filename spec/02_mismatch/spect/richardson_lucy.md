# Single Photon Emission CT (SPECT) — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

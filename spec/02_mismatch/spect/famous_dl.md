# Single Photon Emission CT (SPECT) — SPECT-UNet + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_famous_dl_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — SPECT-UNet + gradient` corresponds to the leaderboard entry at

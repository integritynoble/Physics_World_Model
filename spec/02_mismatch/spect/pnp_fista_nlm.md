# Single Photon Emission CT (SPECT) — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

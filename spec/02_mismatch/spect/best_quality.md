# Single Photon Emission CT (SPECT) — SPECT-DL (OSEM+) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_best_quality_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — SPECT-DL (OSEM+) + gradient` corresponds to the leaderboard entry at

# Single Photon Emission CT (SPECT) — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — TV-ADMM + gradient` corresponds to the leaderboard entry at

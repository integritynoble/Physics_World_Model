# Single Photon Emission CT (SPECT) — DiffusionRecon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — DiffusionRecon + gradient` corresponds to the leaderboard entry at

# Single Photon Emission CT (SPECT) — TransCT + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — TransCT + gradient` corresponds to the leaderboard entry at

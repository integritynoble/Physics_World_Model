# Single Photon Emission CT (SPECT) — U-Net Recon + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_dl_unet_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — U-Net Recon + gradient` corresponds to the leaderboard entry at

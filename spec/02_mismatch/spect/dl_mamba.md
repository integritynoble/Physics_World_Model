# Single Photon Emission CT (SPECT) — MambaRecon + Gradient Mismatch Correction

**Device**: GPU  **Input**: projections (angles × detectors, float32)
...
plt.tight_layout(); plt.savefig('spect_dl_mamba_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — MambaRecon + gradient` corresponds to the leaderboard entry at

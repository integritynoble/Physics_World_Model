# Single Photon Emission CT (SPECT) — FBP (emission tomography) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — FBP (emission tomography) + gradient` corresponds to the leaderboard entry at

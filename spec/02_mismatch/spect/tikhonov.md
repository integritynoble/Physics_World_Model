# Single Photon Emission CT (SPECT) — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

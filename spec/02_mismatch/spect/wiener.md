# Single Photon Emission CT (SPECT) — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_wiener_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

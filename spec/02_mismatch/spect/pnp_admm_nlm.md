# Single Photon Emission CT (SPECT) — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

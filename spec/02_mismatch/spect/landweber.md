# Single Photon Emission CT (SPECT) — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spect_landweber_corrected.png'); plt.show()
```

## Benchmark

`Single Photon Emission CT (SPECT) — Landweber Iteration + gradient` corresponds to the leaderboard entry at

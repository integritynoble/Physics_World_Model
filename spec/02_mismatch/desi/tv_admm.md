# DESI Mass Spectrometry Imaging — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — TV-ADMM + gradient` corresponds to the leaderboard entry at

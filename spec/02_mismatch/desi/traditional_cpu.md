# DESI Mass Spectrometry Imaging — Adjoint [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_traditional_cpu_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — Adjoint [proxy] + gradient` corresponds to the leaderboard entry at

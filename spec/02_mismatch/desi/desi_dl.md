# DESI Mass Spectrometry Imaging — DESI-SegNet [proxy] + Gradient Mismatch Correction
...
x_wrong = run_solver('desi_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('desi_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('desi_desi_dl_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — DESI-SegNet [proxy] + gradient` corresponds to the leaderboard entry at

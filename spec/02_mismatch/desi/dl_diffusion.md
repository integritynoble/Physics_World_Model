# DESI Mass Spectrometry Imaging — Spec-Diffusion + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — Spec-Diffusion + gradient` corresponds to the leaderboard entry at

# DESI Mass Spectrometry Imaging — Spec-Transformer + Gradient Mismatch Correction

**Device**: GPU  **Input**: mass image (H × W × m/z, float32)
...
plt.tight_layout(); plt.savefig('desi_dl_transformer_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — Spec-Transformer + gradient` corresponds to the leaderboard entry at

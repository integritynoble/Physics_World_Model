# DESI Mass Spectrometry Imaging — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

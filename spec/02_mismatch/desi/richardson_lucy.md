# DESI Mass Spectrometry Imaging — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

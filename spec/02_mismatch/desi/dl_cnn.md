# DESI Mass Spectrometry Imaging — Spec-CNN + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_dl_cnn_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — Spec-CNN + gradient` corresponds to the leaderboard entry at

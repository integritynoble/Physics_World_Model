# DESI Mass Spectrometry Imaging — Spec-AE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_dl_autoencoder_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — Spec-AE + gradient` corresponds to the leaderboard entry at

# DESI Mass Spectrometry Imaging — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_landweber_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — Landweber Iteration + gradient` corresponds to the leaderboard entry at

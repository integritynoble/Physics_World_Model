# DESI Mass Spectrometry Imaging — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

# DESI Mass Spectrometry Imaging — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_wiener_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

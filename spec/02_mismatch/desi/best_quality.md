# DESI Mass Spectrometry Imaging — PnP-ADMM [proxy] + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('desi_best_quality_corrected.png'); plt.show()
```

## Benchmark

`DESI Mass Spectrometry Imaging — PnP-ADMM [proxy] + gradient` corresponds to the leaderboard entry at

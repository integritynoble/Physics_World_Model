# X-ray Crystallography — Mismatch Correction + Reconstruct
...
from algorithm_base.xray_crystallography.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('xray_crystallography_corrected.png'); plt.show()
```

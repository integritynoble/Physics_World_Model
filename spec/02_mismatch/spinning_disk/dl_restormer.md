# Spinning Disk Confocal Microscopy — Restormer + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_dl_restormer_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — Restormer + gradient` corresponds to the leaderboard entry at

# Spinning Disk Confocal Microscopy — Tikhonov Regularization + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_tikhonov_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — Tikhonov Regularization + gradient` corresponds to the leaderboard entry at

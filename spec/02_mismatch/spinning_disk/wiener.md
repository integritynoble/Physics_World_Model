# Spinning Disk Confocal Microscopy — Wiener Deconvolution + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_wiener_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — Wiener Deconvolution + gradient` corresponds to the leaderboard entry at

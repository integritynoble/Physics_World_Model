# Spinning Disk Confocal Microscopy — DiffusionMicro + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_dl_diffusion_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — DiffusionMicro + gradient` corresponds to the leaderboard entry at

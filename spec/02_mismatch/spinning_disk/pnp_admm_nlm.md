# Spinning Disk Confocal Microscopy — PnP-ADMM (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_pnp_admm_nlm_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — PnP-ADMM (NLM) + gradient` corresponds to the leaderboard entry at

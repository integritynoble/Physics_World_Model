# Spinning Disk Confocal Microscopy — PnP-FISTA (NLM) + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_pnp_fista_nlm_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — PnP-FISTA (NLM) + gradient` corresponds to the leaderboard entry at

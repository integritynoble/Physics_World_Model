# Spinning Disk Confocal Microscopy — CARE + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_dl_care_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — CARE + gradient` corresponds to the leaderboard entry at

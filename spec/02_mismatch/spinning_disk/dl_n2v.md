# Spinning Disk Confocal Microscopy — Noise2Void + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_dl_n2v_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — Noise2Void + gradient` corresponds to the leaderboard entry at

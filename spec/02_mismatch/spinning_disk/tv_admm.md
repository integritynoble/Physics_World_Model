# Spinning Disk Confocal Microscopy — TV-ADMM + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_tv_admm_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — TV-ADMM + gradient` corresponds to the leaderboard entry at

# Spinning Disk Confocal Microscopy — Landweber Iteration + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_landweber_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — Landweber Iteration + gradient` corresponds to the leaderboard entry at

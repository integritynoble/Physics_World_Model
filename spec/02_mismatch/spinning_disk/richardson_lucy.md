# Spinning Disk Confocal Microscopy — Richardson-Lucy + Gradient Mismatch Correction
...
plt.tight_layout(); plt.savefig('spinning_disk_richardson_lucy_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — Richardson-Lucy + gradient` corresponds to the leaderboard entry at

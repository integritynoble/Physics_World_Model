# Spinning Disk Confocal Microscopy — SD-CARE + Gradient Mismatch Correction
...
x_wrong = run_solver('sd_dl', y, cfg={})
...
cfg.update({})
x_corrected = run_solver('sd_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('spinning_disk_sd_dl_corrected.png'); plt.show()
```

## Benchmark

`Spinning Disk Confocal Microscopy — SD-CARE + gradient` corresponds to the leaderboard entry at

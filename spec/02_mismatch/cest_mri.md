# CEST MRI — Mismatch Correction + Reconstruct
...
from algorithm_base.cest_mri.solvers import run_solver, list_solvers
...
plt.tight_layout(); plt.savefig('cest_mri_corrected.png'); plt.show()
```

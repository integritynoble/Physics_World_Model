...
**Input**: angiography k-space (kx × ky × kz, complex64)
...
| `mra_dl` | MRA-VesselNet [proxy] |  | CPU |
...
from algorithm_base.mra.solvers import run_solver, list_solvers
list_solvers()                    # 15 algorithms
y = ...                           # angiography k-space (kx × ky × kz, complex64)

# Shear-Wave Elastography — MedMamba
...
Shear-Wave Elastography reconstruction problem.
...
import h5py
with h5py.File('elastography_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/elastography/public/
...
plt.tight_layout(); plt.savefig('elastography_dl_mamba.png'); plt.show()
```

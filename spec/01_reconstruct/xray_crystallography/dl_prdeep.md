...
X-ray Crystallography reconstruction problem.
...
import h5py
with h5py.File('xray_crystallography_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/xray_crystallography/public/
...
plt.tight_layout(); plt.savefig('xray_crystallography_dl_prdeep.png'); plt.show()
```

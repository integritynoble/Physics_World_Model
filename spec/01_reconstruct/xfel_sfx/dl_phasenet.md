# XFEL Serial Femtosecond Crystallography (SFX) — PhaseNet
...
cfg = {}
x   = run_solver('dl_phasenet', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('xfel_sfx_dl_phasenet.png'); plt.show()
```

## Reference

*DL phase retrieval, 2018*

...
plt.tight_layout(); plt.savefig('ism_ism_dl.png'); plt.show()
```

## Reference

*Castello, M. et al. (2019) Image scanning microscopy ISM, Nature Methods 16:175*

# Positron Emission Tomography (PET) — TransCT
...
Positron Emission Tomography (PET) reconstruction problem.
...
import h5py
with h5py.File('pet_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/pet/public/
...
plt.tight_layout(); plt.savefig('pet_dl_transformer.png'); plt.show()
```

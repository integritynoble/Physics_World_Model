...
Lattice Light-Sheet Microscopy reconstruction problem.
...
import h5py
with h5py.File('lattice_lightsheet_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/lattice_lightsheet/public/
...
cfg = {}
x   = run_solver('llsm_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lattice_lightsheet_llsm_dl.png'); plt.show()
```

## Reference

*Weigert, M. et al. (2018) Content-aware restoration for lattice light-sheet, Nature Methods 15:1090*

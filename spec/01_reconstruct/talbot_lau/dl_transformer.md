# Talbot-Lau X-ray Grating Interferometry — Phase-Transformer
...
Talbot-Lau X-ray Grating Interferometry reconstruction problem.
...
import h5py
with h5py.File('talbot_lau_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/talbot_lau/public/
...
plt.tight_layout(); plt.savefig('talbot_lau_dl_transformer.png'); plt.show()
```

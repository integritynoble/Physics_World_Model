# Talbot-Lau X-ray Grating Interferometry — Talbot-Net [proxy]
...
cfg = {}
x   = run_solver('talbot_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('talbot_lau_talbot_dl.png'); plt.show()
```

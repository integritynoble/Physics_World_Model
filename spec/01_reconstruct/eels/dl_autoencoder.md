# Electron Energy Loss Spectroscopy (EELS) — Spec-AE
...
cfg = {}
x   = run_solver('dl_autoencoder', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('eels_dl_autoencoder.png'); plt.show()
```

## Reference

*Autoencoder spectral unmixing, 2020*

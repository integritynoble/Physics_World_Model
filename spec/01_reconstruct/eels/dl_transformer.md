# Electron Energy Loss Spectroscopy (EELS) — Spec-Transformer
...
Electron Energy Loss Spectroscopy (EELS) reconstruction problem.
...
import h5py
with h5py.File('eels_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/eels/public/
...
plt.tight_layout(); plt.savefig('eels_dl_transformer.png'); plt.show()
```

## Reference

*Transformer for spectroscopy, 2023*

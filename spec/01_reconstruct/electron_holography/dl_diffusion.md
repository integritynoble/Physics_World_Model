...
Electron Holography reconstruction problem.
...
import h5py
with h5py.File('electron_holography_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/electron_holography/public/
...
plt.tight_layout(); plt.savefig('electron_holography_dl_diffusion.png'); plt.show()
```

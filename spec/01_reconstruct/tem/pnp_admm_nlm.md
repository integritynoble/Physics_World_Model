# Transmission Electron Microscopy (TEM) — PnP-ADMM (NLM)
...
Transmission Electron Microscopy (TEM) reconstruction problem.
...
import h5py
with h5py.File('tem_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/tem/public/
...
plt.tight_layout(); plt.savefig('tem_pnp_admm_nlm.png'); plt.show()
```

# Interferometric SAR (InSAR) — RS-Transformer
...
Interferometric SAR (InSAR) reconstruction problem.
...
import h5py
with h5py.File('insar_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/insar/public/
...
plt.tight_layout(); plt.savefig('insar_dl_transformer.png'); plt.show()
```

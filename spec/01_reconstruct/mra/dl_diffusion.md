# MR Angiography (MRA) — DiffusionMed
...
MR Angiography (MRA) reconstruction problem.
...
import h5py
with h5py.File('mra_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/mra/public/
...
plt.tight_layout(); plt.savefig('mra_dl_diffusion.png'); plt.show()
```

# Coherent Anti-Stokes Raman (CARS) Microscopy — Spec-CNN
...
Coherent Anti-Stokes Raman (CARS) Microscopy reconstruction problem.
...
import h5py
with h5py.File('cars_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/cars/public/
...
plt.tight_layout(); plt.savefig('cars_dl_cnn.png'); plt.show()
```

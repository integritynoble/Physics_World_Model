# Contrast-Enhanced Ultrasound (CEUS) — PnP-ADMM (NLM)
...
Contrast-Enhanced Ultrasound (CEUS) reconstruction problem.
...
import h5py
with h5py.File('ceus_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ceus/public/
...
plt.tight_layout(); plt.savefig('ceus_pnp_admm_nlm.png'); plt.show()
```

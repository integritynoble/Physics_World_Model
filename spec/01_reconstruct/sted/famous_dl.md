...
STED Microscopy reconstruction problem.
...
import h5py
with h5py.File('sted_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/sted/public/
...
plt.tight_layout(); plt.savefig('sted_famous_dl.png'); plt.show()
```

## Reference

*Chen, J. et al. (2021) Three-dimensional residual channel attention for STED, Nature Methods 18:678*

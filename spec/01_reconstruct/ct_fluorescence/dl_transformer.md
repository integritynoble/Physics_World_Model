...
CT + Fluorescence (FLIT) reconstruction problem.
...
import h5py
with h5py.File('ct_fluorescence_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ct_fluorescence/public/
...
plt.tight_layout(); plt.savefig('ct_fluorescence_dl_transformer.png'); plt.show()
```

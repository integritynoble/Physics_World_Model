...
plt.tight_layout(); plt.savefig('palm_storm_best_quality.png'); plt.show()
```

## Reference

*Speiser, A. et al. (2021) Deep learning enables fast and dense SMLM, Nature Methods 18:1090*

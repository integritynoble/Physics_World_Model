...
PALM/STORM Single-Molecule Localization reconstruction problem.
...
import h5py
with h5py.File('palm_storm_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/palm_storm/public/
...
plt.tight_layout(); plt.savefig('palm_storm_famous_dl.png'); plt.show()
```

## Reference

*Nehme, E. et al. (2018) Deep-STORM: super-resolution microscopy, Optica 5(4)*

...
MINFLUX Nanoscopy reconstruction problem.
...
import h5py
with h5py.File('minflux_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/minflux/public/
...
cfg = {}
x   = run_solver('minflux_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('minflux_minflux_dl.png'); plt.show()
```

## Reference

*Gwosch, K.C. et al. (2020) MINFLUX nanoscopy 3D, Nature Methods 17:217*

# Functional MRI (BOLD fMRI) — MedMamba
...
Functional MRI (BOLD fMRI) reconstruction problem.
...
import h5py
with h5py.File('fmri_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/fmri/public/
...
plt.tight_layout(); plt.savefig('fmri_dl_mamba.png'); plt.show()
```

# Small-Angle X-ray Scattering (SAXS) — Phase-Transformer
...
Small-Angle X-ray Scattering (SAXS) reconstruction problem.
...
import h5py
with h5py.File('saxs_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/saxs/public/
...
plt.tight_layout(); plt.savefig('saxs_dl_transformer.png'); plt.show()
```

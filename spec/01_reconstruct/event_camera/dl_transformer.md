# Event Camera / Dynamic Vision Sensor (DVS) — CS-Transformer
...
Event Camera / Dynamic Vision Sensor (DVS) reconstruction problem.
...
import h5py
with h5py.File('event_camera_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/event_camera/public/
...
plt.tight_layout(); plt.savefig('event_camera_dl_transformer.png'); plt.show()
```

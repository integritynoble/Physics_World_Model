# DESI Mass Spectrometry Imaging — Spec-Transformer
...
DESI Mass Spectrometry Imaging reconstruction problem.
...
import h5py
with h5py.File('desi_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/desi/public/
...
plt.tight_layout(); plt.savefig('desi_dl_transformer.png'); plt.show()
```

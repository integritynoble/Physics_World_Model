...
CEST MRI reconstruction problem.
...
import h5py
with h5py.File('cest_mri_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/cest_mri/public/
...
plt.tight_layout(); plt.savefig('cest_mri_dl_diffusion.png'); plt.show()
```

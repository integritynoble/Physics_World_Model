# X-ray Radiography — XR-Diffusion
...
X-ray Radiography reconstruction problem.
...
import h5py
with h5py.File('xray_radiography_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/xray_radiography/public/
...
plt.tight_layout(); plt.savefig('xray_radiography_dl_diffusion.png'); plt.show()
```

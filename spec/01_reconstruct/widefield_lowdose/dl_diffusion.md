# Low-Dose Widefield Microscopy — DiffusionMicro
...
Low-Dose Widefield Microscopy reconstruction problem.
...
import h5py
with h5py.File('widefield_lowdose_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/widefield_lowdose/public/
...
plt.tight_layout(); plt.savefig('widefield_lowdose_dl_diffusion.png'); plt.show()
```

## Reference

*Diffusion-based microscopy, 2025*

# Near-field Scanning Optical Microscopy (NSOM) — PnP-ADMM (NLM)
...
Near-field Scanning Optical Microscopy (NSOM) reconstruction problem.
...
import h5py
with h5py.File('nsom_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/nsom/public/
...
plt.tight_layout(); plt.savefig('nsom_pnp_admm_nlm.png'); plt.show()
```

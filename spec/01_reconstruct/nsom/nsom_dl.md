...
cfg = {}
x   = run_solver('nsom_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('nsom_nsom_dl.png'); plt.show()
```

## Reference

*Park, J. et al. (2020) DL for near-field optical microscopy, Optica 7(11)*

# Functional Near-Infrared Spectroscopy (fNIRS) — SwinIR-Med
...
Functional Near-Infrared Spectroscopy (fNIRS) reconstruction problem.
...
import h5py
with h5py.File('nirs_brain_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/nirs_brain/public/
...
plt.tight_layout(); plt.savefig('nirs_brain_dl_swinir.png'); plt.show()
```

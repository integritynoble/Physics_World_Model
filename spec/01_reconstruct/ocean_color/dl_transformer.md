# Ocean Color Remote Sensing — RS-Transformer
...
Ocean Color Remote Sensing reconstruction problem.
...
import h5py
with h5py.File('ocean_color_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ocean_color/public/
...
plt.tight_layout(); plt.savefig('ocean_color_dl_transformer.png'); plt.show()
```

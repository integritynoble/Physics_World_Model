# Coded Aperture Snapshot Spectral Imaging (CASSI) — λ-Net
...
cfg = {'model_key': 'lambda_net'}
x   = run_solver('lambda_net', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cassi_lambda_net.png'); plt.show()
```

## Reference

*Miao et al., ICCV 2019 — 30.1 dB on KAIST*

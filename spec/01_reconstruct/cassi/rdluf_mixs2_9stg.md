# Coded Aperture Snapshot Spectral Imaging (CASSI) — RDLUF-MixS2-9stg
...
cfg = {'model_key': 'rdluf_mixs2_9stg'}
x   = run_solver('rdluf_mixs2_9stg', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cassi_rdluf_mixs2_9stg.png'); plt.show()
```

## Reference

*Dong et al., CVPR 2023 — 39.6 dB on KAIST*

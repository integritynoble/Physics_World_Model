...
plt.tight_layout(); plt.savefig('edx_mapping_edx_dl.png'); plt.show()
```

## Reference

*Tietz, C. et al. (2021) DL for EDS spectrum imaging, Ultramicroscopy 231*

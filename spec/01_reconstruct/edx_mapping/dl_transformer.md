# STEM-EDX Elemental Mapping — Spec-Transformer
...
STEM-EDX Elemental Mapping reconstruction problem.
...
import h5py
with h5py.File('edx_mapping_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/edx_mapping/public/
...
plt.tight_layout(); plt.savefig('edx_mapping_dl_transformer.png'); plt.show()
```

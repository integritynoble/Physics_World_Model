# Stimulated Raman Scattering (SRS) Microscopy — Spec-Transformer
...
Stimulated Raman Scattering (SRS) Microscopy reconstruction problem.
...
import h5py
with h5py.File('srs_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/srs/public/
...
plt.tight_layout(); plt.savefig('srs_dl_transformer.png'); plt.show()
```

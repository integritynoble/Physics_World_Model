# Passive Microwave Radiometry — RS-CNN
...
Passive Microwave Radiometry reconstruction problem.
...
import h5py
with h5py.File('passive_microwave_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/passive_microwave/public/
...
plt.tight_layout(); plt.savefig('passive_microwave_dl_cnn.png'); plt.show()
```

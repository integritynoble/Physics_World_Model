# Panorama Multi-Focus Fusion — DL-Transformer
...
Panorama Multi-Focus Fusion reconstruction problem.
...
import h5py
with h5py.File('panorama_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/panorama/public/
...
plt.tight_layout(); plt.savefig('panorama_dl_transformer.png'); plt.show()
```

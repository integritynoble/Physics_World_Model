...
plt.tight_layout(); plt.savefig('three_photon_3p_dl.png'); plt.show()
```

## Reference

*Weigert, M. et al. (2018) CARE for 3P deep tissue imaging, Nature Methods 15:1090*

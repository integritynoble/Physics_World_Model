# Three-Photon Microscopy — DiffusionMicro
...
Three-Photon Microscopy reconstruction problem.
...
import h5py
with h5py.File('three_photon_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/three_photon/public/
...
plt.tight_layout(); plt.savefig('three_photon_dl_diffusion.png'); plt.show()
```

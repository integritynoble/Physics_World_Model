# Coded Aperture Compressive Temporal Imaging (CACTI) — GAP-TV
...
Coded Aperture Compressive Temporal Imaging (CACTI) reconstruction problem.
...
import h5py
with h5py.File('cacti_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/cacti/public/
...
plt.tight_layout(); plt.savefig('cacti_traditional_cpu.png'); plt.show()
```

# High Dynamic Range (HDR) Imaging — DL-Transformer
...
High Dynamic Range (HDR) Imaging reconstruction problem.
...
import h5py
with h5py.File('hdr_imaging_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/hdr_imaging/public/
...
plt.tight_layout(); plt.savefig('hdr_imaging_dl_transformer.png'); plt.show()
```

# 4D-STEM Electron Diffraction — prDeep
...
cfg = {}
x   = run_solver('dl_prdeep', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('electron_diffraction_dl_prdeep.png'); plt.show()
```

## Reference

*Deep phase retrieval, 2020*

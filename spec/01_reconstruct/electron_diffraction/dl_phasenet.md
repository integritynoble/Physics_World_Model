# 4D-STEM Electron Diffraction — PhaseNet
...
4D-STEM Electron Diffraction reconstruction problem.
...
import h5py
with h5py.File('electron_diffraction_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/electron_diffraction/public/
...
plt.tight_layout(); plt.savefig('electron_diffraction_dl_phasenet.png'); plt.show()
```

# Confocal Laser Endomicroscopy (CLE) — PnP-ADMM (NLM)
...
Confocal Laser Endomicroscopy (CLE) reconstruction problem.
...
import h5py
with h5py.File('confocal_endomicroscopy_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/confocal_endomicroscopy/public/
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_pnp_admm_nlm.png'); plt.show()
```

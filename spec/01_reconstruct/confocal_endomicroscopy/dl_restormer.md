# Confocal Laser Endomicroscopy (CLE) — Restormer
...
cfg = {}
x   = run_solver('dl_restormer', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('confocal_endomicroscopy_dl_restormer.png'); plt.show()
```

# Scanning Electron Microscopy (SEM) — 3D-Diffusion
...
Scanning Electron Microscopy (SEM) reconstruction problem.
...
import h5py
with h5py.File('sem_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/sem/public/
...
plt.tight_layout(); plt.savefig('sem_dl_diffusion.png'); plt.show()
```

# Time-of-Flight Depth Camera — ReconNet
...
Time-of-Flight Depth Camera reconstruction problem.
...
import h5py
with h5py.File('tof_camera_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/tof_camera/public/
...
plt.tight_layout(); plt.savefig('tof_camera_dl_reconnet.png'); plt.show()
```

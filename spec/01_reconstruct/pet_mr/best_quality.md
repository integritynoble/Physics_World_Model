...
PET/MR Fusion reconstruction problem.
...
import h5py
with h5py.File('pet_mr_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/pet_mr/public/
...
plt.tight_layout(); plt.savefig('pet_mr_best_quality.png'); plt.show()
```

...
Lucky Imaging reconstruction problem.
...
import h5py
with h5py.File('lucky_imaging_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/lucky_imaging/public/
...
plt.tight_layout(); plt.savefig('lucky_imaging_dl_mamba.png'); plt.show()
```

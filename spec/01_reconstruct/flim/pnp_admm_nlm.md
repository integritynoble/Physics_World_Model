# Fluorescence Lifetime Imaging (FLIM) — PnP-ADMM (NLM)
...
Fluorescence Lifetime Imaging (FLIM) reconstruction problem.
...
import h5py
with h5py.File('flim_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/flim/public/
...
plt.tight_layout(); plt.savefig('flim_pnp_admm_nlm.png'); plt.show()
```

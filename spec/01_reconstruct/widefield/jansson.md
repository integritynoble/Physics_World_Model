...
Widefield Fluorescence Microscopy reconstruction problem.
...
import h5py
with h5py.File('widefield_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/widefield/public/
...
cfg = {}
x   = run_solver('jansson', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('widefield_jansson.png'); plt.show()
```

## Reference

*van Cittert 1931, Zeitschrift f. Physik; Jansson 1970*

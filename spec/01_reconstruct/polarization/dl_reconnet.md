# Polarization Microscopy — ReconNet
...
Polarization Microscopy reconstruction problem.
...
import h5py
with h5py.File('polarization_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/polarization/public/
...
plt.tight_layout(); plt.savefig('polarization_dl_reconnet.png'); plt.show()
```

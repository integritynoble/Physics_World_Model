# Brillouin Microscopy — Spec-Transformer
...
Brillouin Microscopy reconstruction problem.
...
import h5py
with h5py.File('brillouin_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/brillouin/public/
...
plt.tight_layout(); plt.savefig('brillouin_dl_transformer.png'); plt.show()
```

# 3D Gaussian Splatting (3DGS) — 3D-Transformer
...
3D Gaussian Splatting (3DGS) reconstruction problem.
...
import h5py
with h5py.File('gaussian_splatting_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/gaussian_splatting/public/
...
plt.tight_layout(); plt.savefig('gaussian_splatting_dl_transformer.png'); plt.show()
```

## Reference

*Transformer for 3D, 2023*

# Gravitational Wave Detection — RS-Transformer
...
Gravitational Wave Detection reconstruction problem.
...
import h5py
with h5py.File('gravitational_wave_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/gravitational_wave/public/
...
plt.tight_layout(); plt.savefig('gravitational_wave_dl_transformer.png'); plt.show()
```

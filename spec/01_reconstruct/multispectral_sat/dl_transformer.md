# Multispectral Satellite Imaging — RS-Transformer
...
Multispectral Satellite Imaging reconstruction problem.
...
import h5py
with h5py.File('multispectral_sat_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/multispectral_sat/public/
...
plt.tight_layout(); plt.savefig('multispectral_sat_dl_transformer.png'); plt.show()
```

...
plt.tight_layout(); plt.savefig('mfm_mfm_dl.png'); plt.show()
```

## Reference

*Kim, M. et al. (2021) DL for magnetic force microscopy, npj Comput. Mater. 7:87*

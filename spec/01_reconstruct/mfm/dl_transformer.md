# Magnetic Force Microscopy (MFM) — Probe-Transformer
...
Magnetic Force Microscopy (MFM) reconstruction problem.
...
import h5py
with h5py.File('mfm_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/mfm/public/
...
plt.tight_layout(); plt.savefig('mfm_dl_transformer.png'); plt.show()
```

## Reference

*Transformer for probe imaging, 2023*

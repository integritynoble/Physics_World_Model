...
Doppler Ultrasound reconstruction problem.
...
import h5py
with h5py.File('doppler_ultrasound_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/doppler_ultrasound/public/
...
plt.tight_layout(); plt.savefig('doppler_ultrasound_dl_diffusion.png'); plt.show()
```

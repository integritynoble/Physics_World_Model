...
Eddy Current Imaging reconstruction problem.
...
import h5py
with h5py.File('eddy_current_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/eddy_current/public/
...
plt.tight_layout(); plt.savefig('eddy_current_dl_transformer.png'); plt.show()
```

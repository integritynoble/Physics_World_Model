...
Phase Contrast Microscopy reconstruction problem.
...
import h5py
with h5py.File('phase_contrast_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/phase_contrast/public/
...
plt.tight_layout(); plt.savefig('phase_contrast_pc_dl.png'); plt.show()
```

## Reference

*Rivenson, Y. et al. (2018) Phase recovery with DL, Light: Sci. & Appl. 7:17141*

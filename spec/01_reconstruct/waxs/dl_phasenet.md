# Wide-Angle X-ray Scattering (WAXS) — PhaseNet
...
Wide-Angle X-ray Scattering (WAXS) reconstruction problem.
...
import h5py
with h5py.File('waxs_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/waxs/public/
...
plt.tight_layout(); plt.savefig('waxs_dl_phasenet.png'); plt.show()
```

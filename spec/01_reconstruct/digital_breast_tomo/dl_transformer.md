# Digital Breast Tomosynthesis (DBT) — TransCT
...
Digital Breast Tomosynthesis (DBT) reconstruction problem.
...
import h5py
with h5py.File('digital_breast_tomo_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/digital_breast_tomo/public/
...
plt.tight_layout(); plt.savefig('digital_breast_tomo_dl_transformer.png'); plt.show()
```

# Acoustic Emission Testing (AE) — PnP-ADMM (NLM)
...
Acoustic Emission Testing (AE) reconstruction problem.
...
import h5py
with h5py.File('acoustic_emission_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/acoustic_emission/public/
...
plt.tight_layout(); plt.savefig('acoustic_emission_pnp_admm_nlm.png'); plt.show()
```

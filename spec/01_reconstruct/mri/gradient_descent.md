# Magnetic Resonance Imaging (MRI) — Gradient Descent
...
cfg = {}
x   = run_solver('gradient_descent', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_gradient_descent.png'); plt.show()
```

## Reference

*Fessler, IEEE SPM 2010*

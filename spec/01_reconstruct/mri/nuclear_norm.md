...
cfg = {}
x   = run_solver('nuclear_norm', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('mri_nuclear_norm.png'); plt.show()
```

## Reference

*Cai, Candes, Shen, SIAM J Optim 2010; Shin et al., MRM 2014 (SAKE)*

# Magnetic Resonance Imaging (MRI) — ALOHA (Hankel Low-Rank)
...
plt.tight_layout(); plt.savefig('mri_aloha.png'); plt.show()
```

## Reference

*Jin & Ye, IEEE TIP 2015*

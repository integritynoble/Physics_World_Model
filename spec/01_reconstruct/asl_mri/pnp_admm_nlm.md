# Arterial Spin Labeling (ASL) MRI — PnP-ADMM (NLM)
...
Arterial Spin Labeling (ASL) MRI reconstruction problem.
...
import h5py
with h5py.File('asl_mri_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/asl_mri/public/
...
plt.tight_layout(); plt.savefig('asl_mri_pnp_admm_nlm.png'); plt.show()
```

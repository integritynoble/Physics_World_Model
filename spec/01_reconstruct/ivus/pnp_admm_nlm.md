# Intravascular Ultrasound (IVUS) — PnP-ADMM (NLM)
...
Intravascular Ultrasound (IVUS) reconstruction problem.
...
import h5py
with h5py.File('ivus_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ivus/public/
...
plt.tight_layout(); plt.savefig('ivus_pnp_admm_nlm.png'); plt.show()
```

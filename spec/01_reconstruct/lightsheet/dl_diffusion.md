# Light-Sheet Fluorescence Microscopy (LSFM) — DiffusionMicro
...
Light-Sheet Fluorescence Microscopy (LSFM) reconstruction problem.
...
import h5py
with h5py.File('lightsheet_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/lightsheet/public/
...
plt.tight_layout(); plt.savefig('lightsheet_dl_diffusion.png'); plt.show()
```

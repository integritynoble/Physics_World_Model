# Integral Photography — Unrolled-Net
...
Integral Photography reconstruction problem.
...
import h5py
with h5py.File('integral_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/integral/public/
...
plt.tight_layout(); plt.savefig('integral_dl_unrolled.png'); plt.show()
```

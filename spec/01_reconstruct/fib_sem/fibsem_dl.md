...
cfg = {}
x   = run_solver('fibsem_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('fib_sem_fibsem_dl.png'); plt.show()
```

## Reference

*Heinrich, L. et al. (2021) Whole-cell organelle segmentation in volume EM, Nature 599:141*

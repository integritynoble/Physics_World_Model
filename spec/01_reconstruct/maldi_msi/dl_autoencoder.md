# MALDI Mass Spectrometry Imaging — Spec-AE
...
MALDI Mass Spectrometry Imaging reconstruction problem.
...
import h5py
with h5py.File('maldi_msi_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/maldi_msi/public/
...
plt.tight_layout(); plt.savefig('maldi_msi_dl_autoencoder.png'); plt.show()
```

# Active Thermography (IR) — Probe-Diffusion
...
Active Thermography (IR) reconstruction problem.
...
import h5py
with h5py.File('active_thermography_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/active_thermography/public/
...
plt.tight_layout(); plt.savefig('active_thermography_dl_diffusion.png'); plt.show()
```

## Reference

*Diffusion for probe imaging, 2025*

...
Cryo-Electron Tomography (Cryo-ET) reconstruction problem.
...
import h5py
with h5py.File('cryo_et_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/cryo_et/public/
...
cfg = {}
x   = run_solver('cryo_et_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cryo_et_cryo_et_dl.png'); plt.show()
```

## Reference

*Buchholz, T.O. et al. (2019) Content-aware image restoration for cryo-EM, Methods Enzymol.*

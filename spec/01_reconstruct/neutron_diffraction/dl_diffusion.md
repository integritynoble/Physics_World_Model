# Neutron Diffraction — 3D-Diffusion
...
Neutron Diffraction reconstruction problem.
...
import h5py
with h5py.File('neutron_diffraction_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/neutron_diffraction/public/
...
plt.tight_layout(); plt.savefig('neutron_diffraction_dl_diffusion.png'); plt.show()
```

## Reference

*Diffusion for 3D reconstruction, 2025*

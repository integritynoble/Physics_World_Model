...
Weather / Doppler Radar reconstruction problem.
...
import h5py
with h5py.File('weather_radar_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/weather_radar/public/
...
plt.tight_layout(); plt.savefig('weather_radar_dl_transformer.png'); plt.show()
```

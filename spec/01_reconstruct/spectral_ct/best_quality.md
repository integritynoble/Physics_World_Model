# Photon-Counting Spectral CT — DL-Recon [proxy]
...
Photon-Counting Spectral CT reconstruction problem.
...
import h5py
with h5py.File('spectral_ct_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/spectral_ct/public/
...
plt.tight_layout(); plt.savefig('spectral_ct_best_quality.png'); plt.show()
```

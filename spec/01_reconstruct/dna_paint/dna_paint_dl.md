...
DNA-PAINT Super-Resolution reconstruction problem.
...
import h5py
with h5py.File('dna_paint_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/dna_paint/public/
...
cfg = {}
x   = run_solver('dna_paint_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('dna_paint_dna_paint_dl.png'); plt.show()
```

## Reference

*Speiser, A. et al. (2021) DL for dense SMLM, Nature Methods 18:1090*

...
Neural Radiance Fields (NeRF) reconstruction problem.
...
import h5py
with h5py.File('nerf_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/nerf/public/
...
cfg = {}
x   = run_solver('fista_proxy', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('nerf_fista_proxy.png'); plt.show()
```

## Reference

*Beck & Teboulle 2009, SIAM*

# MR Elastography (MRE) — DiffusionMed
...
MR Elastography (MRE) reconstruction problem.
...
import h5py
with h5py.File('mr_elastography_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/mr_elastography/public/
...
plt.tight_layout(); plt.savefig('mr_elastography_dl_diffusion.png'); plt.show()
```

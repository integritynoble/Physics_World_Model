# MR Spectroscopy (MRS) — DiffusionMed
...
MR Spectroscopy (MRS) reconstruction problem.
...
import h5py
with h5py.File('mrs_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/mrs/public/
...
plt.tight_layout(); plt.savefig('mrs_dl_diffusion.png'); plt.show()
```

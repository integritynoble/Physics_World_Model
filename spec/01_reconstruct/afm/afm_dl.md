...
plt.tight_layout(); plt.savefig('afm_afm_dl.png'); plt.show()
```

## Reference

*Cherukara, M.J. et al. (2020) AI-enabled high-res, real-time imaging, npj Comput. Mater. 6:203*

# Atomic Force Microscopy (AFM) — Probe-Transformer
...
Atomic Force Microscopy (AFM) reconstruction problem.
...
import h5py
with h5py.File('afm_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/afm/public/
...
plt.tight_layout(); plt.savefig('afm_dl_transformer.png'); plt.show()
```

# Electron Backscatter Diffraction (EBSD) — EMsoft-EBSD [proxy]
...
Electron Backscatter Diffraction (EBSD) reconstruction problem.
...
import h5py
with h5py.File('ebsd_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ebsd/public/
...
plt.tight_layout(); plt.savefig('ebsd_famous_dl.png'); plt.show()
```

...
plt.tight_layout(); plt.savefig('fundus_best_quality.png'); plt.show()
```

## Reference

*Zhou, Y. et al. (2023) RETFound: Foundation model for retinal imaging, Nature 622:156*

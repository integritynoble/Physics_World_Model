# Dual-Energy X-ray Absorptiometry (DEXA) — TransCT
...
Dual-Energy X-ray Absorptiometry (DEXA) reconstruction problem.
...
import h5py
with h5py.File('dexa_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/dexa/public/
...
plt.tight_layout(); plt.savefig('dexa_dl_transformer.png'); plt.show()
```

...
Muon Tomography reconstruction problem.
...
import h5py
with h5py.File('muon_tomo_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/muon_tomo/public/
...
plt.tight_layout(); plt.savefig('muon_tomo_pnp_admm_nlm.png'); plt.show()
```

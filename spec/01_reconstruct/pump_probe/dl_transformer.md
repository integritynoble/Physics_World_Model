# Pump-Probe Microscopy — CS-Transformer
...
Pump-Probe Microscopy reconstruction problem.
...
import h5py
with h5py.File('pump_probe_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/pump_probe/public/
...
plt.tight_layout(); plt.savefig('pump_probe_dl_transformer.png'); plt.show()
```

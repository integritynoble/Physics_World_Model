# Raman Imaging / Microscopy — Spec-Diffusion
...
Raman Imaging / Microscopy reconstruction problem.
...
import h5py
with h5py.File('raman_imaging_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/raman_imaging/public/
...
plt.tight_layout(); plt.savefig('raman_imaging_dl_diffusion.png'); plt.show()
```

...
Spinning Disk Confocal Microscopy reconstruction problem.
...
import h5py
with h5py.File('spinning_disk_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/spinning_disk/public/
...
plt.tight_layout(); plt.savefig('spinning_disk_sd_dl.png'); plt.show()
```

## Reference

*Weigert, M. et al. (2018) CARE for spinning disk confocal, Nature Methods 15:1090*

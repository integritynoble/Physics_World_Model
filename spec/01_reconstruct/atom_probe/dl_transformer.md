# Atom Probe Tomography (APT) — 3D-Transformer
...
Atom Probe Tomography (APT) reconstruction problem.
...
import h5py
with h5py.File('atom_probe_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/atom_probe/public/
...
plt.tight_layout(); plt.savefig('atom_probe_dl_transformer.png'); plt.show()
```

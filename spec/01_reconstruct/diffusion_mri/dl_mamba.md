...
Diffusion MRI (DTI) reconstruction problem.
...
import h5py
with h5py.File('diffusion_mri_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/diffusion_mri/public/
...
plt.tight_layout(); plt.savefig('diffusion_mri_dl_mamba.png'); plt.show()
```

# X-ray Fluorescence (XRF) Imaging — XR-Diffusion
...
X-ray Fluorescence (XRF) Imaging reconstruction problem.
...
import h5py
with h5py.File('xrf_imaging_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/xrf_imaging/public/
...
plt.tight_layout(); plt.savefig('xrf_imaging_dl_diffusion.png'); plt.show()
```

## Reference

*Diffusion for X-ray, 2024*

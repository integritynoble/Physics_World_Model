# X-ray Fluorescence (XRF) Imaging — XR-SwinIR
...
cfg = {}
x   = run_solver('dl_swinir', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('xrf_imaging_dl_swinir.png'); plt.show()
```

## Reference

*SwinIR for X-ray, 2022*

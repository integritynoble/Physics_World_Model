# Machine Vision / AOI — DL-Transformer
...
Machine Vision / AOI reconstruction problem.
...
import h5py
with h5py.File('machine_vision_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/machine_vision/public/
...
plt.tight_layout(); plt.savefig('machine_vision_dl_transformer.png'); plt.show()
```

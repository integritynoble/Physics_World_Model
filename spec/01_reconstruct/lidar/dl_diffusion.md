...
LiDAR Scanner reconstruction problem.
...
import h5py
with h5py.File('lidar_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/lidar/public/
...
plt.tight_layout(); plt.savefig('lidar_dl_diffusion.png'); plt.show()
```

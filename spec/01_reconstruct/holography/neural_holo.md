# Digital Holographic Microscopy — NeuralHolo
...
Digital Holographic Microscopy reconstruction problem.
...
import h5py
with h5py.File('holography_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/holography/public/
...
cfg = {}
x   = run_solver('neural_holo', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_neural_holo.png'); plt.show()
```

## Reference

*Neural-field-based holographic reconstruction with implicit representations, 2022*

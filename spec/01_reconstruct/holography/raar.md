...
plt.tight_layout(); plt.savefig('holography_raar.png'); plt.show()
```

## Reference

*Luke D.R., Relaxed averaged alternating reflections for diffraction imaging, Inverse Problems, 2005*

...
cfg = {}
x   = run_solver('tv_phase', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_tv_phase.png'); plt.show()
```

## Reference

*Horisaki R. et al., Single-shot phase imaging with randomised light, Optics Express, 2016; TV regularisation for phase, 2008*

...
cfg = {}
x   = run_solver('holonet', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_holonet.png'); plt.show()
```

## Reference

*Wu Y. et al., Extended depth-of-field in holographic imaging using deep-learning-based autofocusing, Nature Methods / Optica, 2019*

...
plt.tight_layout(); plt.savefig('holography_small_gpu.png'); plt.show()
```

## Reference

*Zhang Y. et al., PhaseGAN: A deep-learning phase-retrieval approach for unpaired datasets, Optics Letters, 2021*

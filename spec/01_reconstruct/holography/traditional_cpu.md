...
plt.tight_layout(); plt.savefig('holography_traditional_cpu.png'); plt.show()
```

## Reference

*Goodman J.W., Introduction to Fourier Optics, McGraw-Hill, 1968 (angular spectrum propagation, 1960s)*

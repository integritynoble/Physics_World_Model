...
plt.tight_layout(); plt.savefig('holography_tikhonov.png'); plt.show()
```

## Reference

*Tikhonov A.N., Solution of incorrectly formulated problems and the regularization method, Soviet Mathematics Doklady, 1963*

...
cfg = {}
x   = run_solver('holo_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_holo_mamba.png'); plt.show()
```

## Reference

*Mamba-based state-space holographic reconstruction model, 2024*

...
cfg = {}
x   = run_solver('deep_dih', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_deep_dih.png'); plt.show()
```

## Reference

*Ren Z. et al., End-to-end deep learning framework for digital holographic reconstruction, Optics Express, 2019*

...
cfg = {}
x   = run_solver('fresnel', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_fresnel.png'); plt.show()
```

## Reference

*Schnars U. & Jueptner W., Digital Holography, Springer, 2005; Fresnel integral formulation*

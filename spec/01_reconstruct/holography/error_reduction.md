...
cfg = {}
x   = run_solver('error_reduction', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_error_reduction.png'); plt.show()
```

## Reference

*Fienup J.R., Phase retrieval algorithms: a comparison, Applied Optics, 1982*

...
cfg = {}
x   = run_solver('holo_diffusion', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('holography_holo_diffusion.png'); plt.show()
```

## Reference

*Diffusion-model-based holographic image reconstruction, 2023*

...
plt.tight_layout(); plt.savefig('holography_pnp_admm_nlm.png'); plt.show()
```

## Reference

*Venkatakrishnan S.V. et al., Plug-and-Play Priors for Model Based Reconstruction, IEEE GlobalSIP, 2013*

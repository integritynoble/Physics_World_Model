# Radio Aperture Synthesis — RS-Transformer
...
Radio Aperture Synthesis reconstruction problem.
...
import h5py
with h5py.File('radio_astronomy_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/radio_astronomy/public/
...
plt.tight_layout(); plt.savefig('radio_astronomy_dl_transformer.png'); plt.show()
```

## Reference

*Transformer for remote sensing, 2022*

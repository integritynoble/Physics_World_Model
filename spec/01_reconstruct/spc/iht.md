...
Single-Pixel Camera (SPC) reconstruction problem.
...
import h5py
with h5py.File('spc_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/spc/public/
...
plt.tight_layout(); plt.savefig('spc_iht.png'); plt.show()
```

## Reference

*Blumensath & Davies, J. Fourier Anal. Appl. 2009*

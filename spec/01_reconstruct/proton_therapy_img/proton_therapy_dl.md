# Proton Therapy Imaging — ProtonTherapy-Net [proxy]
...
cfg = {}
x   = run_solver('proton_therapy_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('proton_therapy_img_proton_therapy_dl.png'); plt.show()
```

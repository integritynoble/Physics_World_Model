# Bioluminescence Tomography (BLT) — TransCT
...
Bioluminescence Tomography (BLT) reconstruction problem.
...
import h5py
with h5py.File('bioluminescence_tomo_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/bioluminescence_tomo/public/
...
plt.tight_layout(); plt.savefig('bioluminescence_tomo_dl_transformer.png'); plt.show()
```

## Reference

*Wang et al., IEEE TMI 2023*

...
Flash LiDAR reconstruction problem.
...
import h5py
with h5py.File('flash_lidar_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/flash_lidar/public/
...
plt.tight_layout(); plt.savefig('flash_lidar_dl_transformer.png'); plt.show()
```

# Ultrasound B-mode Imaging — US-Diffusion (PnP-PGD DRUNet)
...
Ultrasound B-mode Imaging reconstruction problem.
...
import h5py
with h5py.File('ultrasound_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ultrasound/public/
...
cfg = {}
x   = run_solver('us_diffusion', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ultrasound_us_diffusion.png'); plt.show()
```

## Reference

*Stevens et al. 2023, arXiv:2310.xxxx*

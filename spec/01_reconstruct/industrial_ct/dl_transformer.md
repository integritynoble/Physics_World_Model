...
Industrial X-ray CT reconstruction problem.
...
import h5py
with h5py.File('industrial_ct_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/industrial_ct/public/
...
plt.tight_layout(); plt.savefig('industrial_ct_dl_transformer.png'); plt.show()
```

...
Expansion Microscopy (ExM) reconstruction problem.
...
import h5py
with h5py.File('expansion_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/expansion/public/
...
plt.tight_layout(); plt.savefig('expansion_exm_dl.png'); plt.show()
```

## Reference

*Weigert, M. et al. (2018) CARE for fluorescence microscopy, Nature Methods 15:1090*

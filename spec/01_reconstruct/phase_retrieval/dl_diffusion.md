# Coherent Diffractive Imaging / Phase Retrieval — Phase-Diffusion
...
Coherent Diffractive Imaging / Phase Retrieval reconstruction problem.
...
import h5py
with h5py.File('phase_retrieval_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/phase_retrieval/public/
...
plt.tight_layout(); plt.savefig('phase_retrieval_dl_diffusion.png'); plt.show()
```

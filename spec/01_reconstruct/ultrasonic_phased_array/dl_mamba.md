# Ultrasonic Phased Array (TFM/FMC) — MedMamba
...
Ultrasonic Phased Array (TFM/FMC) reconstruction problem.
...
import h5py
with h5py.File('ultrasonic_phased_array_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ultrasonic_phased_array/public/
...
cfg = {}
x   = run_solver('dl_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_dl_mamba.png'); plt.show()
```

## Reference

*SSM for medical imaging, 2026*

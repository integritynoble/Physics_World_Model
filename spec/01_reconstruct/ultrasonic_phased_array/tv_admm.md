# Ultrasonic Phased Array (TFM/FMC) — TV-ADMM
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_tv_admm.png'); plt.show()
```

## Reference

*Rudin, Osher & Fatemi 1992; Boyd et al. 2010*

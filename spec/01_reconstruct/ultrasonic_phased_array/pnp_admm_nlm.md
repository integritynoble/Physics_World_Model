# Ultrasonic Phased Array (TFM/FMC) — PnP-ADMM (NLM)
...
plt.tight_layout(); plt.savefig('ultrasonic_phased_array_pnp_admm_nlm.png'); plt.show()
```

## Reference

*Venkatakrishnan et al., GlobalSIP 2013*

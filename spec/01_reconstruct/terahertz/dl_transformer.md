# Terahertz Imaging (THz) — DL-Transformer
...
Terahertz Imaging (THz) reconstruction problem.
...
import h5py
with h5py.File('terahertz_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/terahertz/public/
...
plt.tight_layout(); plt.savefig('terahertz_dl_transformer.png'); plt.show()
```

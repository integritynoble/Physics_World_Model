# Fourier Ptychographic Microscopy (FPM) — Phase-Transformer
...
Fourier Ptychographic Microscopy (FPM) reconstruction problem.
...
import h5py
with h5py.File('fpm_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/fpm/public/
...
plt.tight_layout(); plt.savefig('fpm_dl_transformer.png'); plt.show()
```

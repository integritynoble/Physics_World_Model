# Event Horizon Telescope (EHT) Imaging — RS-Transformer
...
Event Horizon Telescope (EHT) Imaging reconstruction problem.
...
import h5py
with h5py.File('eht_imaging_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/eht_imaging/public/
...
plt.tight_layout(); plt.savefig('eht_imaging_dl_transformer.png'); plt.show()
```

# Ocean Acoustic Tomography — RS-Diffusion
...
Ocean Acoustic Tomography reconstruction problem.
...
import h5py
with h5py.File('ocean_acoustic_tomo_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ocean_acoustic_tomo/public/
...
plt.tight_layout(); plt.savefig('ocean_acoustic_tomo_dl_diffusion.png'); plt.show()
```

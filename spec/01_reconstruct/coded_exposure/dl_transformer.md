# Coded Exposure / Flutter Shutter — CS-Transformer
...
Coded Exposure / Flutter Shutter reconstruction problem.
...
import h5py
with h5py.File('coded_exposure_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/coded_exposure/public/
...
plt.tight_layout(); plt.savefig('coded_exposure_dl_transformer.png'); plt.show()
```

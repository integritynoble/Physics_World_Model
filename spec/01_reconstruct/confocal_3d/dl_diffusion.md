...
Confocal 3D Z-Stack reconstruction problem.
...
import h5py
with h5py.File('confocal_3d_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/confocal_3d/public/
...
plt.tight_layout(); plt.savefig('confocal_3d_dl_diffusion.png'); plt.show()
```

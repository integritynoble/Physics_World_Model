# X-ray NDT (Radiography) — XR-Diffusion
...
X-ray NDT (Radiography) reconstruction problem.
...
import h5py
with h5py.File('xray_ndt_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/xray_ndt/public/
...
plt.tight_layout(); plt.savefig('xray_ndt_dl_diffusion.png'); plt.show()
```

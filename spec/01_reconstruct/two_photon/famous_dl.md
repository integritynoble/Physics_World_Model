...
Two-Photon / Multiphoton Microscopy reconstruction problem.
...
import h5py
with h5py.File('two_photon_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/two_photon/public/
...
cfg = {}
x   = run_solver('famous_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('two_photon_famous_dl.png'); plt.show()
```

## Reference

*Lecoq, J. et al. (2021) Removing independent noise in systems neuroscience using DeepInterpolation, Nature Methods 18:1401*

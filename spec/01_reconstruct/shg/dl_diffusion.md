# Second Harmonic Generation (SHG) Microscopy — DiffusionMicro
...
Second Harmonic Generation (SHG) Microscopy reconstruction problem.
...
import h5py
with h5py.File('shg_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/shg/public/
...
plt.tight_layout(); plt.savefig('shg_dl_diffusion.png'); plt.show()
```

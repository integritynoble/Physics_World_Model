# Correlative Light-Electron Microscopy (CLEM) — TV-ADMM
...
Correlative Light-Electron Microscopy (CLEM) reconstruction problem.
...
import h5py
with h5py.File('clem_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/clem/public/
...
plt.tight_layout(); plt.savefig('clem_tv_admm.png'); plt.show()
```

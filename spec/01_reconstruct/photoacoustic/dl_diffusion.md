# Photoacoustic Imaging — DiffusionMed
...
Photoacoustic Imaging reconstruction problem.
...
import h5py
with h5py.File('photoacoustic_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/photoacoustic/public/
...
plt.tight_layout(); plt.savefig('photoacoustic_dl_diffusion.png'); plt.show()
```

...
cfg = {}
x   = run_solver('ptycho_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ptychography_ptycho_mamba.png'); plt.show()
```

## Reference

*Li, Z. et al. (2024) State-space models for efficient ptychographic reconstruction, ACS Photonics*

...
plt.tight_layout(); plt.savefig('ptychography_small_gpu.png'); plt.show()
```

## Reference

*Wu, L. et al. (2022) PtychoNN 2.0: on-the-fly neural network-based reconstruction, Journal of Applied Crystallography*

...
plt.tight_layout(); plt.savefig('ptychography_pnp_admm_nlm.png'); plt.show()
```

## Reference

*Venkatakrishnan, S. et al. (2013) Plug-and-Play priors for model-based reconstruction, IEEE GlobalSIP*

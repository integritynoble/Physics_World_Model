...
plt.tight_layout(); plt.savefig('ptychography_mpie.png'); plt.show()
```

## Reference

*Maiden, A.M. et al. (2012) Further improvements to the ptychographical iterative engine, Optica*

...
plt.tight_layout(); plt.savefig('ptychography_famous_dl.png'); plt.show()
```

## Reference

*Nguyen, T. et al. (2018) Deep learning approach for Fourier ptychography microscopy, Optics Express*

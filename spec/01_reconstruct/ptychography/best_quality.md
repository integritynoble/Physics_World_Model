...
plt.tight_layout(); plt.savefig('ptychography_best_quality.png'); plt.show()
```

## Reference

*Cherukara, M.J. et al. (2020) AI-enabled high-resolution scanning coherent imaging, Applied Physics Letters*

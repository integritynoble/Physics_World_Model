...
plt.tight_layout(); plt.savefig('ptychography_pie.png'); plt.show()
```

## Reference

*Rodenburg, J.M. & Faulkner, H.M.L. (2004) A phase retrieval algorithm for shifting illumination, Applied Physics Letters*

...
**Device**: GPU  **Input**: diffraction patterns (N_pos × H × W, float32)

*No reference metric in registry*

## System

Ptychographic Imaging reconstruction problem.
...
import h5py
with h5py.File('ptychography_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ptychography/public/
...
cfg = {}
x   = run_solver('ptycho_diffusion', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ptychography_ptycho_diffusion.png'); plt.show()
```

## Reference

*Cherukara, M.J. et al. (2023) Diffusion model for ptychographic phase retrieval, Nature Computational Science*

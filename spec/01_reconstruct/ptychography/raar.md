...
plt.tight_layout(); plt.savefig('ptychography_raar.png'); plt.show()
```

## Reference

*Luke, D.R. (2005) Relaxed averaged alternating reflections for diffraction imaging, Inverse Problems*

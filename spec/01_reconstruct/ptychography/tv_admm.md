...
plt.tight_layout(); plt.savefig('ptychography_tv_admm.png'); plt.show()
```

## Reference

*Boyd, S. et al. (2008/2011) Distributed optimization and statistical learning via ADMM, Foundations and Trends in ML*

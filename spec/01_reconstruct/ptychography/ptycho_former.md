...
cfg = {}
x   = run_solver('ptycho_former', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ptychography_ptycho_former.png'); plt.show()
```

## Reference

*Shi, J. et al. (2024) PtychoFormer: transformer-based ptychographic reconstruction, Optica*

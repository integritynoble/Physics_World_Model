...
plt.tight_layout(); plt.savefig('ptychography_landweber.png'); plt.show()
```

## Reference

*Landweber, L. (1951) An iteration formula for Fredholm integral equations, American Journal of Mathematics*

...
plt.tight_layout(); plt.savefig('ptychography_wdd.png'); plt.show()
```

## Reference

*Rodenburg, J.M. & Bates, R.H.T. (1992) The theory of super-resolution electron microscopy via WDD, Phil. Trans. R. Soc. A*

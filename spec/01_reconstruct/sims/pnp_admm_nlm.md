# Secondary Ion Mass Spectrometry (SIMS) Imaging — PnP-ADMM (NLM)
...
Secondary Ion Mass Spectrometry (SIMS) Imaging reconstruction problem.
...
import h5py
with h5py.File('sims_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/sims/public/
...
plt.tight_layout(); plt.savefig('sims_pnp_admm_nlm.png'); plt.show()
```

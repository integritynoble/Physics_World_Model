# Diffuse Optical Tomography (DOT) — PnP-ADMM (NLM)
...
Diffuse Optical Tomography (DOT) reconstruction problem.
...
import h5py
with h5py.File('dot_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/dot/public/
...
plt.tight_layout(); plt.savefig('dot_pnp_admm_nlm.png'); plt.show()
```

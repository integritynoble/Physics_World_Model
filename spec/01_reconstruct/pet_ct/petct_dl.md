...
PET/CT Fusion reconstruction problem.
...
import h5py
with h5py.File('pet_ct_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/pet_ct/public/
...
cfg = {}
x   = run_solver('petct_dl', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('pet_ct_petct_dl.png'); plt.show()
```

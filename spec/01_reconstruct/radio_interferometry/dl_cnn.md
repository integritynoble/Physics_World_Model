# Radio Interferometry (VLBI) — RS-CNN
...
plt.tight_layout(); plt.savefig('radio_interferometry_dl_cnn.png'); plt.show()
```

## Reference

*Deep learning for remote sensing, 2018*

# Radio Interferometry (VLBI) — RS-Diffusion
...
Radio Interferometry (VLBI) reconstruction problem.
...
import h5py
with h5py.File('radio_interferometry_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/radio_interferometry/public/
...
plt.tight_layout(); plt.savefig('radio_interferometry_dl_diffusion.png'); plt.show()
```

## Reference

*Diffusion model for RS, 2024*

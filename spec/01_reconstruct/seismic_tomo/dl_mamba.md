...
Seismic Tomography reconstruction problem.
...
import h5py
with h5py.File('seismic_tomo_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/seismic_tomo/public/
...
plt.tight_layout(); plt.savefig('seismic_tomo_dl_mamba.png'); plt.show()
```

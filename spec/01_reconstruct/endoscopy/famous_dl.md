...
Fiber Bundle Endoscopy reconstruction problem.
...
import h5py
with h5py.File('endoscopy_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/endoscopy/public/
...
plt.tight_layout(); plt.savefig('endoscopy_famous_dl.png'); plt.show()
```

## Reference

*Shao, S. et al. (2022) Self-supervised depth estimation in endoscopy, MICCAI 2022*

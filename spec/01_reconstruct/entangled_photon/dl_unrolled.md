# Entangled Photon Microscopy — Unrolled-Net
...
cfg = {}
x   = run_solver('dl_unrolled', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('entangled_photon_dl_unrolled.png'); plt.show()
```

## Reference

*Deep unrolling for CS, 2020*

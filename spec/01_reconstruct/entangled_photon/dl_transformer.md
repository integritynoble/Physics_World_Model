# Entangled Photon Microscopy — CS-Transformer
...
Entangled Photon Microscopy reconstruction problem.
...
import h5py
with h5py.File('entangled_photon_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/entangled_photon/public/
...
plt.tight_layout(); plt.savefig('entangled_photon_dl_transformer.png'); plt.show()
```

## Reference

*Transformer for CS, 2023*

...
cfg = {}
x   = run_solver('diffuser_dm', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lensless_diffuser_dm.png'); plt.show()
```

## Reference

*Diffusion-based generative model for diffuser camera reconstruction, 2023*

...
cfg = {}
x   = run_solver('lensless_former', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lensless_lensless_former.png'); plt.show()
```

## Reference

*Cao H. et al., LenslessFormer: Lensless Image Restoration via Transformer, CVPR, 2024*

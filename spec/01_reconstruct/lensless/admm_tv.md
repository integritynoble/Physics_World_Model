...
cfg = {}
x   = run_solver('admm_tv', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lensless_admm_tv.png'); plt.show()
```

## Reference

*Antipa N. et al., DiffuserCam: lensless single-exposure 3D imaging, Optica, 2018*

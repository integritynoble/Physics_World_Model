...
cfg = {}
x   = run_solver('lens_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lensless_lens_mamba.png'); plt.show()
```

## Reference

*Mamba-based lensless imaging reconstruction with state-space modelling, 2024*

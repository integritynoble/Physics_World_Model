...
plt.tight_layout(); plt.savefig('lensless_famous_dl.png'); plt.show()
```

## Reference

*Monakhova K. et al., Learned Reconstructions for Practical Mask-Based Lensless Imaging, IEEE TPAMI, 2022*

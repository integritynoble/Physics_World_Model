...
plt.tight_layout(); plt.savefig('lensless_best_quality.png'); plt.show()
```

## Reference

*Khan S.S. et al., FlatNet: Towards Photorealistic Scene Reconstruction from Lensless Measurements, IEEE TPAMI, 2020*

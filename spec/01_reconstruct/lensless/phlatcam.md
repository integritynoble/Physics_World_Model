...
cfg = {}
x   = run_solver('phlatcam', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lensless_phlatcam.png'); plt.show()
```

## Reference

*Boominathan V. et al., PhlatCam: Designed Phase-Mask Based Thin Lensless Camera, IEEE TPAMI / ICCP, 2020*

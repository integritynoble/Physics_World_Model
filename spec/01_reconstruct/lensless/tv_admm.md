...
**Device**: CPU  **Input**: diffuser measurement (H × W, float32)

*No reference metric in registry*

## System

Lensless (Diffuser Camera) Imaging reconstruction problem.
...
import h5py
with h5py.File('lensless_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/lensless/public/
...
plt.tight_layout(); plt.savefig('lensless_tv_admm.png'); plt.show()
```

## Reference

*Boyd S. et al., Distributed Optimization and Statistical Learning via ADMM, Foundations and Trends in ML, 2011; Chambolle A., An algorithm for TV minimization, JMIV, 2004*

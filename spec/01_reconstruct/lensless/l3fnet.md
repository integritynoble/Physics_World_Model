...
plt.tight_layout(); plt.savefig('lensless_l3fnet.png'); plt.show()
```

## Reference

*Tan G. et al., L3Fnet: Lensless Light-Field Reconstruction Network, IEEE TMM, 2023*

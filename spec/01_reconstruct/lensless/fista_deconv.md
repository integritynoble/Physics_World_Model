...
cfg = {}
x   = run_solver('fista_deconv', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('lensless_fista_deconv.png'); plt.show()
```

## Reference

*Beck A. & Teboulle M., A Fast Iterative Shrinkage-Thresholding Algorithm, SIAM J. Imaging Sciences, 2009*

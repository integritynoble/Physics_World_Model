...
plt.tight_layout(); plt.savefig('lensless_landweber.png'); plt.show()
```

## Reference

*Landweber L., An iteration formula for Fredholm integral equations of the first kind, American Journal of Mathematics, 1951*

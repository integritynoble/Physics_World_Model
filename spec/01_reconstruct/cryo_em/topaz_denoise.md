# Cryo-EM Single Particle Analysis — Topaz-Denoise (DRUNet denoise)
...
Cryo-EM Single Particle Analysis reconstruction problem.
...
import h5py
with h5py.File('cryo_em_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/cryo_em/public/
...
cfg = {}
x   = run_solver('topaz_denoise', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cryo_em_topaz_denoise.png'); plt.show()
```

## Reference

*Bepler et al. 2020, Nature Comms.*

...
cfg = {}
x   = run_solver('fdk_shepp_logan', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cbct_fdk_shepp_logan.png'); plt.show()
```

## Reference

*Shepp, L.A. & Logan, B.F. (1974) The Fourier reconstruction of a head section, IEEE Trans. Nuclear Science*

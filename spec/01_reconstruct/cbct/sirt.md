...
plt.tight_layout(); plt.savefig('cbct_sirt.png'); plt.show()
```

## Reference

*Gilbert, P. (1972) Iterative methods for the three-dimensional reconstruction of an object, Journal of Theoretical Biology*

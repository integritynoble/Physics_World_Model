...
plt.tight_layout(); plt.savefig('cbct_tv_admm.png'); plt.show()
```

## Reference

*Sidky, E.Y., Kao, C.-M. & Pan, X. (2008) Accurate image reconstruction from few-views and limited-angle data in divergent-beam CT, JXST*

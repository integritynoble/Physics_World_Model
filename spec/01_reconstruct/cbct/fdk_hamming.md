# Cone-Beam Computed Tomography (CBCT) — FDK Hamming
...
cfg = {}
x   = run_solver('fdk_hamming', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cbct_fdk_hamming.png'); plt.show()
```

## Reference

*Feldkamp, L.A., Davis, L.C. & Kress, J.W. (1984) Practical cone-beam algorithm, JOSA A*

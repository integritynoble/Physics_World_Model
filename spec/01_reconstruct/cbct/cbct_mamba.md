...
cfg = {}
x   = run_solver('cbct_mamba', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cbct_cbct_mamba.png'); plt.show()
```

## Reference

*Wang, Z. et al. (2024) State-space models for efficient CT reconstruction, Medical Image Analysis*

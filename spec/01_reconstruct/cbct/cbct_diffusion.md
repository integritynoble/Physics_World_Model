...
Cone-Beam Computed Tomography (CBCT) reconstruction problem.
...
import h5py
with h5py.File('cbct_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/cbct/public/
...
cfg = {}
x   = run_solver('cbct_diffusion', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cbct_cbct_diffusion.png'); plt.show()
```

## Reference

*Chung, H. et al. (2023) Solving 3D inverse problems using pre-trained 2D diffusion models, CVPR*

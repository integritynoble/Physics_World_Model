...
cfg = {}
x   = run_solver('cbct_naf', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('cbct_cbct_naf.png'); plt.show()
```

## Reference

*Zha, R. et al. (2024) NAF: Neural Attenuation Fields for sparse-view CBCT reconstruction, IEEE TMI*

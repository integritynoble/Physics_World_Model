...
plt.tight_layout(); plt.savefig('cbct_pnp_fista_nlm.png'); plt.show()
```

## Reference

*Beck, A. & Teboulle, M. (2009) A fast iterative shrinkage-thresholding algorithm, SIAM J. Imaging Sci. + PnP framework*

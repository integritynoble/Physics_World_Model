...
plt.tight_layout(); plt.savefig('cbct_art.png'); plt.show()
```

## Reference

*Gordon, R., Bender, R. & Herman, G.T. (1970) Algebraic reconstruction techniques (ART), Journal of Theoretical Biology*

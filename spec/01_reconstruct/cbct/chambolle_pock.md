...
plt.tight_layout(); plt.savefig('cbct_chambolle_pock.png'); plt.show()
```

## Reference

*Chambolle, A. & Pock, T. (2011) A first-order primal-dual algorithm for convex problems, J. Math. Imaging Vis.*

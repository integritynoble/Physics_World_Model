...
Proton Radiography reconstruction problem.
...
import h5py
with h5py.File('proton_radiography_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/proton_radiography/public/
...
plt.tight_layout(); plt.savefig('proton_radiography_dl_transformer.png'); plt.show()
```

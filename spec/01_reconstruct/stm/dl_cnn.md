# Scanning Tunneling Microscopy (STM) — Probe-CNN
...
Scanning Tunneling Microscopy (STM) reconstruction problem.
...
import h5py
with h5py.File('stm_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/stm/public/
...
plt.tight_layout(); plt.savefig('stm_dl_cnn.png'); plt.show()
```

...
Ghost Imaging reconstruction problem.
...
import h5py
with h5py.File('ghost_imaging_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ghost_imaging/public/
...
plt.tight_layout(); plt.savefig('ghost_imaging_dl_reconnet.png'); plt.show()
```

# Scanning Acoustic Microscopy (SAM) — DL-Transformer
...
Scanning Acoustic Microscopy (SAM) reconstruction problem.
...
import h5py
with h5py.File('acoustic_microscopy_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/acoustic_microscopy/public/
...
plt.tight_layout(); plt.savefig('acoustic_microscopy_dl_transformer.png'); plt.show()
```

## Reference

*Transformer reconstruction, 2023*

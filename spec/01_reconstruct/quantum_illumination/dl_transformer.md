# Quantum Illumination — CS-Transformer
...
Quantum Illumination reconstruction problem.
...
import h5py
with h5py.File('quantum_illumination_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/quantum_illumination/public/
...
plt.tight_layout(); plt.savefig('quantum_illumination_dl_transformer.png'); plt.show()
```

# FTIR Spectroscopic Imaging — PnP-ADMM (NLM)
...
FTIR Spectroscopic Imaging reconstruction problem.
...
import h5py
with h5py.File('ftir_imaging_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/ftir_imaging/public/
...
plt.tight_layout(); plt.savefig('ftir_imaging_pnp_admm_nlm.png'); plt.show()
```

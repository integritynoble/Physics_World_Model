...
Light Field Imaging reconstruction problem.
...
import h5py
with h5py.File('light_field_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/light_field/public/
...
plt.tight_layout(); plt.savefig('light_field_dl_reconnet.png'); plt.show()
```

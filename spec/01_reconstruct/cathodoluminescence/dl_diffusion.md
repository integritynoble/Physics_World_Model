# Cathodoluminescence (CL) Imaging — Spec-Diffusion
...
Cathodoluminescence (CL) Imaging reconstruction problem.
...
import h5py
with h5py.File('cathodoluminescence_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/cathodoluminescence/public/
...
plt.tight_layout(); plt.savefig('cathodoluminescence_dl_diffusion.png'); plt.show()
```

# Streak Camera Imaging — Unrolled-Net
...
Streak Camera Imaging reconstruction problem.
...
import h5py
with h5py.File('streak_camera_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/streak_camera/public/
...
plt.tight_layout(); plt.savefig('streak_camera_dl_unrolled.png'); plt.show()
```

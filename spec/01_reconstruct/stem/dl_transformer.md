# Scanning Transmission Electron Microscopy (STEM) — 3D-Transformer
...
Scanning Transmission Electron Microscopy (STEM) reconstruction problem.
...
import h5py
with h5py.File('stem_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/stem/public/
...
plt.tight_layout(); plt.savefig('stem_dl_transformer.png'); plt.show()
```

# Ground-Penetrating Radar (GPR) — RS-CNN
...
Ground-Penetrating Radar (GPR) reconstruction problem.
...
import h5py
with h5py.File('gpr_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/gpr/public/
...
plt.tight_layout(); plt.savefig('gpr_dl_cnn.png'); plt.show()
```

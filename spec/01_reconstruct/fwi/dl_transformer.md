# Full-Waveform Inversion (FWI) — RS-Transformer
...
Full-Waveform Inversion (FWI) reconstruction problem.
...
import h5py
with h5py.File('fwi_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/fwi/public/
...
plt.tight_layout(); plt.savefig('fwi_dl_transformer.png'); plt.show()
```

...
cfg = {}
x   = run_solver('df_unet', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('dark_field_df_unet.png'); plt.show()
```

## Reference

*Wolfer, T. et al. (2021) DL for dark-field X-ray CT, Sci. Rep. 11:5005*

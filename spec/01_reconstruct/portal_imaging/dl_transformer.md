...
Portal Imaging (EPID) reconstruction problem.
...
import h5py
with h5py.File('portal_imaging_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/portal_imaging/public/
...
plt.tight_layout(); plt.savefig('portal_imaging_dl_transformer.png'); plt.show()
```

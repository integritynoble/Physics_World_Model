# Adaptive Optics (AO) Imaging — DL-Diffusion
...
Adaptive Optics (AO) Imaging reconstruction problem.
...
import h5py
with h5py.File('adaptive_optics_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/adaptive_optics/public/
...
plt.tight_layout(); plt.savefig('adaptive_optics_dl_diffusion.png'); plt.show()
```

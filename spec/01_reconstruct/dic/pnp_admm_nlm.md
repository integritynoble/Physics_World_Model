# Differential Interference Contrast (DIC) — PnP-ADMM (NLM)
...
Differential Interference Contrast (DIC) reconstruction problem.
...
import h5py
with h5py.File('dic_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/dic/public/
...
plt.tight_layout(); plt.savefig('dic_pnp_admm_nlm.png'); plt.show()
```

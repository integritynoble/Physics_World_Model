# Hyperspectral Remote Sensing — RS-CNN
...
Hyperspectral Remote Sensing reconstruction problem.
...
import h5py
with h5py.File('hyperspectral_remote_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/hyperspectral_remote/public/
...
plt.tight_layout(); plt.savefig('hyperspectral_remote_dl_cnn.png'); plt.show()
```

# X-ray Computed Tomography (CT) — FBP + Wavelet
...
cfg = {}
x   = run_solver('fbp_wavelet', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ct_fbp_wavelet.png'); plt.show()
```

## Reference

*Donoho, IEEE TIT 1995*

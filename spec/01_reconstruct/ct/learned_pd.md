# X-ray Computed Tomography (CT) — Learned Primal-Dual
...
cfg = {}
x   = run_solver('learned_pd', y, cfg=cfg)
...
plt.tight_layout(); plt.savefig('ct_learned_pd.png'); plt.show()
```

## Reference

*Adler & Oktem, IEEE TMI 2018 — 36.2 dB on LoDoPaB*

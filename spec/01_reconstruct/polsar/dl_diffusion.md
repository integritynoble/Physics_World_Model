# Polarimetric SAR (PolSAR) — RS-Diffusion
...
Polarimetric SAR (PolSAR) reconstruction problem.
...
import h5py
with h5py.File('polsar_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/polsar/public/
...
plt.tight_layout(); plt.savefig('polsar_dl_diffusion.png'); plt.show()
```

# Compressed Ultrafast Photography (CUP) — Unrolled-Net
...
Compressed Ultrafast Photography (CUP) reconstruction problem.
...
import h5py
with h5py.File('cup_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/cup/public/
...
plt.tight_layout(); plt.savefig('cup_dl_unrolled.png'); plt.show()
```

# Structured-Light Depth Camera — Unrolled-Net
...
Structured-Light Depth Camera reconstruction problem.
...
import h5py
with h5py.File('structured_light_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/structured_light/public/
...
plt.tight_layout(); plt.savefig('structured_light_dl_unrolled.png'); plt.show()
```

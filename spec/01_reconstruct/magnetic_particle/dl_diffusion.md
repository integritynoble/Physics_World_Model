# Magnetic Particle Imaging (MPI) — DiffusionMed
...
Magnetic Particle Imaging (MPI) reconstruction problem.
...
import h5py
with h5py.File('magnetic_particle_public.h5', 'r') as f:   # download from GCS below
    y, x_true = f['y'][0], f['x_true'][0]
# GCS: gs://pwm-benchmark-datasets/datasets/Benchmark/magnetic_particle/public/
...
plt.tight_layout(); plt.savefig('magnetic_particle_dl_diffusion.png'); plt.show()
```

## Reference

*Diffusion model for medical imaging, 2024*
